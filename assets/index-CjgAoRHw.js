 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(w,$){var R=w.length;w.push($);e:for(;0<R;){var z=R-1>>>1,B=w[z];if(0<o(B,$))w[z]=$,w[R]=B,R=z;else break e}}function t(w){return w.length===0?null:w[0]}function a(w){if(w.length===0)return null;var $=w[0],R=w.pop();if(R!==$){w[0]=R;e:for(var z=0,B=w.length,F=B>>>1;z<F;){var X=2*(z+1)-1,Q=w[X],se=X+1,le=w[se];if(0>o(Q,R))se<B&&0>o(le,Q)?(w[z]=le,w[se]=R,z=se):(w[z]=Q,w[X]=R,z=X);else if(se<B&&0>o(le,R))w[z]=le,w[se]=R,z=se;else break e}}return $}function o(w,$){var R=w.sortIndex-$.sortIndex;return R!==0?R:w.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var d=[],u=[],f=1,m=null,g=3,h=!1,x=!1,p=!1,_=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(w){for(var $=t(u);$!==null;){if($.callback===null)a(u);else if($.startTime<=w)a(u),$.sortIndex=$.expirationTime,n(d,$);else break;$=t(u)}}function k(w){if(p=!1,v(w),!x)if(t(d)!==null)x=!0,W(C);else{var $=t(u);$!==null&&V(k,$.startTime-w)}}function C(w,$){x=!1,p&&(p=!1,y(E),E=-1),h=!0;var R=g;try{for(v($),m=t(d);m!==null&&(!(m.expirationTime>$)||w&&!L());){var z=m.callback;if(typeof z=="function"){m.callback=null,g=m.priorityLevel;var B=z(m.expirationTime<=$);$=e.unstable_now(),typeof B=="function"?m.callback=B:m===t(d)&&a(d),v($)}else a(d);m=t(d)}if(m!==null)var F=!0;else{var X=t(u);X!==null&&V(k,X.startTime-$),F=!1}return F}finally{m=null,g=R,h=!1}}var M=!1,S=null,E=-1,P=5,N=-1;function L(){return!(e.unstable_now()-N<P)}function D(){if(S!==null){var w=e.unstable_now();N=w;var $=!0;try{$=S(!0,w)}finally{$?J():(M=!1,S=null)}}else M=!1}var J;if(typeof b=="function")J=function(){b(D)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,O=A.port2;A.port1.onmessage=D,J=function(){O.postMessage(null)}}else J=function(){_(D,0)};function W(w){S=w,M||(M=!0,J())}function V(w,$){E=_(function(){w(e.unstable_now())},$)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(w){w.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,W(C))},e.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):P=0<w?Math.floor(1e3/w):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function(w){switch(g){case 1:case 2:case 3:var $=3;break;default:$=g}var R=g;g=$;try{return w()}finally{g=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(w,$){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var R=g;g=w;try{return $()}finally{g=R}},e.unstable_scheduleCallback=function(w,$,R){var z=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?z+R:z):R=z,w){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=R+B,w={id:f++,callback:$,priorityLevel:w,startTime:R,expirationTime:B,sortIndex:-1},R>z?(w.sortIndex=R,n(u,w),t(d)===null&&w===t(u)&&(p?(y(E),E=-1):p=!0,V(k,R-z))):(w.sortIndex=B,n(d,w),x||h||(x=!0,W(C))),w},e.unstable_shouldYield=L,e.unstable_wrapCallback=function(w){var $=g;return function(){var R=g;g=$;try{return w.apply(this,arguments)}finally{g=R}}}})(Vu);Pu.exports=Vu;var Lf=Pu.exports;/**
 * @license React
...
`,la=48,lb=[{facing:"N",label:"↑N",title:"朝北"},{facing:"S",label:"↓S",title:"朝南"},{facing:"E",label:"→E",title:"朝东"},{facing:"W",label:"←W",title:"朝西"}],Qd=.25,cb=2,qd=.1;function db({onBack:e}){const{state:n,dispatch:t}=Ce(),a=Ye.find(z=>z.id===n.map.id)??n.map,o=n.playerIds,s=a.width,i=a.height,l=I.useRef(null),[d,u]=I.useState({x:0,y:0,scale:1}),f=I.useRef(null),m=I.useRef(!1);I.useEffect(()=>{const z=l.current;if(!z)return;const B=z.clientWidth,F=z.clientHeight,X=s*la,Q=i*la;if(!B||!F)return;const se=Math.min(B/X,F/Q),le=Math.max(Qd,Math.min(1.2,se)),de=(B-X*le)/2,vn=(F-Q*le)/2;u({x:de,y:vn,scale:le})},[s,i]),I.useEffect(()=>{const z=l.current;if(!z)return;const B=F=>{F.preventDefault();const X=F.deltaY<0?qd:-qd;u(Q=>({...Q,scale:Math.min(cb,Math.max(Qd,Q.scale+X))}))};return z.addEventListener("wheel",B,{passive:!1}),()=>z.removeEventListener("wheel",B)},[]);const g=I.useCallback(z=>{z.button===0&&(f.current={startX:z.clientX,startY:z.clientY,origX:d.x,origY:d.y},m.current=!1)},[d.x,d.y]),h=I.useCallback(z=>{if(!f.current)return;const B=z.clientX-f.current.startX,F=z.clientY-f.current.startY;!m.current&&Math.sqrt(B*B+F*F)>5&&(m.current=!0),m.current&&u(X=>({...X,x:f.current.origX+B,y:f.current.origY+F}))},[]),x=I.useCallback(()=>{f.current=null,m.current=!1},[]),p=I.useMemo(()=>Object.keys(a.startZones).map(Number).sort((z,B)=>z-B),[a]),[_,y]=I.useState(()=>{const z={};for(let B=0;B<n.teamCount;B++)z[B]=B;return z});I.useEffect(()=>{const z={};for(let B=0;B<n.teamCount;B++)z[B]=B;y(z)},[a.id,n.teamCount]);function b(z,B){y(F=>{const X=Object.entries(F).find(([,se])=>se===B),Q={...F,[z]:B};return X&&(Q[Number(X[0])]=F[z]),Q})}const v=I.useMemo(()=>{const z=new Map;for(let B=0;B<n.teamCount;B++){const F=_[B]??B,X=a.startZones[F];if(X)for(const Q of X){const se=`${Q.row},${Q.col}`,le=z.get(se)??[];le.push(B),z.set(se,le)}}return z},[a,n.teamCount,_]),k=I.useMemo(()=>{const z={};for(const B of o){const F=n.teams[B];z[F]||(z[F]=[]),z[F].push(B)}return z},[o,n.teams]),[C,M]=I.useState(o[0]),[S,E]=I.useState(""),P=I.useMemo(()=>{for(const z of o){const B=n.players[z];if(!B)return!1;const F=n.teams[z],X=_[F]??F,Q=a.startZones[X];if(!Q||!Q.some(le=>le.row===B.position.row&&le.col===B.position.col))return!1}return!0},[o,n.players,n.teams,_,a]);function N(z,B){t({type:"SET_SPAWN_POSITION",playerId:z,position:B})}function L(z,B){t({type:"SET_SPAWN_FACING",playerId:z,facing:B})}function D(){P&&t({type:"CONFIRM_SETUP"})}function J(z){return ht(n,z)}function A(z){var F;const B=(F=k[z])==null?void 0:F[0];return B?J(B):Mn[z%Mn.length][0]}const O=I.useMemo(()=>{const z=new Map;for(const B of o){const F=n.players[B];if(!F)continue;const X=q.find(le=>le.id===F.unitId);if(!X)continue;const Q=`${F.position.row},${F.position.col}`,se=z.get(Q)??[];se.push({pid:B,color:J(B),tokenId:X.tokenId,name:X.nameCn}),z.set(Q,se)}return z},[o,n.players]),{x:W,y:V,scale:w}=d,$=220,R=I.useMemo(()=>{const z={},se=Math.floor((window.innerHeight-56-60)/192);return o.forEach((le,de)=>{const vn=Math.floor(de/se),zn=de%se;z[le]={x:window.innerWidth-($+16)*(vn+1),y:56+zn*192}}),z},[o]);return r.jsxs("div",{className:"ssm__screen",children:[r.jsxs("div",{className:"ssm__topbar",children:[r.jsx("button",{className:"ssm__back-btn",onClick:e,children:"← 返回"}),r.jsx("span",{className:"ssm__title",children:"选择出击位置"}),r.jsxs("span",{className:"ssm__map-name",children:[a.nameCn," (",i,"×",s,")"]}),r.jsx("span",{style:{flex:1}}),r.jsx("button",{className:`ssm__start-btn${P?"":" ssm__start-btn--disabled"}`,onClick:D,disabled:!P,title:P?"开始战斗":"所有玩家必须先选择出击位置",children:"战斗开始 ▶"})]}),r.jsx("div",{className:"ssm__viewport",ref:l,onMouseDown:g,onMouseMove:h,onMouseUp:x,onMouseLeave:x,children:r.jsx("div",{className:"ssm__map-inner",style:{transform:`translate(${W}px, ${V}px) scale(${w})`,transformOrigin:"top left",display:"grid",gridTemplateColumns:`repeat(${s}, ${la}px)`,gridTemplateRows:`repeat(${i}, ${la}px)`},children:a.cells.flatMap((z,B)=>z.map((F,X)=>{const Q=bc(F),se=`${B},${X}`,le=v.get(se)??[],de=O.get(se)??[],vn=le.length>0,zn=le.length>0?A(le[0]):"",Aa=n.teams[C],Jt=vn&&le.includes(Aa);let Zn="ssm__cell";vn&&(Zn+=" ssm__cell--zone"),Jt&&(Zn+=" ssm__cell--placeable"),de.length>0&&(Zn+=" ssm__cell--selected");function re(ee){m.current||(ee.stopPropagation(),Jt&&N(C,{row:B,col:X}))}return r.jsxs("div",{className:Zn,style:{backgroundImage:`url("${Q}")`,...vn?{borderColor:zn,boxShadow:de.length>0?`inset 0 0 10px ${zn}66, 0 0 6px ${zn}44`:void 0}:{}},onClick:Jt?re:void 0,children:[de.length===1&&r.jsx("div",{className:"ssm__token",children:r.jsx("img",{src:`/assets/tokens/${de[0].tokenId}`,alt:de[0].name,style:{boxShadow:`0 0 6px ${de[0].color}`},onError:ee=>{ee.target.style.opacity="0.3"}})}),de.length>1&&r.jsx("div",{className:"ssm__token ssm__token--multi",children:de.map(ee=>r.jsx("img",{src:`/assets/tokens/${ee.tokenId}`,alt:ee.name,className:"ssm__token-img-sm",style:{boxShadow:`0 0 4px ${ee.color}`},onError:Be=>{Be.target.style.opacity="0.3"}},ee.pid))})]},se)}))})}),o.map((z,B)=>{var re;const F=n.players[z],X=q.find(ee=>ee.id===(F==null?void 0:F.unitId)),Q=J(z),se=S===z,le=C===z,de=n.teams[z],vn=((re=k[de])==null?void 0:re[0])===z,zn=_[de]??de,Aa=_[de]??de,Zn=(a.startZones[Aa]??[]).some(ee=>ee.row===F.position.row&&ee.col===F.position.col);return r.jsx(we,{id:`spawn-${z}`,title:`P${B+1} ${(X==null?void 0:X.nameCn)??"—"}`,initialPos:R[z]??{x:100,y:100},width:$,minHeight:60,zIndex:se?50:10+B,onFocus:()=>{E(z),M(z)},children:r.jsxs("div",{className:`ssm__player-card${le?" ssm__player-card--active":""}`,style:{borderTop:`2px solid ${Q}`},onClick:()=>M(z),children:[r.jsxs("div",{className:"ssm__player-label",style:{color:Q},children:["P",B+1," ",le?"◄ 放置中":""," ",Zn?"✓":""]}),vn&&r.jsx("div",{className:"ssm__zone-select",children:r.jsxs("label",{children:["出击区域:",r.jsx("select",{value:zn,onChange:ee=>b(de,Number(ee.target.value)),onClick:ee=>ee.stopPropagation(),children:p.slice(0,a.maxTeams).map(ee=>r.jsxs("option",{value:ee,children:["区域 ",ee+1]},ee))})]})}),r.jsx("div",{className:"ssm__unit-name",children:(X==null?void 0:X.nameCn)??"—"}),r.jsxs("div",{className:"ssm__pos-display",children:["格 (",F.position.row,", ",F.position.col,")"]}),r.jsx("div",{className:"ssm__facing-grid",children:lb.map(({facing:ee,label:Be,title:Ve})=>{const je=F.facing===ee;return r.jsx("button",{className:`ssm__facing-btn${je?" ssm__facing-btn--active":""}`,style:je?{borderColor:Q,color:Q}:void 0,title:Ve,onClick:()=>L(z,ee),children:Be},ee)})})]})},z)}),r.jsx("style",{children:ub})]})}const ub=`
.ssm__screen {
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`;function du(e,n){const t=Pm(e,n);if(t.length===0)return n;if(t.length===1)return t[0];const a=e.players[n].position;let o=t[0],s=1/0;for(const i of t){const l=e.players[i].position,d=Math.max(Math.abs(l.row-a.row),Math.abs(l.col-a.col));d<s&&(s=d,o=i)}return o}function lv(e,n){const t=e.players[n],a=[];for(let o=-1;o<=1;o++)for(let s=-1;s<=1;s++){if(o===0&&s===0)continue;const i=t.position.row+o,l=t.position.col+s;if(i<0||i>=e.map.height||l<0||l>=e.map.width)continue;const d={row:i,col:l};e.mines.some(u=>ve(u.position,d))||a.push(d)}return a}function Rr(e,n){for(const t of n)e({type:"ADD_LOG",message:t})}function cs(){const{state:e,getCard:n}=Ce(),{phase:t,currentTiming:a,turnOrder:o,pendingDamage:s,pendingArmorChoice:i}=e;if(t!=="action_seg1"&&t!=="action_seg2")return null;const l=t==="action_seg1"?1:2;return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"action-hud",style:s||i?{display:"none"}:void 0,children:[a==="movement"&&r.jsx(cv,{seg:l,turnOrder:o,getCard:n},`mov-${l}`),(a==="ranged"||a==="melee")&&r.jsx(uv,{seg:l,getCard:n},`combat-${l}-${a}`),a==="special"&&r.jsx(mv,{seg:l,turnOrder:o,getCard:n},`special-${l}`),r.jsx("style",{children:vi})]}),s&&r.jsxs(r.Fragment,{children:[r.jsx(gv,{pendingDamage:s,getCard:n}),r.jsx("style",{children:vi})]}),i&&r.jsxs(r.Fragment,{children:[r.jsx(fv,{pendingArmorChoice:i,getCard:n}),r.jsx("style",{children:vi})]})]})}function cv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:o,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m,playerIds:g}=a,[h,x]=I.useState(new Set),[p,_]=I.useState(null),[y,b]=I.useState([]),[v,k]=I.useState(null),[C,M]=I.useState("N"),S=I.useRef(!1),E=new Map;for(const $ of g){const R=a.players[$],z=q.find(B=>B.id===R.unitId);E.set($,Vh(R,e,t,z.movement))}I.useEffect(()=>{if(!(p!==null||v!==null)&&!S.current&&!(f||m)){if(i&&l){if(d!==l)return;if(E.get(l))_(l);else{const $=a.players[l],R=e===1?$.plotSeg1:$.plotSeg2;if(!R)o({type:"ADD_LOG",message:`  ${Te(l)} 未配置行动卡，跳过`});else{const z=t(R.defId);z&&z.actionType==="movement"&&o({type:"ADD_LOG",message:`  ${Te(l)}【${z.nameCn}】无法发动移动`})}S.current=!0,o({type:"ADVANCE_TIMING"})}return}for(const $ of n)if(!h.has($))if(E.get($)){_($);return}else{const R=a.players[$],z=e===1?R.plotSeg1:R.plotSeg2;if(!z)o({type:"ADD_LOG",message:`  ${Te($)} 未配置行动卡，跳过`});else{const B=t(z.defId);B&&B.actionType==="movement"&&o({type:"ADD_LOG",message:`  ${Te($)}【${B.nameCn}】无法发动移动`})}x(B=>new Set([...B,$]));return}S.current=!0,o({type:"ADVANCE_TIMING"})}},[h,p,v,f,m,d]),I.useEffect(()=>{if(!p){b([]);return}const $=a.players[p],R=g.filter(Q=>Q!==p).map(Q=>a.players[Q].position),z=q.find(Q=>Q.id===$.unitId),B=gn($,t,"movement"),F=ko($,e,t,B)||z.movement,X=Ds(u,$.position,F,R,B,$.facing);b(X.map(Q=>Q.pos))},[p,a.players,u,e]),I.useEffect(()=>{if(!p||i&&l&&p!==l||!Ae(s,p))return;const R=Pr(s,p),z=setTimeout(()=>{const B=$x(a,p,e,t,R);B&&(Rr(o,B.reasoning),o({type:"MOVE_UNIT",playerId:p,to:B.pos,path:B.path,finalFacing:B.finalFacing})),x(F=>new Set([...F,p])),_(null),b([])},800);return()=>clearTimeout(z)},[p]);function P($,R){if(!p||Ae(s,p)||!y.some(F=>ve(F,$)))return;let z=R;if(!z){const F=a.players[p],X=g.filter(de=>de!==p).map(de=>a.players[de].position),Q=q.find(de=>de.id===F.unitId),se=gn(F,t,"movement"),le=ko(F,e,t,se)||Q.movement;z=$s(u,F.position,F.facing,$,le,X,se)}const B=a.players[p];k({playerId:p,to:$,path:(z==null?void 0:z.path)??[]}),M(B.facing),b([]),_(null)}function N(){v&&(o({type:"MOVE_UNIT",playerId:v.playerId,to:v.to,path:v.path,finalFacing:C}),x($=>new Set([...$,v.playerId])),k(null),i&&(S.current=!0,o({type:"ADVANCE_TIMING"})))}if(i&&l&&d&&d!==l&&!p&&!v)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});const L=n.every($=>!E.get($)||h.has($));if(!i&&L&&p===null&&v===null||i&&S.current&&p===null&&v===null)return null;if(v!==null){const $=Te(v.playerId);return r.jsxs("div",{className:"action-hud__panel",children:[r.jsx("span",{className:"action-hud__mover",children:$}),r.jsx("span",{className:"action-hud__hint",children:"选择移动结束后的机头方向"}),r.jsx(Cc,{currentFacing:C,onSelectFacing:M}),r.jsx("button",{className:"action-hud__skip-btn",onClick:N,children:"确认移动"})]})}const D=p?Ae(s,p):!1,J=p?Te(p):"";if(D)return r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[J," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]});const A=p?a.players[p]:null,O=p&&A?gn(A,t,"movement"):null,W=A?q.find($=>$.id===A.unitId):null,V=p&&A&&W?ko(A,e,t,O??void 0)||W.movement:0,w=p?g.filter($=>$!==p).map($=>a.players[$].position):[];return r.jsxs(r.Fragment,{children:[p&&A&&r.jsx(dv,{reachable:y,map:u,from:A.position,fromFacing:A.facing,movementValue:V,blockedPositions:w,aux:O??void 0,onCellClick:P}),r.jsx("div",{className:"action-hud__panel",children:p?r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"action-hud__mover",children:J}),r.jsx("span",{className:"action-hud__hint",children:"选择目标格（步数须用尽；点击选择路径）"}),(O==null?void 0:O.vernier)&&r.jsx("span",{className:"action-hud__aux-badge",title:"地形移动消耗-1，高低差消耗-1",children:"⚙ 喷射推进器"}),(O==null?void 0:O.wheel)&&r.jsx("span",{className:"action-hud__aux-badge",title:"移动力+2",children:"⚙ 滑轮"})]}):r.jsx("span",{className:"action-hud__hint",children:"计算移动路径中…"})})]})}function Cc({currentFacing:e,onSelectFacing:n,disabledFacing:t}){const a=[{facing:"N",label:"↑N"},{facing:"E",label:"E→"},{facing:"S",label:"↓S"},{facing:"W",label:"←W"}];return r.jsxs("div",{className:"facing-compass",title:"调整机头朝向",children:[r.jsx("span",{className:"facing-compass__label",children:"机头"}),a.map(({facing:o,label:s})=>{const i=o===t;return r.jsx("button",{className:["facing-compass__btn",e===o?"facing-compass__btn--active":"",i?"facing-compass__btn--disabled":""].join(" ").trim(),onClick:()=>{i||n(o)},disabled:i,title:i?"当前规则下不可选":`朝${o}方`,children:s},o)})]})}function dv({reachable:e,map:n,from:t,fromFacing:a,movementValue:o,blockedPositions:s,aux:i,onCellClick:l}){const d=Ks(),u=I.useRef({allPaths:[],selectedIdx:0,hoveredPos:null}),[f,m]=I.useState(0),g=()=>m(x=>x+1);I.useEffect(()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(k=>k.classList.remove("board-cell--path-ghost"));const{allPaths:x,selectedIdx:p,hoveredPos:_}=u.current;if(!_||x.length===0)return;const y=x[p];if(!y)return;const b=y.path.slice(0,-1);for(const k of b){const C=document.querySelector(`.board-cell[data-row="${k.row}"][data-col="${k.col}"]`);C==null||C.classList.add("board-cell--path-ghost")}const v=document.querySelector(`.board-cell[data-row="${_.row}"][data-col="${_.col}"]`);return v&&(v.dataset.pathLabel=x.length>1?`${p+1}/${x.length}`:""),()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(k=>k.classList.remove("board-cell--path-ghost")),v&&delete v.dataset.pathLabel}},[f]),I.useEffect(()=>{const x=[];document.querySelectorAll(".board-cell--reachable").forEach(p=>{p.classList.remove("board-cell--reachable")});for(const p of e){const _=document.querySelector(`.board-cell[data-row="${p.row}"][data-col="${p.col}"]`);if(!_)continue;_.classList.add("board-cell--reachable");const y=()=>{const{allPaths:D,selectedIdx:J}=u.current;l(p,D[J]??null)},b=()=>{const D=Io(n,t,a,p,o,s,i);u.current={allPaths:D,selectedIdx:0,hoveredPos:p},g()},v=()=>{u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()},k=D=>{const{allPaths:J,selectedIdx:A}=u.current;if(J.length<=1)return;D.preventDefault();const O=D.deltaY>0?1:-1;u.current={...u.current,selectedIdx:(A+O+J.length)%J.length},g()};let C=null,M=0,S=0,E=!1;const P=D=>{if(M=D.touches[0].clientX,S=D.touches[0].clientY,E=!1,d){const{hoveredPos:J}=u.current;if(J&&J.row===p.row&&J.col===p.col)return;const A=Io(n,t,a,p,o,s,i);u.current={allPaths:A,selectedIdx:0,hoveredPos:p},g(),D.preventDefault();return}C=setTimeout(()=>{E=!0;const J=Io(n,t,a,p,o,s,i);u.current={allPaths:J,selectedIdx:0,hoveredPos:p},g()},400)},N=()=>{C&&(clearTimeout(C),C=null),E&&!d&&(u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()),E=!1},L=D=>{if(d||!E)return;const J=D.touches[0].clientX-M,A=D.touches[0].clientY-S;if(Math.abs(J)>40||Math.abs(A)>40){const{allPaths:O,selectedIdx:W}=u.current;if(O.length<=1)return;const V=Math.abs(J)>Math.abs(A)?J>0?1:-1:A>0?1:-1;u.current={...u.current,selectedIdx:(W+V+O.length)%O.length},g(),M=D.touches[0].clientX,S=D.touches[0].clientY}};_.addEventListener("click",y),_.addEventListener("mouseenter",b),_.addEventListener("mouseleave",v),_.addEventListener("wheel",k,{passive:!1}),_.addEventListener("touchstart",P,{passive:!0}),_.addEventListener("touchend",N),_.addEventListener("touchcancel",N),_.addEventListener("touchmove",L,{passive:!0}),x.push(()=>{C&&clearTimeout(C),_.removeEventListener("click",y),_.removeEventListener("mouseenter",b),_.removeEventListener("mouseleave",v),_.removeEventListener("wheel",k),_.removeEventListener("touchstart",P),_.removeEventListener("touchend",N),_.removeEventListener("touchcancel",N),_.removeEventListener("touchmove",L)})}return()=>{document.querySelectorAll(".board-cell--reachable").forEach(p=>p.classList.remove("board-cell--reachable")),document.querySelectorAll(".board-cell--path-ghost").forEach(p=>p.classList.remove("board-cell--path-ghost")),document.querySelectorAll(".board-cell[data-path-label]").forEach(p=>delete p.dataset.pathLabel),u.current={allPaths:[],selectedIdx:0,hoveredPos:null},x.forEach(p=>p())}},[e,n,t,a,o,s,i,l]);const h=I.useCallback(()=>{const{allPaths:x,selectedIdx:p}=u.current;x.length<=1||(u.current={...u.current,selectedIdx:(p+1)%x.length},g())},[]);if(d){const{allPaths:x,hoveredPos:p}=u.current;if(p&&x.length>1)return r.jsxs("button",{className:"move-cycle-btn",onClick:h,style:{position:"fixed",bottom:80,left:"50%",transform:"translateX(-50%)",zIndex:600,padding:"10px 24px",background:"rgba(22, 33, 62, 0.95)",border:"1px solid #ffea00",borderRadius:8,color:"#ffea00",fontFamily:"var(--font-mono)",fontSize:"0.85rem",fontWeight:"bold",cursor:"pointer",minHeight:44,backdropFilter:"blur(4px)"},children:["切换路径 (",u.current.selectedIdx+1,"/",x.length,")"]})}return null}function Zm({reachable:e,onCellClick:n}){return I.useEffect(()=>(document.querySelectorAll(".board-cell").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null}),e.forEach(a=>{const o=document.querySelector(`.board-cell[data-row="${a.row}"][data-col="${a.col}"]`);o&&(o.classList.add("board-cell--reachable"),o.onclick=()=>n(a))}),()=>{document.querySelectorAll(".board-cell--reachable").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null})}),[e,n]),null}function uv({seg:e,getCard:n}){const{state:t,dispatch:a,aiConfig:o,isOnline:s,localPlayerId:i,currentTurnPlayerId:l}=Ce(),{map:d,turnOrder:u,currentTiming:f,pendingDamage:m,pendingArmorChoice:g}=t,[h,x]=I.useState(new Set),[p,_]=I.useState(null),[y,b]=I.useState(null),v=I.useRef(!1),[k,C]=I.useState(null);I.useEffect(()=>{p&&C(du(t,p))},[p]);const[M,S]=I.useState(!1),[E,P]=I.useState([]),[N,L]=I.useState(!1),D=f==="ranged"?"ranged":"melee",J=D==="ranged"?"射击时机":"近战时机";if(I.useEffect(()=>{if(p===null&&!v.current&&!(m||g)){if(s&&i){if(l!==i)return;const re=t.players[i];if(Ln(re,e,D,n))_(i),S(!1),L(!1),P([]);else{const Be=e===1?re.plotSeg1:re.plotSeg2;if(Be){const Ve=n(Be.defId);Ve&&(D==="ranged"&&Ve.actionType==="ranged"||D==="melee"&&(Ve.actionType==="melee"||Ve.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(i)}【${Ve.nameCn}】条件不满足，无法发动`})}v.current=!0,a({type:"ADVANCE_TIMING"})}return}for(const re of u){if(h.has(re))continue;const ee=t.players[re];if(!Ln(ee,e,D,n)){const Ve=e===1?ee.plotSeg1:ee.plotSeg2;if(Ve){const je=n(Ve.defId);je&&(D==="ranged"&&je.actionType==="ranged"||D==="melee"&&(je.actionType==="melee"||je.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(re)}【${je.nameCn}】条件不满足，无法发动`})}x(je=>new Set([...je,re]));return}_(re),S(!1),L(!1),P([]);return}v.current=!0,a({type:"ADVANCE_TIMING"})}},[h,p,m,g,n,l]),I.useEffect(()=>{if(!p||m||g||s&&i&&p!==i||!Ae(o,p))return;const ee=Pr(o,p),Be=setTimeout(()=>{const Ve=Ax(t,p,e,D,n,ee);if(Rr(a,Ve.reasoning),Ve.shouldAttack){const je=t.players[p],Bt=Ln(je,e,D,n),mf=(Bt==null?void 0:Bt.actionType)==="charge"?"RESOLVE_CHARGE":D==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE";a({type:mf,attackerId:p,targetId:Ve.targetId})}else{const je=t.players[p],Bt=Ln(je,e,D,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${Bt?`【${Bt.nameCn}】`:J}`})}x(je=>new Set([...je,p])),_(null),S(!1),L(!1),P([])},800);return()=>clearTimeout(Be)},[p,m,g]),s&&i&&l&&l!==i&&!p)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(l)," 行动中…"]})});if(!p)return null;const A=t.players[p],O=Pm(t,p),W=k??du(t,p),V=t.players[W],w=f==="melee"?gn(A,n,"melee"):{vernier:!1,moveSensor:!1},$=Ln(A,e,D,n),R=($==null?void 0:$.actionType)==="charge",z=Ae(o,p),B=O.filter(re=>{const ee=t.players[re];if(R&&D==="melee"){const Be=q.find(je=>je.id===A.unitId),Ve=q.find(je=>je.id===ee.unitId);return qo(A,ee,e,d,Be,Ve,n).canAttack}return Qo(A,ee,e,D,d,n).canAttack});let F;if(R&&D==="melee"){const re=q.find(Be=>Be.id===A.unitId),ee=q.find(Be=>Be.id===V.unitId);F=qo(A,V,e,d,re,ee,n)}else F=Qo(A,V,e,D,d,n);const X=q.find(re=>re.id===A.unitId),Q=q.find(re=>re.id===V.unitId);function se(){if(!F.canAttack||!p)return;a({type:R?"RESOLVE_CHARGE":D==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE",attackerId:p,targetId:W}),b(`${X.nameCn} → ${Q.nameCn}：造成 ${F.damage} 伤害`),x(ee=>new Set([...ee,p])),_(null),S(!1),L(!1),P([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function le(){if(!p)return;const re=Ln(t.players[p],e,D,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${re?`【${re.nameCn}】`:J}`}),b(null),x(ee=>new Set([...ee,p])),_(null),S(!1),L(!1),P([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function de(){if(!p||M)return;const re=Km(d,A.position,[V.position]);P(re),L(!0)}function vn(re){!p||!N||(a({type:"MELEE_SENSOR_MOVE",playerId:p,to:re}),S(!0),L(!1),P([]))}function zn(){L(!1),P([])}const Aa=Te(p),Jt=F.card?R?`【${F.card.nameCn}】突击值 ${X.assault} vs 防御${Q.assaultDef}`:`【${F.card.nameCn}】射程 ${F.card.rangeMin??"—"}–${F.card.rangeMax??"—"}`:null,Zn=D==="melee"&&w.moveSensor&&!M;return z?r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[Te(p)," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):r.jsxs(r.Fragment,{children:[N&&r.jsx(Zm,{reachable:E,onCellClick:vn}),!N&&r.jsx(pv,{validTargets:B.map(re=>({playerId:re,pos:t.players[re].position})),selectedTargetId:W,onSelectTarget:C}),r.jsxs("div",{className:"action-hud__panel action-hud__panel--combat",children:[r.jsx("span",{className:"action-hud__mover",children:Aa}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__timing-label",children:J}),w.moveSensor&&r.jsxs("span",{className:`action-hud__aux-badge ${M?"action-hud__aux-badge--used":""}`,title:"近战前可移动1格",children:["⚙ 移动传感器",M?"（已使用）":""]}),w.vernier&&r.jsx("span",{className:"action-hud__aux-badge",title:"地形消耗-1，高低差-1",children:"⚙ 喷射推进器"}),(D==="melee"||D==="ranged"&&vc(F.card))&&r.jsx(Cc,{currentFacing:A.facing,onSelectFacing:re=>a({type:"ADJUST_FACING",playerId:p,facing:re})}),F.card?r.jsxs("span",{className:"action-hud__card-info",children:[Jt,F.card.damage!==void 0&&r.jsxs("span",{className:"action-hud__dmg",children:[" 伤害 ",F.card.damage]})]}):r.jsxs("span",{className:"action-hud__hint",children:["无",D==="ranged"?"射击":"近战","牌"]}),r.jsx("span",{className:`action-hud__validity ${F.canAttack?"action-hud__validity--ok":"action-hud__validity--no"}`,children:F.canAttack?R?`距离 ${F.dist} ✓ → 造成 ${F.damage} 伤 / 自机反伤 ${F.counterDamage}`:`距离 ${F.dist} ✓ → ${F.damage} 伤`:F.card?F.reason:""}),y&&r.jsx("span",{className:"action-hud__result",children:y}),N?r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"action-hud__hint",children:"点击高亮格移动（传感器），或"}),r.jsx("button",{className:"action-hud__skip-btn",onClick:zn,children:"取消移动"})]}):r.jsxs(r.Fragment,{children:[Zn&&r.jsx("button",{className:"action-hud__sensor-btn",onClick:de,title:"移动传感器：攻击前可移动1格",children:"传感器移动"}),B.length>1&&r.jsxs("span",{className:"action-hud__target-hint",children:["目标: ",Te(W)," (",Q.nameCn,") — 点击地图切换目标 (",B.length,"个可选)"]}),r.jsx("button",{className:"action-hud__attack-btn",onClick:se,disabled:!F.canAttack,title:F.canAttack?`攻击 ${Q.nameCn}`:F.reason,children:"执行攻击"}),r.jsxs("button",{className:"action-hud__skip-btn",onClick:le,children:["跳过",D==="ranged"?"射击":"近战"]})]})]})]})}function pv({validTargets:e,selectedTargetId:n,onSelectTarget:t}){return I.useEffect(()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null});for(const{playerId:a,pos:o}of e){const s=document.querySelector(`.board-cell[data-row="${o.row}"][data-col="${o.col}"]`);s&&(a===n?s.classList.add("board-cell--target"):(s.classList.add("board-cell--target-alt"),s.onclick=i=>{i.stopPropagation(),t(a)}))}return()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null})}},[e,n,t]),null}function mv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:o,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m}=a,[g,h]=I.useState(new Set),[x,p]=I.useState(null),[_,y]=I.useState([]),[b,v]=I.useState("real"),[k,C]=I.useState([]),M=I.useRef(!1);if(I.useEffect(()=>{if(x===null&&!M.current&&!(f||m)){if(i&&l){if(d!==l)return;const V=a.players[l],w=e===1?V.plotSeg1:V.plotSeg2,$=w?t(w.defId):null;!$||$.actionType!=="mine"&&$.actionType!=="special"&&$.actionType!=="aim"?(M.current=!0,o({type:"ADVANCE_TIMING"})):p(l);return}for(const V of n){if(g.has(V))continue;const w=a.players[V],$=e===1?w.plotSeg1:w.plotSeg2,R=$?t($.defId):null;if(!R||R.actionType!=="mine"&&R.actionType!=="special"&&R.actionType!=="aim"){h(z=>new Set([...z,V]));return}p(V);return}M.current=!0,o({type:"ADVANCE_TIMING"})}},[g,x,f,m,t,d]),I.useEffect(()=>{if(!x){y([]),C([]),v("real");return}const V=a.players[x],w=e===1?V.plotSeg1:V.plotSeg2,$=w?t(w.defId):null;if($&&$.actionType==="mine"){const R=lv(a,x);y(R)}else y([]),C([]),v("real")},[x,u,e,a,t]),I.useEffect(()=>{if(!x||f||m||i&&l&&x!==l||!Ae(s,x))return;const w=Pr(s,x),$=setTimeout(()=>{const R=Px(a,x,e,t,w);R&&(Rr(o,R.reasoning),R.actionType==="mine"?o({type:"PLACE_MINE",playerId:x,placements:R.placements,damage:R.damage}):R.actionType==="aim"&&o({type:"ADJUST_FACING",playerId:x,facing:R.facing})),h(z=>new Set([...z,x])),p(null)},800);return()=>clearTimeout($)},[x,f,m]),i&&l&&d&&d!==l&&!x)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});if(!x)return null;const S=a.players[x],E=e===1?S.plotSeg1:S.plotSeg2,P=E?t(E.defId):null,N=Te(x),L=k.filter(V=>V.kind==="real").length,D=k.filter(V=>V.kind==="dummy").length,J=Ae(s,x);function A(){C([]),v("real"),h(V=>new Set([...V,x])),p(null),i&&(M.current=!0,o({type:"ADVANCE_TIMING"}))}function O(V){!x||!P||P.actionType!=="mine"||_.some(w=>ve(w,V))&&C(w=>w.find(z=>ve(z.position,V))?w.filter(z=>!ve(z.position,V)):w.length>=4||w.filter(z=>z.kind===b).length>=2?w:[...w,{position:V,kind:b}])}function W(){!x||!P||P.actionType!=="mine"||k.length!==4||L!==2||D!==2||(o({type:"PLACE_MINE",playerId:x,placements:k,damage:P.damage||3}),C([]),v("real"),h(V=>new Set([...V,x])),p(null),i&&(M.current=!0,o({type:"ADVANCE_TIMING"})))}return J?r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[N," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):r.jsxs(r.Fragment,{children:[_.length>0&&r.jsx(Zm,{reachable:_,onCellClick:O}),r.jsxs("div",{className:"action-hud__panel action-hud__panel--special",children:[r.jsx("span",{className:"action-hud__mover",children:N}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__timing-label",children:"特殊时机"}),r.jsx("span",{className:"action-hud__card-info",children:P?`【${P.nameCn}】效果`:"（无）"}),(P==null?void 0:P.actionType)==="mine"?r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"action-hud__facing-row",children:[r.jsxs("button",{className:`action-hud__facing-btn${b==="real"?" is-selected":""}`,onClick:()=>v("real"),disabled:L>=2,children:["机雷 ",L,"/2"]}),r.jsxs("button",{className:`action-hud__facing-btn${b==="dummy"?" is-selected":""}`,onClick:()=>v("dummy"),disabled:D>=2,children:["替身雷 ",D,"/2"]})]}),r.jsxs("span",{className:"action-hud__hint",children:["点击高亮格放置 ",b==="real"?"机雷":"替身雷","，再次点击已选格可取消。"]}),r.jsxs("span",{className:"action-hud__hint",children:["当前已选 ",k.length,"/4 个指示物，需放满真雷2个与替身雷2个。"]}),r.jsx("button",{className:"action-hud__attack-btn",onClick:W,disabled:k.length!==4||L!==2||D!==2,children:"确认布雷"})]}):(P==null?void 0:P.actionType)==="aim"?r.jsxs(r.Fragment,{children:[r.jsx(Cc,{currentFacing:S.facing,onSelectFacing:V=>o({type:"ADJUST_FACING",playerId:x,facing:V})}),r.jsx("span",{className:"action-hud__hint",children:"可先调整朝向，然后"})]}):r.jsx("span",{className:"action-hud__hint",children:"暂无此牌效果支持，请"}),r.jsx("button",{className:"action-hud__skip-btn",onClick:A,children:(P==null?void 0:P.actionType)==="aim"?"确认":"跳过"})]})]})}function fv({pendingArmorChoice:e,getCard:n}){const{dispatch:t,aiConfig:a,isOnline:o,localPlayerId:s}=Ce(),{zoom:i,getZoomHandlers:l}=Ot(),{targetId:d,damage:u,source:f,handCards:m,plotCards:g}=e,[h,x]=I.useState(null),[p,_]=I.useState(new Set),y=o&&s&&d!==s,b=!y&&Ae(a,d);I.useEffect(()=>{b?x(d):o||x(null)},[d,b,o]),I.useEffect(()=>{if(!b||y)return;const N=Vx(u,m,g),L=setTimeout(()=>{Rr(t,N.reasoning),t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:N.value})},500);return()=>clearTimeout(L)},[d,b,y,u,m,g,t]);function v(N){_(L=>{const D=new Set(L);return D.has(N)?D.delete(N):D.add(N),D})}function k(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[...p]})}function C(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[]})}const M=[...p].reduce((N,L)=>{const D=g.find(A=>A.instanceId===L);if(D)return N+D.armorValue;const J=m.find(A=>A.instanceId===L);return N+((J==null?void 0:J.armorValue)??0)},0),S=Math.max(0,u-M),E=f==="ranged"?"射击":f==="charge"?"突击":f==="mine"?"机雷":"近战",P=Te(d);return y?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),r.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),r.jsx("div",{className:"damage-pass__player",children:P}),r.jsxs("p",{className:"damage-pass__context",children:[P," 正在决定是否激活装甲牌…"]}),r.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),r.jsx("style",{children:ds})]}):!o&&!b&&d!==h?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),r.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),r.jsx("div",{className:"damage-pass__player",children:P}),r.jsxs("p",{className:"damage-pass__context",children:["受到 ",u," 点",E,"伤害，可激活装甲牌减伤"]}),r.jsxs("button",{className:"damage-pass__btn",onClick:()=>x(d),children:[P," 已准备"]})]})}),r.jsx("style",{children:ds})]}):r.jsxs("div",{className:"action-hud",children:[r.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[r.jsxs("div",{className:"damage-panel__header",children:[r.jsx("span",{className:"damage-panel__title",children:"🛡 装甲激活"}),r.jsx("span",{className:"damage-panel__player",children:P}),r.jsxs("span",{className:"damage-panel__remaining",children:["受到 ",r.jsx("strong",{children:u})," 点",E,"伤害",M>0&&r.jsxs(r.Fragment,{children:[" → 减免后 ",r.jsx("strong",{className:"armor-reduced",children:S})," 点"]})]})]}),r.jsx("div",{className:"damage-panel__hint",children:f==="ranged"?"手牌中的装甲牌可防御射击伤害；准备区中的装甲牌可防御任意伤害。选择要激活的装甲牌，或跳过。":"准备区中的装甲牌可防御任意伤害（含突击/近战）。选择要激活的装甲牌，或跳过。"}),r.jsxs("div",{className:"damage-panel__zones",children:[m.length>0&&r.jsxs("div",{className:"damage-zone",children:[r.jsx("span",{className:"damage-zone__label",children:"手牌装甲"}),r.jsx("div",{className:"damage-zone__cards",children:m.map(N=>{const L=n(N.defId),D=p.has(N.instanceId),J=l((L==null?void 0:L.frontImageId)??"");return r.jsxs("button",{className:`damage-card-btn ${D?"damage-card-btn--selected":""}`,onClick:()=>v(N.instanceId),...J,children:[r.jsx("span",{className:"damage-card-btn__name",children:(L==null?void 0:L.nameCn)??N.defId}),r.jsxs("span",{className:"armor-value-badge",children:["-",N.armorValue]})]},N.instanceId)})})]}),g.length>0&&r.jsxs("div",{className:"damage-zone",children:[r.jsx("span",{className:"damage-zone__label",children:"准备区装甲"}),r.jsx("div",{className:"damage-zone__cards",children:g.map(N=>{const L=n(N.defId),D=p.has(N.instanceId),J=l((L==null?void 0:L.frontImageId)??"");return r.jsxs("button",{className:`damage-card-btn ${D?"damage-card-btn--selected":""}`,onClick:()=>v(N.instanceId),...J,children:[r.jsx("span",{className:"damage-card-btn__name",children:(L==null?void 0:L.nameCn)??N.defId}),r.jsxs("span",{className:"damage-zone__sub",children:["主要阶段",N.seg]}),r.jsxs("span",{className:"armor-value-badge",children:["-",N.armorValue]})]},N.instanceId)})})]})]}),r.jsxs("div",{className:"damage-panel__actions",children:[r.jsxs("button",{className:"action-hud__attack-btn",onClick:k,disabled:p.size===0,children:["激活选中装甲 (-",M," 点)"]}),r.jsx("button",{className:"action-hud__skip-btn",onClick:C,children:"不使用装甲"})]})]}),r.jsx(Kt,{zoom:i})]})}function gv({pendingDamage:e,getCard:n}){const{state:t,dispatch:a,aiConfig:o,isOnline:s,localPlayerId:i}=Ce(),{targetId:l,remaining:d,selectedInstanceIds:u}=e,{zoom:f,getZoomHandlers:m}=Ot(),[g,h]=I.useState(null),[x,p]=I.useState(!1),_=t.players[l];$n(_);const y=u.length===0,b=!!e.attackerId&&y&&!e.attackerDesignatedCardId,v=b?e.attackerId:l,k=Te(v),C=s&&i&&v!==i,M=!C&&Ae(o,v),S=Pr(o,v),E=!s&&!M&&v!==g;I.useEffect(()=>{M?h(v):s||h(null)},[v,M,s]),I.useEffect(()=>{if(!M||C||d<=0)return;const w=t.players[l],$=Sa(w),R=t.playerIds.filter(F=>F!==l&&t.teams[F]!==t.teams[l]&&!t.players[F].isDefeated),z=R.length>0?t.players[R[0]]:w,B=setTimeout(()=>{if($.length>0){const F=Hd(e,w,n,S,b,z);Rr(a,F.reasoning),F.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:F.value}):a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})},600);return()=>clearTimeout(B)},[d,v,M,C,t.players]),I.useEffect(()=>{if(!x)return;if(d<=0){p(!1);return}const w=t.players[l],$=Sa(w),R=setTimeout(()=>{if($.length>0){const z=t.playerIds.filter(X=>X!==l&&t.teams[X]!==t.teams[l]&&!t.players[X].isDefeated),B=z.length>0?t.players[z[0]]:w,F=Hd(e,w,n,"hard",b,B);F.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:F.value}):(a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1))}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1)},150);return()=>clearTimeout(R)},[x,d,t.players]);function P(w){a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:w})}function N(){p(!0)}if(C)return r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),r.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),r.jsx("div",{className:"damage-pass__player",children:k}),r.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方正在指定要摧毁的卡牌…":`${k} 正在选择要摧毁的 ${d} 张卡牌…`}),r.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),r.jsx("style",{children:ds})]});if(E)return r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),r.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),r.jsx("div",{className:"damage-pass__player",children:k}),r.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方有权指定第一张要摧毁的卡牌":`防方选择要摧毁的 ${d} 张卡牌（可自动分配）`}),r.jsxs("button",{className:"damage-pass__btn",onClick:()=>h(v),children:[k," 已准备"]})]})}),r.jsx("style",{children:ds})]});const L=_.hand.filter(w=>!w.destroyed),D=_.plotSeg1&&!_.plotSeg1.destroyed?[_.plotSeg1]:[],J=_.plotSeg2&&!_.plotSeg2.destroyed?[_.plotSeg2]:[],A=_.auxiliary.filter(w=>!w.destroyed),O=_.deck.filter(w=>!w.destroyed),W=[];L.length>0&&W.push({label:"手牌",cards:L}),D.length>0&&W.push({label:"布局格",sublabel:"主要阶段1",cards:D}),J.length>0&&W.push({label:"布局格",sublabel:"主要阶段2",cards:J}),A.length>0&&W.push({label:"辅助区",cards:A});const V=O[0]??null;return r.jsxs("div",{className:"action-hud",children:[r.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[r.jsxs("div",{className:"damage-panel__header",children:[r.jsx("span",{className:"damage-panel__title",children:"⚔️ 伤害分配"}),r.jsx("span",{className:"damage-panel__player",children:b?`${k} (瞄准指定)`:k}),r.jsxs("span",{className:"damage-panel__remaining",children:["还需摧毁 ",r.jsx("strong",{children:d})," 张卡牌"]})]}),(e.destroyedBombCount??0)>0&&r.jsxs("div",{className:"damage-panel__bomb-alert",children:["💣 已选中 ",e.destroyedBombCount," 张炸弹卡，选完后将进行誘爆检查"]}),r.jsx("div",{className:"damage-panel__hint",children:b?`【瞄准加成】攻方有权指定第一张要摧毁的卡牌！可从手牌、辅助区、卡组、布局格中选择。请 ${k} 选择：`:e.source==="ranged"?"射击伤害：须先从手牌 / 布局格 / 辅助区选择卡牌破坏，不足部分自动从牌组顶破坏。":"牌组与弃牌区已耗尽，近战伤害切换为自选模式。请从手牌 / 布局格 / 辅助区选择。"}),r.jsxs("div",{className:"damage-panel__zones",children:[W.map((w,$)=>r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:[w.label,w.sublabel&&r.jsxs("span",{className:"damage-zone__sub",children:["（",w.sublabel,"）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:w.cards.map(R=>{const z=n(R.defId),B=(z==null?void 0:z.nameCn)??R.defId,F=u.includes(R.instanceId),X=z!=null&&z.frontImageId?`/assets/${z.frontImageId}`:null;return r.jsxs("button",{className:`damage-card-btn ${F?"damage-card-btn--selected":""} ${z!=null&&z.hasBombIcon?"damage-card-btn--bomb":""}`,onClick:()=>P(R.instanceId),disabled:F,title:`${B} (${(z==null?void 0:z.actionType)??"?"})${z!=null&&z.hasBombIcon?" ⚠️ 含诱爆":""}`,...X?m(X):{},children:[r.jsx("span",{className:"damage-card-btn__name",children:B}),(z==null?void 0:z.isKaiVariant)&&r.jsx("span",{className:"damage-card-btn__det",title:"改型",children:"◆"}),(z==null?void 0:z.hasBombIcon)&&r.jsx("span",{className:"damage-card-btn__det damage-card-btn__bomb-icon",title:"诱爆卡",children:"💣"})]},R.instanceId)})})]},$)),V&&(e.source!=="ranged"||b)&&r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:["卡组",r.jsxs("span",{className:"damage-zone__sub",children:["（共 ",O.length," 张，正面朝下）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:r.jsxs("button",{className:"damage-card-btn damage-card-btn--deck",onClick:()=>P(V.instanceId),title:"从卡组顶部翻开并摧毁 1 张（诱爆正常触发）",children:[r.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),r.jsx("span",{className:"damage-card-btn__name",children:"顶部 × 1"})]})})]}),V&&e.source==="ranged"&&!b&&r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:["卡组",r.jsxs("span",{className:"damage-zone__sub",children:["（共 ",O.length," 张）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:r.jsxs("div",{className:"damage-card-btn damage-card-btn--deck",style:{opacity:.5,cursor:"default"},title:"射击伤害的牌组部分将在选完表牌后自动从顶部破坏",children:[r.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),r.jsx("span",{className:"damage-card-btn__name",children:"自动破坏"})]})})]})]}),r.jsx("div",{className:"damage-panel__actions",children:r.jsx("button",{className:"action-hud__skip-btn",onClick:N,disabled:x,title:"智能选择价值最低的卡牌优先破坏，剩余部分从牌组顶部自动摧毁",children:x?"自动分配中…":"智能分配剩余伤害"})})]}),r.jsx(Kt,{zoom:f})]})}const vi=`
.action-hud {
...
`),l=new Blob([i],{type:"text/plain;charset=utf-8"}),d=URL.createObjectURL(l),u=document.createElement("a");u.href=d,u.download=`embryo-log-${a}.txt`,u.click(),URL.revokeObjectURL(d)}const yu=[1e3,2e3,4e3,8e3,15e3];class d1{constructor(n,t,a){en(this,"ws",null);en(this,"url");en(this,"sessionId");en(this,"onMessage");en(this,"onStatus");en(this,"reconnectAttempt",0);en(this,"reconnectTimer",null);en(this,"intentionallyClosed",!1);en(this,"hasEverConnected",!1);this.url=n,this.sessionId=localStorage.getItem("embryo-session-id"),this.onMessage=t,this.onStatus=a}connect(){this.intentionallyClosed=!1,this.onStatus("connecting");const n=this.sessionId?`?sessionId=${this.sessionId}`:"";this.ws=new WebSocket(`${this.url}${n}`),this.ws.onopen=()=>{var t;if(this.intentionallyClosed){(t=this.ws)==null||t.close(),this.ws=null,this.onStatus("disconnected");return}this.hasEverConnected=!0,this.reconnectAttempt=0,this.onStatus("connected")},this.ws.onmessage=t=>{try{const a=JSON.parse(t.data);a.type==="SESSION_ID"&&(this.sessionId=a.sessionId,localStorage.setItem("embryo-session-id",a.sessionId)),this.onMessage(a)}catch{console.warn("[GameSocket] Failed to parse message:",t.data)}},this.ws.onclose=()=>{if(this.intentionallyClosed){this.onStatus("disconnected");return}this.hasEverConnected||(this.sessionId=null,localStorage.removeItem("embryo-session-id")),this.onStatus("reconnecting"),this.scheduleReconnect()},this.ws.onerror=()=>{}}send(n){var t;((t=this.ws)==null?void 0:t.readyState)===WebSocket.OPEN?this.ws.send(JSON.stringify(n)):console.warn("[GameSocket] Cannot send — not connected")}disconnect(){if(this.intentionallyClosed=!0,this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws){const n=this.ws.readyState;n===WebSocket.OPEN||n===WebSocket.CLOSING?(this.ws.close(),this.ws=null):n===WebSocket.CONNECTING&&(this.ws.onmessage=null,this.ws.onerror=null)}this.onStatus("disconnected")}clearSession(){this.sessionId=null,localStorage.removeItem("embryo-session-id")}get isConnected(){var n;return((n=this.ws)==null?void 0:n.readyState)===WebSocket.OPEN}scheduleReconnect(){const n=yu[Math.min(this.reconnectAttempt,yu.length-1)];this.reconnectAttempt++,this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect()},n)}}const lf=I.createContext(null);function u1({serverUrl:e,children:n}){const[t,a]=I.useState(null),[o,s]=I.useState(null),[i,l]=I.useState(null),[d,u]=I.useState("disconnected"),[f,m]=I.useState(null),[g,h]=I.useState(null),[x,p]=I.useState([]),[_,y]=I.useState(null),[b,v]=I.useState(null),[k,C]=I.useState(null),[M,S]=I.useState([]),E=I.useRef(null),P=I.useRef(null),N=I.useRef(-1),L=I.useRef([]),D=I.useCallback(w=>{switch(w.type){case"SESSION_ID":break;case"ROOM_STATE":s(w.room),l(w.yourPlayerId);break;case"ROOM_LIST":p(w.rooms);break;case"GAME_STATE":{w.state.phase==="plotting"&&(P.current!=="plotting"||N.current!==w.state.roundNumber)&&m(null),P.current=w.state.phase,N.current=w.state.roundNumber,a(w.state),l(w.yourPlayerId),y(w.currentTurnPlayerId??null),v(w.turnDeadline??null),w.replayActions&&w.replayActions.length>0?(L.current=[...L.current,...w.replayActions],S(w.replayActions)):S([]);break}case"PLOTTING_STATUS":m({confirmed:w.confirmed,total:w.total});break;case"GAME_STARTED":w.initialState&&(C(w.initialState),L.current=[],S([]));break;case"RECONNECTED":s(w.room),a(w.state),l(w.yourPlayerId),y(w.currentTurnPlayerId??null),v(w.turnDeadline??null),P.current=w.state.phase,N.current=w.state.roundNumber,w.initialState&&C(w.initialState),w.replayActions&&(L.current=w.replayActions,S([]));break;case"SPECTATE_STATE":a(w.state),s(w.room),l(null);break;case"ACTION_REJECTED":h(w.reason),setTimeout(()=>h(null),5e3);break;case"PLAYER_JOINED":case"PLAYER_LEFT":case"PLAYER_RECONNECTED":case"PLAYER_DISCONNECTED":break;case"ERROR":h(w.message),setTimeout(()=>h(null),5e3);break}},[]);I.useEffect(()=>{const w=new d1(e,D,u);return E.current=w,w.connect(),()=>{w.clearSession(),w.disconnect(),E.current=null}},[e,D]);const J=I.useCallback(w=>{var $;($=E.current)==null||$.send({type:"GAME_ACTION",action:w})},[]),A=I.useCallback(w=>{var $;($=E.current)==null||$.send({type:"LOBBY_ACTION",action:w})},[]),O=I.useCallback(w=>{var $;($=E.current)==null||$.send(w)},[]),W=I.useCallback(w=>te(w),[]),V={state:t,room:o,localPlayerId:i,dispatch:J,sendLobbyAction:A,send:O,getCard:W,connectionStatus:d,plottingStatus:f,isOnline:!0,lastError:g,roomList:x,currentTurnPlayerId:_,turnDeadline:b,replayInitialState:k,replayActions:L.current,latestDeltaActions:M};return r.jsx(lf.Provider,{value:V,children:n})}function Ec(){const e=I.useContext(lf);if(!e)throw new Error("useOnlineGame must be used within OnlineGameProvider");return e}function p1({children:e}){var $;const{state:n,localPlayerId:t,dispatch:a,getCard:o,plottingStatus:s,send:i,currentTurnPlayerId:l,replayInitialState:d,replayActions:u,latestDeltaActions:f,room:m}=Ec(),[g,h]=I.useState(!0),x=I.useRef(-1),p=I.useRef(null),_={player1:!1,player2:!1,player1Difficulty:"hard",player2Difficulty:"hard"},y=(($=m==null?void 0:m.settings)==null?void 0:$.simplifiedMode)!==!1,[b,v]=I.useState(n),k=I.useRef(b);k.current=b;const C=I.useRef(-1),[,M]=I.useState(0),S=I.useCallback(R=>{v(z=>on(z,R))},[]),E=Gm(S,k),{isAnimating:P}=Ea(),N=I.useRef([]),L=I.useRef(n);I.useEffect(()=>{n&&n!==L.current&&(L.current=n,y?(v(n),N.current=[]):f&&f.length>0?N.current.push(...f):(v(n),N.current=[]))},[n,f,y]),I.useEffect(()=>{if(!P&&N.current.length>0){const R=N.current.shift();E(R),N.current.length===0&&setTimeout(()=>v(L.current),200)}},[P,E]);const D=I.useCallback(R=>{if(R.type==="ADVANCE_TIMING"||R.type==="ADVANCE_PHASE"){i({type:"TIMING_DONE"});return}R.type==="START_PLOTTING"||R.type==="DRAW_CARDS"||(R.type==="CONFIRM_PLOT"&&(C.current=k.current.roundNumber,M(z=>z+1)),a(R))},[a,i]),J=I.useCallback(()=>d?{initialState:d,actions:[...u]}:null,[d,u]);if(I.useEffect(()=>{if(!(!g||!n)){if(n.phase==="plotting"&&p.current!=="plotting"&&n.roundNumber!==x.current){x.current=n.roundNumber;try{Sc("auto",n,_,!0)}catch{}}p.current=n.phase}},[g,n]),!n||!t)return null;let A=b;const O=C.current===A.roundNumber;if(A.phase==="plotting"){const R=O||((s==null?void 0:s.confirmed.includes(t))??!1);A={...A,plottingStep:R?"waiting_online":t}}const W=(()=>{if(!O)return s;const R=s??{confirmed:[],total:n.playerIds.filter(z=>!n.players[z].isDefeated).length};return R.confirmed.includes(t)?R:{...R,confirmed:[...R.confirmed,t]}})(),V={player1:t!=="player1",player2:t!=="player2",player1Difficulty:"easy",player2Difficulty:"easy",playerAI:Object.fromEntries(n.playerIds.map(R=>[R,R!==t])),playerDifficulty:Object.fromEntries(n.playerIds.map(R=>[R,"easy"]))},w={state:A,dispatch:D,rawDispatch:D,getCard:o,aiConfig:V,setAIConfig:()=>{},getReplayData:J,autoSaveEnabled:g,setAutoSaveEnabled:h,exposureMode:!1,setExposureMode:()=>{},isOnline:!0,localPlayerId:t,currentTurnPlayerId:l,plottingStatus:W};return r.jsx(Os.Provider,{value:w,children:e})}const m1={lobby:"等待中",playing:"游戏中",finished:"已结束"};function cf({onBack:e,onCreateRoom:n,onJoinRoom:t,roomList:a,onRefreshRooms:o,onSpectate:s}){const[i,l]=I.useState("create"),[d,u]=I.useState(()=>localStorage.getItem("embryo-player-name")??""),[f,m]=I.useState(""),[g,h]=I.useState(""),[x,p]=I.useState(2),[_,y]=I.useState(2),[b,v]=I.useState(Ye[0].id);function k(w){const $=[];for(let R=2;R<=w;R++)w%R===0&&$.push(R);return $}function C(w){p(w);const $=k(w);$.includes(_)||y($[0]);const R=Ye.find(z=>z.id===b);if(!R||R.maxPlayers<w){const z=Ye.find(B=>B.maxPlayers>=w);z&&v(z.id)}}const[M,S]=I.useState(""),[E,P]=I.useState(!1),[N,L]=I.useState(0),[D,J]=I.useState(!0);function A(){const w=d.trim()||`Player_${Math.random().toString(36).slice(2,6)}`;return localStorage.setItem("embryo-player-name",w),w}function O(){n(A(),{maxPlayers:x,teamCount:_,mapId:b,turnTimeoutSeconds:N,password:E?M:void 0,simplifiedMode:D})}function W(){const w=f.trim().toUpperCase();w&&t(w,A(),g||void 0)}function V(w,$){m(w),$?(l("join"),h("")):t(w,A())}return r.jsxs("div",{className:"ol-screen",children:[r.jsxs("div",{className:"ol-center",children:[r.jsx("h1",{className:"ol-title",children:"联机对战"}),r.jsx("p",{className:"ol-subtitle",children:"创建、加入或浏览房间"}),r.jsx("div",{className:"ol-divider"}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"昵称"}),r.jsx("input",{className:"ol-input",value:d,onChange:w=>u(w.target.value),placeholder:"输入昵称…",maxLength:16})]}),r.jsxs("div",{className:"ol-tabs",children:[r.jsx("button",{className:`ol-tab${i==="create"?" ol-tab--active":""}`,onClick:()=>l("create"),children:"创建房间"}),r.jsx("button",{className:`ol-tab${i==="join"?" ol-tab--active":""}`,onClick:()=>l("join"),children:"加入房间"}),r.jsx("button",{className:`ol-tab${i==="browse"?" ol-tab--active":""}`,onClick:()=>{l("browse"),o==null||o()},children:"浏览房间"})]}),i==="create"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"最大玩家数"}),r.jsx("select",{className:"ol-select",value:x,onChange:w=>C(+w.target.value),children:[2,3,4,5,6,7,8].map(w=>r.jsxs("option",{value:w,children:[w," 人"]},w))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"队伍数量"}),r.jsx("select",{className:"ol-select",value:_,onChange:w=>y(+w.target.value),children:k(x).map(w=>r.jsxs("option",{value:w,children:[w," 队 (",x/w,"人/队)"]},w))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"地图"}),r.jsx("select",{className:"ol-select",value:b,onChange:w=>v(w.target.value),children:Ye.filter(w=>w.maxPlayers>=x).map(w=>r.jsxs("option",{value:w.id,children:[w.nameCn," (",w.maxPlayers,"人)"]},w.id))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"回合限时"}),r.jsxs("select",{className:"ol-select",value:N,onChange:w=>L(+w.target.value),children:[r.jsx("option",{value:0,children:"无限制"}),r.jsx("option",{value:30,children:"30 秒"}),r.jsx("option",{value:60,children:"60 秒"}),r.jsx("option",{value:90,children:"90 秒"}),r.jsx("option",{value:120,children:"120 秒"})]})]}),r.jsxs("label",{className:"ol-check",onClick:()=>J(!D),children:[r.jsx("span",{className:`ol-check__box${D?" ol-check__box--on":""}`,children:D?"✓":""}),r.jsx("span",{children:"简易模式（无战斗动画，快速结算）"})]}),r.jsxs("label",{className:"ol-check",onClick:()=>P(!E),children:[r.jsx("span",{className:`ol-check__box${E?" ol-check__box--on":""}`,children:E?"✓":""}),r.jsx("span",{children:"设置房间密码"})]}),E&&r.jsx("div",{className:"ol-field",children:r.jsx("input",{className:"ol-input",value:M,onChange:w=>S(w.target.value),placeholder:"输入密码…",maxLength:20,type:"password"})}),r.jsx("button",{className:"ol-btn ol-btn--primary",onClick:O,children:"创建房间"})]}),i==="join"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"房间号"}),r.jsx("input",{className:"ol-input ol-input--code",value:f,onChange:w=>m(w.target.value.toUpperCase()),placeholder:"输入6位房间号",maxLength:6})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"密码（若有）"}),r.jsx("input",{className:"ol-input",value:g,onChange:w=>h(w.target.value),placeholder:"无密码可留空",maxLength:20,type:"password"})]}),r.jsx("button",{className:"ol-btn ol-btn--primary",onClick:W,disabled:f.trim().length<1,children:"加入房间"})]}),i==="browse"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-browse-header",children:[r.jsx("span",{className:"ol-label",children:"在线房间"}),r.jsx("button",{className:"ol-refresh-btn",onClick:o,children:"刷新"})]}),!a||a.length===0?r.jsx("div",{className:"ol-empty",children:"暂无房间，创建一个吧"}):r.jsx("div",{className:"ol-room-list",children:a.map(w=>r.jsxs("div",{className:"ol-room-row",children:[r.jsx("span",{className:"ol-room-row__code",children:w.roomCode}),r.jsx("span",{className:"ol-room-row__host",children:w.hostName}),r.jsx("span",{className:`ol-room-row__status ol-room-row__status--${w.status}`,children:m1[w.status]??w.status}),r.jsxs("span",{className:"ol-room-row__count",children:[w.playerCount,"/",w.maxPlayers]}),w.hasPassword&&r.jsx("span",{className:"ol-room-row__lock",title:"需要密码",children:"🔒"}),w.status==="lobby"?r.jsx("button",{className:"ol-room-row__join",onClick:()=>V(w.roomCode,w.hasPassword),children:"加入"}):r.jsx("button",{className:"ol-room-row__join",onClick:()=>s==null?void 0:s(w.roomCode),disabled:!s,children:"观战"})]},w.roomCode))})]}),r.jsx("button",{className:"ol-btn ol-btn--back",onClick:e,children:"返回主菜单"})]}),r.jsx("style",{children:f1})]})}const f1=`
.ol-screen {
  display: flex;
  align-items: center;
  justify-content: center;
