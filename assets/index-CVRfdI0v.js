 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(L,P){var H=L.length;L.push(P);e:for(;0<H;){var O=H-1>>>1,R=L[O];if(0<r(R,P))L[O]=P,L[H]=R,H=O;else break e}}function t(L){return L.length===0?null:L[0]}function a(L){if(L.length===0)return null;var P=L[0],H=L.pop();if(H!==P){L[0]=H;e:for(var O=0,R=L.length,Y=R>>>1;O<Y;){var X=2*(O+1)-1,oe=L[X],ie=X+1,ce=L[ie];if(0>r(oe,H))ie<R&&0>r(ce,oe)?(L[O]=ce,L[ie]=H,O=ie):(L[O]=oe,L[X]=H,O=X);else if(ie<R&&0>r(ce,H))L[O]=ce,L[ie]=H,O=ie;else break e}}return P}function r(L,P){var H=L.sortIndex-P.sortIndex;return H!==0?H:L.id-P.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var d=[],u=[],p=1,f=null,x=3,g=!1,m=!1,v=!1,_=typeof setTimeout=="function"?setTimeout:null,b=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(L){for(var P=t(u);P!==null;){if(P.callback===null)a(u);else if(P.startTime<=L)a(u),P.sortIndex=P.expirationTime,n(d,P);else break;P=t(u)}}function j(L){if(v=!1,y(L),!m)if(t(d)!==null)m=!0,z(M);else{var P=t(u);P!==null&&J(j,P.startTime-L)}}function M(L,P){m=!1,v&&(v=!1,b(S),S=-1),g=!0;var H=x;try{for(y(P),f=t(d);f!==null&&(!(f.expirationTime>P)||L&&!$());){var O=f.callback;if(typeof O=="function"){f.callback=null,x=f.priorityLevel;var R=O(f.expirationTime<=P);P=e.unstable_now(),typeof R=="function"?f.callback=R:f===t(d)&&a(d),y(P)}else a(d);f=t(d)}if(f!==null)var Y=!0;else{var X=t(u);X!==null&&J(j,X.startTime-P),Y=!1}return Y}finally{f=null,x=H,g=!1}}var E=!1,w=null,S=-1,A=5,N=-1;function $(){return!(e.unstable_now()-N<A)}function T(){if(w!==null){var L=e.unstable_now();N=L;var P=!0;try{P=w(!0,L)}finally{P?D():(E=!1,w=null)}}else E=!1}var D;if(typeof h=="function")D=function(){h(T)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,U=K.port2;K.port1.onmessage=T,D=function(){U.postMessage(null)}}else D=function(){_(T,0)};function z(L){w=L,E||(E=!0,D())}function J(L,P){S=_(function(){L(e.unstable_now())},P)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){m||g||(m=!0,z(M))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return x},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function(L){switch(x){case 1:case 2:case 3:var P=3;break;default:P=x}var H=x;x=P;try{return L()}finally{x=H}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,P){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var H=x;x=L;try{return P()}finally{x=H}},e.unstable_scheduleCallback=function(L,P,H){var O=e.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?O+H:O):H=O,L){case 1:var R=-1;break;case 2:R=250;break;case 5:R=1073741823;break;case 4:R=1e4;break;default:R=5e3}return R=H+R,L={id:p++,callback:P,priorityLevel:L,startTime:H,expirationTime:R,sortIndex:-1},H>O?(L.sortIndex=H,n(u,L),t(d)===null&&L===t(u)&&(v?(b(S),S=-1):v=!0,J(j,H-O))):(L.sortIndex=R,n(d,L),m||g||(m=!0,z(M))),L},e.unstable_shouldYield=$,e.unstable_wrapCallback=function(L){var P=x;return function(){var H=x;x=P;try{return L.apply(this,arguments)}finally{x=H}}}})(ku);Iu.exports=ku;var Im=Iu.exports;/**
 * @license React
...
`,Ad=768;function wi(){const[e,n]=k.useState(()=>typeof window<"u"&&window.innerWidth<=Ad);return k.useEffect(()=>{const t=window.matchMedia(`(max-width: ${Ad}px)`),a=r=>n(r.matches);return t.addEventListener("change",a),n(t.matches),()=>t.removeEventListener("change",a)},[]),e}const An=18;function je({id:e,title:n,initialPos:t,width:a=300,height:r,minHeight:i=80,children:s,zIndex:l=10,defaultMinimized:d=!1,onFocus:u,siblingRects:p=[]}){const f=wi(),[x,g]=k.useState(t),[m,v]=k.useState(d),_=k.useRef(null),b=k.useRef(!1);k.useEffect(()=>{b.current||(b.current=!0,g(t))},[]);const h=k.useCallback(y=>{if(f||y.button!==0)return;y.preventDefault(),u==null||u(e);const j=y.clientX-x.x,M=y.clientY-x.y,E=S=>{var z;let A=S.clientX-j,N=S.clientY-M;const $=window.innerWidth,T=window.innerHeight,D=(z=_.current)==null?void 0:z.getBoundingClientRect(),K=(D==null?void 0:D.width)??a,U=(D==null?void 0:D.height)??40;A<An&&(A=0),N<An&&(N=0),A+K>$-An&&(A=$-K),N+U>T-An&&(N=T-U);for(const J of p)Math.abs(A+K-J.left)<An&&(A=J.left-K),Math.abs(A-J.right)<An&&(A=J.right),Math.abs(N+U-J.top)<An&&(N=J.top-U),Math.abs(N-J.bottom)<An&&(N=J.bottom),Math.abs(N-J.top)<An&&(N=J.top);g({x:Math.max(0,A),y:Math.max(0,N)})},w=()=>{document.removeEventListener("mousemove",E),document.removeEventListener("mouseup",w)};document.addEventListener("mousemove",E),document.addEventListener("mouseup",w)},[e,x,u,p,a,f]);return f?o.jsxs("div",{ref:_,className:`dp dp--mobile ${m?"dp--min":""}`,onClick:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar dp__bar--mobile",onClick:()=>v(y=>!y),children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("span",{className:"dp__min-btn dp__min-btn--mobile",children:m?"▼":"▲"})]}),!m&&o.jsx("div",{className:"dp__body dp__body--mobile",children:s}),o.jsx("style",{children:Pd})]}):o.jsxs("div",{ref:_,className:`dp ${m?"dp--min":""}`,style:{left:x.x,top:x.y,width:a,height:m?void 0:r,minHeight:m?0:i,zIndex:l},onMouseDown:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar",onMouseDown:h,children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("button",{className:"dp__min-btn",onMouseDown:y=>y.stopPropagation(),onClick:()=>v(y=>!y),title:m?"展开":"最小化",children:m?"▢":"▬"})]}),!m&&o.jsx("div",{className:"dp__body",children:s}),o.jsx("style",{children:Pd})]})}const Pd=`
.dp {
  position: absolute;
