 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(w,$){var J=w.length;w.push($);e:for(;0<J;){var P=J-1>>>1,B=w[P];if(0<o(B,$))w[P]=$,w[J]=B,J=P;else break e}}function t(w){return w.length===0?null:w[0]}function a(w){if(w.length===0)return null;var $=w[0],J=w.pop();if(J!==$){w[0]=J;e:for(var P=0,B=w.length,G=B>>>1;P<G;){var X=2*(P+1)-1,Q=w[X],se=X+1,le=w[se];if(0>o(Q,J))se<B&&0>o(le,Q)?(w[P]=le,w[se]=J,P=se):(w[P]=Q,w[X]=J,P=X);else if(se<B&&0>o(le,J))w[P]=le,w[se]=J,P=se;else break e}}return $}function o(w,$){var J=w.sortIndex-$.sortIndex;return J!==0?J:w.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var d=[],u=[],f=1,m=null,g=3,h=!1,x=!1,p=!1,_=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(w){for(var $=t(u);$!==null;){if($.callback===null)a(u);else if($.startTime<=w)a(u),$.sortIndex=$.expirationTime,n(d,$);else break;$=t(u)}}function k(w){if(p=!1,v(w),!x)if(t(d)!==null)x=!0,F(N);else{var $=t(u);$!==null&&R(k,$.startTime-w)}}function N(w,$){x=!1,p&&(p=!1,y(C),C=-1),h=!0;var J=g;try{for(v($),m=t(d);m!==null&&(!(m.expirationTime>$)||w&&!O());){var P=m.callback;if(typeof P=="function"){m.callback=null,g=m.priorityLevel;var B=P(m.expirationTime<=$);$=e.unstable_now(),typeof B=="function"?m.callback=B:m===t(d)&&a(d),v($)}else a(d);m=t(d)}if(m!==null)var G=!0;else{var X=t(u);X!==null&&R(k,X.startTime-$),G=!1}return G}finally{m=null,g=J,h=!1}}var T=!1,S=null,C=-1,z=5,E=-1;function O(){return!(e.unstable_now()-E<z)}function D(){if(S!==null){var w=e.unstable_now();E=w;var $=!0;try{$=S(!0,w)}finally{$?K():(T=!1,S=null)}}else T=!1}var K;if(typeof b=="function")K=function(){b(D)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,V=A.port2;A.port1.onmessage=D,K=function(){V.postMessage(null)}}else K=function(){_(D,0)};function F(w){S=w,T||(T=!0,K())}function R(w,$){C=_(function(){w(e.unstable_now())},$)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(w){w.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,F(N))},e.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<w?Math.floor(1e3/w):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function(w){switch(g){case 1:case 2:case 3:var $=3;break;default:$=g}var J=g;g=$;try{return w()}finally{g=J}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(w,$){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var J=g;g=w;try{return $()}finally{g=J}},e.unstable_scheduleCallback=function(w,$,J){var P=e.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?P+J:P):J=P,w){case 1:var B=-1;break;case 2:B=250;break;case 5:B=1073741823;break;case 4:B=1e4;break;default:B=5e3}return B=J+B,w={id:f++,callback:$,priorityLevel:w,startTime:J,expirationTime:B,sortIndex:-1},J>P?(w.sortIndex=J,n(u,w),t(d)===null&&w===t(u)&&(p?(y(C),C=-1):p=!0,R(k,J-P))):(w.sortIndex=B,n(d,w),x||h||(x=!0,F(N))),w},e.unstable_shouldYield=O,e.unstable_wrapCallback=function(w){var $=g;return function(){var J=g;g=$;try{return w.apply(this,arguments)}finally{g=J}}}})(Vu);Pu.exports=Vu;var Lf=Pu.exports;/**
 * @license React
...
`,tb={gameTitle:"Embryo Machine",statMovement:"移动力",statEvasion:"回避值",statAssault:"突击",statAssaultDef:"被突击",statInitiative:"先制值"},Mn=[["#00f0ff","#00c8e0","#40e8ff","#80f0ff"],["#ff00c8","#ff44aa","#e040d0","#ff77dd"],["#00cc88","#44dd66","#00aa6e","#66eebb"],["#ff8800","#ffaa33","#e07000","#ffcc66"],["#6688ff","#4466ee","#88aaff","#3355dd"],["#cc44ff","#aa22dd","#dd77ff","#bb00ee"],["#44dddd","#22bbbb","#66eeee","#00ccbb"],["#ff4466","#dd2244","#ff6688","#ee0033"]];function ht(e,n){const t=e.teams[n]??0,a=Mn[t%Mn.length],s=e.playerIds.filter(i=>e.teams[i]===t).indexOf(n);return a[Math.max(0,s)%a.length]}const Wt=tb;function ab({onNext:e,onBack:n,autoFill:t=!1}){const{state:a,dispatch:o,setAIConfig:s,setExposureMode:i}=Ce(),[l,d]=I.useState({}),[u,f]=I.useState({}),[m,g]=I.useState({}),h=a.playerIds.length,x=a.teamCount,p=I.useMemo(()=>ha.slice(0,h),[h]);function _(E,O){o({type:"SELECT_UNIT",playerId:E,unitId:O}),g(D=>({...D,[E]:!0}))}function y(E,O){d(D=>({...D,[E]:O}))}function b(E,O){f(D=>({...D,[E]:O}))}const v=p.map(E=>{var O;return((O=a.players[E])==null?void 0:O.unitId)??""}),k=v.every(E=>E!==""),N=new Set(v.filter(E=>E!=="")).size===v.filter(E=>E!=="").length,T=p.filter(E=>m[E]).map(E=>{var O;return((O=a.players[E])==null?void 0:O.unitId)??""}).filter(E=>E!==""),S=new Set(T).size===T.length,C=t?S:k&&N,z={};for(let E=0;E<p.length;E++){const O=E%x;z[O]||(z[O]=[]),z[O].push(p[E])}return r.jsxs("div",{className:"setup-screen",children:[r.jsx("button",{className:"setup-back-btn",onClick:n,children:"← 上一步"}),r.jsx("h1",{className:"setup-title",children:Wt.gameTitle}),r.jsx("p",{className:"setup-subtitle",children:"选择机体"}),r.jsx("div",{className:"setup-teams",children:Object.entries(z).map(([E,O])=>r.jsxs("div",{className:"setup-team",children:[r.jsxs("h3",{className:"team-header",style:{color:Mn[Number(E)%Mn.length][0]},children:["队伍 ",Number(E)+1]}),r.jsx("div",{className:"setup-players",children:O.map((D,K)=>{var $;const A=ha.indexOf(D),V=Mn[Number(E)%Mn.length],F=V[K%V.length],R=(($=a.players[D])==null?void 0:$.unitId)??"",w=v.filter((J,P)=>P!==p.indexOf(D)&&J);return r.jsxs("div",{className:"setup-player-col",children:[r.jsx(rb,{label:`P${A+1}`,selectedUnit:R,blockedUnits:w,accentColor:F,onSelect:J=>_(D,J)}),r.jsxs("div",{className:"ai-control",children:[r.jsxs("label",{className:"ai-control__label",children:[r.jsx("input",{type:"checkbox",checked:l[D]??!1,onChange:J=>y(D,J.target.checked)}),"AI控制"]}),l[D]&&r.jsxs("select",{className:"ai-control__difficulty",value:u[D]??"hard",onChange:J=>b(D,J.target.value),children:[r.jsx("option",{value:"easy",children:"简单"}),r.jsx("option",{value:"hard",children:"困难"})]})]})]},D)})})]},E))}),r.jsx("button",{className:"start-btn",onClick:()=>{const E=new Set(p.filter($=>m[$]).map($=>{var J;return((J=a.players[$])==null?void 0:J.unitId)??""}).filter($=>$!=="")),D=[...q.map($=>$.id).filter($=>!E.has($))];for(let $=D.length-1;$>0;$--){const J=Math.floor(Math.random()*($+1));[D[$],D[J]]=[D[J],D[$]]}const K={...l},A={...u};let V=0;for(const $ of p)t&&!m[$]&&V<D.length&&(o({type:"SELECT_UNIT",playerId:$,unitId:D[V]}),V++,K[$]=!0,A[$]="hard");const F={},R={};for(const $ of p)F[$]=K[$]??!1,R[$]=A[$]??"hard";s({player1:F.player1??!1,player2:F.player2??!1,player1Difficulty:R.player1??"hard",player2Difficulty:R.player2??"hard",playerAI:F,playerDifficulty:R}),p.every($=>F[$])&&i(!0),e()},disabled:!C,title:C?"":"请为所有玩家分别选择不同的机体",children:"下一步 →"}),!C&&r.jsx("p",{className:"setup-hint",children:t?"手动选择的机体之间不可重复":k?"每位玩家须选择不同的机体":"请为所有玩家各选择一台机体"}),r.jsx("style",{children:ib})]})}function rb({label:e,selectedUnit:n,blockedUnits:t,accentColor:a,onSelect:o}){return r.jsxs("div",{className:"unit-picker",children:[r.jsx("h2",{className:"unit-picker__title",style:{color:a},children:e}),r.jsx("div",{className:"unit-grid",children:q.map(s=>{const i=t.includes(s.id);return r.jsx(ob,{unit:s,isSelected:s.id===n,isBlocked:i,accentColor:a,onSelect:()=>!i&&o(s.id)},s.id)})}),n&&r.jsx(sb,{unit:q.find(s=>s.id===n),accentColor:a})]})}function ob({unit:e,isSelected:n,isBlocked:t,accentColor:a,onSelect:o}){return r.jsxs("button",{className:`unit-card ${n?"unit-card--selected":""} ${t?"unit-card--blocked":""}`,onClick:o,disabled:t,title:t?"该机体已被其他玩家选择":e.nameCn,style:n?{borderColor:a,boxShadow:`0 0 8px ${a}55`}:{},children:[r.jsx("img",{src:`/assets/tokens/${e.tokenId}`,alt:e.nameCn,className:"unit-card__token",onError:s=>{s.target.style.opacity="0.3"}}),r.jsx("span",{className:"unit-card__name",children:e.nameCn}),r.jsxs("span",{className:"unit-card__init",children:["先制 ",e.initiative]})]})}function sb({unit:e,accentColor:n}){return r.jsxs("div",{className:"unit-stats",children:[r.jsxs("div",{className:"unit-stats__name",children:[e.nameCn," ",r.jsxs("small",{children:["(",e.nameJa,")"]})]}),r.jsx("div",{className:"unit-stats__type",children:e.type}),r.jsxs("div",{className:"unit-stats__grid",children:[r.jsx(Ga,{label:Wt.statMovement,value:e.movement,color:n}),r.jsx(Ga,{label:Wt.statEvasion,value:e.evasion,color:n}),r.jsx(Ga,{label:Wt.statAssault,value:e.assault,color:n}),r.jsx(Ga,{label:Wt.statAssaultDef,value:e.assaultDef,color:n}),r.jsx(Ga,{label:Wt.statInitiative,value:e.initiative,color:n})]})]})}function Ga({label:e,value:n,color:t}){return r.jsxs("div",{className:"stat",children:[r.jsx("span",{className:"stat__label",children:e}),r.jsx("span",{className:"stat__value",style:{color:t},children:n})]})}const ib=`
.setup-screen {
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,la=48,lb=[{facing:"N",label:"↑N",title:"朝北"},{facing:"S",label:"↓S",title:"朝南"},{facing:"E",label:"→E",title:"朝东"},{facing:"W",label:"←W",title:"朝西"}],Qd=.25,cb=2,qd=.1;function db({onBack:e}){const{state:n,dispatch:t}=Ce(),a=Ye.find(P=>P.id===n.map.id)??n.map,o=n.playerIds,s=a.width,i=a.height,l=I.useRef(null),[d,u]=I.useState({x:0,y:0,scale:1}),f=I.useRef(null),m=I.useRef(!1);I.useEffect(()=>{const P=l.current;if(!P)return;const B=P.clientWidth,G=P.clientHeight,X=s*la,Q=i*la;if(!B||!G)return;const se=Math.min(B/X,G/Q),le=Math.max(Qd,Math.min(1.2,se)),de=(B-X*le)/2,vn=(G-Q*le)/2;u({x:de,y:vn,scale:le})},[s,i]),I.useEffect(()=>{const P=l.current;if(!P)return;const B=G=>{G.preventDefault();const X=G.deltaY<0?qd:-qd;u(Q=>({...Q,scale:Math.min(cb,Math.max(Qd,Q.scale+X))}))};return P.addEventListener("wheel",B,{passive:!1}),()=>P.removeEventListener("wheel",B)},[]);const g=I.useCallback(P=>{P.button===0&&(f.current={startX:P.clientX,startY:P.clientY,origX:d.x,origY:d.y},m.current=!1)},[d.x,d.y]),h=I.useCallback(P=>{if(!f.current)return;const B=P.clientX-f.current.startX,G=P.clientY-f.current.startY;!m.current&&Math.sqrt(B*B+G*G)>5&&(m.current=!0),m.current&&u(X=>({...X,x:f.current.origX+B,y:f.current.origY+G}))},[]),x=I.useCallback(()=>{f.current=null,m.current=!1},[]),p=I.useMemo(()=>Object.keys(a.startZones).map(Number).sort((P,B)=>P-B),[a]),[_,y]=I.useState(()=>{const P={};for(let B=0;B<n.teamCount;B++)P[B]=B;return P});I.useEffect(()=>{const P={};for(let B=0;B<n.teamCount;B++)P[B]=B;y(P)},[a.id,n.teamCount]);function b(P,B){y(G=>{const X=Object.entries(G).find(([,se])=>se===B),Q={...G,[P]:B};return X&&(Q[Number(X[0])]=G[P]),Q})}const v=I.useMemo(()=>{const P=new Map;for(let B=0;B<n.teamCount;B++){const G=_[B]??B,X=a.startZones[G];if(X)for(const Q of X){const se=`${Q.row},${Q.col}`,le=P.get(se)??[];le.push(B),P.set(se,le)}}return P},[a,n.teamCount,_]),k=I.useMemo(()=>{const P={};for(const B of o){const G=n.teams[B];P[G]||(P[G]=[]),P[G].push(B)}return P},[o,n.teams]),[N,T]=I.useState(o[0]),[S,C]=I.useState(""),z=I.useMemo(()=>{for(const P of o){const B=n.players[P];if(!B)return!1;const G=n.teams[P],X=_[G]??G,Q=a.startZones[X];if(!Q||!Q.some(le=>le.row===B.position.row&&le.col===B.position.col))return!1}return!0},[o,n.players,n.teams,_,a]);function E(P,B){t({type:"SET_SPAWN_POSITION",playerId:P,position:B})}function O(P,B){t({type:"SET_SPAWN_FACING",playerId:P,facing:B})}function D(){z&&t({type:"CONFIRM_SETUP"})}function K(P){return ht(n,P)}function A(P){var G;const B=(G=k[P])==null?void 0:G[0];return B?K(B):Mn[P%Mn.length][0]}const V=I.useMemo(()=>{const P=new Map;for(const B of o){const G=n.players[B];if(!G)continue;const X=q.find(le=>le.id===G.unitId);if(!X)continue;const Q=`${G.position.row},${G.position.col}`,se=P.get(Q)??[];se.push({pid:B,color:K(B),tokenId:X.tokenId,name:X.nameCn}),P.set(Q,se)}return P},[o,n.players]),{x:F,y:R,scale:w}=d,$=220,J=I.useMemo(()=>{const P={},se=Math.floor((window.innerHeight-56-60)/192);return o.forEach((le,de)=>{const vn=Math.floor(de/se),zn=de%se;P[le]={x:window.innerWidth-($+16)*(vn+1),y:56+zn*192}}),P},[o]);return r.jsxs("div",{className:"ssm__screen",children:[r.jsxs("div",{className:"ssm__topbar",children:[r.jsx("button",{className:"ssm__back-btn",onClick:e,children:"← 返回"}),r.jsx("span",{className:"ssm__title",children:"选择出击位置"}),r.jsxs("span",{className:"ssm__map-name",children:[a.nameCn," (",i,"×",s,")"]}),r.jsx("span",{style:{flex:1}}),r.jsx("button",{className:`ssm__start-btn${z?"":" ssm__start-btn--disabled"}`,onClick:D,disabled:!z,title:z?"开始战斗":"所有玩家必须先选择出击位置",children:"战斗开始 ▶"})]}),r.jsx("div",{className:"ssm__viewport",ref:l,onMouseDown:g,onMouseMove:h,onMouseUp:x,onMouseLeave:x,children:r.jsx("div",{className:"ssm__map-inner",style:{transform:`translate(${F}px, ${R}px) scale(${w})`,transformOrigin:"top left",display:"grid",gridTemplateColumns:`repeat(${s}, ${la}px)`,gridTemplateRows:`repeat(${i}, ${la}px)`},children:a.cells.flatMap((P,B)=>P.map((G,X)=>{const Q=bc(G),se=`${B},${X}`,le=v.get(se)??[],de=V.get(se)??[],vn=le.length>0,zn=le.length>0?A(le[0]):"",Aa=n.teams[N],Jt=vn&&le.includes(Aa);let Zn="ssm__cell";vn&&(Zn+=" ssm__cell--zone"),Jt&&(Zn+=" ssm__cell--placeable"),de.length>0&&(Zn+=" ssm__cell--selected");function re(ee){m.current||(ee.stopPropagation(),Jt&&E(N,{row:B,col:X}))}return r.jsxs("div",{className:Zn,style:{backgroundImage:`url("${Q}")`,...vn?{borderColor:zn,boxShadow:de.length>0?`inset 0 0 10px ${zn}66, 0 0 6px ${zn}44`:void 0}:{}},onClick:Jt?re:void 0,children:[de.length===1&&r.jsx("div",{className:"ssm__token",children:r.jsx("img",{src:`/assets/tokens/${de[0].tokenId}`,alt:de[0].name,style:{boxShadow:`0 0 6px ${de[0].color}`},onError:ee=>{ee.target.style.opacity="0.3"}})}),de.length>1&&r.jsx("div",{className:"ssm__token ssm__token--multi",children:de.map(ee=>r.jsx("img",{src:`/assets/tokens/${ee.tokenId}`,alt:ee.name,className:"ssm__token-img-sm",style:{boxShadow:`0 0 4px ${ee.color}`},onError:Be=>{Be.target.style.opacity="0.3"}},ee.pid))})]},se)}))})}),o.map((P,B)=>{var re;const G=n.players[P],X=q.find(ee=>ee.id===(G==null?void 0:G.unitId)),Q=K(P),se=S===P,le=N===P,de=n.teams[P],vn=((re=k[de])==null?void 0:re[0])===P,zn=_[de]??de,Aa=_[de]??de,Zn=(a.startZones[Aa]??[]).some(ee=>ee.row===G.position.row&&ee.col===G.position.col);return r.jsx(we,{id:`spawn-${P}`,title:`P${B+1} ${(X==null?void 0:X.nameCn)??"—"}`,initialPos:J[P]??{x:100,y:100},width:$,minHeight:60,zIndex:se?50:10+B,onFocus:()=>{C(P),T(P)},children:r.jsxs("div",{className:`ssm__player-card${le?" ssm__player-card--active":""}`,style:{borderTop:`2px solid ${Q}`},onClick:()=>T(P),children:[r.jsxs("div",{className:"ssm__player-label",style:{color:Q},children:["P",B+1," ",le?"◄ 放置中":""," ",Zn?"✓":""]}),vn&&r.jsx("div",{className:"ssm__zone-select",children:r.jsxs("label",{children:["出击区域:",r.jsx("select",{value:zn,onChange:ee=>b(de,Number(ee.target.value)),onClick:ee=>ee.stopPropagation(),children:p.slice(0,a.maxTeams).map(ee=>r.jsxs("option",{value:ee,children:["区域 ",ee+1]},ee))})]})}),r.jsx("div",{className:"ssm__unit-name",children:(X==null?void 0:X.nameCn)??"—"}),r.jsxs("div",{className:"ssm__pos-display",children:["格 (",G.position.row,", ",G.position.col,")"]}),r.jsx("div",{className:"ssm__facing-grid",children:lb.map(({facing:ee,label:Be,title:Ve})=>{const je=G.facing===ee;return r.jsx("button",{className:`ssm__facing-btn${je?" ssm__facing-btn--active":""}`,style:je?{borderColor:Q,color:Q}:void 0,title:Ve,onClick:()=>O(P,ee),children:Be},ee)})})]})},P)}),r.jsx("style",{children:ub})]})}const ub=`
.ssm__screen {
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`;function du(e,n){const t=Pm(e,n);if(t.length===0)return n;if(t.length===1)return t[0];const a=e.players[n].position;let o=t[0],s=1/0;for(const i of t){const l=e.players[i].position,d=Math.max(Math.abs(l.row-a.row),Math.abs(l.col-a.col));d<s&&(s=d,o=i)}return o}function lv(e,n){const t=e.players[n],a=[];for(let o=-1;o<=1;o++)for(let s=-1;s<=1;s++){if(o===0&&s===0)continue;const i=t.position.row+o,l=t.position.col+s;if(i<0||i>=e.map.height||l<0||l>=e.map.width)continue;const d={row:i,col:l};e.mines.some(u=>ve(u.position,d))||a.push(d)}return a}function Rr(e,n){for(const t of n)e({type:"ADD_LOG",message:t})}function cs(){const{state:e,getCard:n}=Ce(),{phase:t,currentTiming:a,turnOrder:o,pendingDamage:s,pendingArmorChoice:i}=e;if(t!=="action_seg1"&&t!=="action_seg2")return null;const l=t==="action_seg1"?1:2;return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"action-hud",style:s||i?{display:"none"}:void 0,children:[a==="movement"&&r.jsx(cv,{seg:l,turnOrder:o,getCard:n},`mov-${l}`),(a==="ranged"||a==="melee")&&r.jsx(uv,{seg:l,getCard:n},`combat-${l}-${a}`),a==="special"&&r.jsx(mv,{seg:l,turnOrder:o,getCard:n},`special-${l}`),r.jsx("style",{children:vi})]}),s&&r.jsxs(r.Fragment,{children:[r.jsx(gv,{pendingDamage:s,getCard:n}),r.jsx("style",{children:vi})]}),i&&r.jsxs(r.Fragment,{children:[r.jsx(fv,{pendingArmorChoice:i,getCard:n}),r.jsx("style",{children:vi})]})]})}function cv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:o,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m,playerIds:g}=a,[h,x]=I.useState(new Set),[p,_]=I.useState(null),[y,b]=I.useState([]),[v,k]=I.useState(null),[N,T]=I.useState("N"),S=I.useRef(!1),C=new Map;for(const $ of g){const J=a.players[$],P=q.find(B=>B.id===J.unitId);C.set($,Vh(J,e,t,P.movement))}I.useEffect(()=>{if(!(p!==null||v!==null)&&!S.current&&!(f||m)){if(i&&l){if(d!==l)return;if(C.get(l))_(l);else{const $=a.players[l],J=e===1?$.plotSeg1:$.plotSeg2;if(!J)o({type:"ADD_LOG",message:`  ${Te(l)} 未配置行动卡，跳过`});else{const P=t(J.defId);P&&P.actionType==="movement"&&o({type:"ADD_LOG",message:`  ${Te(l)}【${P.nameCn}】无法发动移动`})}S.current=!0,o({type:"ADVANCE_TIMING"})}return}for(const $ of n)if(!h.has($))if(C.get($)){_($);return}else{const J=a.players[$],P=e===1?J.plotSeg1:J.plotSeg2;if(!P)o({type:"ADD_LOG",message:`  ${Te($)} 未配置行动卡，跳过`});else{const B=t(P.defId);B&&B.actionType==="movement"&&o({type:"ADD_LOG",message:`  ${Te($)}【${B.nameCn}】无法发动移动`})}x(B=>new Set([...B,$]));return}S.current=!0,o({type:"ADVANCE_TIMING"})}},[h,p,v,f,m,d]),I.useEffect(()=>{if(!p){b([]);return}const $=a.players[p],J=g.filter(Q=>Q!==p).map(Q=>a.players[Q].position),P=q.find(Q=>Q.id===$.unitId),B=gn($,t,"movement"),G=ko($,e,t,B)||P.movement,X=Ds(u,$.position,G,J,B,$.facing);b(X.map(Q=>Q.pos))},[p,a.players,u,e]),I.useEffect(()=>{if(!p||i&&l&&p!==l||!Ae(s,p))return;const J=Pr(s,p),P=setTimeout(()=>{const B=$x(a,p,e,t,J);B&&(Rr(o,B.reasoning),o({type:"MOVE_UNIT",playerId:p,to:B.pos,path:B.path,finalFacing:B.finalFacing})),x(G=>new Set([...G,p])),_(null),b([])},800);return()=>clearTimeout(P)},[p]);function z($,J){if(!p||Ae(s,p)||!y.some(G=>ve(G,$)))return;let P=J;if(!P){const G=a.players[p],X=g.filter(de=>de!==p).map(de=>a.players[de].position),Q=q.find(de=>de.id===G.unitId),se=gn(G,t,"movement"),le=ko(G,e,t,se)||Q.movement;P=$s(u,G.position,G.facing,$,le,X,se)}const B=a.players[p];k({playerId:p,to:$,path:(P==null?void 0:P.path)??[]}),T(B.facing),b([]),_(null)}function E(){v&&(o({type:"MOVE_UNIT",playerId:v.playerId,to:v.to,path:v.path,finalFacing:N}),x($=>new Set([...$,v.playerId])),k(null),i&&(S.current=!0,o({type:"ADVANCE_TIMING"})))}if(i&&l&&d&&d!==l&&!p&&!v)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});const O=n.every($=>!C.get($)||h.has($));if(!i&&O&&p===null&&v===null||i&&S.current&&p===null&&v===null)return null;if(v!==null){const $=Te(v.playerId);return r.jsxs("div",{className:"action-hud__panel",children:[r.jsx("span",{className:"action-hud__mover",children:$}),r.jsx("span",{className:"action-hud__hint",children:"选择移动结束后的机头方向"}),r.jsx(Cc,{currentFacing:N,onSelectFacing:T}),r.jsx("button",{className:"action-hud__skip-btn",onClick:E,children:"确认移动"})]})}const D=p?Ae(s,p):!1,K=p?Te(p):"";if(D)return r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[K," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]});const A=p?a.players[p]:null,V=p&&A?gn(A,t,"movement"):null,F=A?q.find($=>$.id===A.unitId):null,R=p&&A&&F?ko(A,e,t,V??void 0)||F.movement:0,w=p?g.filter($=>$!==p).map($=>a.players[$].position):[];return r.jsxs(r.Fragment,{children:[p&&A&&r.jsx(dv,{reachable:y,map:u,from:A.position,fromFacing:A.facing,movementValue:R,blockedPositions:w,aux:V??void 0,onCellClick:z}),r.jsx("div",{className:"action-hud__panel",children:p?r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"action-hud__mover",children:K}),r.jsx("span",{className:"action-hud__hint",children:"选择目标格（步数须用尽；点击选择路径）"}),(V==null?void 0:V.vernier)&&r.jsx("span",{className:"action-hud__aux-badge",title:"地形移动消耗-1，高低差消耗-1",children:"⚙ 喷射推进器"}),(V==null?void 0:V.wheel)&&r.jsx("span",{className:"action-hud__aux-badge",title:"移动力+2",children:"⚙ 滑轮"})]}):r.jsx("span",{className:"action-hud__hint",children:"计算移动路径中…"})})]})}function Cc({currentFacing:e,onSelectFacing:n,disabledFacing:t}){const a=[{facing:"N",label:"↑N"},{facing:"E",label:"E→"},{facing:"S",label:"↓S"},{facing:"W",label:"←W"}];return r.jsxs("div",{className:"facing-compass",title:"调整机头朝向",children:[r.jsx("span",{className:"facing-compass__label",children:"机头"}),a.map(({facing:o,label:s})=>{const i=o===t;return r.jsx("button",{className:["facing-compass__btn",e===o?"facing-compass__btn--active":"",i?"facing-compass__btn--disabled":""].join(" ").trim(),onClick:()=>{i||n(o)},disabled:i,title:i?"当前规则下不可选":`朝${o}方`,children:s},o)})]})}function dv({reachable:e,map:n,from:t,fromFacing:a,movementValue:o,blockedPositions:s,aux:i,onCellClick:l}){const d=Ks(),u=I.useRef({allPaths:[],selectedIdx:0,hoveredPos:null}),[f,m]=I.useState(0),g=()=>m(x=>x+1);I.useEffect(()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(k=>k.classList.remove("board-cell--path-ghost"));const{allPaths:x,selectedIdx:p,hoveredPos:_}=u.current;if(!_||x.length===0)return;const y=x[p];if(!y)return;const b=y.path.slice(0,-1);for(const k of b){const N=document.querySelector(`.board-cell[data-row="${k.row}"][data-col="${k.col}"]`);N==null||N.classList.add("board-cell--path-ghost")}const v=document.querySelector(`.board-cell[data-row="${_.row}"][data-col="${_.col}"]`);return v&&(v.dataset.pathLabel=x.length>1?`${p+1}/${x.length}`:""),()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(k=>k.classList.remove("board-cell--path-ghost")),v&&delete v.dataset.pathLabel}},[f]),I.useEffect(()=>{const x=[];document.querySelectorAll(".board-cell--reachable").forEach(p=>{p.classList.remove("board-cell--reachable")});for(const p of e){const _=document.querySelector(`.board-cell[data-row="${p.row}"][data-col="${p.col}"]`);if(!_)continue;_.classList.add("board-cell--reachable");const y=()=>{const{allPaths:D,selectedIdx:K}=u.current;l(p,D[K]??null)},b=()=>{const D=Io(n,t,a,p,o,s,i);u.current={allPaths:D,selectedIdx:0,hoveredPos:p},g()},v=()=>{u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()},k=D=>{const{allPaths:K,selectedIdx:A}=u.current;if(K.length<=1)return;D.preventDefault();const V=D.deltaY>0?1:-1;u.current={...u.current,selectedIdx:(A+V+K.length)%K.length},g()};let N=null,T=0,S=0,C=!1;const z=D=>{if(T=D.touches[0].clientX,S=D.touches[0].clientY,C=!1,d){const{hoveredPos:K}=u.current;if(K&&K.row===p.row&&K.col===p.col)return;const A=Io(n,t,a,p,o,s,i);u.current={allPaths:A,selectedIdx:0,hoveredPos:p},g(),D.preventDefault();return}N=setTimeout(()=>{C=!0;const K=Io(n,t,a,p,o,s,i);u.current={allPaths:K,selectedIdx:0,hoveredPos:p},g()},400)},E=()=>{N&&(clearTimeout(N),N=null),C&&!d&&(u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()),C=!1},O=D=>{if(d||!C)return;const K=D.touches[0].clientX-T,A=D.touches[0].clientY-S;if(Math.abs(K)>40||Math.abs(A)>40){const{allPaths:V,selectedIdx:F}=u.current;if(V.length<=1)return;const R=Math.abs(K)>Math.abs(A)?K>0?1:-1:A>0?1:-1;u.current={...u.current,selectedIdx:(F+R+V.length)%V.length},g(),T=D.touches[0].clientX,S=D.touches[0].clientY}};_.addEventListener("click",y),_.addEventListener("mouseenter",b),_.addEventListener("mouseleave",v),_.addEventListener("wheel",k,{passive:!1}),_.addEventListener("touchstart",z,{passive:!0}),_.addEventListener("touchend",E),_.addEventListener("touchcancel",E),_.addEventListener("touchmove",O,{passive:!0}),x.push(()=>{N&&clearTimeout(N),_.removeEventListener("click",y),_.removeEventListener("mouseenter",b),_.removeEventListener("mouseleave",v),_.removeEventListener("wheel",k),_.removeEventListener("touchstart",z),_.removeEventListener("touchend",E),_.removeEventListener("touchcancel",E),_.removeEventListener("touchmove",O)})}return()=>{document.querySelectorAll(".board-cell--reachable").forEach(p=>p.classList.remove("board-cell--reachable")),document.querySelectorAll(".board-cell--path-ghost").forEach(p=>p.classList.remove("board-cell--path-ghost")),document.querySelectorAll(".board-cell[data-path-label]").forEach(p=>delete p.dataset.pathLabel),u.current={allPaths:[],selectedIdx:0,hoveredPos:null},x.forEach(p=>p())}},[e,n,t,a,o,s,i,l]);const h=I.useCallback(()=>{const{allPaths:x,selectedIdx:p}=u.current;x.length<=1||(u.current={...u.current,selectedIdx:(p+1)%x.length},g())},[]);if(d){const{allPaths:x,hoveredPos:p}=u.current;if(p&&x.length>1)return r.jsxs("button",{className:"move-cycle-btn",onClick:h,style:{position:"fixed",bottom:80,left:"50%",transform:"translateX(-50%)",zIndex:600,padding:"10px 24px",background:"rgba(22, 33, 62, 0.95)",border:"1px solid #ffea00",borderRadius:8,color:"#ffea00",fontFamily:"var(--font-mono)",fontSize:"0.85rem",fontWeight:"bold",cursor:"pointer",minHeight:44,backdropFilter:"blur(4px)"},children:["切换路径 (",u.current.selectedIdx+1,"/",x.length,")"]})}return null}function Zm({reachable:e,onCellClick:n}){return I.useEffect(()=>(document.querySelectorAll(".board-cell").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null}),e.forEach(a=>{const o=document.querySelector(`.board-cell[data-row="${a.row}"][data-col="${a.col}"]`);o&&(o.classList.add("board-cell--reachable"),o.onclick=()=>n(a))}),()=>{document.querySelectorAll(".board-cell--reachable").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null})}),[e,n]),null}function uv({seg:e,getCard:n}){const{state:t,dispatch:a,aiConfig:o,isOnline:s,localPlayerId:i,currentTurnPlayerId:l}=Ce(),{map:d,turnOrder:u,currentTiming:f,pendingDamage:m,pendingArmorChoice:g}=t,[h,x]=I.useState(new Set),[p,_]=I.useState(null),[y,b]=I.useState(null),v=I.useRef(!1),[k,N]=I.useState(null);I.useEffect(()=>{p&&N(du(t,p))},[p]);const[T,S]=I.useState(!1),[C,z]=I.useState([]),[E,O]=I.useState(!1),D=f==="ranged"?"ranged":"melee",K=D==="ranged"?"射击时机":"近战时机";if(I.useEffect(()=>{if(p===null&&!v.current&&!(m||g)){if(s&&i){if(l!==i)return;const re=t.players[i];if(Ln(re,e,D,n))_(i),S(!1),O(!1),z([]);else{const Be=e===1?re.plotSeg1:re.plotSeg2;if(Be){const Ve=n(Be.defId);Ve&&(D==="ranged"&&Ve.actionType==="ranged"||D==="melee"&&(Ve.actionType==="melee"||Ve.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(i)}【${Ve.nameCn}】条件不满足，无法发动`})}v.current=!0,a({type:"ADVANCE_TIMING"})}return}for(const re of u){if(h.has(re))continue;const ee=t.players[re];if(!Ln(ee,e,D,n)){const Ve=e===1?ee.plotSeg1:ee.plotSeg2;if(Ve){const je=n(Ve.defId);je&&(D==="ranged"&&je.actionType==="ranged"||D==="melee"&&(je.actionType==="melee"||je.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(re)}【${je.nameCn}】条件不满足，无法发动`})}x(je=>new Set([...je,re]));return}_(re),S(!1),O(!1),z([]);return}v.current=!0,a({type:"ADVANCE_TIMING"})}},[h,p,m,g,n,l]),I.useEffect(()=>{if(!p||m||g||s&&i&&p!==i||!Ae(o,p))return;const ee=Pr(o,p),Be=setTimeout(()=>{const Ve=Ax(t,p,e,D,n,ee);if(Rr(a,Ve.reasoning),Ve.shouldAttack){const je=t.players[p],Bt=Ln(je,e,D,n),mf=(Bt==null?void 0:Bt.actionType)==="charge"?"RESOLVE_CHARGE":D==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE";a({type:mf,attackerId:p,targetId:Ve.targetId})}else{const je=t.players[p],Bt=Ln(je,e,D,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${Bt?`【${Bt.nameCn}】`:K}`})}x(je=>new Set([...je,p])),_(null),S(!1),O(!1),z([])},800);return()=>clearTimeout(Be)},[p,m,g]),s&&i&&l&&l!==i&&!p)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(l)," 行动中…"]})});if(!p)return null;const A=t.players[p],V=Pm(t,p),F=k??du(t,p),R=t.players[F],w=f==="melee"?gn(A,n,"melee"):{vernier:!1,moveSensor:!1},$=Ln(A,e,D,n),J=($==null?void 0:$.actionType)==="charge",P=Ae(o,p),B=V.filter(re=>{const ee=t.players[re];if(J&&D==="melee"){const Be=q.find(je=>je.id===A.unitId),Ve=q.find(je=>je.id===ee.unitId);return qo(A,ee,e,d,Be,Ve,n).canAttack}return Qo(A,ee,e,D,d,n).canAttack});let G;if(J&&D==="melee"){const re=q.find(Be=>Be.id===A.unitId),ee=q.find(Be=>Be.id===R.unitId);G=qo(A,R,e,d,re,ee,n)}else G=Qo(A,R,e,D,d,n);const X=q.find(re=>re.id===A.unitId),Q=q.find(re=>re.id===R.unitId);function se(){if(!G.canAttack||!p)return;a({type:J?"RESOLVE_CHARGE":D==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE",attackerId:p,targetId:F}),b(`${X.nameCn} → ${Q.nameCn}：造成 ${G.damage} 伤害`),x(ee=>new Set([...ee,p])),_(null),S(!1),O(!1),z([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function le(){if(!p)return;const re=Ln(t.players[p],e,D,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${re?`【${re.nameCn}】`:K}`}),b(null),x(ee=>new Set([...ee,p])),_(null),S(!1),O(!1),z([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function de(){if(!p||T)return;const re=Km(d,A.position,[R.position]);z(re),O(!0)}function vn(re){!p||!E||(a({type:"MELEE_SENSOR_MOVE",playerId:p,to:re}),S(!0),O(!1),z([]))}function zn(){O(!1),z([])}const Aa=Te(p),Jt=G.card?J?`【${G.card.nameCn}】突击值 ${X.assault} vs 防御${Q.assaultDef}`:`【${G.card.nameCn}】射程 ${G.card.rangeMin??"—"}–${G.card.rangeMax??"—"}`:null,Zn=D==="melee"&&w.moveSensor&&!T;return P?r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[Te(p)," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):r.jsxs(r.Fragment,{children:[E&&r.jsx(Zm,{reachable:C,onCellClick:vn}),!E&&r.jsx(pv,{validTargets:B.map(re=>({playerId:re,pos:t.players[re].position})),selectedTargetId:F,onSelectTarget:N}),r.jsxs("div",{className:"action-hud__panel action-hud__panel--combat",children:[r.jsx("span",{className:"action-hud__mover",children:Aa}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__timing-label",children:K}),w.moveSensor&&r.jsxs("span",{className:`action-hud__aux-badge ${T?"action-hud__aux-badge--used":""}`,title:"近战前可移动1格",children:["⚙ 移动传感器",T?"（已使用）":""]}),w.vernier&&r.jsx("span",{className:"action-hud__aux-badge",title:"地形消耗-1，高低差-1",children:"⚙ 喷射推进器"}),(D==="melee"||D==="ranged"&&vc(G.card))&&r.jsx(Cc,{currentFacing:A.facing,onSelectFacing:re=>a({type:"ADJUST_FACING",playerId:p,facing:re})}),G.card?r.jsxs("span",{className:"action-hud__card-info",children:[Jt,G.card.damage!==void 0&&r.jsxs("span",{className:"action-hud__dmg",children:[" 伤害 ",G.card.damage]})]}):r.jsxs("span",{className:"action-hud__hint",children:["无",D==="ranged"?"射击":"近战","牌"]}),r.jsx("span",{className:`action-hud__validity ${G.canAttack?"action-hud__validity--ok":"action-hud__validity--no"}`,children:G.canAttack?J?`距离 ${G.dist} ✓ → 造成 ${G.damage} 伤 / 自机反伤 ${G.counterDamage}`:`距离 ${G.dist} ✓ → ${G.damage} 伤`:G.card?G.reason:""}),y&&r.jsx("span",{className:"action-hud__result",children:y}),E?r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"action-hud__hint",children:"点击高亮格移动（传感器），或"}),r.jsx("button",{className:"action-hud__skip-btn",onClick:zn,children:"取消移动"})]}):r.jsxs(r.Fragment,{children:[Zn&&r.jsx("button",{className:"action-hud__sensor-btn",onClick:de,title:"移动传感器：攻击前可移动1格",children:"传感器移动"}),B.length>1&&r.jsxs("span",{className:"action-hud__target-hint",children:["目标: ",Te(F)," (",Q.nameCn,") — 点击地图切换目标 (",B.length,"个可选)"]}),r.jsx("button",{className:"action-hud__attack-btn",onClick:se,disabled:!G.canAttack,title:G.canAttack?`攻击 ${Q.nameCn}`:G.reason,children:"执行攻击"}),r.jsxs("button",{className:"action-hud__skip-btn",onClick:le,children:["跳过",D==="ranged"?"射击":"近战"]})]})]})]})}function pv({validTargets:e,selectedTargetId:n,onSelectTarget:t}){return I.useEffect(()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null});for(const{playerId:a,pos:o}of e){const s=document.querySelector(`.board-cell[data-row="${o.row}"][data-col="${o.col}"]`);s&&(a===n?s.classList.add("board-cell--target"):(s.classList.add("board-cell--target-alt"),s.onclick=i=>{i.stopPropagation(),t(a)}))}return()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null})}},[e,n,t]),null}function mv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:o,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m}=a,[g,h]=I.useState(new Set),[x,p]=I.useState(null),[_,y]=I.useState([]),[b,v]=I.useState("real"),[k,N]=I.useState([]),T=I.useRef(!1);if(I.useEffect(()=>{if(x===null&&!T.current&&!(f||m)){if(i&&l){if(d!==l)return;const R=a.players[l],w=e===1?R.plotSeg1:R.plotSeg2,$=w?t(w.defId):null;!$||$.actionType!=="mine"&&$.actionType!=="special"&&$.actionType!=="aim"?(T.current=!0,o({type:"ADVANCE_TIMING"})):p(l);return}for(const R of n){if(g.has(R))continue;const w=a.players[R],$=e===1?w.plotSeg1:w.plotSeg2,J=$?t($.defId):null;if(!J||J.actionType!=="mine"&&J.actionType!=="special"&&J.actionType!=="aim"){h(P=>new Set([...P,R]));return}p(R);return}T.current=!0,o({type:"ADVANCE_TIMING"})}},[g,x,f,m,t,d]),I.useEffect(()=>{if(!x){y([]),N([]),v("real");return}const R=a.players[x],w=e===1?R.plotSeg1:R.plotSeg2,$=w?t(w.defId):null;if($&&$.actionType==="mine"){const J=lv(a,x);y(J)}else y([]),N([]),v("real")},[x,u,e,a,t]),I.useEffect(()=>{if(!x||f||m||i&&l&&x!==l||!Ae(s,x))return;const w=Pr(s,x),$=setTimeout(()=>{const J=Px(a,x,e,t,w);J&&(Rr(o,J.reasoning),J.actionType==="mine"?o({type:"PLACE_MINE",playerId:x,placements:J.placements,damage:J.damage}):J.actionType==="aim"&&o({type:"ADJUST_FACING",playerId:x,facing:J.facing})),h(P=>new Set([...P,x])),p(null)},800);return()=>clearTimeout($)},[x,f,m]),i&&l&&d&&d!==l&&!x)return r.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:r.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});if(!x)return null;const S=a.players[x],C=e===1?S.plotSeg1:S.plotSeg2,z=C?t(C.defId):null,E=Te(x),O=k.filter(R=>R.kind==="real").length,D=k.filter(R=>R.kind==="dummy").length,K=Ae(s,x);function A(){N([]),v("real"),h(R=>new Set([...R,x])),p(null),i&&(T.current=!0,o({type:"ADVANCE_TIMING"}))}function V(R){!x||!z||z.actionType!=="mine"||_.some(w=>ve(w,R))&&N(w=>w.find(P=>ve(P.position,R))?w.filter(P=>!ve(P.position,R)):w.length>=4||w.filter(P=>P.kind===b).length>=2?w:[...w,{position:R,kind:b}])}function F(){!x||!z||z.actionType!=="mine"||k.length!==4||O!==2||D!==2||(o({type:"PLACE_MINE",playerId:x,placements:k,damage:z.damage||3}),N([]),v("real"),h(R=>new Set([...R,x])),p(null),i&&(T.current=!0,o({type:"ADVANCE_TIMING"})))}return K?r.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[r.jsxs("span",{className:"action-hud__mover",children:[E," (AI)"]}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):r.jsxs(r.Fragment,{children:[_.length>0&&r.jsx(Zm,{reachable:_,onCellClick:V}),r.jsxs("div",{className:"action-hud__panel action-hud__panel--special",children:[r.jsx("span",{className:"action-hud__mover",children:E}),r.jsx("span",{className:"action-hud__divider",children:"│"}),r.jsx("span",{className:"action-hud__timing-label",children:"特殊时机"}),r.jsx("span",{className:"action-hud__card-info",children:z?`【${z.nameCn}】效果`:"（无）"}),(z==null?void 0:z.actionType)==="mine"?r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"action-hud__facing-row",children:[r.jsxs("button",{className:`action-hud__facing-btn${b==="real"?" is-selected":""}`,onClick:()=>v("real"),disabled:O>=2,children:["机雷 ",O,"/2"]}),r.jsxs("button",{className:`action-hud__facing-btn${b==="dummy"?" is-selected":""}`,onClick:()=>v("dummy"),disabled:D>=2,children:["替身雷 ",D,"/2"]})]}),r.jsxs("span",{className:"action-hud__hint",children:["点击高亮格放置 ",b==="real"?"机雷":"替身雷","，再次点击已选格可取消。"]}),r.jsxs("span",{className:"action-hud__hint",children:["当前已选 ",k.length,"/4 个指示物，需放满真雷2个与替身雷2个。"]}),r.jsx("button",{className:"action-hud__attack-btn",onClick:F,disabled:k.length!==4||O!==2||D!==2,children:"确认布雷"})]}):(z==null?void 0:z.actionType)==="aim"?r.jsxs(r.Fragment,{children:[r.jsx(Cc,{currentFacing:S.facing,onSelectFacing:R=>o({type:"ADJUST_FACING",playerId:x,facing:R})}),r.jsx("span",{className:"action-hud__hint",children:"可先调整朝向，然后"})]}):r.jsx("span",{className:"action-hud__hint",children:"暂无此牌效果支持，请"}),r.jsx("button",{className:"action-hud__skip-btn",onClick:A,children:(z==null?void 0:z.actionType)==="aim"?"确认":"跳过"})]})]})}function fv({pendingArmorChoice:e,getCard:n}){const{dispatch:t,aiConfig:a,isOnline:o,localPlayerId:s}=Ce(),{zoom:i,getZoomHandlers:l}=Ot(),{targetId:d,damage:u,source:f,handCards:m,plotCards:g}=e,[h,x]=I.useState(null),[p,_]=I.useState(new Set),y=o&&s&&d!==s,b=!y&&Ae(a,d);I.useEffect(()=>{b?x(d):o||x(null)},[d,b,o]),I.useEffect(()=>{if(!b||y)return;const E=Vx(u,m,g),O=setTimeout(()=>{Rr(t,E.reasoning),t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:E.value})},500);return()=>clearTimeout(O)},[d,b,y,u,m,g,t]);function v(E){_(O=>{const D=new Set(O);return D.has(E)?D.delete(E):D.add(E),D})}function k(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[...p]})}function N(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[]})}const T=[...p].reduce((E,O)=>{const D=g.find(A=>A.instanceId===O);if(D)return E+D.armorValue;const K=m.find(A=>A.instanceId===O);return E+((K==null?void 0:K.armorValue)??0)},0),S=Math.max(0,u-T),C=f==="ranged"?"射击":f==="charge"?"突击":f==="mine"?"机雷":"近战",z=Te(d);return y?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),r.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),r.jsx("div",{className:"damage-pass__player",children:z}),r.jsxs("p",{className:"damage-pass__context",children:[z," 正在决定是否激活装甲牌…"]}),r.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),r.jsx("style",{children:ds})]}):!o&&!b&&d!==h?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),r.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),r.jsx("div",{className:"damage-pass__player",children:z}),r.jsxs("p",{className:"damage-pass__context",children:["受到 ",u," 点",C,"伤害，可激活装甲牌减伤"]}),r.jsxs("button",{className:"damage-pass__btn",onClick:()=>x(d),children:[z," 已准备"]})]})}),r.jsx("style",{children:ds})]}):r.jsxs("div",{className:"action-hud",children:[r.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[r.jsxs("div",{className:"damage-panel__header",children:[r.jsx("span",{className:"damage-panel__title",children:"🛡 装甲激活"}),r.jsx("span",{className:"damage-panel__player",children:z}),r.jsxs("span",{className:"damage-panel__remaining",children:["受到 ",r.jsx("strong",{children:u})," 点",C,"伤害",T>0&&r.jsxs(r.Fragment,{children:[" → 减免后 ",r.jsx("strong",{className:"armor-reduced",children:S})," 点"]})]})]}),r.jsx("div",{className:"damage-panel__hint",children:f==="ranged"?"手牌中的装甲牌可防御射击伤害；准备区中的装甲牌可防御任意伤害。选择要激活的装甲牌，或跳过。":"准备区中的装甲牌可防御任意伤害（含突击/近战）。选择要激活的装甲牌，或跳过。"}),r.jsxs("div",{className:"damage-panel__zones",children:[m.length>0&&r.jsxs("div",{className:"damage-zone",children:[r.jsx("span",{className:"damage-zone__label",children:"手牌装甲"}),r.jsx("div",{className:"damage-zone__cards",children:m.map(E=>{const O=n(E.defId),D=p.has(E.instanceId),K=l((O==null?void 0:O.frontImageId)??"");return r.jsxs("button",{className:`damage-card-btn ${D?"damage-card-btn--selected":""}`,onClick:()=>v(E.instanceId),...K,children:[r.jsx("span",{className:"damage-card-btn__name",children:(O==null?void 0:O.nameCn)??E.defId}),r.jsxs("span",{className:"armor-value-badge",children:["-",E.armorValue]})]},E.instanceId)})})]}),g.length>0&&r.jsxs("div",{className:"damage-zone",children:[r.jsx("span",{className:"damage-zone__label",children:"准备区装甲"}),r.jsx("div",{className:"damage-zone__cards",children:g.map(E=>{const O=n(E.defId),D=p.has(E.instanceId),K=l((O==null?void 0:O.frontImageId)??"");return r.jsxs("button",{className:`damage-card-btn ${D?"damage-card-btn--selected":""}`,onClick:()=>v(E.instanceId),...K,children:[r.jsx("span",{className:"damage-card-btn__name",children:(O==null?void 0:O.nameCn)??E.defId}),r.jsxs("span",{className:"damage-zone__sub",children:["主要阶段",E.seg]}),r.jsxs("span",{className:"armor-value-badge",children:["-",E.armorValue]})]},E.instanceId)})})]})]}),r.jsxs("div",{className:"damage-panel__actions",children:[r.jsxs("button",{className:"action-hud__attack-btn",onClick:k,disabled:p.size===0,children:["激活选中装甲 (-",T," 点)"]}),r.jsx("button",{className:"action-hud__skip-btn",onClick:N,children:"不使用装甲"})]})]}),r.jsx(Kt,{zoom:i})]})}function gv({pendingDamage:e,getCard:n}){const{state:t,dispatch:a,aiConfig:o,isOnline:s,localPlayerId:i}=Ce(),{targetId:l,remaining:d,selectedInstanceIds:u}=e,{zoom:f,getZoomHandlers:m}=Ot(),[g,h]=I.useState(null),[x,p]=I.useState(!1),_=t.players[l];$n(_);const y=u.length===0,b=!!e.attackerId&&y&&!e.attackerDesignatedCardId,v=b?e.attackerId:l,k=Te(v),N=s&&i&&v!==i,T=!N&&Ae(o,v),S=Pr(o,v),C=!s&&!T&&v!==g;I.useEffect(()=>{T?h(v):s||h(null)},[v,T,s]),I.useEffect(()=>{if(!T||N||d<=0)return;const w=t.players[l],$=Sa(w),J=t.playerIds.filter(G=>G!==l&&t.teams[G]!==t.teams[l]&&!t.players[G].isDefeated),P=J.length>0?t.players[J[0]]:w,B=setTimeout(()=>{if($.length>0){const G=Hd(e,w,n,S,b,P);Rr(a,G.reasoning),G.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:G.value}):a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})},600);return()=>clearTimeout(B)},[d,v,T,N,t.players]),I.useEffect(()=>{if(!x)return;if(d<=0){p(!1);return}const w=t.players[l],$=Sa(w),J=setTimeout(()=>{if($.length>0){const P=t.playerIds.filter(X=>X!==l&&t.teams[X]!==t.teams[l]&&!t.players[X].isDefeated),B=P.length>0?t.players[P[0]]:w,G=Hd(e,w,n,"hard",b,B);G.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:G.value}):(a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1))}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1)},150);return()=>clearTimeout(J)},[x,d,t.players]);function z(w){a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:w})}function E(){p(!0)}if(N)return r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),r.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),r.jsx("div",{className:"damage-pass__player",children:k}),r.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方正在指定要摧毁的卡牌…":`${k} 正在选择要摧毁的 ${d} 张卡牌…`}),r.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),r.jsx("style",{children:ds})]});if(C)return r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"damage-pass-overlay",children:r.jsxs("div",{className:"damage-pass-card",children:[r.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),r.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),r.jsx("div",{className:"damage-pass__player",children:k}),r.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方有权指定第一张要摧毁的卡牌":`防方选择要摧毁的 ${d} 张卡牌（可自动分配）`}),r.jsxs("button",{className:"damage-pass__btn",onClick:()=>h(v),children:[k," 已准备"]})]})}),r.jsx("style",{children:ds})]});const O=_.hand.filter(w=>!w.destroyed),D=_.plotSeg1&&!_.plotSeg1.destroyed?[_.plotSeg1]:[],K=_.plotSeg2&&!_.plotSeg2.destroyed?[_.plotSeg2]:[],A=_.auxiliary.filter(w=>!w.destroyed),V=_.deck.filter(w=>!w.destroyed),F=[];O.length>0&&F.push({label:"手牌",cards:O}),D.length>0&&F.push({label:"布局格",sublabel:"主要阶段1",cards:D}),K.length>0&&F.push({label:"布局格",sublabel:"主要阶段2",cards:K}),A.length>0&&F.push({label:"辅助区",cards:A});const R=V[0]??null;return r.jsxs("div",{className:"action-hud",children:[r.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[r.jsxs("div",{className:"damage-panel__header",children:[r.jsx("span",{className:"damage-panel__title",children:"⚔️ 伤害分配"}),r.jsx("span",{className:"damage-panel__player",children:b?`${k} (瞄准指定)`:k}),r.jsxs("span",{className:"damage-panel__remaining",children:["还需摧毁 ",r.jsx("strong",{children:d})," 张卡牌"]})]}),(e.destroyedBombCount??0)>0&&r.jsxs("div",{className:"damage-panel__bomb-alert",children:["💣 已选中 ",e.destroyedBombCount," 张炸弹卡，选完后将进行誘爆检查"]}),r.jsx("div",{className:"damage-panel__hint",children:b?`【瞄准加成】攻方有权指定第一张要摧毁的卡牌！可从手牌、辅助区、卡组、布局格中选择。请 ${k} 选择：`:e.source==="ranged"?"射击伤害：须先从手牌 / 布局格 / 辅助区选择卡牌破坏，不足部分自动从牌组顶破坏。":"牌组与弃牌区已耗尽，近战伤害切换为自选模式。请从手牌 / 布局格 / 辅助区选择。"}),r.jsxs("div",{className:"damage-panel__zones",children:[F.map((w,$)=>r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:[w.label,w.sublabel&&r.jsxs("span",{className:"damage-zone__sub",children:["（",w.sublabel,"）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:w.cards.map(J=>{const P=n(J.defId),B=(P==null?void 0:P.nameCn)??J.defId,G=u.includes(J.instanceId),X=P!=null&&P.frontImageId?`/assets/${P.frontImageId}`:null;return r.jsxs("button",{className:`damage-card-btn ${G?"damage-card-btn--selected":""} ${P!=null&&P.hasBombIcon?"damage-card-btn--bomb":""}`,onClick:()=>z(J.instanceId),disabled:G,title:`${B} (${(P==null?void 0:P.actionType)??"?"})${P!=null&&P.hasBombIcon?" ⚠️ 含诱爆":""}`,...X?m(X):{},children:[r.jsx("span",{className:"damage-card-btn__name",children:B}),(P==null?void 0:P.isKaiVariant)&&r.jsx("span",{className:"damage-card-btn__det",title:"改型",children:"◆"}),(P==null?void 0:P.hasBombIcon)&&r.jsx("span",{className:"damage-card-btn__det damage-card-btn__bomb-icon",title:"诱爆卡",children:"💣"})]},J.instanceId)})})]},$)),R&&(e.source!=="ranged"||b)&&r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:["卡组",r.jsxs("span",{className:"damage-zone__sub",children:["（共 ",V.length," 张，正面朝下）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:r.jsxs("button",{className:"damage-card-btn damage-card-btn--deck",onClick:()=>z(R.instanceId),title:"从卡组顶部翻开并摧毁 1 张（诱爆正常触发）",children:[r.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),r.jsx("span",{className:"damage-card-btn__name",children:"顶部 × 1"})]})})]}),R&&e.source==="ranged"&&!b&&r.jsxs("div",{className:"damage-zone",children:[r.jsxs("span",{className:"damage-zone__label",children:["卡组",r.jsxs("span",{className:"damage-zone__sub",children:["（共 ",V.length," 张）"]})]}),r.jsx("div",{className:"damage-zone__cards",children:r.jsxs("div",{className:"damage-card-btn damage-card-btn--deck",style:{opacity:.5,cursor:"default"},title:"射击伤害的牌组部分将在选完表牌后自动从顶部破坏",children:[r.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),r.jsx("span",{className:"damage-card-btn__name",children:"自动破坏"})]})})]})]}),r.jsx("div",{className:"damage-panel__actions",children:r.jsx("button",{className:"action-hud__skip-btn",onClick:E,disabled:x,title:"智能选择价值最低的卡牌优先破坏，剩余部分从牌组顶部自动摧毁",children:x?"自动分配中…":"智能分配剩余伤害"})})]}),r.jsx(Kt,{zoom:f})]})}const vi=`
.action-hud {
...
`,Tv={slot_1:"存档位 1",slot_2:"存档位 2",slot_3:"存档位 3",slot_4:"存档位 4",slot_5:"存档位 5",auto:"自动存档"},Mv=[...Rx,"auto"];function Ev(e){const n=new Date(e),t=a=>String(a).padStart(2,"0");return`${n.getFullYear()}-${t(n.getMonth()+1)}-${t(n.getDate())} ${t(n.getHours())}:${t(n.getMinutes())}`}function pu({mode:e,onBack:n,onLoad:t,currentState:a,aiConfig:o}){const[s,i]=I.useState([]),[l,d]=I.useState(null),[u,f]=I.useState(null),[m,g]=I.useState(null),[h,x]=I.useState(null);I.useEffect(()=>{i(Ud())},[]);function p(){i(Ud())}function _(S){g(S),setTimeout(()=>g(null),2e3)}function y(S){return s.find(C=>C.slotId===S)}function b(S){if(!a||!o)return;if(y(S)){f(S);return}v(S)}function v(S){if(!(!a||!o))try{Sc(S,a,o,!1),p(),f(null),_("存档已保存")}catch(C){x(C instanceof Error?C.message:"保存失败")}}function k(S){const C=Ox(S);if(!C){x("存档数据已损坏，无法加载");return}t==null||t(C)}function N(S){Kx(S),p(),d(null),_("存档已删除")}const T=e==="save"?"保存游戏":"加载存档";return r.jsxs("div",{className:"sl-screen",children:[r.jsxs("div",{className:"sl-panel",children:[r.jsx("h2",{className:"sl-title",children:T}),r.jsx("div",{className:"sl-slots",children:Mv.map(S=>{const C=y(S),E=e==="save"&&!(S==="auto")&&a!=null;return r.jsxs("div",{className:`sl-slot ${C?"sl-slot--occupied":"sl-slot--empty"}`,children:[r.jsxs("div",{className:"sl-slot__label",children:[Tv[S],(C==null?void 0:C.isAutoSave)&&r.jsx("span",{className:"sl-badge",children:"自动"})]}),C?r.jsxs("div",{className:"sl-slot__info",children:[r.jsxs("span",{className:"sl-slot__units",children:[C.player1Unit," vs ",C.player2Unit]}),r.jsx("span",{className:"sl-slot__map",children:C.mapName}),r.jsxs("span",{className:"sl-slot__round",children:["第 ",C.roundNumber," 回合"]}),r.jsx("span",{className:"sl-slot__time",children:Ev(C.timestamp)})]}):r.jsx("div",{className:"sl-slot__info sl-slot__empty-label",children:"空存档位"}),r.jsxs("div",{className:"sl-slot__actions",children:[e==="load"&&C&&r.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>k(S),children:"加载"}),E&&r.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>b(S),children:C?"覆盖":"保存"}),C&&(l===S?r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"sl-confirm-text",children:"确认删除？"}),r.jsx("button",{className:"sl-btn sl-btn--danger",onClick:()=>N(S),children:"确认"}),r.jsx("button",{className:"sl-btn",onClick:()=>d(null),children:"取消"})]}):r.jsx("button",{className:"sl-btn sl-btn--ghost",onClick:()=>d(S),children:"删除"}))]}),u===S&&r.jsxs("div",{className:"sl-overwrite",children:[r.jsx("span",{children:"覆盖此存档？"}),r.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>v(S),children:"确认"}),r.jsx("button",{className:"sl-btn",onClick:()=>f(null),children:"取消"})]})]},S)})}),h&&r.jsxs("div",{className:"sl-error",onClick:()=>x(null),children:["⚠ ",h]}),r.jsx("button",{className:"sl-back-btn",onClick:n,children:"← 返回"})]}),m&&r.jsx("div",{className:"sl-toast",children:m}),r.jsx("style",{children:Dv})]})}const Dv=`
.sl-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`),l=new Blob([i],{type:"text/plain;charset=utf-8"}),d=URL.createObjectURL(l),u=document.createElement("a");u.href=d,u.download=`embryo-log-${a}.txt`,u.click(),URL.revokeObjectURL(d)}const yu=[1e3,2e3,4e3,8e3,15e3];class d1{constructor(n,t,a){en(this,"ws",null);en(this,"url");en(this,"sessionId");en(this,"onMessage");en(this,"onStatus");en(this,"reconnectAttempt",0);en(this,"reconnectTimer",null);en(this,"intentionallyClosed",!1);en(this,"hasEverConnected",!1);this.url=n,this.sessionId=localStorage.getItem("embryo-session-id"),this.onMessage=t,this.onStatus=a}connect(){this.intentionallyClosed=!1,this.onStatus("connecting");const n=this.sessionId?`?sessionId=${this.sessionId}`:"";this.ws=new WebSocket(`${this.url}${n}`),this.ws.onopen=()=>{var t;if(this.intentionallyClosed){(t=this.ws)==null||t.close(),this.ws=null,this.onStatus("disconnected");return}this.hasEverConnected=!0,this.reconnectAttempt=0,this.onStatus("connected")},this.ws.onmessage=t=>{try{const a=JSON.parse(t.data);a.type==="SESSION_ID"&&(this.sessionId=a.sessionId,localStorage.setItem("embryo-session-id",a.sessionId)),this.onMessage(a)}catch{console.warn("[GameSocket] Failed to parse message:",t.data)}},this.ws.onclose=()=>{if(this.intentionallyClosed){this.onStatus("disconnected");return}this.hasEverConnected||(this.sessionId=null,localStorage.removeItem("embryo-session-id")),this.onStatus("reconnecting"),this.scheduleReconnect()},this.ws.onerror=()=>{}}send(n){var t;((t=this.ws)==null?void 0:t.readyState)===WebSocket.OPEN?this.ws.send(JSON.stringify(n)):console.warn("[GameSocket] Cannot send — not connected")}disconnect(){if(this.intentionallyClosed=!0,this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws){const n=this.ws.readyState;n===WebSocket.OPEN||n===WebSocket.CLOSING?(this.ws.close(),this.ws=null):n===WebSocket.CONNECTING&&(this.ws.onmessage=null,this.ws.onerror=null)}this.onStatus("disconnected")}clearSession(){this.sessionId=null,localStorage.removeItem("embryo-session-id")}get isConnected(){var n;return((n=this.ws)==null?void 0:n.readyState)===WebSocket.OPEN}scheduleReconnect(){const n=yu[Math.min(this.reconnectAttempt,yu.length-1)];this.reconnectAttempt++,this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect()},n)}}const lf=I.createContext(null);function u1({serverUrl:e,children:n}){const[t,a]=I.useState(null),[o,s]=I.useState(null),[i,l]=I.useState(null),[d,u]=I.useState("disconnected"),[f,m]=I.useState(null),[g,h]=I.useState(null),[x,p]=I.useState([]),[_,y]=I.useState(null),[b,v]=I.useState(null),[k,N]=I.useState(null),[T,S]=I.useState([]),C=I.useRef(null),z=I.useRef(null),E=I.useRef(-1),O=I.useRef([]),D=I.useCallback(w=>{switch(w.type){case"SESSION_ID":break;case"ROOM_STATE":s(w.room),l(w.yourPlayerId);break;case"ROOM_LIST":p(w.rooms);break;case"GAME_STATE":{w.state.phase==="plotting"&&(z.current!=="plotting"||E.current!==w.state.roundNumber)&&m(null),z.current=w.state.phase,E.current=w.state.roundNumber,a(w.state),l(w.yourPlayerId),y(w.currentTurnPlayerId??null),v(w.turnDeadline??null),w.replayActions&&w.replayActions.length>0?(O.current=[...O.current,...w.replayActions],S(w.replayActions)):S([]);break}case"PLOTTING_STATUS":m({confirmed:w.confirmed,total:w.total});break;case"GAME_STARTED":w.initialState&&(N(w.initialState),O.current=[],S([]));break;case"RECONNECTED":s(w.room),a(w.state),l(w.yourPlayerId),y(w.currentTurnPlayerId??null),v(w.turnDeadline??null),z.current=w.state.phase,E.current=w.state.roundNumber,w.initialState&&N(w.initialState),w.replayActions&&(O.current=w.replayActions,S([]));break;case"SPECTATE_STATE":a(w.state),s(w.room),l(null);break;case"ACTION_REJECTED":h(w.reason),setTimeout(()=>h(null),5e3);break;case"PLAYER_JOINED":case"PLAYER_LEFT":case"PLAYER_RECONNECTED":case"PLAYER_DISCONNECTED":break;case"ERROR":h(w.message),setTimeout(()=>h(null),5e3);break}},[]);I.useEffect(()=>{const w=new d1(e,D,u);return C.current=w,w.connect(),()=>{w.clearSession(),w.disconnect(),C.current=null}},[e,D]);const K=I.useCallback(w=>{var $;($=C.current)==null||$.send({type:"GAME_ACTION",action:w})},[]),A=I.useCallback(w=>{var $;($=C.current)==null||$.send({type:"LOBBY_ACTION",action:w})},[]),V=I.useCallback(w=>{var $;($=C.current)==null||$.send(w)},[]),F=I.useCallback(w=>te(w),[]),R={state:t,room:o,localPlayerId:i,dispatch:K,sendLobbyAction:A,send:V,getCard:F,connectionStatus:d,plottingStatus:f,isOnline:!0,lastError:g,roomList:x,currentTurnPlayerId:_,turnDeadline:b,replayInitialState:k,replayActions:O.current,latestDeltaActions:T};return r.jsx(lf.Provider,{value:R,children:n})}function Ec(){const e=I.useContext(lf);if(!e)throw new Error("useOnlineGame must be used within OnlineGameProvider");return e}function p1({children:e}){var V;const{state:n,localPlayerId:t,dispatch:a,getCard:o,plottingStatus:s,send:i,currentTurnPlayerId:l,replayInitialState:d,replayActions:u,latestDeltaActions:f,room:m}=Ec(),[g,h]=I.useState(!0),x=I.useRef(-1),p=I.useRef(null),_={player1:!1,player2:!1,player1Difficulty:"hard",player2Difficulty:"hard"},y=((V=m==null?void 0:m.settings)==null?void 0:V.simplifiedMode)!==!1,[b,v]=I.useState(n),k=I.useRef(b);k.current=b;const N=I.useCallback(F=>{v(R=>on(R,F))},[]),T=Gm(N,k),{isAnimating:S}=Ea(),C=I.useRef([]),z=I.useRef(n);I.useEffect(()=>{n&&n!==z.current&&(z.current=n,y?(v(n),C.current=[]):f&&f.length>0?C.current.push(...f):(v(n),C.current=[]))},[n,f,y]),I.useEffect(()=>{if(!S&&C.current.length>0){const F=C.current.shift();T(F),C.current.length===0&&setTimeout(()=>v(z.current),200)}},[S,T]);const E=I.useCallback(F=>{if(F.type==="ADVANCE_TIMING"||F.type==="ADVANCE_PHASE"){i({type:"TIMING_DONE"});return}F.type==="START_PLOTTING"||F.type==="DRAW_CARDS"||a(F)},[a,i]),O=I.useCallback(()=>d?{initialState:d,actions:[...u]}:null,[d,u]);if(I.useEffect(()=>{if(!(!g||!n)){if(n.phase==="plotting"&&p.current!=="plotting"&&n.roundNumber!==x.current){x.current=n.roundNumber;try{Sc("auto",n,_,!0)}catch{}}p.current=n.phase}},[g,n]),!n||!t)return null;let D=b;if(D.phase==="plotting"){const F=(s==null?void 0:s.confirmed.includes(t))??!1;D={...D,plottingStep:F?"waiting_online":t}}const K={player1:t!=="player1",player2:t!=="player2",player1Difficulty:"easy",player2Difficulty:"easy",playerAI:Object.fromEntries(n.playerIds.map(F=>[F,F!==t])),playerDifficulty:Object.fromEntries(n.playerIds.map(F=>[F,"easy"]))},A={state:D,dispatch:E,rawDispatch:E,getCard:o,aiConfig:K,setAIConfig:()=>{},getReplayData:O,autoSaveEnabled:g,setAutoSaveEnabled:h,exposureMode:!1,setExposureMode:()=>{},isOnline:!0,localPlayerId:t,currentTurnPlayerId:l,plottingStatus:s};return r.jsx(Os.Provider,{value:A,children:e})}const m1={lobby:"等待中",playing:"游戏中",finished:"已结束"};function cf({onBack:e,onCreateRoom:n,onJoinRoom:t,roomList:a,onRefreshRooms:o,onSpectate:s}){const[i,l]=I.useState("create"),[d,u]=I.useState(()=>localStorage.getItem("embryo-player-name")??""),[f,m]=I.useState(""),[g,h]=I.useState(""),[x,p]=I.useState(2),[_,y]=I.useState(2),[b,v]=I.useState(Ye[0].id);function k(w){const $=[];for(let J=2;J<=w;J++)w%J===0&&$.push(J);return $}function N(w){p(w);const $=k(w);$.includes(_)||y($[0]);const J=Ye.find(P=>P.id===b);if(!J||J.maxPlayers<w){const P=Ye.find(B=>B.maxPlayers>=w);P&&v(P.id)}}const[T,S]=I.useState(""),[C,z]=I.useState(!1),[E,O]=I.useState(0),[D,K]=I.useState(!0);function A(){const w=d.trim()||`Player_${Math.random().toString(36).slice(2,6)}`;return localStorage.setItem("embryo-player-name",w),w}function V(){n(A(),{maxPlayers:x,teamCount:_,mapId:b,turnTimeoutSeconds:E,password:C?T:void 0,simplifiedMode:D})}function F(){const w=f.trim().toUpperCase();w&&t(w,A(),g||void 0)}function R(w,$){m(w),$?(l("join"),h("")):t(w,A())}return r.jsxs("div",{className:"ol-screen",children:[r.jsxs("div",{className:"ol-center",children:[r.jsx("h1",{className:"ol-title",children:"联机对战"}),r.jsx("p",{className:"ol-subtitle",children:"创建、加入或浏览房间"}),r.jsx("div",{className:"ol-divider"}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"昵称"}),r.jsx("input",{className:"ol-input",value:d,onChange:w=>u(w.target.value),placeholder:"输入昵称…",maxLength:16})]}),r.jsxs("div",{className:"ol-tabs",children:[r.jsx("button",{className:`ol-tab${i==="create"?" ol-tab--active":""}`,onClick:()=>l("create"),children:"创建房间"}),r.jsx("button",{className:`ol-tab${i==="join"?" ol-tab--active":""}`,onClick:()=>l("join"),children:"加入房间"}),r.jsx("button",{className:`ol-tab${i==="browse"?" ol-tab--active":""}`,onClick:()=>{l("browse"),o==null||o()},children:"浏览房间"})]}),i==="create"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"最大玩家数"}),r.jsx("select",{className:"ol-select",value:x,onChange:w=>N(+w.target.value),children:[2,3,4,5,6,7,8].map(w=>r.jsxs("option",{value:w,children:[w," 人"]},w))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"队伍数量"}),r.jsx("select",{className:"ol-select",value:_,onChange:w=>y(+w.target.value),children:k(x).map(w=>r.jsxs("option",{value:w,children:[w," 队 (",x/w,"人/队)"]},w))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"地图"}),r.jsx("select",{className:"ol-select",value:b,onChange:w=>v(w.target.value),children:Ye.filter(w=>w.maxPlayers>=x).map(w=>r.jsxs("option",{value:w.id,children:[w.nameCn," (",w.maxPlayers,"人)"]},w.id))})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"回合限时"}),r.jsxs("select",{className:"ol-select",value:E,onChange:w=>O(+w.target.value),children:[r.jsx("option",{value:0,children:"无限制"}),r.jsx("option",{value:30,children:"30 秒"}),r.jsx("option",{value:60,children:"60 秒"}),r.jsx("option",{value:90,children:"90 秒"}),r.jsx("option",{value:120,children:"120 秒"})]})]}),r.jsxs("label",{className:"ol-check",onClick:()=>K(!D),children:[r.jsx("span",{className:`ol-check__box${D?" ol-check__box--on":""}`,children:D?"✓":""}),r.jsx("span",{children:"简易模式（无战斗动画，快速结算）"})]}),r.jsxs("label",{className:"ol-check",onClick:()=>z(!C),children:[r.jsx("span",{className:`ol-check__box${C?" ol-check__box--on":""}`,children:C?"✓":""}),r.jsx("span",{children:"设置房间密码"})]}),C&&r.jsx("div",{className:"ol-field",children:r.jsx("input",{className:"ol-input",value:T,onChange:w=>S(w.target.value),placeholder:"输入密码…",maxLength:20,type:"password"})}),r.jsx("button",{className:"ol-btn ol-btn--primary",onClick:V,children:"创建房间"})]}),i==="join"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"房间号"}),r.jsx("input",{className:"ol-input ol-input--code",value:f,onChange:w=>m(w.target.value.toUpperCase()),placeholder:"输入6位房间号",maxLength:6})]}),r.jsxs("div",{className:"ol-field",children:[r.jsx("label",{className:"ol-label",children:"密码（若有）"}),r.jsx("input",{className:"ol-input",value:g,onChange:w=>h(w.target.value),placeholder:"无密码可留空",maxLength:20,type:"password"})]}),r.jsx("button",{className:"ol-btn ol-btn--primary",onClick:F,disabled:f.trim().length<1,children:"加入房间"})]}),i==="browse"&&r.jsxs("div",{className:"ol-panel",children:[r.jsxs("div",{className:"ol-browse-header",children:[r.jsx("span",{className:"ol-label",children:"在线房间"}),r.jsx("button",{className:"ol-refresh-btn",onClick:o,children:"刷新"})]}),!a||a.length===0?r.jsx("div",{className:"ol-empty",children:"暂无房间，创建一个吧"}):r.jsx("div",{className:"ol-room-list",children:a.map(w=>r.jsxs("div",{className:"ol-room-row",children:[r.jsx("span",{className:"ol-room-row__code",children:w.roomCode}),r.jsx("span",{className:"ol-room-row__host",children:w.hostName}),r.jsx("span",{className:`ol-room-row__status ol-room-row__status--${w.status}`,children:m1[w.status]??w.status}),r.jsxs("span",{className:"ol-room-row__count",children:[w.playerCount,"/",w.maxPlayers]}),w.hasPassword&&r.jsx("span",{className:"ol-room-row__lock",title:"需要密码",children:"🔒"}),w.status==="lobby"?r.jsx("button",{className:"ol-room-row__join",onClick:()=>R(w.roomCode,w.hasPassword),children:"加入"}):r.jsx("button",{className:"ol-room-row__join",onClick:()=>s==null?void 0:s(w.roomCode),disabled:!s,children:"观战"})]},w.roomCode))})]}),r.jsx("button",{className:"ol-btn ol-btn--back",onClick:e,children:"返回主菜单"})]}),r.jsx("style",{children:f1})]})}const f1=`
.ol-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`;function I1(){return"wss://embryo-machine.onrender.com/"}const k1=I1();function j1({onBack:e}){const[n]=I.useState(k1),[t,a]=I.useState("lobby"),[o,s]=I.useState(null),i=I.useCallback((m,g)=>{s({type:"create",playerName:m,settings:g}),a("connected")},[]),l=I.useCallback((m,g,h)=>{s({type:"join",roomCode:m,playerName:g,password:h}),a("connected")},[]),d=I.useCallback(m=>{s({type:"spectate",roomCode:m}),a("connected")},[]),u=I.useCallback(()=>{t!=="connected"&&(s({type:"browse"}),a("connected"))},[t]),f=I.useCallback(()=>{s(null),a("lobby")},[]);return t==="lobby"?r.jsx(cf,{onBack:e,onCreateRoom:i,onJoinRoom:l,onRefreshRooms:u,onSpectate:d}):r.jsx(u1,{serverUrl:n,children:r.jsx(w1,{pendingAction:o,onBack:e,onDisconnect:f})})}function w1({pendingAction:e,onDisconnect:n}){const{state:t,room:a,localPlayerId:o,send:s,connectionStatus:i,lastError:l,roomList:d}=Ec(),[u,f]=I.useState(!1);return!u&&i==="connected"&&e&&(e.type==="create"?s({type:"CREATE_ROOM",playerName:e.playerName,settings:e.settings}):e.type==="join"?s({type:"JOIN_ROOM",roomCode:e.roomCode,playerName:e.playerName,password:e.password}):e.type==="spectate"?s({type:"SPECTATE_ROOM",roomCode:e.roomCode}):e.type==="browse"&&s({type:"LIST_ROOMS"}),f(!0)),(e==null?void 0:e.type)==="browse"&&!a&&!t?r.jsx(cf,{onBack:n,onCreateRoom:(m,g)=>{s({type:"CREATE_ROOM",playerName:m,settings:g})},onJoinRoom:(m,g,h)=>{s({type:"JOIN_ROOM",roomCode:m,playerName:g,password:h})},roomList:d,onRefreshRooms:()=>s({type:"LIST_ROOMS"})}):i==="connecting"?r.jsxs("div",{className:"og-connecting",children:[r.jsx("div",{className:"og-spinner"}),r.jsx("p",{children:"正在连接服务器…"}),r.jsx("button",{className:"ol-btn ol-btn--back",onClick:n,children:"取消"}),r.jsx("style",{children:Nr})]}):a&&!t?r.jsx(g1,{room:a,localPlayerId:o,connectionStatus:i,lastError:l,send:s,onLeave:n}):t&&o?r.jsx(As,{children:r.jsx(p1,{children:r.jsx(S1,{})})}):t&&!o?r.jsx(C1,{state:t,room:a,onLeave:n}):r.jsxs("div",{className:"og-connecting",children:[r.jsx("div",{className:"og-spinner"}),r.jsx("p",{children:"等待服务器响应…"}),l&&r.jsx("div",{className:"rm-error",children:l}),r.jsx("button",{className:"ol-btn ol-btn--back",onClick:n,children:"返回"}),r.jsx("style",{children:Nr})]})}function S1(){const e=Vr(),{dispatch:n,aiConfig:t}=Ce(),{localPlayerId:a,connectionStatus:o,plottingStatus:s,lastError:i,turnDeadline:l}=Ec(),[d,u]=I.useState(null);I.useEffect(()=>{if(!l){u(null);return}const S=()=>{const z=Math.max(0,Math.ceil((l-Date.now())/1e3));u(z)};S();const C=setInterval(S,500);return()=>clearInterval(C)},[l]),I.useEffect(()=>{e.phase==="pregame"&&n({type:"START_PLOTTING"})},[e.phase,n]);const[f,m]=I.useState([{id:"map",zIndex:10},{id:"log",zIndex:11},{id:"mecha",zIndex:12},{id:"plot",zIndex:100}]),g=I.useCallback(S=>{m(C=>{const z=Math.max(...C.map(V=>V.zIndex)),E=C.find(V=>V.id===S);if(E&&E.zIndex===z)return C;const O=[...C].sort((V,F)=>V.zIndex-F.zIndex),D=10,K=new Map;let A=0;for(const V of O)V.id!==S&&K.set(V.id,D+A++);return K.set(S,D+O.length-1),C.map(V=>({...V,zIndex:K.get(V.id)??V.zIndex}))})},[]),h=S=>{var C;return((C=f.find(z=>z.id===S))==null?void 0:C.zIndex)??10},x=I.useCallback(S=>[],[]),p=Ks();if(e.phase==="game_over")return r.jsx(df,{state:e,onHome:()=>{window.location.reload()},onSaveReplay:()=>{},isOnline:!0});const _=p?window.innerWidth:Math.max(400,Math.min(window.innerWidth*.6,620)),y=300,b=window.innerWidth-y-16,v=p?window.innerWidth:380,k=window.innerWidth-v-16,N=e.phase==="plotting"&&e.plottingStep!=="complete"&&e.plottingStep!==null&&!e.plottingStep.startsWith("transition_to_")&&!Ae(t,e.plottingStep),T=r.jsxs("div",{className:"og-status-bar",children:[r.jsxs("span",{className:"og-round",children:["第 ",e.roundNumber," 回合"]}),r.jsx("span",{className:"og-phase",children:uf(e.phase)}),e.currentTiming&&r.jsxs("span",{className:"og-timing",children:["▶ ",pf(e.currentTiming)]}),!p&&e.turnOrder.length>0&&r.jsxs("span",{className:"og-debug-info",title:"当前行动顺序",children:["[",e.turnOrder.map(S=>S.replace("player","P")).join("→"),"]"]}),d!==null&&d>0&&r.jsxs("span",{className:`og-countdown${d<=10?" og-countdown--warn":""}`,children:["⏱ ",d,"s"]}),r.jsx("span",{style:{flex:1}}),s&&e.phase==="plotting"&&r.jsxs("span",{className:"og-plotting",children:["布局进度: ",s.confirmed.length,"/",s.total]}),!p&&r.jsx("button",{className:"og-export-btn",onClick:()=>sf(e,{localPlayerId:a??void 0,connectionStatus:o}),title:"导出全量日志（含调试状态快照）",children:"📋 导出日志"}),r.jsx("span",{className:`og-conn og-conn--${o}`,children:o==="connected"?"在线":o}),a&&r.jsx("span",{className:"og-pid",children:a.replace("player","P")})]});return p?r.jsxs("div",{className:"game-screen game-screen--mobile",children:[T,i&&r.jsx("div",{className:"rm-error",style:{margin:"4px 12px 0"},children:i}),r.jsx("div",{className:"game-screen__board-mobile",children:r.jsx(Ca,{})}),r.jsxs("div",{className:"game-screen__panels-mobile",children:[N&&r.jsx(we,{id:"plot",title:"布局阶段",initialPos:{x:0,y:0},width:v,children:r.jsx(ca,{})}),r.jsx(we,{id:"mecha",title:"机体信息",initialPos:{x:0,y:0},defaultMinimized:!0,children:r.jsx(us,{})}),r.jsx(we,{id:"log",title:"行动日志",initialPos:{x:0,y:0},defaultMinimized:!0,children:r.jsx(Tr,{})})]}),r.jsx(ls,{}),r.jsx(cs,{}),r.jsx("style",{children:Nr})]}):r.jsxs("div",{className:"game-screen",style:{position:"relative",height:"100vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[T,i&&r.jsx("div",{className:"rm-error",style:{margin:"4px 16px 0"},children:i}),r.jsxs("div",{style:{position:"relative",flex:1},children:[r.jsx(we,{id:"map",title:"地图",initialPos:{x:16,y:8},width:_,minHeight:300,zIndex:h("map"),onFocus:g,siblingRects:x("map"),children:r.jsx("div",{style:{height:"calc(100vh - 100px)",minHeight:300},children:r.jsx(Ca,{})})}),r.jsx(we,{id:"log",title:"行动日志",initialPos:{x:b,y:8},width:y,height:260,minHeight:120,zIndex:h("log"),onFocus:g,siblingRects:x("log"),children:r.jsx(Tr,{})}),r.jsx(we,{id:"mecha",title:"机体信息",initialPos:{x:b,y:280},width:y,minHeight:160,zIndex:h("mecha"),onFocus:g,siblingRects:x("mecha"),children:r.jsx(us,{})}),N&&r.jsx(we,{id:"plot",title:"布局阶段",initialPos:{x:k,y:8},width:v,height:620,minHeight:80,zIndex:h("plot"),onFocus:g,siblingRects:x("plot"),children:r.jsx(ca,{})})]}),r.jsx(ls,{}),r.jsx(cs,{}),r.jsx("style",{children:Nr})]})}function C1({state:e,room:n,onLeave:t}){const a={player1:!0,player2:!0,player1Difficulty:"easy",player2Difficulty:"easy",playerAI:Object.fromEntries(e.playerIds.map(i=>[i,!0])),playerDifficulty:Object.fromEntries(e.playerIds.map(i=>[i,"easy"]))},o=()=>{},s={state:e,dispatch:o,rawDispatch:o,getCard:i=>te(i),aiConfig:a,setAIConfig:()=>{},getReplayData:()=>null,autoSaveEnabled:!1,setAutoSaveEnabled:()=>{},exposureMode:!1,setExposureMode:()=>{},isOnline:!0,localPlayerId:null,currentTurnPlayerId:null};return r.jsx(Os.Provider,{value:s,children:r.jsx(As,{children:r.jsxs("div",{className:"game-screen",style:{position:"relative",height:"100vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[r.jsxs("div",{className:"og-status-bar",children:[r.jsx("span",{className:"og-spectate-badge",children:"观战中"}),r.jsxs("span",{className:"og-round",children:["第 ",e.roundNumber," 回合"]}),r.jsx("span",{className:"og-phase",children:uf(e.phase)}),e.currentTiming&&r.jsxs("span",{className:"og-timing",children:["▶ ",pf(e.currentTiming)]}),r.jsx("span",{style:{flex:1}}),n&&r.jsx("span",{className:"og-room-code-badge",children:n.roomCode}),r.jsx("button",{className:"rm-btn rm-btn--leave",onClick:t,children:"离开"})]}),r.jsxs("div",{style:{position:"relative",flex:1},children:[r.jsx(we,{id:"map",title:"地图",initialPos:{x:16,y:8},width:Math.max(400,Math.min(window.innerWidth*.7,700)),minHeight:300,children:r.jsx("div",{style:{height:"calc(100vh - 100px)",minHeight:300},children:r.jsx(Ca,{})})}),r.jsx(we,{id:"log",title:"行动日志",initialPos:{x:window.innerWidth-316,y:8},width:300,height:400,minHeight:120,children:r.jsx(Tr,{})})]}),r.jsx("style",{children:Nr})]})})})}function uf(e){return{pregame:"战前准备",draw:"抽牌阶段",plotting:"布局阶段",action_seg1:"主要阶段 1",action_seg2:"主要阶段 2",cleanup:"清理阶段",game_over:"游戏结束"}[e]??e}function pf(e){return{movement:"移动",ranged:"射击",melee:"近战",special:"特殊"}[e]??e}const Nr=`
.og-connecting {
  display: flex;
  flex-direction: column;
  align-items: center;
