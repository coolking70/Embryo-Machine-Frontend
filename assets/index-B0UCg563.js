 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n($,P){var H=$.length;$.push(P);e:for(;0<H;){var L=H-1>>>1,K=$[L];if(0<r(K,P))$[L]=P,$[H]=K,H=L;else break e}}function t($){return $.length===0?null:$[0]}function a($){if($.length===0)return null;var P=$[0],H=$.pop();if(H!==P){$[0]=H;e:for(var L=0,K=$.length,Y=K>>>1;L<Y;){var X=2*(L+1)-1,oe=$[X],ie=X+1,ce=$[ie];if(0>r(oe,H))ie<K&&0>r(ce,oe)?($[L]=ce,$[ie]=H,L=ie):($[L]=oe,$[X]=H,L=X);else if(ie<K&&0>r(ce,H))$[L]=ce,$[ie]=H,L=ie;else break e}}return P}function r($,P){var H=$.sortIndex-P.sortIndex;return H!==0?H:$.id-P.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var s=Date,c=s.now();e.unstable_now=function(){return s.now()-c}}var d=[],u=[],p=1,f=null,g=3,h=!1,m=!1,v=!1,_=typeof setTimeout=="function"?setTimeout:null,b=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y($){for(var P=t(u);P!==null;){if(P.callback===null)a(u);else if(P.startTime<=$)a(u),P.sortIndex=P.expirationTime,n(d,P);else break;P=t(u)}}function w($){if(v=!1,y($),!m)if(t(d)!==null)m=!0,O(E);else{var P=t(u);P!==null&&U(w,P.startTime-$)}}function E($,P){m=!1,v&&(v=!1,b(S),S=-1),h=!0;var H=g;try{for(y(P),f=t(d);f!==null&&(!(f.expirationTime>P)||$&&!T());){var L=f.callback;if(typeof L=="function"){f.callback=null,g=f.priorityLevel;var K=L(f.expirationTime<=P);P=e.unstable_now(),typeof K=="function"?f.callback=K:f===t(d)&&a(d),y(P)}else a(d);f=t(d)}if(f!==null)var Y=!0;else{var X=t(u);X!==null&&U(w,X.startTime-P),Y=!1}return Y}finally{f=null,g=H,h=!1}}var D=!1,k=null,S=-1,z=5,M=-1;function T(){return!(e.unstable_now()-M<z)}function A(){if(k!==null){var $=e.unstable_now();M=$;var P=!0;try{P=k(!0,$)}finally{P?C():(D=!1,k=null)}}else D=!1}var C;if(typeof x=="function")C=function(){x(A)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,G=R.port2;R.port1.onmessage=A,C=function(){G.postMessage(null)}}else C=function(){_(A,0)};function O($){k=$,D||(D=!0,C())}function U($,P){S=_(function(){$(e.unstable_now())},P)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){m||h||(m=!0,O(E))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function($){switch(g){case 1:case 2:case 3:var P=3;break;default:P=g}var H=g;g=P;try{return $()}finally{g=H}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,P){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var H=g;g=$;try{return P()}finally{g=H}},e.unstable_scheduleCallback=function($,P,H){var L=e.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?L+H:L):H=L,$){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=H+K,$={id:p++,callback:P,priorityLevel:$,startTime:H,expirationTime:K,sortIndex:-1},H>L?($.sortIndex=H,n(u,$),t(d)===null&&$===t(u)&&(v?(b(S),S=-1):v=!0,U(w,H-L))):($.sortIndex=K,n(d,$),m||h||(m=!0,O(E))),$},e.unstable_shouldYield=T,e.unstable_wrapCallback=function($){var P=g;return function(){var H=g;g=P;try{return $.apply(this,arguments)}finally{g=H}}}})(ju);ku.exports=ju;var Im=ku.exports;/**
 * @license React
...
`,Cx={gameTitle:"Embryo Machine",statMovement:"移动力",statEvasion:"回避值",statAssault:"突击",statAssaultDef:"被突击",statInitiative:"先制值"},Vt=Cx,Xi=["var(--color-accent)","#ff00c8","#00cc88","#ff8800","#6688ff","#cc44ff","#44dddd","#ff4466"];function Nx({onNext:e,onBack:n,autoFill:t=!1}){const{state:a,dispatch:r,setAIConfig:i,setExposureMode:s}=Se(),[c,d]=j.useState({}),[u,p]=j.useState({}),[f,g]=j.useState({}),h=a.playerIds.length,m=a.teamCount,v=j.useMemo(()=>ra.slice(0,h),[h]);function _(M,T){r({type:"SELECT_UNIT",playerId:M,unitId:T}),g(A=>({...A,[M]:!0}))}function b(M,T){d(A=>({...A,[M]:T}))}function x(M,T){p(A=>({...A,[M]:T}))}const y=v.map(M=>{var T;return((T=a.players[M])==null?void 0:T.unitId)??""}),w=y.every(M=>M!==""),E=new Set(y.filter(M=>M!=="")).size===y.filter(M=>M!=="").length,D=v.filter(M=>f[M]).map(M=>{var T;return((T=a.players[M])==null?void 0:T.unitId)??""}).filter(M=>M!==""),k=new Set(D).size===D.length,S=t?k:w&&E,z={};for(let M=0;M<v.length;M++){const T=M%m;z[T]||(z[T]=[]),z[T].push(v[M])}return o.jsxs("div",{className:"setup-screen",children:[o.jsx("button",{className:"setup-back-btn",onClick:n,children:"← 上一步"}),o.jsx("h1",{className:"setup-title",children:Vt.gameTitle}),o.jsx("p",{className:"setup-subtitle",children:"选择机体"}),o.jsx("div",{className:"setup-teams",children:Object.entries(z).map(([M,T])=>o.jsxs("div",{className:"setup-team",children:[o.jsxs("h3",{className:"team-header",style:{color:Xi[Number(M)*(h/m)]},children:["队伍 ",Number(M)+1]}),o.jsx("div",{className:"setup-players",children:T.map(A=>{var U;const C=ra.indexOf(A),R=Xi[C%Xi.length],G=((U=a.players[A])==null?void 0:U.unitId)??"",O=y.filter(($,P)=>P!==v.indexOf(A)&&$);return o.jsxs("div",{className:"setup-player-col",children:[o.jsx(Mx,{label:`P${C+1}`,selectedUnit:G,blockedUnits:O,accentColor:R,onSelect:$=>_(A,$)}),o.jsxs("div",{className:"ai-control",children:[o.jsxs("label",{className:"ai-control__label",children:[o.jsx("input",{type:"checkbox",checked:c[A]??!1,onChange:$=>b(A,$.target.checked)}),"AI控制"]}),c[A]&&o.jsxs("select",{className:"ai-control__difficulty",value:u[A]??"hard",onChange:$=>x(A,$.target.value),children:[o.jsx("option",{value:"easy",children:"简单"}),o.jsx("option",{value:"hard",children:"困难"})]})]})]},A)})})]},M))}),o.jsx("button",{className:"start-btn",onClick:()=>{const M=new Set(v.filter(P=>f[P]).map(P=>{var H;return((H=a.players[P])==null?void 0:H.unitId)??""}).filter(P=>P!=="")),A=[...Q.map(P=>P.id).filter(P=>!M.has(P))];for(let P=A.length-1;P>0;P--){const H=Math.floor(Math.random()*(P+1));[A[P],A[H]]=[A[H],A[P]]}const C={...c},R={...u};let G=0;for(const P of v)t&&!f[P]&&G<A.length&&(r({type:"SELECT_UNIT",playerId:P,unitId:A[G]}),G++,C[P]=!0,R[P]="hard");const O={},U={};for(const P of v)O[P]=C[P]??!1,U[P]=R[P]??"hard";i({player1:O.player1??!1,player2:O.player2??!1,player1Difficulty:U.player1??"hard",player2Difficulty:U.player2??"hard",playerAI:O,playerDifficulty:U}),v.every(P=>O[P])&&s(!0),e()},disabled:!S,title:S?"":"请为所有玩家分别选择不同的机体",children:"下一步 →"}),!S&&o.jsx("p",{className:"setup-hint",children:t?"手动选择的机体之间不可重复":w?"每位玩家须选择不同的机体":"请为所有玩家各选择一台机体"}),o.jsx("style",{children:Dx})]})}function Mx({label:e,selectedUnit:n,blockedUnits:t,accentColor:a,onSelect:r}){return o.jsxs("div",{className:"unit-picker",children:[o.jsx("h2",{className:"unit-picker__title",style:{color:a},children:e}),o.jsx("div",{className:"unit-grid",children:Q.map(i=>{const s=t.includes(i.id);return o.jsx(Tx,{unit:i,isSelected:i.id===n,isBlocked:s,accentColor:a,onSelect:()=>!s&&r(i.id)},i.id)})}),n&&o.jsx(Ex,{unit:Q.find(i=>i.id===n),accentColor:a})]})}function Tx({unit:e,isSelected:n,isBlocked:t,accentColor:a,onSelect:r}){return o.jsxs("button",{className:`unit-card ${n?"unit-card--selected":""} ${t?"unit-card--blocked":""}`,onClick:r,disabled:t,title:t?"该机体已被其他玩家选择":e.nameCn,style:n?{borderColor:a,boxShadow:`0 0 8px ${a}55`}:{},children:[o.jsx("img",{src:`/assets/tokens/${e.tokenId}`,alt:e.nameCn,className:"unit-card__token",onError:i=>{i.target.style.opacity="0.3"}}),o.jsx("span",{className:"unit-card__name",children:e.nameCn}),o.jsxs("span",{className:"unit-card__init",children:["先制 ",e.initiative]})]})}function Ex({unit:e,accentColor:n}){return o.jsxs("div",{className:"unit-stats",children:[o.jsxs("div",{className:"unit-stats__name",children:[e.nameCn," ",o.jsxs("small",{children:["(",e.nameJa,")"]})]}),o.jsx("div",{className:"unit-stats__type",children:e.type}),o.jsxs("div",{className:"unit-stats__grid",children:[o.jsx(za,{label:Vt.statMovement,value:e.movement,color:n}),o.jsx(za,{label:Vt.statEvasion,value:e.evasion,color:n}),o.jsx(za,{label:Vt.statAssault,value:e.assault,color:n}),o.jsx(za,{label:Vt.statAssaultDef,value:e.assaultDef,color:n}),o.jsx(za,{label:Vt.statInitiative,value:e.initiative,color:n})]})]})}function za({label:e,value:n,color:t}){return o.jsxs("div",{className:"stat",children:[o.jsx("span",{className:"stat__label",children:e}),o.jsx("span",{className:"stat__value",style:{color:t},children:n})]})}const Dx=`
.setup-screen {
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,zd=768;function Ii(){const[e,n]=j.useState(()=>typeof window<"u"&&window.innerWidth<=zd);return j.useEffect(()=>{const t=window.matchMedia(`(max-width: ${zd}px)`),a=r=>n(r.matches);return t.addEventListener("change",a),n(t.matches),()=>t.removeEventListener("change",a)},[]),e}const $n=18;function je({id:e,title:n,initialPos:t,width:a=300,height:r,minHeight:i=80,children:s,zIndex:c=10,defaultMinimized:d=!1,onFocus:u,siblingRects:p=[]}){const f=Ii(),[g,h]=j.useState(t),[m,v]=j.useState(d),_=j.useRef(null),b=j.useRef(!1);j.useEffect(()=>{b.current||(b.current=!0,h(t))},[]);const x=j.useCallback(y=>{if(f||y.button!==0)return;y.preventDefault(),u==null||u(e);const w=y.clientX-g.x,E=y.clientY-g.y,D=S=>{var O;let z=S.clientX-w,M=S.clientY-E;const T=window.innerWidth,A=window.innerHeight,C=(O=_.current)==null?void 0:O.getBoundingClientRect(),R=(C==null?void 0:C.width)??a,G=(C==null?void 0:C.height)??40;z<$n&&(z=0),M<$n&&(M=0),z+R>T-$n&&(z=T-R),M+G>A-$n&&(M=A-G);for(const U of p)Math.abs(z+R-U.left)<$n&&(z=U.left-R),Math.abs(z-U.right)<$n&&(z=U.right),Math.abs(M+G-U.top)<$n&&(M=U.top-G),Math.abs(M-U.bottom)<$n&&(M=U.bottom),Math.abs(M-U.top)<$n&&(M=U.top);h({x:Math.max(0,z),y:Math.max(0,M)})},k=()=>{document.removeEventListener("mousemove",D),document.removeEventListener("mouseup",k)};document.addEventListener("mousemove",D),document.addEventListener("mouseup",k)},[e,g,u,p,a,f]);return f?o.jsxs("div",{ref:_,className:`dp dp--mobile ${m?"dp--min":""}`,onClick:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar dp__bar--mobile",onClick:()=>v(y=>!y),children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("span",{className:"dp__min-btn dp__min-btn--mobile",children:m?"▼":"▲"})]}),!m&&o.jsx("div",{className:"dp__body dp__body--mobile",children:s}),o.jsx("style",{children:$d})]}):o.jsxs("div",{ref:_,className:`dp ${m?"dp--min":""}`,style:{left:g.x,top:g.y,width:a,height:m?void 0:r,minHeight:m?0:i,zIndex:c},onMouseDown:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar",onMouseDown:x,children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("button",{className:"dp__min-btn",onMouseDown:y=>y.stopPropagation(),onClick:()=>v(y=>!y),title:m?"展开":"最小化",children:m?"▢":"▬"})]}),!m&&o.jsx("div",{className:"dp__body",children:s}),o.jsx("style",{children:$d})]})}const $d=`
.dp {
  position: absolute;
...
`,Yt=48,qr=["#00f0ff","#ff00c8","#00cc88","#ff8800","#6688ff","#cc44ff","#44dddd","#ff4466"],zx=[{facing:"N",label:"↑N",title:"朝北"},{facing:"S",label:"↓S",title:"朝南"},{facing:"E",label:"→E",title:"朝东"},{facing:"W",label:"←W",title:"朝西"}],Ad=.25,$x=2,Pd=.1;function Ax({onBack:e}){const{state:n,dispatch:t}=Se(),a=Ze.find(L=>L.id===n.map.id)??n.map,r=n.playerIds,i=a.width,s=a.height,c=j.useRef(null),[d,u]=j.useState({x:0,y:0,scale:1}),p=j.useRef(null),f=j.useRef(!1);j.useEffect(()=>{const L=c.current;if(!L)return;const K=L.clientWidth,Y=L.clientHeight,X=i*Yt,oe=s*Yt;if(!K||!Y)return;const ie=Math.min(K/X,Y/oe),ce=Math.max(Ad,Math.min(1.2,ie)),ye=(K-X*ce)/2,ne=(Y-oe*ce)/2;u({x:ye,y:ne,scale:ce})},[i,s]),j.useEffect(()=>{const L=c.current;if(!L)return;const K=Y=>{Y.preventDefault();const X=Y.deltaY<0?Pd:-Pd;u(oe=>({...oe,scale:Math.min($x,Math.max(Ad,oe.scale+X))}))};return L.addEventListener("wheel",K,{passive:!1}),()=>L.removeEventListener("wheel",K)},[]);const g=j.useCallback(L=>{L.button===0&&(p.current={startX:L.clientX,startY:L.clientY,origX:d.x,origY:d.y},f.current=!1)},[d.x,d.y]),h=j.useCallback(L=>{if(!p.current)return;const K=L.clientX-p.current.startX,Y=L.clientY-p.current.startY;!f.current&&Math.sqrt(K*K+Y*Y)>5&&(f.current=!0),f.current&&u(X=>({...X,x:p.current.origX+K,y:p.current.origY+Y}))},[]),m=j.useCallback(()=>{p.current=null,f.current=!1},[]),v=j.useMemo(()=>Object.keys(a.startZones).map(Number).sort((L,K)=>L-K),[a]),[_,b]=j.useState(()=>{const L={};for(let K=0;K<n.teamCount;K++)L[K]=K;return L});j.useEffect(()=>{const L={};for(let K=0;K<n.teamCount;K++)L[K]=K;b(L)},[a.id,n.teamCount]);function x(L,K){b(Y=>{const X=Object.entries(Y).find(([,ie])=>ie===K),oe={...Y,[L]:K};return X&&(oe[Number(X[0])]=Y[L]),oe})}const y=j.useMemo(()=>{const L=new Map;for(let K=0;K<n.teamCount;K++){const Y=_[K]??K,X=a.startZones[Y];if(X)for(const oe of X){const ie=`${oe.row},${oe.col}`,ce=L.get(ie)??[];ce.push(K),L.set(ie,ce)}}return L},[a,n.teamCount,_]),w=j.useMemo(()=>{const L={};for(const K of r){const Y=n.teams[K];L[Y]||(L[Y]=[]),L[Y].push(K)}return L},[r,n.teams]),[E,D]=j.useState(r[0]),[k,S]=j.useState(""),z=j.useMemo(()=>{for(const L of r){const K=n.players[L];if(!K)return!1;const Y=n.teams[L],X=_[Y]??Y,oe=a.startZones[X];if(!oe||!oe.some(ce=>ce.row===K.position.row&&ce.col===K.position.col))return!1}return!0},[r,n.players,n.teams,_,a]);function M(L,K){t({type:"SET_SPAWN_POSITION",playerId:L,position:K})}function T(L,K){t({type:"SET_SPAWN_FACING",playerId:L,facing:K})}function A(){z&&t({type:"CONFIRM_SETUP"})}function C(L){const K=r.indexOf(L);return qr[K%qr.length]}function R(L){var Y;const K=(Y=w[L])==null?void 0:Y[0];return K?C(K):qr[L%qr.length]}const G=j.useMemo(()=>{const L=new Map;for(const K of r){const Y=n.players[K];if(!Y)continue;const X=Q.find(ce=>ce.id===Y.unitId);if(!X)continue;const oe=`${Y.position.row},${Y.position.col}`,ie=L.get(oe)??[];ie.push({pid:K,color:C(K),tokenId:X.tokenId,name:X.nameCn}),L.set(oe,ie)}return L},[r,n.players]),{x:O,y:U,scale:$}=d,P=220,H=j.useMemo(()=>{const L={},ie=Math.floor((window.innerHeight-56-60)/192);return r.forEach((ce,ye)=>{const ne=Math.floor(ye/ie),ke=ye%ie;L[ce]={x:window.innerWidth-(P+16)*(ne+1),y:56+ke*192}}),L},[r]);return o.jsxs("div",{className:"ssm__screen",children:[o.jsxs("div",{className:"ssm__topbar",children:[o.jsx("button",{className:"ssm__back-btn",onClick:e,children:"← 返回"}),o.jsx("span",{className:"ssm__title",children:"选择出击位置"}),o.jsxs("span",{className:"ssm__map-name",children:[a.nameCn," (",s,"×",i,")"]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:`ssm__start-btn${z?"":" ssm__start-btn--disabled"}`,onClick:A,disabled:!z,title:z?"开始战斗":"所有玩家必须先选择出击位置",children:"战斗开始 ▶"})]}),o.jsx("div",{className:"ssm__viewport",ref:c,onMouseDown:g,onMouseMove:h,onMouseUp:m,onMouseLeave:m,children:o.jsx("div",{className:"ssm__map-inner",style:{transform:`translate(${O}px, ${U}px) scale(${$})`,transformOrigin:"top left",display:"grid",gridTemplateColumns:`repeat(${i}, ${Yt}px)`,gridTemplateRows:`repeat(${s}, ${Yt}px)`},children:a.cells.flatMap((L,K)=>L.map((Y,X)=>{const oe=nc(Y),ie=`${K},${X}`,ce=y.get(ie)??[],ye=G.get(ie)??[],ne=ce.length>0,ke=ce.length>0?R(ce[0]):"",qe=n.teams[E],Ke=ne&&ce.includes(qe);let Je="ssm__cell";ne&&(Je+=" ssm__cell--zone"),Ke&&(Je+=" ssm__cell--placeable"),ye.length>0&&(Je+=" ssm__cell--selected");function Sn(ae){f.current||(ae.stopPropagation(),Ke&&M(E,{row:K,col:X}))}return o.jsxs("div",{className:Je,style:{backgroundImage:`url("${oe}")`,...ne?{borderColor:ke,boxShadow:ye.length>0?`inset 0 0 10px ${ke}66, 0 0 6px ${ke}44`:void 0}:{}},onClick:Ke?Sn:void 0,children:[ye.length===1&&o.jsx("div",{className:"ssm__token",children:o.jsx("img",{src:`/assets/tokens/${ye[0].tokenId}`,alt:ye[0].name,style:{boxShadow:`0 0 6px ${ye[0].color}`},onError:ae=>{ae.target.style.opacity="0.3"}})}),ye.length>1&&o.jsx("div",{className:"ssm__token ssm__token--multi",children:ye.map(ae=>o.jsx("img",{src:`/assets/tokens/${ae.tokenId}`,alt:ae.name,className:"ssm__token-img-sm",style:{boxShadow:`0 0 4px ${ae.color}`},onError:ja=>{ja.target.style.opacity="0.3"}},ae.pid))})]},ie)}))})}),r.map((L,K)=>{var Sn;const Y=n.players[L],X=Q.find(ae=>ae.id===(Y==null?void 0:Y.unitId)),oe=C(L),ie=k===L,ce=E===L,ye=n.teams[L],ne=((Sn=w[ye])==null?void 0:Sn[0])===L,ke=_[ye]??ye,qe=_[ye]??ye,Je=(a.startZones[qe]??[]).some(ae=>ae.row===Y.position.row&&ae.col===Y.position.col);return o.jsx(je,{id:`spawn-${L}`,title:`P${K+1} ${(X==null?void 0:X.nameCn)??"—"}`,initialPos:H[L]??{x:100,y:100},width:P,minHeight:60,zIndex:ie?50:10+K,onFocus:()=>{S(L),D(L)},children:o.jsxs("div",{className:`ssm__player-card${ce?" ssm__player-card--active":""}`,style:{borderTop:`2px solid ${oe}`},onClick:()=>D(L),children:[o.jsxs("div",{className:"ssm__player-label",style:{color:oe},children:["P",K+1," ",ce?"◄ 放置中":""," ",Je?"✓":""]}),ne&&o.jsx("div",{className:"ssm__zone-select",children:o.jsxs("label",{children:["出击区域:",o.jsx("select",{value:ke,onChange:ae=>x(ye,Number(ae.target.value)),onClick:ae=>ae.stopPropagation(),children:v.slice(0,a.maxTeams).map(ae=>o.jsxs("option",{value:ae,children:["区域 ",ae+1]},ae))})]})}),o.jsx("div",{className:"ssm__unit-name",children:(X==null?void 0:X.nameCn)??"—"}),o.jsxs("div",{className:"ssm__pos-display",children:["格 (",Y.position.row,", ",Y.position.col,")"]}),o.jsx("div",{className:"ssm__facing-grid",children:zx.map(({facing:ae,label:ja,title:Yf})=>{const fc=Y.facing===ae;return o.jsx("button",{className:`ssm__facing-btn${fc?" ssm__facing-btn--active":""}`,style:fc?{borderColor:oe,color:oe}:void 0,title:Yf,onClick:()=>T(L,ae),children:ja},ae)})})]})},L)}),o.jsx("style",{children:Px})]})}const Px=`
.ssm__screen {
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`;function Zd(e,n){const t=N0(e,n);if(t.length===0)return n;if(t.length===1)return t[0];const a=e.players[n].position;let r=t[0],i=1/0;for(const s of t){const c=e.players[s].position,d=Math.abs(c.row-a.row)+Math.abs(c.col-a.col);d<i&&(i=d,r=s)}return r}function Yo(){const{state:e,getCard:n}=Se(),{phase:t,currentTiming:a,turnOrder:r,pendingDamage:i}=e;if(t!=="action_seg1"&&t!=="action_seg2")return null;const s=t==="action_seg1"?1:2;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"action-hud",style:i?{display:"none"}:void 0,children:[a==="movement"&&o.jsx(Dv,{seg:s,turnOrder:r,getCard:n},`mov-${s}`),(a==="ranged"||a==="melee")&&o.jsx(Av,{seg:s,getCard:n},`combat-${s}-${a}`),a==="special"&&o.jsx(Vv,{seg:s,turnOrder:r,getCard:n},`special-${s}`),o.jsx("style",{children:Yd})]}),i&&o.jsxs(o.Fragment,{children:[o.jsx(Lv,{pendingDamage:i,getCard:n}),o.jsx("style",{children:Yd})]})]})}function Dv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:r,aiConfig:i,isOnline:s,localPlayerId:c,currentTurnPlayerId:d}=Se(),{map:u,pendingDamage:p,playerIds:f}=a,[g,h]=j.useState(new Set),[m,v]=j.useState(null),[_,b]=j.useState([]),[x,y]=j.useState(null),w=j.useRef(!1),E=new Map;for(const O of f){const U=a.players[O],$=Q.find(P=>P.id===U.unitId);E.set(O,gh(U,e,t,$.movement))}j.useEffect(()=>{if(!(m!==null||x!==null)&&!w.current&&!p){if(s&&c){if(d!==c)return;if(E.get(c))v(c);else{const O=a.players[c],U=e===1?O.plotSeg1:O.plotSeg2;if(!U)r({type:"ADD_LOG",message:`  ${ze(c)} 未配置行动卡，跳过`});else{const $=t(U.defId);$&&$.actionType==="movement"&&r({type:"ADD_LOG",message:`  ${ze(c)}【${$.nameCn}】无法发动移动`})}w.current=!0,r({type:"ADVANCE_TIMING"})}return}for(const O of n)if(!g.has(O))if(E.get(O)){v(O);return}else{const U=a.players[O],$=e===1?U.plotSeg1:U.plotSeg2;if(!$)r({type:"ADD_LOG",message:`  ${ze(O)} 未配置行动卡，跳过`});else{const P=t($.defId);P&&P.actionType==="movement"&&r({type:"ADD_LOG",message:`  ${ze(O)}【${P.nameCn}】无法发动移动`})}h(P=>new Set([...P,O]));return}w.current=!0,r({type:"ADVANCE_TIMING"})}},[g,m,x,p,d]),j.useEffect(()=>{if(!m){b([]);return}const O=a.players[m],U=f.filter(K=>K!==m).map(K=>a.players[K].position),$=Q.find(K=>K.id===O.unitId),P=jn(O,t,"movement"),H=Yi(O,e,t,P)||$.movement,L=gi(u,O.position,H,U,P,O.facing);b(L.map(K=>K.pos))},[m,a.players,u,e]),j.useEffect(()=>{if(!m||s&&c&&m!==c||!Re(i,m))return;const U=Mr(i,m),$=setTimeout(()=>{const P=ix(a,m,e,t,U);P&&r({type:"MOVE_UNIT",playerId:m,to:P.pos,path:P.path,finalFacing:P.finalFacing}),h(H=>new Set([...H,m])),v(null),b([])},800);return()=>clearTimeout($)},[m]);function D(O,U){if(!m||Re(i,m)||!_.some(P=>re(P,O)))return;let $=U;if(!$){const P=a.players[m],H=f.filter(X=>X!==m).map(X=>a.players[X].position),L=Q.find(X=>X.id===P.unitId),K=jn(P,t,"movement"),Y=Yi(P,e,t,K)||L.movement;$=tc(u,P.position,P.facing,O,Y,H,K)}r({type:"MOVE_UNIT",playerId:m,to:O,path:$==null?void 0:$.path,finalFacing:$==null?void 0:$.finalFacing}),b([]),y(m),v(null)}function k(){x&&(h(O=>new Set([...O,x])),y(null),s&&(w.current=!0,r({type:"ADVANCE_TIMING"})))}if(s&&c&&d&&d!==c&&!m&&!x)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",ze(d)," 行动中…"]})});const S=n.every(O=>!E.get(O)||g.has(O));if(!s&&S&&m===null&&x===null||s&&w.current&&m===null&&x===null)return null;if(x!==null){const O=a.players[x],U=ze(x),$=ma(O.facing);return o.jsxs("div",{className:"action-hud__panel",children:[o.jsx("span",{className:"action-hud__mover",children:U}),o.jsx("span",{className:"action-hud__hint",children:"移动完毕，可选择调整机头方向（最多90°）"}),o.jsx(zv,{playerId:x,disabledFacing:$}),o.jsx("button",{className:"action-hud__skip-btn",onClick:k,children:"确认方向"})]})}const z=m?Re(i,m):!1,M=m?ze(m):"";if(z)return o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[M," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]});const T=m?a.players[m]:null,A=m&&T?jn(T,t,"movement"):null,C=T?Q.find(O=>O.id===T.unitId):null,R=m&&T&&C?Yi(T,e,t,A??void 0)||C.movement:0,G=m?f.filter(O=>O!==m).map(O=>a.players[O].position):[];return o.jsxs(o.Fragment,{children:[m&&T&&o.jsx($v,{reachable:_,map:u,from:T.position,fromFacing:T.facing,movementValue:R,blockedPositions:G,aux:A??void 0,onCellClick:D}),o.jsx("div",{className:"action-hud__panel",children:m?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"action-hud__mover",children:M}),o.jsx("span",{className:"action-hud__hint",children:"选择目标格（步数须用尽；点击选择路径）"}),(A==null?void 0:A.vernier)&&o.jsx("span",{className:"action-hud__aux-badge",title:"地形移动消耗-1，高低差消耗-1",children:"⚙ 喷射推进器"}),(A==null?void 0:A.wheel)&&o.jsx("span",{className:"action-hud__aux-badge",title:"移动力+2",children:"⚙ 滑轮"})]}):o.jsx("span",{className:"action-hud__hint",children:"计算移动路径中…"})})]})}function zv({playerId:e,disabledFacing:n}){const{state:t,dispatch:a}=Se(),i=t.players[e].facing,s=[{facing:"N",label:"↑N"},{facing:"E",label:"E→"},{facing:"S",label:"↓S"},{facing:"W",label:"←W"}];return o.jsxs("div",{className:"facing-compass",title:"调整机头朝向（不可掉头）",children:[o.jsx("span",{className:"facing-compass__label",children:"机头"}),s.map(({facing:c,label:d})=>{const u=c===n;return o.jsx("button",{className:["facing-compass__btn",i===c?"facing-compass__btn--active":"",u?"facing-compass__btn--disabled":""].join(" ").trim(),onClick:()=>{u||a({type:"ADJUST_FACING",playerId:e,facing:c})},disabled:u,title:u?"无法180°掉头":`朝${c}方`,children:d},c)})]})}function $v({reachable:e,map:n,from:t,fromFacing:a,movementValue:r,blockedPositions:i,aux:s,onCellClick:c}){const d=Ii(),u=j.useRef({allPaths:[],selectedIdx:0,hoveredPos:null}),[p,f]=j.useState(0),g=()=>f(m=>m+1);j.useEffect(()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(w=>w.classList.remove("board-cell--path-ghost"));const{allPaths:m,selectedIdx:v,hoveredPos:_}=u.current;if(!_||m.length===0)return;const b=m[v];if(!b)return;const x=b.path.slice(0,-1);for(const w of x){const E=document.querySelector(`.board-cell[data-row="${w.row}"][data-col="${w.col}"]`);E==null||E.classList.add("board-cell--path-ghost")}const y=document.querySelector(`.board-cell[data-row="${_.row}"][data-col="${_.col}"]`);return y&&(y.dataset.pathLabel=m.length>1?`${v+1}/${m.length}`:""),()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(w=>w.classList.remove("board-cell--path-ghost")),y&&delete y.dataset.pathLabel}},[p]),j.useEffect(()=>{const m=[];document.querySelectorAll(".board-cell--reachable").forEach(v=>{v.classList.remove("board-cell--reachable")});for(const v of e){const _=document.querySelector(`.board-cell[data-row="${v.row}"][data-col="${v.col}"]`);if(!_)continue;_.classList.add("board-cell--reachable");const b=()=>{const{allPaths:A,selectedIdx:C}=u.current;c(v,A[C]??null)},x=()=>{const A=Zi(n,t,a,v,r,i,s);u.current={allPaths:A,selectedIdx:0,hoveredPos:v},g()},y=()=>{u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()},w=A=>{const{allPaths:C,selectedIdx:R}=u.current;if(C.length<=1)return;A.preventDefault();const G=A.deltaY>0?1:-1;u.current={...u.current,selectedIdx:(R+G+C.length)%C.length},g()};let E=null,D=0,k=0,S=!1;const z=A=>{if(D=A.touches[0].clientX,k=A.touches[0].clientY,S=!1,d){const{hoveredPos:C}=u.current;if(C&&C.row===v.row&&C.col===v.col)return;const R=Zi(n,t,a,v,r,i,s);u.current={allPaths:R,selectedIdx:0,hoveredPos:v},g(),A.preventDefault();return}E=setTimeout(()=>{S=!0;const C=Zi(n,t,a,v,r,i,s);u.current={allPaths:C,selectedIdx:0,hoveredPos:v},g()},400)},M=()=>{E&&(clearTimeout(E),E=null),S&&!d&&(u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()),S=!1},T=A=>{if(d||!S)return;const C=A.touches[0].clientX-D,R=A.touches[0].clientY-k;if(Math.abs(C)>40||Math.abs(R)>40){const{allPaths:G,selectedIdx:O}=u.current;if(G.length<=1)return;const U=Math.abs(C)>Math.abs(R)?C>0?1:-1:R>0?1:-1;u.current={...u.current,selectedIdx:(O+U+G.length)%G.length},g(),D=A.touches[0].clientX,k=A.touches[0].clientY}};_.addEventListener("click",b),_.addEventListener("mouseenter",x),_.addEventListener("mouseleave",y),_.addEventListener("wheel",w,{passive:!1}),_.addEventListener("touchstart",z,{passive:!0}),_.addEventListener("touchend",M),_.addEventListener("touchcancel",M),_.addEventListener("touchmove",T,{passive:!0}),m.push(()=>{E&&clearTimeout(E),_.removeEventListener("click",b),_.removeEventListener("mouseenter",x),_.removeEventListener("mouseleave",y),_.removeEventListener("wheel",w),_.removeEventListener("touchstart",z),_.removeEventListener("touchend",M),_.removeEventListener("touchcancel",M),_.removeEventListener("touchmove",T)})}return()=>{document.querySelectorAll(".board-cell--reachable").forEach(v=>v.classList.remove("board-cell--reachable")),document.querySelectorAll(".board-cell--path-ghost").forEach(v=>v.classList.remove("board-cell--path-ghost")),document.querySelectorAll(".board-cell[data-path-label]").forEach(v=>delete v.dataset.pathLabel),u.current={allPaths:[],selectedIdx:0,hoveredPos:null},m.forEach(v=>v())}},[e,n,t,a,r,i,s,c]);const h=j.useCallback(()=>{const{allPaths:m,selectedIdx:v}=u.current;m.length<=1||(u.current={...u.current,selectedIdx:(v+1)%m.length},g())},[]);if(d){const{allPaths:m,hoveredPos:v}=u.current;if(v&&m.length>1)return o.jsxs("button",{className:"move-cycle-btn",onClick:h,style:{position:"fixed",bottom:80,left:"50%",transform:"translateX(-50%)",zIndex:600,padding:"10px 24px",background:"rgba(22, 33, 62, 0.95)",border:"1px solid #ffea00",borderRadius:8,color:"#ffea00",fontFamily:"var(--font-mono)",fontSize:"0.85rem",fontWeight:"bold",cursor:"pointer",minHeight:44,backdropFilter:"blur(4px)"},children:["切换路径 (",u.current.selectedIdx+1,"/",m.length,")"]})}return null}function $f({reachable:e,onCellClick:n}){return j.useEffect(()=>(document.querySelectorAll(".board-cell").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null}),e.forEach(a=>{const r=document.querySelector(`.board-cell[data-row="${a.row}"][data-col="${a.col}"]`);r&&(r.classList.add("board-cell--reachable"),r.onclick=()=>n(a))}),()=>{document.querySelectorAll(".board-cell--reachable").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null})}),[e,n]),null}function Av({seg:e,getCard:n}){const{state:t,dispatch:a,aiConfig:r,isOnline:i,localPlayerId:s,currentTurnPlayerId:c}=Se(),{map:d,turnOrder:u,currentTiming:p,pendingDamage:f}=t,[g,h]=j.useState(new Set),[m,v]=j.useState(null),[_,b]=j.useState(null),x=j.useRef(!1),[y,w]=j.useState(!1),[E,D]=j.useState([]),[k,S]=j.useState(!1),z=p==="ranged"?"ranged":"melee",M=z==="ranged"?"射击时机":"近战时机";if(j.useEffect(()=>{if(m===null&&!x.current&&!f){if(i&&s){if(c!==s)return;const ne=t.players[s];if(Vn(ne,e,z,n))v(s),w(!1),S(!1),D([]);else{const qe=e===1?ne.plotSeg1:ne.plotSeg2;if(qe){const Ke=n(qe.defId);Ke&&(z==="ranged"&&Ke.actionType==="ranged"||z==="melee"&&(Ke.actionType==="melee"||Ke.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${ze(s)}【${Ke.nameCn}】条件不满足，无法发动`})}x.current=!0,a({type:"ADVANCE_TIMING"})}return}for(const ne of u){if(g.has(ne))continue;const ke=t.players[ne];if(!Vn(ke,e,z,n)){const Ke=e===1?ke.plotSeg1:ke.plotSeg2;if(Ke){const Je=n(Ke.defId);Je&&(z==="ranged"&&Je.actionType==="ranged"||z==="melee"&&(Je.actionType==="melee"||Je.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${ze(ne)}【${Je.nameCn}】条件不满足，无法发动`})}h(Je=>new Set([...Je,ne]));return}v(ne),w(!1),S(!1),D([]);return}x.current=!0,a({type:"ADVANCE_TIMING"})}},[g,m,f,n,c]),j.useEffect(()=>{if(!m||f||i&&s&&m!==s||!Re(r,m))return;const ke=Mr(r,m),qe=Zd(t,m),Ke=setTimeout(()=>{if(sx(t,m,e,z,n,ke)){const Sn=t.players[m],ae=Vn(Sn,e,z,n),ja=(ae==null?void 0:ae.actionType)==="charge"?"RESOLVE_CHARGE":z==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE";a({type:ja,attackerId:m,targetId:qe})}else{const Sn=t.players[m],ae=Vn(Sn,e,z,n);a({type:"ADD_LOG",message:`  ${ze(m)} 放弃发动${ae?`【${ae.nameCn}】`:M}`})}h(Sn=>new Set([...Sn,m])),v(null),w(!1),S(!1),D([])},800);return()=>clearTimeout(Ke)},[m,f]),i&&s&&c&&c!==s&&!m)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",ze(c)," 行动中…"]})});if(!m)return null;const T=t.players[m],A=Zd(t,m),C=t.players[A],R=p==="melee"?jn(T,n,"melee"):{vernier:!1,moveSensor:!1},G=Vn(T,e,z,n),O=(G==null?void 0:G.actionType)==="charge",U=Re(r,m);let $;if(O&&z==="melee"){const ne=Q.find(qe=>qe.id===T.unitId),ke=Q.find(qe=>qe.id===C.unitId);$=Jo(T,C,e,d,ne,ke,n)}else $=ac(T,C,e,z,d,n);const P=Q.find(ne=>ne.id===T.unitId),H=Q.find(ne=>ne.id===C.unitId);function L(){if(!$.canAttack||!m)return;a({type:O?"RESOLVE_CHARGE":z==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE",attackerId:m,targetId:A}),b(`${P.nameCn} → ${H.nameCn}：造成 ${$.damage} 伤害`),h(ke=>new Set([...ke,m])),v(null),w(!1),S(!1),D([]),i&&(x.current=!0,a({type:"ADVANCE_TIMING"}))}function K(){if(!m)return;const ne=Vn(t.players[m],e,z,n);a({type:"ADD_LOG",message:`  ${ze(m)} 放弃发动${ne?`【${ne.nameCn}】`:M}`}),b(null),h(ke=>new Set([...ke,m])),v(null),w(!1),S(!1),D([]),i&&(x.current=!0,a({type:"ADVANCE_TIMING"}))}function Y(){if(!m||y)return;const ne=Nf(d,T.position,[C.position]);D(ne),S(!0)}function X(ne){!m||!k||(a({type:"MELEE_SENSOR_MOVE",playerId:m,to:ne}),w(!0),S(!1),D([]))}function oe(){S(!1),D([])}const ie=ze(m),ce=$.card?O?`【${$.card.nameCn}】突击值 ${P.assault} vs 防御${H.assaultDef}`:`【${$.card.nameCn}】射程 ${$.card.rangeMin??"—"}–${$.card.rangeMax??"—"}`:null,ye=z==="melee"&&R.moveSensor&&!y;return U?o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[ze(m)," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):o.jsxs(o.Fragment,{children:[k&&o.jsx($f,{reachable:E,onCellClick:X}),!k&&o.jsx(Pv,{targetPos:$.canAttack?C.position:null}),o.jsxs("div",{className:"action-hud__panel action-hud__panel--combat",children:[o.jsx("span",{className:"action-hud__mover",children:ie}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__timing-label",children:M}),R.moveSensor&&o.jsxs("span",{className:`action-hud__aux-badge ${y?"action-hud__aux-badge--used":""}`,title:"近战前可移动1格",children:["⚙ 移动传感器",y?"（已使用）":""]}),R.vernier&&o.jsx("span",{className:"action-hud__aux-badge",title:"地形消耗-1，高低差-1",children:"⚙ 喷射推进器"}),$.card?o.jsxs("span",{className:"action-hud__card-info",children:[ce,$.card.damage!==void 0&&o.jsxs("span",{className:"action-hud__dmg",children:[" 伤害 ",$.card.damage]})]}):o.jsxs("span",{className:"action-hud__hint",children:["无",z==="ranged"?"射击":"近战","牌"]}),o.jsx("span",{className:`action-hud__validity ${$.canAttack?"action-hud__validity--ok":"action-hud__validity--no"}`,children:$.canAttack?O?`距离 ${$.dist} ✓ → 造成 ${$.damage} 伤 / 自机反伤 ${$.counterDamage}`:`距离 ${$.dist} ✓ → ${$.damage} 伤`:$.card?$.reason:""}),_&&o.jsx("span",{className:"action-hud__result",children:_}),k?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"action-hud__hint",children:"点击高亮格移动（传感器），或"}),o.jsx("button",{className:"action-hud__skip-btn",onClick:oe,children:"取消移动"})]}):o.jsxs(o.Fragment,{children:[ye&&o.jsx("button",{className:"action-hud__sensor-btn",onClick:Y,title:"移动传感器：攻击前可移动1格",children:"传感器移动"}),o.jsx("button",{className:"action-hud__attack-btn",onClick:L,disabled:!$.canAttack,title:$.canAttack?`攻击 ${H.nameCn}`:$.reason,children:"执行攻击"}),o.jsxs("button",{className:"action-hud__skip-btn",onClick:K,children:["跳过",z==="ranged"?"射击":"近战"]})]})]})]})}function Pv({targetPos:e}){return j.useEffect(()=>{if(document.querySelectorAll(".board-cell--target").forEach(n=>{n.classList.remove("board-cell--target")}),e){const n=document.querySelector(`.board-cell[data-row="${e.row}"][data-col="${e.col}"]`);n==null||n.classList.add("board-cell--target")}return()=>{document.querySelectorAll(".board-cell--target").forEach(n=>{n.classList.remove("board-cell--target")})}},[e]),null}function Vv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:r,aiConfig:i,isOnline:s,localPlayerId:c,currentTurnPlayerId:d}=Se(),{map:u,pendingDamage:p}=a,[f,g]=j.useState(new Set),[h,m]=j.useState(null),[v,_]=j.useState([]),b=j.useRef(!1);if(j.useEffect(()=>{if(h===null&&!b.current&&!p){if(s&&c){if(d!==c)return;const z=a.players[c],M=e===1?z.plotSeg1:z.plotSeg2,T=M?t(M.defId):null;!T||T.actionType!=="mine"&&T.actionType!=="special"?(b.current=!0,r({type:"ADVANCE_TIMING"})):m(c);return}for(const z of n){if(f.has(z))continue;const M=a.players[z],T=e===1?M.plotSeg1:M.plotSeg2,A=T?t(T.defId):null;if(!A||A.actionType!=="mine"&&A.actionType!=="special"){g(C=>new Set([...C,z]));return}m(z);return}b.current=!0,r({type:"ADVANCE_TIMING"})}},[f,h,p,t,d]),j.useEffect(()=>{if(!h){_([]);return}const z=a.players[h],M=e===1?z.plotSeg1:z.plotSeg2,T=M?t(M.defId):null;if(T&&T.actionType==="mine"){const A=Cf(u,z.position,1,[]);_(A)}else _([])},[h,u,e,a.players,t]),j.useEffect(()=>{if(!h||p||s&&c&&h!==c||!Re(i,h))return;const M=Mr(i,h),T=setTimeout(()=>{const A=cx(a,h,e,t,M);if(A){const C=a.players[h],R=e===1?C.plotSeg1:C.plotSeg2,G=R?t(R.defId):null;r({type:"PLACE_MINE",playerId:h,to:A,damage:(G==null?void 0:G.damage)||3})}g(C=>new Set([...C,h])),m(null)},800);return()=>clearTimeout(T)},[h,p]),s&&c&&d&&d!==c&&!h)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",ze(d)," 行动中…"]})});if(!h)return null;const x=a.players[h],y=e===1?x.plotSeg1:x.plotSeg2,w=y?t(y.defId):null,E=ze(h),D=Re(i,h);function k(){g(z=>new Set([...z,h])),m(null),s&&(b.current=!0,r({type:"ADVANCE_TIMING"}))}function S(z){!h||!w||w.actionType!=="mine"||v.some(M=>re(M,z))&&(r({type:"PLACE_MINE",playerId:h,to:z,damage:w.damage||3}),g(M=>new Set([...M,h])),m(null),s&&(b.current=!0,r({type:"ADVANCE_TIMING"})))}return D?o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[E," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):o.jsxs(o.Fragment,{children:[v.length>0&&o.jsx($f,{reachable:v,onCellClick:S}),o.jsxs("div",{className:"action-hud__panel action-hud__panel--special",children:[o.jsx("span",{className:"action-hud__mover",children:E}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__timing-label",children:"特殊时机"}),o.jsx("span",{className:"action-hud__card-info",children:w?`【${w.nameCn}】效果`:"（无）"}),(w==null?void 0:w.actionType)==="mine"?o.jsx("span",{className:"action-hud__hint",children:"请点击高亮格部署机雷，或"}):o.jsx("span",{className:"action-hud__hint",children:"暂无此牌效果支持，请"}),o.jsx("button",{className:"action-hud__skip-btn",onClick:k,children:"跳过"})]})]})}function Lv({pendingDamage:e,getCard:n}){const{state:t,dispatch:a,aiConfig:r,isOnline:i,localPlayerId:s}=Se(),{targetId:c,remaining:d,selectedInstanceIds:u}=e,{zoom:p,getZoomHandlers:f}=_a(),[g,h]=j.useState(null),m=t.players[c];Tt(m);const v=u.length===0,_=!!e.attackerId&&v&&!e.attackerDesignatedCardId,b=_?e.attackerId:c,x=ze(b),y=i&&s&&b!==s,w=!y&&Re(r,b),E=Mr(r,b),D=!i&&!w&&b!==g;j.useEffect(()=>{w?h(b):i||h(null)},[b,w,i]),j.useEffect(()=>{if(!w||y||d<=0)return;const O=t.players[c],U=Cr(O),$=t.playerIds.filter(L=>L!==c&&t.teams[L]!==t.teams[c]&&!t.players[L].isDefeated),P=$.length>0?t.players[$[0]]:O,H=setTimeout(()=>{if(U.length>0){const L=lx(e,O,n,E,_,P);a(L?{type:"SELECT_DAMAGE_CARD",playerId:b,instanceId:L}:{type:"CONFIRM_DAMAGE_SELECTION",playerId:b})}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:b})},600);return()=>clearTimeout(H)},[d,b,w,y,t.players]);function k(O){a({type:"SELECT_DAMAGE_CARD",playerId:b,instanceId:O})}function S(){a({type:"CONFIRM_DAMAGE_SELECTION",playerId:b})}if(y)return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),o.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),o.jsx("div",{className:"damage-pass__player",children:x}),o.jsx("p",{className:"damage-pass__context",children:_?"【瞄准加成】攻方正在指定要摧毁的卡牌…":`${x} 正在选择要摧毁的 ${d} 张卡牌…`}),o.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),o.jsx("style",{children:Xd})]});if(D)return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),o.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),o.jsx("div",{className:"damage-pass__player",children:x}),o.jsx("p",{className:"damage-pass__context",children:_?"【瞄准加成】攻方有权指定第一张要摧毁的卡牌":`防方选择要摧毁的 ${d} 张卡牌（可自动分配）`}),o.jsxs("button",{className:"damage-pass__btn",onClick:()=>h(b),children:[x," 已准备"]})]})}),o.jsx("style",{children:Xd})]});const z=m.hand.filter(O=>!O.destroyed),M=m.plotSeg1&&!m.plotSeg1.destroyed?[m.plotSeg1]:[],T=m.plotSeg2&&!m.plotSeg2.destroyed?[m.plotSeg2]:[],A=m.auxiliary.filter(O=>!O.destroyed),C=m.deck.filter(O=>!O.destroyed),R=[];z.length>0&&R.push({label:"手牌",cards:z}),M.length>0&&R.push({label:"布局格",sublabel:"主要阶段1",cards:M}),T.length>0&&R.push({label:"布局格",sublabel:"主要阶段2",cards:T}),A.length>0&&R.push({label:"辅助区",cards:A});const G=C[0]??null;return o.jsxs("div",{className:"action-hud",children:[o.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[o.jsxs("div",{className:"damage-panel__header",children:[o.jsx("span",{className:"damage-panel__title",children:"⚔️ 伤害分配"}),o.jsx("span",{className:"damage-panel__player",children:_?`${x} (瞄准指定)`:x}),o.jsxs("span",{className:"damage-panel__remaining",children:["还需摧毁 ",o.jsx("strong",{children:d})," 张卡牌"]})]}),(e.destroyedBombCount??0)>0&&o.jsxs("div",{className:"damage-panel__bomb-alert",children:["💣 已选中 ",e.destroyedBombCount," 张炸弹卡，选完后将进行誘爆检查"]}),o.jsx("div",{className:"damage-panel__hint",children:_?`【瞄准加成】攻方有权指定第一张要摧毁的卡牌！可从手牌、辅助区、卡组、布局格中选择。请 ${x} 选择：`:e.source==="ranged"?"射击伤害：须先从手牌 / 布局格 / 辅助区选择卡牌破坏，不足部分自动从牌组顶破坏。":"牌组与弃牌区已耗尽，近战伤害切换为自选模式。请从手牌 / 布局格 / 辅助区选择。"}),o.jsxs("div",{className:"damage-panel__zones",children:[R.map((O,U)=>o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:[O.label,O.sublabel&&o.jsxs("span",{className:"damage-zone__sub",children:["（",O.sublabel,"）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:O.cards.map($=>{const P=n($.defId),H=(P==null?void 0:P.nameCn)??$.defId,L=u.includes($.instanceId),K=P!=null&&P.frontImageId?`/assets/${P.frontImageId}`:null;return o.jsxs("button",{className:`damage-card-btn ${L?"damage-card-btn--selected":""} ${P!=null&&P.hasBombIcon?"damage-card-btn--bomb":""}`,onClick:()=>k($.instanceId),disabled:L,title:`${H} (${(P==null?void 0:P.actionType)??"?"})${P!=null&&P.hasBombIcon?" ⚠️ 含诱爆":""}`,...K?f(K):{},children:[o.jsx("span",{className:"damage-card-btn__name",children:H}),(P==null?void 0:P.isKaiVariant)&&o.jsx("span",{className:"damage-card-btn__det",title:"改型",children:"◆"}),(P==null?void 0:P.hasBombIcon)&&o.jsx("span",{className:"damage-card-btn__det damage-card-btn__bomb-icon",title:"诱爆卡",children:"💣"})]},$.instanceId)})})]},U)),G&&(e.source!=="ranged"||_)&&o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:["卡组",o.jsxs("span",{className:"damage-zone__sub",children:["（共 ",C.length," 张，正面朝下）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:o.jsxs("button",{className:"damage-card-btn damage-card-btn--deck",onClick:()=>k(G.instanceId),title:"从卡组顶部翻开并摧毁 1 张（诱爆正常触发）",children:[o.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),o.jsx("span",{className:"damage-card-btn__name",children:"顶部 × 1"})]})})]}),G&&e.source==="ranged"&&!_&&o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:["卡组",o.jsxs("span",{className:"damage-zone__sub",children:["（共 ",C.length," 张）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:o.jsxs("div",{className:"damage-card-btn damage-card-btn--deck",style:{opacity:.5,cursor:"default"},title:"射击伤害的牌组部分将在选完表牌后自动从顶部破坏",children:[o.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),o.jsx("span",{className:"damage-card-btn__name",children:"自动破坏"})]})})]})]}),o.jsx("div",{className:"damage-panel__actions",children:o.jsx("button",{className:"action-hud__skip-btn",onClick:S,title:"剩余伤害将从牌库顶部自动摧毁",children:"自动分配剩余伤害"})})]}),o.jsx(Ia,{zoom:p})]})}const Yd=`
.action-hud {
...
`,Qv={slot_1:"存档位 1",slot_2:"存档位 2",slot_3:"存档位 3",slot_4:"存档位 4",slot_5:"存档位 5",auto:"自动存档"},qv=[...dx,"auto"];function eb(e){const n=new Date(e),t=a=>String(a).padStart(2,"0");return`${n.getFullYear()}-${t(n.getMonth()+1)}-${t(n.getDate())} ${t(n.getHours())}:${t(n.getMinutes())}`}function qd({mode:e,onBack:n,onLoad:t,currentState:a,aiConfig:r}){const[i,s]=j.useState([]),[c,d]=j.useState(null),[u,p]=j.useState(null),[f,g]=j.useState(null),[h,m]=j.useState(null);j.useEffect(()=>{s(Md())},[]);function v(){s(Md())}function _(k){g(k),setTimeout(()=>g(null),2e3)}function b(k){return i.find(S=>S.slotId===k)}function x(k){if(!a||!r)return;if(b(k)){p(k);return}y(k)}function y(k){if(!(!a||!r))try{Ef(k,a,r,!1),v(),p(null),_("存档已保存")}catch(S){m(S instanceof Error?S.message:"保存失败")}}function w(k){const S=px(k);if(!S){m("存档数据已损坏，无法加载");return}t==null||t(S)}function E(k){fx(k),v(),d(null),_("存档已删除")}const D=e==="save"?"保存游戏":"加载存档";return o.jsxs("div",{className:"sl-screen",children:[o.jsxs("div",{className:"sl-panel",children:[o.jsx("h2",{className:"sl-title",children:D}),o.jsx("div",{className:"sl-slots",children:qv.map(k=>{const S=b(k),M=e==="save"&&!(k==="auto")&&a!=null;return o.jsxs("div",{className:`sl-slot ${S?"sl-slot--occupied":"sl-slot--empty"}`,children:[o.jsxs("div",{className:"sl-slot__label",children:[Qv[k],(S==null?void 0:S.isAutoSave)&&o.jsx("span",{className:"sl-badge",children:"自动"})]}),S?o.jsxs("div",{className:"sl-slot__info",children:[o.jsxs("span",{className:"sl-slot__units",children:[S.player1Unit," vs ",S.player2Unit]}),o.jsx("span",{className:"sl-slot__map",children:S.mapName}),o.jsxs("span",{className:"sl-slot__round",children:["第 ",S.roundNumber," 回合"]}),o.jsx("span",{className:"sl-slot__time",children:eb(S.timestamp)})]}):o.jsx("div",{className:"sl-slot__info sl-slot__empty-label",children:"空存档位"}),o.jsxs("div",{className:"sl-slot__actions",children:[e==="load"&&S&&o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>w(k),children:"加载"}),M&&o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>x(k),children:S?"覆盖":"保存"}),S&&(c===k?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"sl-confirm-text",children:"确认删除？"}),o.jsx("button",{className:"sl-btn sl-btn--danger",onClick:()=>E(k),children:"确认"}),o.jsx("button",{className:"sl-btn",onClick:()=>d(null),children:"取消"})]}):o.jsx("button",{className:"sl-btn sl-btn--ghost",onClick:()=>d(k),children:"删除"}))]}),u===k&&o.jsxs("div",{className:"sl-overwrite",children:[o.jsx("span",{children:"覆盖此存档？"}),o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>y(k),children:"确认"}),o.jsx("button",{className:"sl-btn",onClick:()=>p(null),children:"取消"})]})]},k)})}),h&&o.jsxs("div",{className:"sl-error",onClick:()=>m(null),children:["⚠ ",h]}),o.jsx("button",{className:"sl-back-btn",onClick:n,children:"← 返回"})]}),f&&o.jsx("div",{className:"sl-toast",children:f}),o.jsx("style",{children:nb})]})}const nb=`
.sl-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`),c=new Blob([s],{type:"text/plain;charset=utf-8"}),d=URL.createObjectURL(c),u=document.createElement("a");u.href=d,u.download=`embryo-log-${a}.txt`,u.click(),URL.revokeObjectURL(d)}const su=[1e3,2e3,4e3,8e3,15e3];class zb{constructor(n,t,a){en(this,"ws",null);en(this,"url");en(this,"sessionId");en(this,"onMessage");en(this,"onStatus");en(this,"reconnectAttempt",0);en(this,"reconnectTimer",null);en(this,"intentionallyClosed",!1);en(this,"hasEverConnected",!1);this.url=n,this.sessionId=localStorage.getItem("embryo-session-id"),this.onMessage=t,this.onStatus=a}connect(){this.intentionallyClosed=!1,this.onStatus("connecting");const n=this.sessionId?`?sessionId=${this.sessionId}`:"";this.ws=new WebSocket(`${this.url}${n}`),this.ws.onopen=()=>{var t;if(this.intentionallyClosed){(t=this.ws)==null||t.close(),this.ws=null,this.onStatus("disconnected");return}this.hasEverConnected=!0,this.reconnectAttempt=0,this.onStatus("connected")},this.ws.onmessage=t=>{try{const a=JSON.parse(t.data);a.type==="SESSION_ID"&&(this.sessionId=a.sessionId,localStorage.setItem("embryo-session-id",a.sessionId)),this.onMessage(a)}catch{console.warn("[GameSocket] Failed to parse message:",t.data)}},this.ws.onclose=()=>{if(this.intentionallyClosed){this.onStatus("disconnected");return}this.hasEverConnected||(this.sessionId=null,localStorage.removeItem("embryo-session-id")),this.onStatus("reconnecting"),this.scheduleReconnect()},this.ws.onerror=()=>{}}send(n){var t;((t=this.ws)==null?void 0:t.readyState)===WebSocket.OPEN?this.ws.send(JSON.stringify(n)):console.warn("[GameSocket] Cannot send — not connected")}disconnect(){if(this.intentionallyClosed=!0,this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws){const n=this.ws.readyState;n===WebSocket.OPEN||n===WebSocket.CLOSING?(this.ws.close(),this.ws=null):n===WebSocket.CONNECTING&&(this.ws.onmessage=null,this.ws.onerror=null)}this.onStatus("disconnected")}clearSession(){this.sessionId=null,localStorage.removeItem("embryo-session-id")}get isConnected(){var n;return((n=this.ws)==null?void 0:n.readyState)===WebSocket.OPEN}scheduleReconnect(){const n=su[Math.min(this.reconnectAttempt,su.length-1)];this.reconnectAttempt++,this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect()},n)}}const Uf=j.createContext(null);function $b({serverUrl:e,children:n}){const[t,a]=j.useState(null),[r,i]=j.useState(null),[s,c]=j.useState(null),[d,u]=j.useState("disconnected"),[p,f]=j.useState(null),[g,h]=j.useState(null),[m,v]=j.useState([]),[_,b]=j.useState(null),[x,y]=j.useState(null),w=j.useRef(null),E=j.useRef(null),D=j.useRef(-1),k=j.useCallback(C=>{switch(C.type){case"SESSION_ID":break;case"ROOM_STATE":i(C.room),c(C.yourPlayerId);break;case"ROOM_LIST":v(C.rooms);break;case"GAME_STATE":{C.state.phase==="plotting"&&(E.current!=="plotting"||D.current!==C.state.roundNumber)&&f(null),E.current=C.state.phase,D.current=C.state.roundNumber,a(C.state),c(C.yourPlayerId),b(C.currentTurnPlayerId??null),y(C.turnDeadline??null);break}case"PLOTTING_STATUS":f({confirmed:C.confirmed,total:C.total});break;case"GAME_STARTED":break;case"RECONNECTED":i(C.room),a(C.state),c(C.yourPlayerId),b(C.currentTurnPlayerId??null),y(C.turnDeadline??null),E.current=C.state.phase,D.current=C.state.roundNumber;break;case"SPECTATE_STATE":a(C.state),i(C.room),c(null);break;case"ACTION_REJECTED":h(C.reason),setTimeout(()=>h(null),5e3);break;case"PLAYER_JOINED":case"PLAYER_LEFT":case"PLAYER_RECONNECTED":case"PLAYER_DISCONNECTED":break;case"ERROR":h(C.message),setTimeout(()=>h(null),5e3);break}},[]);j.useEffect(()=>{const C=new zb(e,k,u);return w.current=C,C.connect(),()=>{C.clearSession(),C.disconnect(),w.current=null}},[e,k]);const S=j.useCallback(C=>{var R;(R=w.current)==null||R.send({type:"GAME_ACTION",action:C})},[]),z=j.useCallback(C=>{var R;(R=w.current)==null||R.send({type:"LOBBY_ACTION",action:C})},[]),M=j.useCallback(C=>{var R;(R=w.current)==null||R.send(C)},[]),T=j.useCallback(C=>q(C),[]),A={state:t,room:r,localPlayerId:s,dispatch:S,sendLobbyAction:z,send:M,getCard:T,connectionStatus:d,plottingStatus:p,isOnline:!0,lastError:g,roomList:m,currentTurnPlayerId:_,turnDeadline:x};return o.jsx(Uf.Provider,{value:A,children:n})}function pc(){const e=j.useContext(Uf);if(!e)throw new Error("useOnlineGame must be used within OnlineGameProvider");return e}function Ab({children:e}){const{state:n,localPlayerId:t,dispatch:a,getCard:r,plottingStatus:i,send:s,currentTurnPlayerId:c}=pc(),d=j.useCallback(g=>{if(g.type==="ADVANCE_TIMING"||g.type==="ADVANCE_PHASE"){s({type:"TIMING_DONE"});return}g.type==="START_PLOTTING"||g.type==="DRAW_CARDS"||a(g)},[a,s]);if(!n||!t)return null;let u=n;if(n.phase==="plotting"){const g=(i==null?void 0:i.confirmed.includes(t))??!1;u={...n,plottingStep:g?"complete":t}}const p={player1:t!=="player1",player2:t!=="player2",player1Difficulty:"easy",player2Difficulty:"easy",playerAI:Object.fromEntries(n.playerIds.map(g=>[g,g!==t])),playerDifficulty:Object.fromEntries(n.playerIds.map(g=>[g,"easy"]))},f={state:u,dispatch:d,rawDispatch:d,getCard:r,aiConfig:p,setAIConfig:()=>{},getReplayData:()=>null,autoSaveEnabled:!1,setAutoSaveEnabled:()=>{},exposureMode:!1,setExposureMode:()=>{},isOnline:!0,localPlayerId:t,currentTurnPlayerId:c};return o.jsx(_i.Provider,{value:f,children:e})}const Pb={lobby:"等待中",playing:"游戏中",finished:"已结束"};function Hf({onBack:e,onCreateRoom:n,onJoinRoom:t,roomList:a,onRefreshRooms:r,onSpectate:i}){const[s,c]=j.useState("create"),[d,u]=j.useState(()=>localStorage.getItem("embryo-player-name")??""),[p,f]=j.useState(""),[g,h]=j.useState(""),[m,v]=j.useState(2),[_,b]=j.useState(Ze[0].id);function x(C){v(C);const R=Ze.find(G=>G.id===_);if(!R||R.maxPlayers<C){const G=Ze.find(O=>O.maxPlayers>=C);G&&b(G.id)}}const[y,w]=j.useState(""),[E,D]=j.useState(!1),[k,S]=j.useState(0);function z(){const C=d.trim()||`Player_${Math.random().toString(36).slice(2,6)}`;return localStorage.setItem("embryo-player-name",C),C}function M(){n(z(),{maxPlayers:m,teamCount:m,mapId:_,turnTimeoutSeconds:k,password:E?y:void 0})}function T(){const C=p.trim().toUpperCase();C&&t(C,z(),g||void 0)}function A(C,R){f(C),R?(c("join"),h("")):t(C,z())}return o.jsxs("div",{className:"ol-screen",children:[o.jsxs("div",{className:"ol-center",children:[o.jsx("h1",{className:"ol-title",children:"联机对战"}),o.jsx("p",{className:"ol-subtitle",children:"创建、加入或浏览房间"}),o.jsx("div",{className:"ol-divider"}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"昵称"}),o.jsx("input",{className:"ol-input",value:d,onChange:C=>u(C.target.value),placeholder:"输入昵称…",maxLength:16})]}),o.jsxs("div",{className:"ol-tabs",children:[o.jsx("button",{className:`ol-tab${s==="create"?" ol-tab--active":""}`,onClick:()=>c("create"),children:"创建房间"}),o.jsx("button",{className:`ol-tab${s==="join"?" ol-tab--active":""}`,onClick:()=>c("join"),children:"加入房间"}),o.jsx("button",{className:`ol-tab${s==="browse"?" ol-tab--active":""}`,onClick:()=>{c("browse"),r==null||r()},children:"浏览房间"})]}),s==="create"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"最大玩家数"}),o.jsx("select",{className:"ol-select",value:m,onChange:C=>x(+C.target.value),children:[2,3,4,5,6,7,8].map(C=>o.jsxs("option",{value:C,children:[C," 人"]},C))})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"地图"}),o.jsx("select",{className:"ol-select",value:_,onChange:C=>b(C.target.value),children:Ze.filter(C=>C.maxPlayers>=m).map(C=>o.jsxs("option",{value:C.id,children:[C.nameCn," (",C.maxPlayers,"人)"]},C.id))})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"回合限时"}),o.jsxs("select",{className:"ol-select",value:k,onChange:C=>S(+C.target.value),children:[o.jsx("option",{value:0,children:"无限制"}),o.jsx("option",{value:30,children:"30 秒"}),o.jsx("option",{value:60,children:"60 秒"}),o.jsx("option",{value:90,children:"90 秒"}),o.jsx("option",{value:120,children:"120 秒"})]})]}),o.jsxs("label",{className:"ol-check",onClick:()=>D(!E),children:[o.jsx("span",{className:`ol-check__box${E?" ol-check__box--on":""}`,children:E?"✓":""}),o.jsx("span",{children:"设置房间密码"})]}),E&&o.jsx("div",{className:"ol-field",children:o.jsx("input",{className:"ol-input",value:y,onChange:C=>w(C.target.value),placeholder:"输入密码…",maxLength:20,type:"password"})}),o.jsx("button",{className:"ol-btn ol-btn--primary",onClick:M,children:"创建房间"})]}),s==="join"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"房间号"}),o.jsx("input",{className:"ol-input ol-input--code",value:p,onChange:C=>f(C.target.value.toUpperCase()),placeholder:"输入6位房间号",maxLength:6})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"密码（若有）"}),o.jsx("input",{className:"ol-input",value:g,onChange:C=>h(C.target.value),placeholder:"无密码可留空",maxLength:20,type:"password"})]}),o.jsx("button",{className:"ol-btn ol-btn--primary",onClick:T,disabled:p.trim().length<1,children:"加入房间"})]}),s==="browse"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-browse-header",children:[o.jsx("span",{className:"ol-label",children:"在线房间"}),o.jsx("button",{className:"ol-refresh-btn",onClick:r,children:"刷新"})]}),!a||a.length===0?o.jsx("div",{className:"ol-empty",children:"暂无房间，创建一个吧"}):o.jsx("div",{className:"ol-room-list",children:a.map(C=>o.jsxs("div",{className:"ol-room-row",children:[o.jsx("span",{className:"ol-room-row__code",children:C.roomCode}),o.jsx("span",{className:"ol-room-row__host",children:C.hostName}),o.jsx("span",{className:`ol-room-row__status ol-room-row__status--${C.status}`,children:Pb[C.status]??C.status}),o.jsxs("span",{className:"ol-room-row__count",children:[C.playerCount,"/",C.maxPlayers]}),C.hasPassword&&o.jsx("span",{className:"ol-room-row__lock",title:"需要密码",children:"🔒"}),C.status==="lobby"?o.jsx("button",{className:"ol-room-row__join",onClick:()=>A(C.roomCode,C.hasPassword),children:"加入"}):o.jsx("button",{className:"ol-room-row__join",onClick:()=>i==null?void 0:i(C.roomCode),disabled:!i,children:"观战"})]},C.roomCode))})]}),o.jsx("button",{className:"ol-btn ol-btn--back",onClick:e,children:"返回主菜单"})]}),o.jsx("style",{children:Vb})]})}const Vb=`
.ol-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`;function Hb(){const e=Tr(),{rawDispatch:n,aiConfig:t,setAIConfig:a,getReplayData:r,autoSaveEnabled:i,setAutoSaveEnabled:s,exposureMode:c,setExposureMode:d}=Se(),[u,p]=j.useState("home"),[f,g]=j.useState("map"),[h,m]=j.useState(!0),[v,_]=j.useState(2),[b,x]=j.useState(2),[y,w]=j.useState(null),[E,D]=j.useState({loaded:0,total:0}),k=j.useRef(null),S=j.useCallback(()=>{ge.init(),g("map"),p("game")},[]),z=j.useCallback(()=>{const C=zf().length;D({loaded:0,total:C}),w("asking")},[]),M=j.useCallback(()=>{w("loading");const C=new AbortController;k.current=C,Wx((R,G)=>{D({loaded:R,total:G}),R>=G&&setTimeout(()=>w(null),600)},C.signal)},[]),T=j.useCallback(()=>{var C;(C=k.current)==null||C.abort(),w(null)},[]);function A(C){n({type:"LOAD_GAME",state:C.gameState}),a(C.aiConfig),p("game")}return u==="rules"?o.jsx(Rv,{onBack:()=>p((e.phase==="setup","game"))}):u==="data"?o.jsx(Kv,{onBack:()=>p("game")}):u==="load"?o.jsx(qd,{mode:"load",onBack:()=>p("home"),onLoad:A}):u==="replay"?o.jsx(rb,{onBack:()=>p("home")}):u==="save"?o.jsx(qd,{mode:"save",onBack:()=>p("game"),currentState:e,aiConfig:t}):u==="mapEditor"?o.jsx(Ib,{onBack:()=>p("home")}):u==="online"?o.jsx(Bb,{onBack:()=>p("home")}):u==="settings"?o.jsxs(o.Fragment,{children:[y!==null&&o.jsx(Kx,{phase:y,loaded:E.loaded,total:E.total,onConfirm:M,onSkip:T}),o.jsx(Rx,{onBack:()=>p("home"),soundEnabled:ge.enabled,onToggleSound:()=>{ge.enabled=!ge.enabled,D(C=>({...C}))},soundVolume:ge.volume,onVolumeChange:C=>{ge.volume=C,ge.init(),ge.uiBlip(),D(R=>({...R}))},exposureMode:c,onToggleExposure:()=>d(!c),autoFill:h,onToggleAutoFill:()=>m(!h),onCacheAssets:z})]}):u==="home"?o.jsx(Vx,{onStart:S,onOnlinePlay:()=>{ge.init(),p("online")},onViewRules:()=>p("rules"),onViewData:()=>p("data"),onLoadGame:()=>p("load"),onReplay:()=>p("replay"),onMapEditor:()=>p("mapEditor"),onSettings:()=>p("settings")}):e.phase==="setup"?f==="map"?o.jsx(wx,{onNext:()=>g("units"),onBack:()=>p("home"),playerCount:v,setPlayerCount:_,teamCount:b,setTeamCount:x}):f==="units"?o.jsx(Nx,{onNext:()=>g("spawn"),onBack:()=>g("map"),autoFill:h}):o.jsx(Ax,{onBack:()=>g("units")}):e.phase==="game_over"?o.jsx(Yb,{onHome:()=>{p("home"),g("map")},onSaveReplay:()=>{const C=r();if(!C)return;const R=e.players.player1.isDefeated,G=e.players.player2.isDefeated,O=R&&G?"draw":R?"player2":G?"player1":null;try{gx(C.initialState,C.actions,O),alert("录像已保存！")}catch{alert("保存失败，存储空间可能不足。")}}}):o.jsx(Wb,{onSave:()=>p("save"),autoSaveEnabled:i,onToggleAutoSave:()=>s(!i)})}function Wb({onSave:e,autoSaveEnabled:n,onToggleAutoSave:t}){const a=Tr(),{dispatch:r,exposureMode:i,getCard:s,aiConfig:c}=Se();j.useEffect(()=>{a.phase==="pregame"&&r({type:"START_PLOTTING"})},[a.phase,r]);const d=j.useRef(a.phase);j.useEffect(()=>{const D=d.current;if(d.current=a.phase,!!i&&D==="plotting"&&a.phase==="action_seg1"){const k=S=>{if(!S)return"无";const z=s(S.defId);return z?z.nameCn:S.defId};for(const S of a.playerIds){const z=a.players[S];if(z.isDefeated)continue;const M=`P${S.replace("player","")}`;r({type:"ADD_LOG",message:`[暴露] ${M} 布局: 段1=${k(z.plotSeg1)} / 段2=${k(z.plotSeg2)}`})}}},[a.phase]);const[u,p]=j.useState([{id:"map",zIndex:10},{id:"log",zIndex:11},{id:"mecha",zIndex:12},{id:"plot",zIndex:100}]),f=j.useRef(new Map),g=j.useCallback(D=>{p(k=>{const S=Math.max(...k.map(R=>R.zIndex)),z=k.find(R=>R.id===D);if(z&&z.zIndex===S)return k;const M=[...k].sort((R,G)=>R.zIndex-G.zIndex),T=10,A=new Map;let C=0;for(const R of M)R.id!==D&&A.set(R.id,T+C++);return A.set(D,T+M.length-1),k.map(R=>({...R,zIndex:A.get(R.id)??R.zIndex}))})},[]),h=D=>{var k;return((k=u.find(S=>S.id===D))==null?void 0:k.zIndex)??10},m=j.useCallback(D=>{const k=[];return f.current.forEach((S,z)=>{z!==D&&S&&k.push(S.getBoundingClientRect())}),k},[]),v=Ii(),_=v?window.innerWidth:Math.max(400,Math.min(window.innerWidth*.6,620)),b=300,x=window.innerWidth-b-16,y=36,w=v?window.innerWidth:380,E=window.innerWidth-w-16;if(v){const D=a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&!Re(c,a.plottingStep),k=a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&Re(c,a.plottingStep);return o.jsxs("div",{className:"game-screen game-screen--mobile",children:[o.jsx("div",{className:"game-screen__header",style:{flexShrink:0},children:o.jsx(lu,{onSave:e,autoSaveEnabled:n,onToggleAutoSave:t})}),o.jsxs("div",{className:"game-screen__board-mobile",children:[o.jsx(ha,{}),o.jsx(cu,{})]}),o.jsxs("div",{className:"game-screen__panels-mobile",children:[D&&o.jsx(je,{id:"plot",title:"布局阶段",initialPos:{x:0,y:0},width:w,children:o.jsx(Xt,{})}),k&&o.jsx("div",{style:{width:0,height:0,overflow:"hidden",opacity:0,pointerEvents:"none"},children:o.jsx(Xt,{})}),o.jsx(je,{id:"mecha",title:"机体信息",initialPos:{x:0,y:0},defaultMinimized:!0,children:o.jsx(Xo,{})}),o.jsx(je,{id:"log",title:"行动日志",initialPos:{x:0,y:0},defaultMinimized:!0,children:o.jsx(yr,{})})]}),o.jsx(Zo,{}),o.jsx(Yo,{}),o.jsx("style",{children:du})]})}return o.jsxs("div",{className:"game-screen",style:{position:"relative",height:"100vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[o.jsx("div",{className:"game-screen__header",style:{flexShrink:0},children:o.jsx(lu,{onSave:e,autoSaveEnabled:n,onToggleAutoSave:t})}),o.jsxs("div",{style:{position:"relative",flex:1},children:[o.jsx(je,{id:"map",title:"地图",initialPos:{x:16,y:8},width:_,minHeight:300,zIndex:h("map"),onFocus:g,siblingRects:m("map"),children:o.jsx("div",{style:{height:`calc(100vh - ${y+60}px)`,minHeight:300},children:o.jsx(ha,{})})}),o.jsx(je,{id:"log",title:"行动日志",initialPos:{x,y:8},width:b,height:260,minHeight:120,zIndex:h("log"),onFocus:g,siblingRects:m("log"),children:o.jsx(yr,{})}),o.jsx(je,{id:"mecha",title:"机体信息",initialPos:{x,y:280},width:b,minHeight:160,zIndex:h("mecha"),onFocus:g,siblingRects:m("mecha"),children:o.jsx(Xo,{})}),a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&!Re(c,a.plottingStep)&&o.jsx(je,{id:"plot",title:"布局阶段",initialPos:{x:E,y:8},width:w,height:620,minHeight:80,zIndex:h("plot"),onFocus:g,siblingRects:m("plot"),children:o.jsx(Xt,{})}),a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&Re(c,a.plottingStep)&&o.jsx("div",{style:{position:"absolute",width:0,height:0,overflow:"hidden",opacity:0,pointerEvents:"none"},children:o.jsx(Xt,{})})]}),o.jsx(Zo,{}),o.jsx(Yo,{}),o.jsx(cu,{}),o.jsx("style",{children:du})]})}function lu({onSave:e,autoSaveEnabled:n,onToggleAutoSave:t}){const a=Tr(),r={pregame:"战前准备",draw:"抽牌阶段",plotting:"布局阶段",action_seg1:"行动阶段 [主要阶段 1]",action_seg2:"行动阶段 [主要阶段 2]",cleanup:"清理阶段",game_over:"游戏结束"},i={movement:"移动",ranged:"射击",melee:"近战",special:"特殊"};return o.jsxs("div",{className:"phase-bar",children:[o.jsxs("span",{className:"phase-bar__round",children:["第 ",a.roundNumber," 回合"]}),o.jsx("span",{className:"phase-bar__phase",children:r[a.phase]??a.phase}),a.currentTiming&&o.jsxs("span",{className:"phase-bar__timing",children:["▶ ",i[a.currentTiming]??a.currentTiming]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:"phase-bar__autosave-btn",onClick:t,title:n?"自动存档已开启（点击关闭）":"自动存档已关闭（点击开启）",children:n?"💾 自动":"💾 关"}),o.jsx("button",{className:"phase-bar__save-btn",onClick:e,title:"保存游戏",children:"💾 保存"}),o.jsx("button",{className:"phase-bar__save-btn",onClick:()=>Gf(a),title:"导出全量日志（含调试状态快照）",children:"📋 日志"})]})}function Zb(e){return e.startsWith("[DBG]")?"log-panel__entry log-panel__entry--debug":e.startsWith("===")?"log-panel__entry log-panel__entry--round-start":e.startsWith("---")?"log-panel__entry log-panel__entry--round-end":e.includes("发动")||e.includes("攻击")?"log-panel__entry log-panel__entry--attack":e.includes("摧毁")||e.includes("连锁")||e.includes("诱爆")?"log-panel__entry log-panel__entry--damage":e.includes("移动到")?"log-panel__entry log-panel__entry--move":e.includes("获胜")||e.includes("击破")||e.includes("平局")?"log-panel__entry log-panel__entry--victory":"log-panel__entry"}function yr(){const e=Tr();return o.jsx("div",{className:"log-panel",children:o.jsx("div",{className:"log-panel__entries",children:[...e.log].reverse().map((n,t)=>o.jsx("div",{className:Zb(n),children:n},t))})})}function Yb({onHome:e,onSaveReplay:n}){const{state:t,dispatch:a}=Se(),r=t.log[t.log.length-1]??"游戏结束",i=t.players.player1.isDefeated,s=t.players.player2.isDefeated,c=i&&s?"双方同时击破":i?"玩家 2 获胜":"玩家 1 获胜";function d(){a({type:"RESET_GAME"}),e()}return o.jsxs("div",{className:"gameover-screen",children:[o.jsx("div",{className:"gameover-icon",children:"💥"}),o.jsx("h1",{className:"gameover-title",children:c}),o.jsx("p",{className:"gameover-sub",children:r}),o.jsxs("div",{className:"gameover-actions",children:[o.jsx("button",{className:"gameover-restart",onClick:d,children:"返回主菜单"}),o.jsx("button",{className:"gameover-save-replay",onClick:n,children:"🎬 保存录像"})]}),o.jsx("style",{children:Qb})]})}function cu(){const{isAnimating:e,skipAnimation:n}=Nr();return e?o.jsx("button",{className:"skip-anim-btn",onClick:n,children:"⏩ 跳过"}):null}function Xb(){return o.jsx(hi,{children:o.jsx(Df,{children:o.jsx(Hb,{})})})}const du=`
.game-screen__header {
  background: var(--color-bg-panel);
  border-bottom: 1px solid var(--color-border);
}
