 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(P,A){var B=P.length;P.push(A);e:for(;0<B;){var V=B-1>>>1,F=P[V];if(0<r(F,A))P[V]=A,P[B]=F,B=V;else break e}}function t(P){return P.length===0?null:P[0]}function a(P){if(P.length===0)return null;var A=P[0],B=P.pop();if(B!==A){P[0]=B;e:for(var V=0,F=P.length,G=F>>>1;V<G;){var X=2*(V+1)-1,Q=P[X],se=X+1,le=P[se];if(0>r(Q,B))se<F&&0>r(le,Q)?(P[V]=le,P[se]=B,V=se):(P[V]=Q,P[X]=B,V=X);else if(se<F&&0>r(le,B))P[V]=le,P[se]=B,V=se;else break e}}return A}function r(P,A){var B=P.sortIndex-A.sortIndex;return B!==0?B:P.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var d=[],u=[],f=1,m=null,g=3,h=!1,x=!1,p=!1,_=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,b=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(P){for(var A=t(u);A!==null;){if(A.callback===null)a(u);else if(A.startTime<=P)a(u),A.sortIndex=A.expirationTime,n(d,A);else break;A=t(u)}}function I(P){if(p=!1,v(P),!x)if(t(d)!==null)x=!0,D(S);else{var A=t(u);A!==null&&R(I,A.startTime-P)}}function S(P,A){x=!1,p&&(p=!1,y(N),N=-1),h=!0;var B=g;try{for(v(A),m=t(d);m!==null&&(!(m.expirationTime>A)||P&&!J());){var V=m.callback;if(typeof V=="function"){m.callback=null,g=m.priorityLevel;var F=V(m.expirationTime<=A);A=e.unstable_now(),typeof F=="function"?m.callback=F:m===t(d)&&a(d),v(A)}else a(d);m=t(d)}if(m!==null)var G=!0;else{var X=t(u);X!==null&&R(I,X.startTime-A),G=!1}return G}finally{m=null,g=B,h=!1}}var C=!1,w=null,N=-1,z=5,M=-1;function J(){return!(e.unstable_now()-M<z)}function E(){if(w!==null){var P=e.unstable_now();M=P;var A=!0;try{A=w(!0,P)}finally{A?K():(C=!1,w=null)}}else C=!1}var K;if(typeof b=="function")K=function(){b(E)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,L=$.port2;$.port1.onmessage=E,K=function(){L.postMessage(null)}}else K=function(){_(E,0)};function D(P){w=P,C||(C=!0,K())}function R(P,A){N=_(function(){P(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,D(S))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(d)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var A=3;break;default:A=g}var B=g;g=A;try{return P()}finally{g=B}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,A){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var B=g;g=P;try{return A()}finally{g=B}},e.unstable_scheduleCallback=function(P,A,B){var V=e.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?V+B:V):B=V,P){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=B+F,P={id:f++,callback:A,priorityLevel:P,startTime:B,expirationTime:F,sortIndex:-1},B>V?(P.sortIndex=B,n(u,P),t(d)===null&&P===t(u)&&(p?(y(N),N=-1):p=!0,R(I,B-V))):(P.sortIndex=F,n(d,P),x||h||(x=!0,D(S))),P},e.unstable_shouldYield=J,e.unstable_wrapCallback=function(P){var A=g;return function(){var B=g;g=A;try{return P.apply(this,arguments)}finally{g=B}}}})(Vu);Pu.exports=Vu;var Rf=Pu.exports;/**
 * @license React
...
`,tb={gameTitle:"Embryo Machine",statMovement:"移动力",statEvasion:"回避值",statAssault:"突击",statAssaultDef:"被突击",statInitiative:"先制值"},Mn=[["#00f0ff","#00c8e0","#40e8ff","#80f0ff"],["#ff00c8","#ff44aa","#e040d0","#ff77dd"],["#00cc88","#44dd66","#00aa6e","#66eebb"],["#ff8800","#ffaa33","#e07000","#ffcc66"],["#6688ff","#4466ee","#88aaff","#3355dd"],["#cc44ff","#aa22dd","#dd77ff","#bb00ee"],["#44dddd","#22bbbb","#66eeee","#00ccbb"],["#ff4466","#dd2244","#ff6688","#ee0033"]];function ht(e,n){const t=e.teams[n]??0,a=Mn[t%Mn.length],s=e.playerIds.filter(i=>e.teams[i]===t).indexOf(n);return a[Math.max(0,s)%a.length]}const Wt=tb;function ab({onNext:e,onBack:n,autoFill:t=!1}){const{state:a,dispatch:r,setAIConfig:s,setExposureMode:i}=Ce(),[l,d]=k.useState({}),[u,f]=k.useState({}),[m,g]=k.useState({}),h=a.playerIds.length,x=a.teamCount,p=k.useMemo(()=>ha.slice(0,h),[h]);function _(M,J){r({type:"SELECT_UNIT",playerId:M,unitId:J}),g(E=>({...E,[M]:!0}))}function y(M,J){d(E=>({...E,[M]:J}))}function b(M,J){f(E=>({...E,[M]:J}))}const v=p.map(M=>{var J;return((J=a.players[M])==null?void 0:J.unitId)??""}),I=v.every(M=>M!==""),S=new Set(v.filter(M=>M!=="")).size===v.filter(M=>M!=="").length,C=p.filter(M=>m[M]).map(M=>{var J;return((J=a.players[M])==null?void 0:J.unitId)??""}).filter(M=>M!==""),w=new Set(C).size===C.length,N=t?w:I&&S,z={};for(let M=0;M<p.length;M++){const J=M%x;z[J]||(z[J]=[]),z[J].push(p[M])}return o.jsxs("div",{className:"setup-screen",children:[o.jsx("button",{className:"setup-back-btn",onClick:n,children:"← 上一步"}),o.jsx("h1",{className:"setup-title",children:Wt.gameTitle}),o.jsx("p",{className:"setup-subtitle",children:"选择机体"}),o.jsx("div",{className:"setup-teams",children:Object.entries(z).map(([M,J])=>o.jsxs("div",{className:"setup-team",children:[o.jsxs("h3",{className:"team-header",style:{color:Mn[Number(M)%Mn.length][0]},children:["队伍 ",Number(M)+1]}),o.jsx("div",{className:"setup-players",children:J.map((E,K)=>{var A;const $=ha.indexOf(E),L=Mn[Number(M)%Mn.length],D=L[K%L.length],R=((A=a.players[E])==null?void 0:A.unitId)??"",P=v.filter((B,V)=>V!==p.indexOf(E)&&B);return o.jsxs("div",{className:"setup-player-col",children:[o.jsx(rb,{label:`P${$+1}`,selectedUnit:R,blockedUnits:P,accentColor:D,onSelect:B=>_(E,B)}),o.jsxs("div",{className:"ai-control",children:[o.jsxs("label",{className:"ai-control__label",children:[o.jsx("input",{type:"checkbox",checked:l[E]??!1,onChange:B=>y(E,B.target.checked)}),"AI控制"]}),l[E]&&o.jsxs("select",{className:"ai-control__difficulty",value:u[E]??"hard",onChange:B=>b(E,B.target.value),children:[o.jsx("option",{value:"easy",children:"简单"}),o.jsx("option",{value:"hard",children:"困难"})]})]})]},E)})})]},M))}),o.jsx("button",{className:"start-btn",onClick:()=>{const M=new Set(p.filter(A=>m[A]).map(A=>{var B;return((B=a.players[A])==null?void 0:B.unitId)??""}).filter(A=>A!=="")),E=[...q.map(A=>A.id).filter(A=>!M.has(A))];for(let A=E.length-1;A>0;A--){const B=Math.floor(Math.random()*(A+1));[E[A],E[B]]=[E[B],E[A]]}const K={...l},$={...u};let L=0;for(const A of p)t&&!m[A]&&L<E.length&&(r({type:"SELECT_UNIT",playerId:A,unitId:E[L]}),L++,K[A]=!0,$[A]="hard");const D={},R={};for(const A of p)D[A]=K[A]??!1,R[A]=$[A]??"hard";s({player1:D.player1??!1,player2:D.player2??!1,player1Difficulty:R.player1??"hard",player2Difficulty:R.player2??"hard",playerAI:D,playerDifficulty:R}),p.every(A=>D[A])&&i(!0),e()},disabled:!N,title:N?"":"请为所有玩家分别选择不同的机体",children:"下一步 →"}),!N&&o.jsx("p",{className:"setup-hint",children:t?"手动选择的机体之间不可重复":I?"每位玩家须选择不同的机体":"请为所有玩家各选择一台机体"}),o.jsx("style",{children:ib})]})}function rb({label:e,selectedUnit:n,blockedUnits:t,accentColor:a,onSelect:r}){return o.jsxs("div",{className:"unit-picker",children:[o.jsx("h2",{className:"unit-picker__title",style:{color:a},children:e}),o.jsx("div",{className:"unit-grid",children:q.map(s=>{const i=t.includes(s.id);return o.jsx(ob,{unit:s,isSelected:s.id===n,isBlocked:i,accentColor:a,onSelect:()=>!i&&r(s.id)},s.id)})}),n&&o.jsx(sb,{unit:q.find(s=>s.id===n),accentColor:a})]})}function ob({unit:e,isSelected:n,isBlocked:t,accentColor:a,onSelect:r}){return o.jsxs("button",{className:`unit-card ${n?"unit-card--selected":""} ${t?"unit-card--blocked":""}`,onClick:r,disabled:t,title:t?"该机体已被其他玩家选择":e.nameCn,style:n?{borderColor:a,boxShadow:`0 0 8px ${a}55`}:{},children:[o.jsx("img",{src:`/assets/tokens/${e.tokenId}`,alt:e.nameCn,className:"unit-card__token",onError:s=>{s.target.style.opacity="0.3"}}),o.jsx("span",{className:"unit-card__name",children:e.nameCn}),o.jsxs("span",{className:"unit-card__init",children:["先制 ",e.initiative]})]})}function sb({unit:e,accentColor:n}){return o.jsxs("div",{className:"unit-stats",children:[o.jsxs("div",{className:"unit-stats__name",children:[e.nameCn," ",o.jsxs("small",{children:["(",e.nameJa,")"]})]}),o.jsx("div",{className:"unit-stats__type",children:e.type}),o.jsxs("div",{className:"unit-stats__grid",children:[o.jsx(Fa,{label:Wt.statMovement,value:e.movement,color:n}),o.jsx(Fa,{label:Wt.statEvasion,value:e.evasion,color:n}),o.jsx(Fa,{label:Wt.statAssault,value:e.assault,color:n}),o.jsx(Fa,{label:Wt.statAssaultDef,value:e.assaultDef,color:n}),o.jsx(Fa,{label:Wt.statInitiative,value:e.initiative,color:n})]})]})}function Fa({label:e,value:n,color:t}){return o.jsxs("div",{className:"stat",children:[o.jsx("span",{className:"stat__label",children:e}),o.jsx("span",{className:"stat__value",style:{color:t},children:n})]})}const ib=`
.setup-screen {
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Yd=768;function Ks(){const[e,n]=k.useState(()=>typeof window<"u"&&window.innerWidth<=Yd);return k.useEffect(()=>{const t=window.matchMedia(`(max-width: ${Yd}px)`),a=r=>n(r.matches);return t.addEventListener("change",a),n(t.matches),()=>t.removeEventListener("change",a)},[]),e}const Pn=18;function we({id:e,title:n,initialPos:t,width:a=300,height:r,minHeight:s=80,children:i,zIndex:l=10,defaultMinimized:d=!1,onFocus:u,siblingRects:f=[]}){const m=Ks(),[g,h]=k.useState(t),[x,p]=k.useState(d),_=k.useRef(null),y=k.useRef(!1);k.useEffect(()=>{y.current||(y.current=!0,h(t))},[]);const b=k.useCallback(v=>{if(m||v.button!==0)return;v.preventDefault(),u==null||u(e);const I=v.clientX-g.x,S=v.clientY-g.y,C=N=>{var D;let z=N.clientX-I,M=N.clientY-S;const J=window.innerWidth,E=window.innerHeight,K=(D=_.current)==null?void 0:D.getBoundingClientRect(),$=(K==null?void 0:K.width)??a,L=(K==null?void 0:K.height)??40;z<Pn&&(z=0),M<Pn&&(M=0),z+$>J-Pn&&(z=J-$),M+L>E-Pn&&(M=E-L);for(const R of f)Math.abs(z+$-R.left)<Pn&&(z=R.left-$),Math.abs(z-R.right)<Pn&&(z=R.right),Math.abs(M+L-R.top)<Pn&&(M=R.top-L),Math.abs(M-R.bottom)<Pn&&(M=R.bottom),Math.abs(M-R.top)<Pn&&(M=R.top);h({x:Math.max(0,z),y:Math.max(0,M)})},w=()=>{document.removeEventListener("mousemove",C),document.removeEventListener("mouseup",w)};document.addEventListener("mousemove",C),document.addEventListener("mouseup",w)},[e,g,u,f,a,m]);return m?o.jsxs("div",{ref:_,className:`dp dp--mobile ${x?"dp--min":""}`,onClick:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar dp__bar--mobile",onClick:()=>p(v=>!v),children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("span",{className:"dp__min-btn dp__min-btn--mobile",children:x?"▼":"▲"})]}),!x&&o.jsx("div",{className:"dp__body dp__body--mobile",children:i}),o.jsx("style",{children:Xd})]}):o.jsxs("div",{ref:_,className:`dp ${x?"dp--min":""}`,style:{left:g.x,top:g.y,width:a,height:x?void 0:r,minHeight:x?0:s,zIndex:l},onMouseDown:()=>u==null?void 0:u(e),children:[o.jsxs("div",{className:"dp__bar",onMouseDown:b,children:[o.jsx("span",{className:"dp__title",children:n}),o.jsx("button",{className:"dp__min-btn",onMouseDown:v=>v.stopPropagation(),onClick:()=>p(v=>!v),title:x?"展开":"最小化",children:x?"▢":"▬"})]}),!x&&o.jsx("div",{className:"dp__body",children:i}),o.jsx("style",{children:Xd})]})}const Xd=`
.dp {
  position: absolute;
...
`,la=48,lb=[{facing:"N",label:"↑N",title:"朝北"},{facing:"S",label:"↓S",title:"朝南"},{facing:"E",label:"→E",title:"朝东"},{facing:"W",label:"←W",title:"朝西"}],Qd=.25,cb=2,qd=.1;function db({onBack:e}){const{state:n,dispatch:t}=Ce(),a=Ye.find(V=>V.id===n.map.id)??n.map,r=n.playerIds,s=a.width,i=a.height,l=k.useRef(null),[d,u]=k.useState({x:0,y:0,scale:1}),f=k.useRef(null),m=k.useRef(!1);k.useEffect(()=>{const V=l.current;if(!V)return;const F=V.clientWidth,G=V.clientHeight,X=s*la,Q=i*la;if(!F||!G)return;const se=Math.min(F/X,G/Q),le=Math.max(Qd,Math.min(1.2,se)),de=(F-X*le)/2,vn=(G-Q*le)/2;u({x:de,y:vn,scale:le})},[s,i]),k.useEffect(()=>{const V=l.current;if(!V)return;const F=G=>{G.preventDefault();const X=G.deltaY<0?qd:-qd;u(Q=>({...Q,scale:Math.min(cb,Math.max(Qd,Q.scale+X))}))};return V.addEventListener("wheel",F,{passive:!1}),()=>V.removeEventListener("wheel",F)},[]);const g=k.useCallback(V=>{V.button===0&&(f.current={startX:V.clientX,startY:V.clientY,origX:d.x,origY:d.y},m.current=!1)},[d.x,d.y]),h=k.useCallback(V=>{if(!f.current)return;const F=V.clientX-f.current.startX,G=V.clientY-f.current.startY;!m.current&&Math.sqrt(F*F+G*G)>5&&(m.current=!0),m.current&&u(X=>({...X,x:f.current.origX+F,y:f.current.origY+G}))},[]),x=k.useCallback(()=>{f.current=null,m.current=!1},[]),p=k.useMemo(()=>Object.keys(a.startZones).map(Number).sort((V,F)=>V-F),[a]),[_,y]=k.useState(()=>{const V={};for(let F=0;F<n.teamCount;F++)V[F]=F;return V});k.useEffect(()=>{const V={};for(let F=0;F<n.teamCount;F++)V[F]=F;y(V)},[a.id,n.teamCount]);function b(V,F){y(G=>{const X=Object.entries(G).find(([,se])=>se===F),Q={...G,[V]:F};return X&&(Q[Number(X[0])]=G[V]),Q})}const v=k.useMemo(()=>{const V=new Map;for(let F=0;F<n.teamCount;F++){const G=_[F]??F,X=a.startZones[G];if(X)for(const Q of X){const se=`${Q.row},${Q.col}`,le=V.get(se)??[];le.push(F),V.set(se,le)}}return V},[a,n.teamCount,_]),I=k.useMemo(()=>{const V={};for(const F of r){const G=n.teams[F];V[G]||(V[G]=[]),V[G].push(F)}return V},[r,n.teams]),[S,C]=k.useState(r[0]),[w,N]=k.useState(""),z=k.useMemo(()=>{for(const V of r){const F=n.players[V];if(!F)return!1;const G=n.teams[V],X=_[G]??G,Q=a.startZones[X];if(!Q||!Q.some(le=>le.row===F.position.row&&le.col===F.position.col))return!1}return!0},[r,n.players,n.teams,_,a]);function M(V,F){t({type:"SET_SPAWN_POSITION",playerId:V,position:F})}function J(V,F){t({type:"SET_SPAWN_FACING",playerId:V,facing:F})}function E(){z&&t({type:"CONFIRM_SETUP"})}function K(V){return ht(n,V)}function $(V){var G;const F=(G=I[V])==null?void 0:G[0];return F?K(F):Mn[V%Mn.length][0]}const L=k.useMemo(()=>{const V=new Map;for(const F of r){const G=n.players[F];if(!G)continue;const X=q.find(le=>le.id===G.unitId);if(!X)continue;const Q=`${G.position.row},${G.position.col}`,se=V.get(Q)??[];se.push({pid:F,color:K(F),tokenId:X.tokenId,name:X.nameCn}),V.set(Q,se)}return V},[r,n.players]),{x:D,y:R,scale:P}=d,A=220,B=k.useMemo(()=>{const V={},se=Math.floor((window.innerHeight-56-60)/192);return r.forEach((le,de)=>{const vn=Math.floor(de/se),zn=de%se;V[le]={x:window.innerWidth-(A+16)*(vn+1),y:56+zn*192}}),V},[r]);return o.jsxs("div",{className:"ssm__screen",children:[o.jsxs("div",{className:"ssm__topbar",children:[o.jsx("button",{className:"ssm__back-btn",onClick:e,children:"← 返回"}),o.jsx("span",{className:"ssm__title",children:"选择出击位置"}),o.jsxs("span",{className:"ssm__map-name",children:[a.nameCn," (",i,"×",s,")"]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:`ssm__start-btn${z?"":" ssm__start-btn--disabled"}`,onClick:E,disabled:!z,title:z?"开始战斗":"所有玩家必须先选择出击位置",children:"战斗开始 ▶"})]}),o.jsx("div",{className:"ssm__viewport",ref:l,onMouseDown:g,onMouseMove:h,onMouseUp:x,onMouseLeave:x,children:o.jsx("div",{className:"ssm__map-inner",style:{transform:`translate(${D}px, ${R}px) scale(${P})`,transformOrigin:"top left",display:"grid",gridTemplateColumns:`repeat(${s}, ${la}px)`,gridTemplateRows:`repeat(${i}, ${la}px)`},children:a.cells.flatMap((V,F)=>V.map((G,X)=>{const Q=bc(G),se=`${F},${X}`,le=v.get(se)??[],de=L.get(se)??[],vn=le.length>0,zn=le.length>0?$(le[0]):"",$a=n.teams[S],Jt=vn&&le.includes($a);let Zn="ssm__cell";vn&&(Zn+=" ssm__cell--zone"),Jt&&(Zn+=" ssm__cell--placeable"),de.length>0&&(Zn+=" ssm__cell--selected");function re(ee){m.current||(ee.stopPropagation(),Jt&&M(S,{row:F,col:X}))}return o.jsxs("div",{className:Zn,style:{backgroundImage:`url("${Q}")`,...vn?{borderColor:zn,boxShadow:de.length>0?`inset 0 0 10px ${zn}66, 0 0 6px ${zn}44`:void 0}:{}},onClick:Jt?re:void 0,children:[de.length===1&&o.jsx("div",{className:"ssm__token",children:o.jsx("img",{src:`/assets/tokens/${de[0].tokenId}`,alt:de[0].name,style:{boxShadow:`0 0 6px ${de[0].color}`},onError:ee=>{ee.target.style.opacity="0.3"}})}),de.length>1&&o.jsx("div",{className:"ssm__token ssm__token--multi",children:de.map(ee=>o.jsx("img",{src:`/assets/tokens/${ee.tokenId}`,alt:ee.name,className:"ssm__token-img-sm",style:{boxShadow:`0 0 4px ${ee.color}`},onError:Be=>{Be.target.style.opacity="0.3"}},ee.pid))})]},se)}))})}),r.map((V,F)=>{var re;const G=n.players[V],X=q.find(ee=>ee.id===(G==null?void 0:G.unitId)),Q=K(V),se=w===V,le=S===V,de=n.teams[V],vn=((re=I[de])==null?void 0:re[0])===V,zn=_[de]??de,$a=_[de]??de,Zn=(a.startZones[$a]??[]).some(ee=>ee.row===G.position.row&&ee.col===G.position.col);return o.jsx(we,{id:`spawn-${V}`,title:`P${F+1} ${(X==null?void 0:X.nameCn)??"—"}`,initialPos:B[V]??{x:100,y:100},width:A,minHeight:60,zIndex:se?50:10+F,onFocus:()=>{N(V),C(V)},children:o.jsxs("div",{className:`ssm__player-card${le?" ssm__player-card--active":""}`,style:{borderTop:`2px solid ${Q}`},onClick:()=>C(V),children:[o.jsxs("div",{className:"ssm__player-label",style:{color:Q},children:["P",F+1," ",le?"◄ 放置中":""," ",Zn?"✓":""]}),vn&&o.jsx("div",{className:"ssm__zone-select",children:o.jsxs("label",{children:["出击区域:",o.jsx("select",{value:zn,onChange:ee=>b(de,Number(ee.target.value)),onClick:ee=>ee.stopPropagation(),children:p.slice(0,a.maxTeams).map(ee=>o.jsxs("option",{value:ee,children:["区域 ",ee+1]},ee))})]})}),o.jsx("div",{className:"ssm__unit-name",children:(X==null?void 0:X.nameCn)??"—"}),o.jsxs("div",{className:"ssm__pos-display",children:["格 (",G.position.row,", ",G.position.col,")"]}),o.jsx("div",{className:"ssm__facing-grid",children:lb.map(({facing:ee,label:Be,title:Ve})=>{const je=G.facing===ee;return o.jsx("button",{className:`ssm__facing-btn${je?" ssm__facing-btn--active":""}`,style:je?{borderColor:Q,color:Q}:void 0,title:Ve,onClick:()=>J(V,ee),children:Be},ee)})})]})},V)}),o.jsx("style",{children:ub})]})}const ub=`
.ssm__screen {
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`,bl=62,xi=Math.round(bl*(1042/756)),tu=68,zb=6,au=140;function Pb({p1Cards:e,p2Cards:n}){const[t,a]=k.useState("init"),[r,s]=k.useState(null);return k.useEffect(()=>{const i=document.querySelector(".unit-token-abs--p1"),l=document.querySelector(".unit-token-abs--p2"),d=i==null?void 0:i.getBoundingClientRect(),u=l==null?void 0:l.getBoundingClientRect();s({p1:d?{x:d.left+d.width/2,y:d.top+d.height/2}:{x:window.innerWidth*.3,y:window.innerHeight*.55},p2:u?{x:u.left+u.width/2,y:u.top+u.height/2}:{x:window.innerWidth*.7,y:window.innerHeight*.45}});const f=setTimeout(()=>a("fan"),50),m=setTimeout(()=>a("hold"),650),g=setTimeout(()=>a("cluster"),1650),h=setTimeout(()=>a("exit"),2e3);return()=>{[f,m,g,h].forEach(clearTimeout)}},[]),r?Ar.createPortal(o.jsxs("div",{style:{position:"fixed",inset:0,zIndex:900,pointerEvents:"none"},children:[o.jsx(ru,{cards:e,origin:r.p1,phase:t,color:"#00f0ff",label:"P1"}),o.jsx(ru,{cards:n,origin:r.p2,phase:t,color:"#ff8844",label:"P2"})]}),document.body):null}function ru({cards:e,origin:n,phase:t,color:a,label:r}){if(e.length===0)return null;const s=e.length,l=(s-1)*tu>window.innerWidth*.7?Math.floor(window.innerWidth*.7/Math.max(s-1,1)):tu,d=t==="hold"||t==="cluster";return o.jsxs("div",{style:{position:"fixed",left:n.x,top:n.y},children:[o.jsxs("div",{style:{position:"absolute",top:-(au+xi/2+28),left:0,transform:"translateX(-50%)",color:a,fontSize:"0.78rem",fontWeight:"bold",whiteSpace:"nowrap",textShadow:`0 0 10px ${a}, 1px 1px 3px #000`,opacity:d?1:0,transition:"opacity 250ms",letterSpacing:"0.06em"},children:[r,"  弃牌 ×",s]}),e.map((u,f)=>{const m=te(u.defId),g=(s-1)/2,h=f-g,x=h*l,p=-au,_=h*zb;let y,b,v,I,S;switch(t){case"init":y=0,b=0,v=0,I=.15,S=0;break;case"fan":case"hold":y=x,b=p,v=_,I=1,S=1;break;case"cluster":y=0,b=p,v=0,I=.85,S=1;break;case"exit":default:y=0,b=p-520,v=0,I=.2,S=0;break}const C=f*28;let w;switch(t){case"fan":w=[`transform 480ms cubic-bezier(0.34,1.56,0.64,1) ${C}ms`,`opacity   300ms ease-out ${C}ms`].join(", ");break;case"hold":w="none";break;case"cluster":w="transform 320ms ease-in, opacity 150ms ease-in";break;case"exit":w="transform 450ms ease-in, opacity 380ms ease-in 60ms";break;default:w="none"}return o.jsx("div",{style:{position:"absolute",width:bl,height:xi,left:-bl/2,top:-xi/2,borderRadius:5,overflow:"hidden",border:`1px solid ${a}55`,boxShadow:`0 6px 20px rgba(0,0,0,0.7), 0 0 8px ${a}44`,zIndex:f,transform:`translate(${y}px, ${b}px) rotate(${v}deg) scale(${I})`,opacity:S,transition:w,willChange:"transform, opacity"},children:m?o.jsx("img",{src:`/assets/${m.frontImageId}`,alt:m.nameCn,style:{width:"100%",height:"100%",objectFit:"fill",display:"block"},draggable:!1}):o.jsx("div",{style:{width:"100%",height:"100%",background:"#222"}})},u.instanceId)})]})}const vl=62,bi=Math.round(vl*(1042/756)),ou=52,Vb=5,su=120;function Rb({playerId:e,count:n}){const[t,a]=k.useState("init"),[r,s]=k.useState(null),[i,l]=k.useState(null);if(k.useEffect(()=>{const u=e==="player1"?".mp__deck--p1":".mp__deck--p2",f=document.querySelector(u),m=document.querySelector(e==="player1"?".unit-token-abs--p1":".unit-token-abs--p2"),g=f==null?void 0:f.getBoundingClientRect(),h=m==null?void 0:m.getBoundingClientRect();s(g?{x:g.left+g.width/2,y:g.top+g.height/2}:{x:window.innerWidth*.5,y:window.innerHeight*.85}),l(h?{x:h.left+h.width/2,y:h.top+h.height/2}:{x:e==="player1"?window.innerWidth*.3:window.innerWidth*.7,y:e==="player1"?window.innerHeight*.55:window.innerHeight*.45});const x=setTimeout(()=>a("spread"),50),p=setTimeout(()=>a("hold"),600),_=setTimeout(()=>a("cluster"),900),y=setTimeout(()=>a("fly"),1200);return()=>{[x,p,_,y].forEach(clearTimeout)}},[e]),!r||!i)return null;const d=e==="player1"?"#00f0ff":"#ff8844";return Ar.createPortal(o.jsx("div",{style:{position:"fixed",inset:0,zIndex:900,pointerEvents:"none"},children:o.jsx(Lb,{count:n,deckPos:r,mechaPos:i,phase:t,color:d,playerId:e})}),document.body)}function Lb({count:e,deckPos:n,mechaPos:t,phase:a,color:r,playerId:s}){if(e===0)return null;const i=e,d=(i-1)*ou>window.innerWidth*.6?Math.floor(window.innerWidth*.6/Math.max(i-1,1)):ou,u=t.x-n.x,f=t.y-n.y,m=a==="hold"||a==="cluster",g=`${s==="player1"?"P1":"P2"} 抽牌 ×${i}`;return o.jsxs("div",{style:{position:"fixed",left:n.x,top:n.y},children:[o.jsx("div",{style:{position:"absolute",top:-(su+bi/2+28),left:0,transform:"translateX(-50%)",color:r,fontSize:"0.78rem",fontWeight:"bold",whiteSpace:"nowrap",textShadow:`0 0 10px ${r}, 1px 1px 3px #000`,opacity:m?1:0,transition:"opacity 250ms",letterSpacing:"0.06em"},children:g}),Array.from({length:i},(h,x)=>{const p=(i-1)/2,_=x-p,y=_*d,b=-su,v=_*Vb;let I,S,C,w,N;switch(a){case"init":I=0,S=0,C=0,w=.15,N=0;break;case"spread":case"hold":I=y,S=b,C=v,w=1,N=1;break;case"cluster":I=0,S=b,C=0,w=.85,N=1;break;case"fly":default:I=u,S=f,C=0,w=.2,N=0;break}const z=x*24;let M;switch(a){case"spread":M=[`transform 480ms cubic-bezier(0.34,1.56,0.64,1) ${z}ms`,`opacity   300ms ease-out ${z}ms`].join(", ");break;case"hold":M="none";break;case"cluster":M="transform 280ms ease-in, opacity 150ms ease-in";break;case"fly":M="transform 400ms cubic-bezier(0.4,0,1,1), opacity 300ms ease-in 80ms";break;default:M="none"}return o.jsx("div",{style:{position:"absolute",width:vl,height:bi,left:-vl/2,top:-bi/2,borderRadius:5,overflow:"hidden",border:`1px solid ${r}55`,boxShadow:`0 6px 20px rgba(0,0,0,0.7), 0 0 8px ${r}44`,zIndex:x,transform:`translate(${I}px, ${S}px) rotate(${C}deg) scale(${w})`,opacity:N,transition:M,willChange:"transform, opacity"},children:o.jsx("img",{src:"/assets/ui/card-back.jpg",alt:"card back",style:{width:"100%",height:"100%",objectFit:"fill",display:"block"},draggable:!1})},x)})]})}const yl=56,_l=Math.round(yl*(1042/756));function Ob({playerId:e}){const[n,t]=k.useState("face-up"),[a,r]=k.useState(null);if(k.useEffect(()=>{const i=e==="player1"?".mp__deck--p1":".mp__deck--p2",l=document.querySelector(i),d=l==null?void 0:l.getBoundingClientRect();r(d?{x:d.left+d.width/2,y:d.top+d.height/2}:{x:window.innerWidth*.5,y:window.innerHeight*.85});const u=setTimeout(()=>t("flip"),150),f=setTimeout(()=>t("face-down"),500),m=setTimeout(()=>t("fade"),650);return()=>{[u,f,m].forEach(clearTimeout)}},[e]),!a)return null;const s=e==="player1"?"#00f0ff":"#ff8844";return Ar.createPortal(o.jsxs("div",{style:{position:"fixed",inset:0,zIndex:900,pointerEvents:"none"},children:[o.jsxs("div",{style:{position:"fixed",left:a.x,top:a.y},children:[[0,1,2].map(i=>o.jsx(Kb,{index:i,phase:n,color:s},i)),o.jsx("div",{style:{position:"absolute",top:-(_l/2+32),left:0,transform:"translateX(-50%)",color:s,fontSize:"0.78rem",fontWeight:"bold",whiteSpace:"nowrap",textShadow:`0 0 10px ${s}, 1px 1px 3px #000`,letterSpacing:"0.06em",opacity:n==="face-up"||n==="flip"||n==="face-down"?1:0,transition:"opacity 200ms"},children:"♻️ 重洗牌组"})]}),o.jsx("style",{children:Jb})]}),document.body)}function Kb({index:e,phase:n,color:t}){const a=(e-1)*3,r=(e-1)*2;let s;switch(n){case"face-up":case"flip":case"face-down":s=1;break;case"fade":s=0;break}const i=n==="flip"?"reshuffle-card--flipping":n==="face-down"||n==="fade"?"reshuffle-card--flipped":"";return o.jsxs("div",{className:`reshuffle-card ${i}`,style:{position:"absolute",width:yl,height:_l,left:-yl/2+a,top:-_l/2+r,perspective:600,opacity:s,transition:"opacity 200ms ease-in",willChange:"opacity",zIndex:e},children:[o.jsx("div",{className:"reshuffle-card__face reshuffle-card__front",style:{background:t+"33",border:`2px solid ${t}88`,borderRadius:5,boxShadow:`0 0 12px ${t}55`}}),o.jsx("div",{className:"reshuffle-card__face reshuffle-card__back",style:{borderRadius:5,overflow:"hidden",border:"1px solid #ffffff44",boxShadow:"0 4px 12px rgba(0,0,0,0.6)"},children:o.jsx("img",{src:"/assets/ui/card-back.jpg",alt:"card back",style:{width:"100%",height:"100%",objectFit:"fill",display:"block"},draggable:!1})})]})}const Jb=`
.reshuffle-card {
  transform-style: preserve-3d;
...
`,cn=68;function Bb(){const{currentEvent:e}=zr();return e?o.jsxs("div",{className:"effects-layer",style:{position:"absolute",inset:0,pointerEvents:"none",zIndex:20},children:[e.type==="damage_number"&&o.jsx(wb,{x:e.position.col*cn+cn/2,y:e.position.row*cn+cn/2,value:e.value},`dmg-${Date.now()}`),(e.type==="ranged_hit"||e.type==="melee_hit"||e.type==="charge_hit")&&o.jsx(Cb,{x:e.targetPos.col*cn+cn/2,y:e.targetPos.row*cn+cn/2,variant:e.type==="ranged_hit"?"ranged":e.type==="melee_hit"?"melee":"charge"},`hit-${Date.now()}`),e.type==="mine_explode"&&o.jsx(Tb,{x:e.position.col*cn+cn/2,y:e.position.row*cn+cn/2},`exp-${Date.now()}`),e.type==="card_draw"&&o.jsx(Eb,{defId:e.defId,isAuxiliary:e.isAuxiliary,playerId:e.playerId},`draw-${e.card.instanceId}`),e.type==="card_destroy"&&o.jsx($b,{defId:e.defId,isBomb:e.isBomb,index:e.index,total:e.total},`destroy-${e.card.instanceId}`),e.type==="cleanup_discard"&&o.jsx(Pb,{p1Cards:e.p1Cards,p2Cards:e.p2Cards},`cleanup-${Date.now()}`),e.type==="batch_card_draw"&&o.jsx(Rb,{playerId:e.playerId,count:e.count},`draw-${e.playerId}-${Date.now()}`),e.type==="deck_reshuffle"&&o.jsx(Ob,{playerId:e.playerId},`reshuffle-${e.playerId}-${Date.now()}`)]}):null}function Ca(){const{state:e}=Ce(),{map:n,mines:t}=e,{currentEvent:a,animatedPositions:r}=zr(),{transform:s,viewportRef:i,handlers:l,resetView:d}=jb(.9),u=(a==null?void 0:a.type)==="screen_shake"?`board-transform board-shake board-shake--${a.intensity}`:"board-transform";return o.jsxs("div",{ref:i,className:"board-viewport",...l,style:{cursor:"grab"},children:[o.jsxs("div",{className:u,style:{transform:`translate(${s.x}px, ${s.y}px) scale(${s.scale})`,transformOrigin:"top left"},children:[o.jsx("div",{className:"game-board",style:{gridTemplateColumns:`repeat(${n.width}, var(--cell-size))`,gridTemplateRows:`repeat(${n.height}, var(--cell-size))`},children:n.cells.flatMap((f,m)=>f.map((g,h)=>o.jsx(Fb,{cell:g,row:m,col:h,mines:t},`${m}-${h}`)))}),e.playerIds.map((f,m)=>{const g=e.players[f];return!g||g.isDefeated?null:o.jsx(Gb,{player:g,side:`p${m+1}`,playerIndex:m,color:ht(e,f),animatedPos:r[f]??null},f)}),o.jsx(Bb,{})]}),o.jsx("button",{className:"board-reset-btn",onClick:d,title:"重置视角",children:"⟳"})]})}function Fb({cell:e,row:n,col:t,mines:a}){const r=bc(e),s=e.terrain==="highland"&&e.elevation>0?`+${e.elevation}`:null,i=a.filter(l=>l.position.row===n&&l.position.col===t);return o.jsxs("div",{className:`board-cell board-cell--${e.terrain}`,style:{backgroundImage:`url("${r}")`},"data-row":n,"data-col":t,children:[s&&o.jsx("span",{className:"board-cell__elev",children:s}),i.map((l,d)=>o.jsx(Hb,{mine:l,offset:d*4},l.id))]})}function Gb({player:e,side:n,playerIndex:t,color:a,animatedPos:r}){const s=q.find(m=>m.id===e.unitId);if(!s)return null;const i=(r==null?void 0:r.pos)??e.position,l=(r==null?void 0:r.facing)??e.facing,d={N:0,E:90,S:180,W:270}[l]??0,u=(()=>{switch(l){case"N":return{top:0,left:"50%",translate:"-50% 0"};case"S":return{bottom:0,left:"50%",translate:"-50% 0"};case"E":return{right:0,top:"50%",translate:"0 -50%"};case"W":return{left:0,top:"50%",translate:"0 -50%"};default:return{top:0,left:"50%",translate:"-50% 0"}}})(),f=`P${t+1}`;return o.jsxs("div",{className:`unit-token-abs unit-token-abs--${n}`,style:{left:`calc(${i.col} * var(--cell-size))`,top:`calc(${i.row} * var(--cell-size))`,width:"var(--cell-size)",height:"var(--cell-size)","--token-color":a},children:[o.jsx("div",{className:"unit-token-abs__label",style:{borderColor:a,backgroundColor:a+"33"},title:`${f} ${s.nameCn}`,children:f}),o.jsx("span",{className:"unit-token-abs__facing-arrow",style:{...u,transform:`rotate(${d}deg)`,color:a},title:`机头朝向：${e.facing}`,children:"▲"})]})}function Hb({mine:e,offset:n}){const t=e.kind==="real"?"隐藏机雷指示物":"隐藏替身雷指示物";return o.jsx("div",{className:"mine-token",style:{transform:`translate(${n}px, ${n}px)`},title:t,children:o.jsx("span",{className:"mine-token__icon",children:"◆"})})}const Ub=250,Wb=480,Zb=2e3,ss=252,wo=Math.round(ss*(1042/756)),Gt=12;function Ot(){const[e,n]=k.useState(null),t=k.useRef(null),a=k.useRef(null),r=k.useRef(null),s=k.useRef({x:0,y:0}),i=k.useRef(!1),l=()=>{t.current&&(clearTimeout(t.current),t.current=null),a.current&&(clearTimeout(a.current),a.current=null),r.current&&(clearTimeout(r.current),r.current=null)},d=k.useCallback(()=>{l(),n(null)},[]),u=k.useCallback(f=>({onMouseEnter:m=>{s.current={x:m.clientX,y:m.clientY},l(),t.current=setTimeout(()=>{n({src:f,x:s.current.x,y:s.current.y})},Ub)},onMouseMove:m=>{s.current={x:m.clientX,y:m.clientY},n(g=>g&&{...g,x:m.clientX,y:m.clientY})},onMouseLeave:()=>d(),onTouchStart:m=>{const g=m.touches[0];i.current=!1,l(),a.current=setTimeout(()=>{i.current||(n({src:f,x:g.clientX,y:g.clientY}),r.current=setTimeout(()=>n(null),Zb))},Wb)},onTouchMove:()=>{i.current=!0,d()},onTouchEnd:()=>{l()}}),[d]);return{zoom:e,hide:d,getZoomHandlers:u}}function Yb(e,n){const t=window.innerWidth,a=window.innerHeight;let r=e+18;r+ss+Gt>t&&(r=e-ss-18);let s=n-wo/2;return s<Gt&&(s=Gt),s+wo>a-Gt&&(s=a-wo-Gt),{left:Math.max(Gt,r),top:s}}function Kt({zoom:e}){if(!e)return null;const{left:n,top:t}=Yb(e.x,e.y);return Ar.createPortal(o.jsxs("div",{style:{position:"fixed",left:n,top:t,width:ss,height:wo,zIndex:99999,pointerEvents:"none",borderRadius:8,overflow:"hidden",boxShadow:"0 12px 40px rgba(0,0,0,0.75), 0 0 0 2px rgba(255,255,255,0.15)",background:"#111",animation:"card-zoom-in 0.12s ease-out both"},children:[o.jsx("img",{src:e.src,alt:"",style:{width:"100%",height:"100%",objectFit:"fill",display:"block"},draggable:!1}),o.jsx("style",{children:Xb})]}),document.body)}const Xb=`
@keyframes card-zoom-in {
  from { opacity: 0; transform: scale(0.88); }
  to   { opacity: 1; transform: scale(1); }
}
`;function is(e){return`P${e.replace("player","")}`}function Qb(e,n){const t=Vt[n]??[];return[...e].sort((a,r)=>{const s=t.findIndex(l=>l.id===a.defId),i=t.findIndex(l=>l.id===r.defId);return s-i})}function qb(e,n,t,a,r,s){function i(h){if(!h)return null;const x=[...e.hand,...e.auxiliary].find(p=>p.instanceId===h);return x?r(x.defId)??null:null}const l=i(t),d=i(a),u=fn(e,r,"movement"),f=e.position,m=[];let g=[f];if(l){if(l.actionType==="movement"){const h=(l.movementValue??0)+(u.wheel?2:0);if(h>0){const x=Ds(s,f,h,[n],u,e.facing);g=x.map(p=>p.pos),m.push(...x.map(p=>({pos:p.pos,cls:"preview-move-s1"})))}}else if(l.actionType==="ranged"){const h=l.rangeMin??1,x=l.rangeMax??6;for(let p=0;p<s.height;p++)for(let _=0;_<s.width;_++)Ke(f,{row:p,col:_})>=h&&Ke(f,{row:p,col:_})<=x&&m.push({pos:{row:p,col:_},cls:"preview-atk-s1"})}else if(l.actionType==="melee"||l.actionType==="charge")for(const[h,x]of[[-1,0],[1,0],[0,-1],[0,1]]){const p=f.row+h,_=f.col+x;p>=0&&p<s.height&&_>=0&&_<s.width&&m.push({pos:{row:p,col:_},cls:"preview-atk-s1"})}}if(d){const h=new Map,x=p=>`${p.row},${p.col}`;if(d.actionType==="movement"){const p=(d.movementValue??0)+(u.wheel?2:0);if(p>0){for(const _ of g)Ah(s,_,p,[n],u).forEach(y=>h.set(x(y.pos),y.pos));h.forEach(_=>m.push({pos:_,cls:"preview-move-s2"}))}}else if(d.actionType==="ranged"){const p=d.rangeMin??1,_=d.rangeMax??6;for(const y of g)for(let b=0;b<s.height;b++)for(let v=0;v<s.width;v++){const I=Ke(y,{row:b,col:v});I>=p&&I<=_&&h.set(x({row:b,col:v}),{row:b,col:v})}h.forEach(y=>m.push({pos:y,cls:"preview-atk-s2"}))}else if(d.actionType==="melee"||d.actionType==="charge"){for(const p of g)for(const[_,y]of[[-1,0],[1,0],[0,-1],[0,1]]){const b=p.row+_,v=p.col+y;b>=0&&b<s.height&&v>=0&&v<s.width&&h.set(x({row:b,col:v}),{row:b,col:v})}h.forEach(p=>m.push({pos:p,cls:"preview-atk-s2"}))}}return m}const ev=["board-cell--preview-move-s1","board-cell--preview-move-s2","board-cell--preview-atk-s1","board-cell--preview-atk-s2"];function iu(){document.querySelectorAll(".board-cell").forEach(e=>ev.forEach(n=>e.classList.remove(n)))}const nv=[{id:"hand",label:"手牌",icon:"🃏"},{id:"auxiliary",label:"辅助区",icon:"⚙️"},{id:"discard",label:"弃牌区",icon:"♻️"},{id:"destroyed",label:"已破坏",icon:"💀"}];function ls(){const{state:e,dispatch:n,aiConfig:t}=Ce(),{isAnimating:a}=zr(),r=()=>n({type:"ADVANCE_PLOT_STEP"});if(k.useEffect(()=>{if(e.phase!=="plotting"||a)return;const i=e.plottingStep;if(!i||!i.startsWith("transition_to_"))return;const l=i.replace("transition_to_","");if(!Ae(t,l))return;const d=setTimeout(r,400);return()=>clearTimeout(d)},[e.plottingStep,e.phase,a,t]),e.phase!=="plotting"||a)return null;const s=e.plottingStep;if(s&&s.startsWith("transition_to_")){const i=s.replace("transition_to_","");return Ae(t,i)?null:o.jsx(ov,{onContinue:r,playerLabel:is(i),hint:"请确认对方不在旁后开始布局"})}return null}function ca(){const{state:e,dispatch:n,getCard:t,aiConfig:a}=Ce(),{plottingStep:r}=e;if(e.phase!=="plotting"||r==="complete"||r===null||r.startsWith("transition_to_"))return null;if(r==="waiting_online")return o.jsx(tv,{});const s=r,i=Ae(a,s),l=Pr(a,s);return o.jsx(av,{activePlottingPlayerId:s,getCard:t,isAI:i,aiDifficulty:l,onConfirm:(d,u)=>{d&&n({type:"PLOT_CARD",playerId:s,seg:1,instanceId:d}),u&&n({type:"PLOT_CARD",playerId:s,seg:2,instanceId:u}),n({type:"CONFIRM_PLOT",playerId:s})}},s)}function tv(){const{state:e,plottingStatus:n}=Ce(),t=e.playerIds.filter(a=>!(n!=null&&n.confirmed.includes(a))&&!e.players[a].isDefeated);return o.jsxs("div",{className:"plot-content",style:{justifyContent:"center",alignItems:"center",textAlign:"center",padding:"10%"},children:[o.jsx("div",{style:{fontSize:"3.5rem",marginBottom:"20px"},children:"⏳"}),o.jsx("h2",{style:{color:"var(--color-text-light)",fontFamily:"var(--font-mono)"},children:"等待其他玩家布局"}),t.length>0?o.jsxs("div",{style:{marginTop:"30px",fontSize:"0.9rem",color:"var(--color-text-muted)"},children:["未确认玩家：",o.jsx("div",{style:{display:"flex",gap:"8px",justifyContent:"center",marginTop:"14px",flexWrap:"wrap"},children:t.map(a=>o.jsx("span",{style:{background:"var(--color-bg-card)",padding:"6px 12px",borderRadius:"4px",border:`1px solid ${ht(e,a)}`,color:ht(e,a),fontFamily:"var(--font-mono)",fontWeight:"bold"},children:is(a)},a))})]}):o.jsx("div",{style:{marginTop:"30px",fontSize:"0.95rem",color:"var(--color-text-muted)",fontFamily:"var(--font-mono)"},children:"等待服务器响应..."})]})}function av({activePlottingPlayerId:e,getCard:n,onConfirm:t,isAI:a=!1,aiDifficulty:r="hard"}){const{state:s,dispatch:i,exposureMode:l}=Ce(),[d,u]=k.useState(null),[f,m]=k.useState(null),[g,h]=k.useState("hand"),[x,p]=k.useState(e);function _($){for(const L of $)i({type:"ADD_LOG",message:L})}const y=x===e||l,b=s.players[x],v=s.players[e],I=$=>ht(s,$),S=I(e),C=(()=>{const $=s.playerIds.filter(P=>P!==e&&s.teams[P]!==s.teams[e]&&!s.players[P].isDefeated);if($.length===0)return null;const L=v.position;let D=$[0],R=Math.max(Math.abs(s.players[$[0]].position.row-L.row),Math.abs(s.players[$[0]].position.col-L.col));for(let P=1;P<$.length;P++){const A=s.players[$[P]].position,B=Math.max(Math.abs(A.row-L.row),Math.abs(A.col-L.col));B<R&&(D=$[P],R=B)}return s.players[D]})();k.useEffect(()=>{h(x===e?"hand":"auxiliary")},[x,e]),k.useEffect(()=>{const $=(C==null?void 0:C.position)??{row:0,col:0},L=qb(v,$,d,f,n,s.map);return iu(),L.forEach(({pos:D,cls:R})=>{const P=document.querySelector(`.board-cell[data-row="${D.row}"][data-col="${D.col}"]`);P&&P.classList.add(`board-cell--${R}`)}),iu},[d,f]),k.useEffect(()=>{if(!a)return;const $=s.playerIds.filter(R=>R!==e&&s.teams[R]!==s.teams[e]&&!s.players[R].isDefeated).map(R=>s.players[R]),L=$.length>0?$:[v],D=setTimeout(()=>{const{seg1:R,seg2:P,reasoning:A}=Dx(v,L,n,r,s.map);_(A),R&&P?t(R,P):t(R||null,null)},800);return()=>clearTimeout(D)},[a]);function w($){if(M<=1){if(d===$){u(null),m($);return}if(f===$){m(null);return}u($);return}if(d===$){u(null);return}if(f===$){m(null);return}if(!d){u($);return}if(!f){m($);return}m($)}function N($){return $==="deck"?b.deck.filter(L=>!L.destroyed).length:$==="hand"?b.hand.filter(L=>!L.destroyed).length:$==="auxiliary"?b.auxiliary.length:$==="discard"?b.discard.length:$==="destroyed"?b.destroyedCards.length:0}function z($){return $==="deck"?y?Qb(b.deck,b.unitId):[]:$==="hand"?b.hand.filter(L=>!L.destroyed):$==="auxiliary"?b.auxiliary:$==="discard"?b.discard:$==="destroyed"?b.destroyedCards:[]}const M=v.hand.filter($=>!$.destroyed).length,J=M===0?!0:M===1?d!==null||f!==null:d!==null&&f!==null,E=y,K=g==="deck"&&y;return o.jsxs("div",{className:"plot-content",children:[o.jsxs("div",{className:"plot-panel__header",children:[o.jsx("span",{className:"plot-panel__player",style:{color:S},children:is(e)}),o.jsx("span",{className:"plot-panel__prompt",children:"布局中"})]}),o.jsx("div",{className:"plot-tab-row",children:s.playerIds.map($=>{const L=x===$,D=$===e;return o.jsxs("button",{className:`plot-tab${L?" plot-tab--active":""}`,style:L?{color:I($),borderBottomColor:I($)}:void 0,onClick:()=>p($),children:[is($),D&&!L&&o.jsx("span",{className:"plot-tab__dot",style:{background:I($)}})]},$)})}),x===e?o.jsxs("div",{className:"plot-slots",children:[o.jsx(lu,{label:"主要阶段 1",cardInstanceId:d,getCard:n,hand:v.hand,onClear:()=>u(null),color:S}),o.jsx(lu,{label:"主要阶段 2",cardInstanceId:f,getCard:n,hand:v.hand,onClear:()=>m(null),color:S})]}):l?o.jsxs("div",{className:"plot-slots",children:[o.jsx(cu,{label:"主要阶段 1",card:b.plotSeg1,getCard:n}),o.jsx(cu,{label:"主要阶段 2",card:b.plotSeg2,getCard:n})]}):o.jsxs("div",{className:"plot-slots",children:[o.jsxs("div",{className:"plot-slot-locked",children:[o.jsx("span",{children:"🔒"}),o.jsx("span",{children:"主要阶段 1"}),o.jsx("span",{className:"plot-slot-locked__hint",children:"对方已锁定"})]}),o.jsxs("div",{className:"plot-slot-locked",children:[o.jsx("span",{children:"🔒"}),o.jsx("span",{children:"主要阶段 2"}),o.jsx("span",{className:"plot-slot-locked__hint",children:"对方已锁定"})]})]}),o.jsxs("div",{className:"plot-zone-tabs",children:[o.jsxs("button",{className:`plot-zone-tab${K?" plot-zone-tab--active":""}`,style:K?{borderColor:S}:void 0,onClick:E?()=>h("deck"):void 0,disabled:!E,title:E?"卡组：按资料集顺序查看":"对方卡组不可查看",children:[o.jsx("span",{className:"plot-zone-tab__icon",children:E?"🂠":"🔒"}),o.jsx("span",{className:"plot-zone-tab__label",children:"卡组"}),o.jsx("span",{className:"plot-zone-tab__count",children:b.deck.filter($=>!$.destroyed).length})]}),nv.map(({id:$,label:L,icon:D})=>{const R=g===$;return o.jsxs("button",{className:`plot-zone-tab${R?" plot-zone-tab--active":""}`,style:R?{borderColor:y?S:I(x)}:void 0,onClick:()=>h($),title:`${L}：点击查看`,children:[o.jsx("span",{className:"plot-zone-tab__icon",children:D}),o.jsx("span",{className:"plot-zone-tab__label",children:L}),o.jsx("span",{className:"plot-zone-tab__count",children:N($)})]},$)})]}),o.jsx("div",{className:"plot-zone-view",children:g==="hand"&&!y?o.jsxs("div",{className:"plot-zone-private",children:["🔒 对方手牌不可查看",o.jsx("br",{}),o.jsxs("span",{className:"plot-zone-private__count",children:["共 ",N("hand")," 张"]})]}):z(g).length===0?o.jsx("p",{className:"plot-zone-empty",children:"（此区域为空）"}):o.jsx("div",{className:"plot-card-grid",children:z(g).map($=>{const L=n($.defId),D=g==="hand"&&x===e,R=$.instanceId===d,P=$.instanceId===f;return o.jsx(rv,{card:$,def:L,isSelected:R||P,segLabel:R?"①":P?"②":null,onClick:D?()=>w($.instanceId):void 0},$.instanceId)})})}),o.jsx("div",{className:"plot-footer",children:o.jsx("button",{className:"plot-confirm-btn",disabled:!J,style:J?{borderColor:S,color:S}:void 0,onClick:()=>{J&&t(d,f)},children:J?M===0?"确定布局（无手牌可部署）":M===1&&(!d||!f)?`确定布局（仅部署主要阶段 ${d?"1":"2"}）`:"确定布局":`请选择主要阶段 ${d?"2":"1"} 的卡牌`})}),o.jsx("style",{children:sv})]})}function lu({label:e,cardInstanceId:n,getCard:t,hand:a,onClear:r,color:s}){const i=a.find(g=>g.instanceId===n)??null,l=i?t(i.defId):null,{zoom:d,hide:u,getZoomHandlers:f}=Ot(),m=l?`/assets/${l.frontImageId}`:"";return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"plot-slot",children:[o.jsx("div",{className:"plot-slot__label",children:e}),l&&i?o.jsxs("div",{className:"plot-slot__card",onClick:()=>{u(),r()},title:"点击取消选择",style:{borderColor:s,boxShadow:`0 0 8px ${s}55`},...f(m),children:[o.jsx("img",{src:m,alt:l.nameCn,className:"plot-slot__img",onError:g=>{g.target.style.opacity="0.4"}}),o.jsx("span",{className:"plot-slot__name",children:l.nameCn}),o.jsx("span",{className:"plot-slot__clear",children:"✕"})]}):o.jsx("div",{className:"plot-slot__empty",children:"— 未选择 —"})]}),o.jsx(Kt,{zoom:d})]})}function cu({label:e,card:n,getCard:t}){const a=n?t(n.defId):null,r=a?`/assets/${a.frontImageId}`:"";return o.jsxs("div",{className:"plot-slot",children:[o.jsx("div",{className:"plot-slot__label",children:e}),a&&n?o.jsxs("div",{className:"plot-slot__card",style:{borderColor:"#888",cursor:"default"},children:[o.jsx("img",{src:r,alt:a.nameCn,className:"plot-slot__img",onError:s=>{s.target.style.opacity="0.4"}}),o.jsx("span",{className:"plot-slot__name",children:a.nameCn})]}):o.jsx("div",{className:"plot-slot__empty",children:"— 未布局 —"})]})}function rv({card:e,def:n,isSelected:t,segLabel:a,onClick:r}){const{zoom:s,getZoomHandlers:i}=Ot(),l=n?`/assets/${n.frontImageId}`:"";return o.jsxs(o.Fragment,{children:[o.jsxs("button",{className:`plot-card${t?" plot-card--selected":""}${r?"":" plot-card--readonly"}`,onClick:r,disabled:!r,title:(n==null?void 0:n.nameCn)??"???",...n?i(l):{},children:[n?o.jsxs(o.Fragment,{children:[o.jsx("img",{src:l,alt:n.nameCn,className:"plot-card__img",onError:d=>{d.target.style.opacity="0.3"}}),o.jsx("span",{className:"plot-card__name",children:n.nameCn}),n.damage!==void 0&&o.jsxs("span",{className:"plot-card__stat",children:["💥",n.damage]}),n.movementValue!==void 0&&o.jsxs("span",{className:"plot-card__stat",children:["🏃",n.movementValue]}),n.rangeMin!==void 0&&o.jsxs("span",{className:"plot-card__stat",children:["🎯",n.rangeMin,"–",n.rangeMax]})]}):o.jsx("span",{className:"plot-card__name",children:"???"}),a&&o.jsx("span",{className:"plot-card__badge",children:a})]}),o.jsx(Kt,{zoom:s})]})}function ov({onContinue:e,playerLabel:n,hint:t}){return o.jsxs("div",{className:"pass-device-screen",children:[o.jsxs("div",{className:"pass-device-screen__content",children:[o.jsx("div",{className:"pass-device-screen__icon",children:"🤖"}),o.jsx("h2",{className:"pass-device-screen__title",children:"请将设备交给"}),o.jsx("h1",{className:"pass-device-screen__player",children:n}),o.jsx("p",{className:"pass-device-screen__hint",children:t}),o.jsxs("button",{className:"pass-device-screen__btn",onClick:e,children:[n," 已就位，继续"]})]}),o.jsx("style",{children:iv})]})}const sv=`
...
`;function du(e,n){const t=Pm(e,n);if(t.length===0)return n;if(t.length===1)return t[0];const a=e.players[n].position;let r=t[0],s=1/0;for(const i of t){const l=e.players[i].position,d=Math.max(Math.abs(l.row-a.row),Math.abs(l.col-a.col));d<s&&(s=d,r=i)}return r}function lv(e,n){const t=e.players[n],a=[];for(let r=-1;r<=1;r++)for(let s=-1;s<=1;s++){if(r===0&&s===0)continue;const i=t.position.row+r,l=t.position.col+s;if(i<0||i>=e.map.height||l<0||l>=e.map.width)continue;const d={row:i,col:l};e.mines.some(u=>ve(u.position,d))||a.push(d)}return a}function Rr(e,n){for(const t of n)e({type:"ADD_LOG",message:t})}function cs(){const{state:e,getCard:n}=Ce(),{phase:t,currentTiming:a,turnOrder:r,pendingDamage:s,pendingArmorChoice:i}=e;if(t!=="action_seg1"&&t!=="action_seg2")return null;const l=t==="action_seg1"?1:2;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"action-hud",style:s||i?{display:"none"}:void 0,children:[a==="movement"&&o.jsx(cv,{seg:l,turnOrder:r,getCard:n},`mov-${l}`),(a==="ranged"||a==="melee")&&o.jsx(uv,{seg:l,getCard:n},`combat-${l}-${a}`),a==="special"&&o.jsx(mv,{seg:l,turnOrder:r,getCard:n},`special-${l}`),o.jsx("style",{children:vi})]}),s&&o.jsxs(o.Fragment,{children:[o.jsx(gv,{pendingDamage:s,getCard:n}),o.jsx("style",{children:vi})]}),i&&o.jsxs(o.Fragment,{children:[o.jsx(fv,{pendingArmorChoice:i,getCard:n}),o.jsx("style",{children:vi})]})]})}function cv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:r,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m,playerIds:g}=a,[h,x]=k.useState(new Set),[p,_]=k.useState(null),[y,b]=k.useState([]),[v,I]=k.useState(null),[S,C]=k.useState("N"),w=k.useRef(!1),N=new Map;for(const A of g){const B=a.players[A],V=q.find(F=>F.id===B.unitId);N.set(A,Ph(B,e,t,V.movement))}k.useEffect(()=>{if(!(p!==null||v!==null)&&!w.current&&!(f||m)){if(i&&l){if(d!==l)return;if(N.get(l))_(l);else{const A=a.players[l],B=e===1?A.plotSeg1:A.plotSeg2;if(!B)r({type:"ADD_LOG",message:`  ${Te(l)} 未配置行动卡，跳过`});else{const V=t(B.defId);V&&V.actionType==="movement"&&r({type:"ADD_LOG",message:`  ${Te(l)}【${V.nameCn}】无法发动移动`})}w.current=!0,r({type:"ADVANCE_TIMING"})}return}for(const A of n)if(!h.has(A))if(N.get(A)){_(A);return}else{const B=a.players[A],V=e===1?B.plotSeg1:B.plotSeg2;if(!V)r({type:"ADD_LOG",message:`  ${Te(A)} 未配置行动卡，跳过`});else{const F=t(V.defId);F&&F.actionType==="movement"&&r({type:"ADD_LOG",message:`  ${Te(A)}【${F.nameCn}】无法发动移动`})}x(F=>new Set([...F,A]));return}w.current=!0,r({type:"ADVANCE_TIMING"})}},[h,p,v,f,m,d]),k.useEffect(()=>{if(!p){b([]);return}const A=a.players[p],B=g.filter(Q=>Q!==p).map(Q=>a.players[Q].position),V=q.find(Q=>Q.id===A.unitId),F=fn(A,t,"movement"),G=ko(A,e,t,F)||V.movement,X=Ds(u,A.position,G,B,F,A.facing);b(X.map(Q=>Q.pos))},[p,a.players,u,e]),k.useEffect(()=>{if(!p||i&&l&&p!==l||!Ae(s,p))return;const B=Pr(s,p),V=setTimeout(()=>{const F=$x(a,p,e,t,B);F&&(Rr(r,F.reasoning),r({type:"MOVE_UNIT",playerId:p,to:F.pos,path:F.path,finalFacing:F.finalFacing})),x(G=>new Set([...G,p])),_(null),b([])},800);return()=>clearTimeout(V)},[p]);function z(A,B){if(!p||Ae(s,p)||!y.some(G=>ve(G,A)))return;let V=B;if(!V){const G=a.players[p],X=g.filter(de=>de!==p).map(de=>a.players[de].position),Q=q.find(de=>de.id===G.unitId),se=fn(G,t,"movement"),le=ko(G,e,t,se)||Q.movement;V=$s(u,G.position,G.facing,A,le,X,se)}const F=a.players[p];I({playerId:p,to:A,path:(V==null?void 0:V.path)??[]}),C(F.facing),b([]),_(null)}function M(){v&&(r({type:"MOVE_UNIT",playerId:v.playerId,to:v.to,path:v.path,finalFacing:S}),x(A=>new Set([...A,v.playerId])),I(null),i&&(w.current=!0,r({type:"ADVANCE_TIMING"})))}if(i&&l&&d&&d!==l&&!p&&!v)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});const J=n.every(A=>!N.get(A)||h.has(A));if(!i&&J&&p===null&&v===null||i&&w.current&&p===null&&v===null)return null;if(v!==null){const A=Te(v.playerId);return o.jsxs("div",{className:"action-hud__panel",children:[o.jsx("span",{className:"action-hud__mover",children:A}),o.jsx("span",{className:"action-hud__hint",children:"选择移动结束后的机头方向"}),o.jsx(Cc,{currentFacing:S,onSelectFacing:C}),o.jsx("button",{className:"action-hud__skip-btn",onClick:M,children:"确认移动"})]})}const E=p?Ae(s,p):!1,K=p?Te(p):"";if(E)return o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[K," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]});const $=p?a.players[p]:null,L=p&&$?fn($,t,"movement"):null,D=$?q.find(A=>A.id===$.unitId):null,R=p&&$&&D?ko($,e,t,L??void 0)||D.movement:0,P=p?g.filter(A=>A!==p).map(A=>a.players[A].position):[];return o.jsxs(o.Fragment,{children:[p&&$&&o.jsx(dv,{reachable:y,map:u,from:$.position,fromFacing:$.facing,movementValue:R,blockedPositions:P,aux:L??void 0,onCellClick:z}),o.jsx("div",{className:"action-hud__panel",children:p?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"action-hud__mover",children:K}),o.jsx("span",{className:"action-hud__hint",children:"选择目标格（步数须用尽；点击选择路径）"}),(L==null?void 0:L.vernier)&&o.jsx("span",{className:"action-hud__aux-badge",title:"地形移动消耗-1，高低差消耗-1",children:"⚙ 喷射推进器"}),(L==null?void 0:L.wheel)&&o.jsx("span",{className:"action-hud__aux-badge",title:"移动力+2",children:"⚙ 滑轮"})]}):o.jsx("span",{className:"action-hud__hint",children:"计算移动路径中…"})})]})}function Cc({currentFacing:e,onSelectFacing:n,disabledFacing:t}){const a=[{facing:"N",label:"↑N"},{facing:"E",label:"E→"},{facing:"S",label:"↓S"},{facing:"W",label:"←W"}];return o.jsxs("div",{className:"facing-compass",title:"调整机头朝向",children:[o.jsx("span",{className:"facing-compass__label",children:"机头"}),a.map(({facing:r,label:s})=>{const i=r===t;return o.jsx("button",{className:["facing-compass__btn",e===r?"facing-compass__btn--active":"",i?"facing-compass__btn--disabled":""].join(" ").trim(),onClick:()=>{i||n(r)},disabled:i,title:i?"当前规则下不可选":`朝${r}方`,children:s},r)})]})}function dv({reachable:e,map:n,from:t,fromFacing:a,movementValue:r,blockedPositions:s,aux:i,onCellClick:l}){const d=Ks(),u=k.useRef({allPaths:[],selectedIdx:0,hoveredPos:null}),[f,m]=k.useState(0),g=()=>m(x=>x+1);k.useEffect(()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(I=>I.classList.remove("board-cell--path-ghost"));const{allPaths:x,selectedIdx:p,hoveredPos:_}=u.current;if(!_||x.length===0)return;const y=x[p];if(!y)return;const b=y.path.slice(0,-1);for(const I of b){const S=document.querySelector(`.board-cell[data-row="${I.row}"][data-col="${I.col}"]`);S==null||S.classList.add("board-cell--path-ghost")}const v=document.querySelector(`.board-cell[data-row="${_.row}"][data-col="${_.col}"]`);return v&&(v.dataset.pathLabel=x.length>1?`${p+1}/${x.length}`:""),()=>{document.querySelectorAll(".board-cell--path-ghost").forEach(I=>I.classList.remove("board-cell--path-ghost")),v&&delete v.dataset.pathLabel}},[f]),k.useEffect(()=>{const x=[];document.querySelectorAll(".board-cell--reachable").forEach(p=>{p.classList.remove("board-cell--reachable")});for(const p of e){const _=document.querySelector(`.board-cell[data-row="${p.row}"][data-col="${p.col}"]`);if(!_)continue;_.classList.add("board-cell--reachable");const y=()=>{const{allPaths:E,selectedIdx:K}=u.current;l(p,E[K]??null)},b=()=>{const E=Io(n,t,a,p,r,s,i);u.current={allPaths:E,selectedIdx:0,hoveredPos:p},g()},v=()=>{u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()},I=E=>{const{allPaths:K,selectedIdx:$}=u.current;if(K.length<=1)return;E.preventDefault();const L=E.deltaY>0?1:-1;u.current={...u.current,selectedIdx:($+L+K.length)%K.length},g()};let S=null,C=0,w=0,N=!1;const z=E=>{if(C=E.touches[0].clientX,w=E.touches[0].clientY,N=!1,d){const{hoveredPos:K}=u.current;if(K&&K.row===p.row&&K.col===p.col)return;const $=Io(n,t,a,p,r,s,i);u.current={allPaths:$,selectedIdx:0,hoveredPos:p},g(),E.preventDefault();return}S=setTimeout(()=>{N=!0;const K=Io(n,t,a,p,r,s,i);u.current={allPaths:K,selectedIdx:0,hoveredPos:p},g()},400)},M=()=>{S&&(clearTimeout(S),S=null),N&&!d&&(u.current={allPaths:[],selectedIdx:0,hoveredPos:null},g()),N=!1},J=E=>{if(d||!N)return;const K=E.touches[0].clientX-C,$=E.touches[0].clientY-w;if(Math.abs(K)>40||Math.abs($)>40){const{allPaths:L,selectedIdx:D}=u.current;if(L.length<=1)return;const R=Math.abs(K)>Math.abs($)?K>0?1:-1:$>0?1:-1;u.current={...u.current,selectedIdx:(D+R+L.length)%L.length},g(),C=E.touches[0].clientX,w=E.touches[0].clientY}};_.addEventListener("click",y),_.addEventListener("mouseenter",b),_.addEventListener("mouseleave",v),_.addEventListener("wheel",I,{passive:!1}),_.addEventListener("touchstart",z,{passive:!0}),_.addEventListener("touchend",M),_.addEventListener("touchcancel",M),_.addEventListener("touchmove",J,{passive:!0}),x.push(()=>{S&&clearTimeout(S),_.removeEventListener("click",y),_.removeEventListener("mouseenter",b),_.removeEventListener("mouseleave",v),_.removeEventListener("wheel",I),_.removeEventListener("touchstart",z),_.removeEventListener("touchend",M),_.removeEventListener("touchcancel",M),_.removeEventListener("touchmove",J)})}return()=>{document.querySelectorAll(".board-cell--reachable").forEach(p=>p.classList.remove("board-cell--reachable")),document.querySelectorAll(".board-cell--path-ghost").forEach(p=>p.classList.remove("board-cell--path-ghost")),document.querySelectorAll(".board-cell[data-path-label]").forEach(p=>delete p.dataset.pathLabel),u.current={allPaths:[],selectedIdx:0,hoveredPos:null},x.forEach(p=>p())}},[e,n,t,a,r,s,i,l]);const h=k.useCallback(()=>{const{allPaths:x,selectedIdx:p}=u.current;x.length<=1||(u.current={...u.current,selectedIdx:(p+1)%x.length},g())},[]);if(d){const{allPaths:x,hoveredPos:p}=u.current;if(p&&x.length>1)return o.jsxs("button",{className:"move-cycle-btn",onClick:h,style:{position:"fixed",bottom:80,left:"50%",transform:"translateX(-50%)",zIndex:600,padding:"10px 24px",background:"rgba(22, 33, 62, 0.95)",border:"1px solid #ffea00",borderRadius:8,color:"#ffea00",fontFamily:"var(--font-mono)",fontSize:"0.85rem",fontWeight:"bold",cursor:"pointer",minHeight:44,backdropFilter:"blur(4px)"},children:["切换路径 (",u.current.selectedIdx+1,"/",x.length,")"]})}return null}function Wm({reachable:e,onCellClick:n}){return k.useEffect(()=>(document.querySelectorAll(".board-cell").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null}),e.forEach(a=>{const r=document.querySelector(`.board-cell[data-row="${a.row}"][data-col="${a.col}"]`);r&&(r.classList.add("board-cell--reachable"),r.onclick=()=>n(a))}),()=>{document.querySelectorAll(".board-cell--reachable").forEach(a=>{a.classList.remove("board-cell--reachable"),a.onclick=null})}),[e,n]),null}function uv({seg:e,getCard:n}){const{state:t,dispatch:a,aiConfig:r,isOnline:s,localPlayerId:i,currentTurnPlayerId:l}=Ce(),{map:d,turnOrder:u,currentTiming:f,pendingDamage:m,pendingArmorChoice:g}=t,[h,x]=k.useState(new Set),[p,_]=k.useState(null),[y,b]=k.useState(null),v=k.useRef(!1),[I,S]=k.useState(null);k.useEffect(()=>{p&&S(du(t,p))},[p]);const[C,w]=k.useState(!1),[N,z]=k.useState([]),[M,J]=k.useState(!1),E=f==="ranged"?"ranged":"melee",K=E==="ranged"?"射击时机":"近战时机";if(k.useEffect(()=>{if(p===null&&!v.current&&!(m||g)){if(s&&i){if(l!==i)return;const re=t.players[i];if(Ln(re,e,E,n))_(i),w(!1),J(!1),z([]);else{const Be=e===1?re.plotSeg1:re.plotSeg2;if(Be){const Ve=n(Be.defId);Ve&&(E==="ranged"&&Ve.actionType==="ranged"||E==="melee"&&(Ve.actionType==="melee"||Ve.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(i)}【${Ve.nameCn}】条件不满足，无法发动`})}v.current=!0,a({type:"ADVANCE_TIMING"})}return}for(const re of u){if(h.has(re))continue;const ee=t.players[re];if(!Ln(ee,e,E,n)){const Ve=e===1?ee.plotSeg1:ee.plotSeg2;if(Ve){const je=n(Ve.defId);je&&(E==="ranged"&&je.actionType==="ranged"||E==="melee"&&(je.actionType==="melee"||je.actionType==="charge"))&&a({type:"ADD_LOG",message:`  ${Te(re)}【${je.nameCn}】条件不满足，无法发动`})}x(je=>new Set([...je,re]));return}_(re),w(!1),J(!1),z([]);return}v.current=!0,a({type:"ADVANCE_TIMING"})}},[h,p,m,g,n,l]),k.useEffect(()=>{if(!p||m||g||s&&i&&p!==i||!Ae(r,p))return;const ee=Pr(r,p),Be=setTimeout(()=>{const Ve=Ax(t,p,e,E,n,ee);if(Rr(a,Ve.reasoning),Ve.shouldAttack){const je=t.players[p],Bt=Ln(je,e,E,n),pf=(Bt==null?void 0:Bt.actionType)==="charge"?"RESOLVE_CHARGE":E==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE";a({type:pf,attackerId:p,targetId:Ve.targetId})}else{const je=t.players[p],Bt=Ln(je,e,E,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${Bt?`【${Bt.nameCn}】`:K}`})}x(je=>new Set([...je,p])),_(null),w(!1),J(!1),z([])},800);return()=>clearTimeout(Be)},[p,m,g]),s&&i&&l&&l!==i&&!p)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(l)," 行动中…"]})});if(!p)return null;const $=t.players[p],L=Pm(t,p),D=I??du(t,p),R=t.players[D],P=f==="melee"?fn($,n,"melee"):{vernier:!1,moveSensor:!1},A=Ln($,e,E,n),B=(A==null?void 0:A.actionType)==="charge",V=Ae(r,p),F=L.filter(re=>{const ee=t.players[re];if(B&&E==="melee"){const Be=q.find(je=>je.id===$.unitId),Ve=q.find(je=>je.id===ee.unitId);return qo($,ee,e,d,Be,Ve,n).canAttack}return Qo($,ee,e,E,d,n).canAttack});let G;if(B&&E==="melee"){const re=q.find(Be=>Be.id===$.unitId),ee=q.find(Be=>Be.id===R.unitId);G=qo($,R,e,d,re,ee,n)}else G=Qo($,R,e,E,d,n);const X=q.find(re=>re.id===$.unitId),Q=q.find(re=>re.id===R.unitId);function se(){if(!G.canAttack||!p)return;a({type:B?"RESOLVE_CHARGE":E==="ranged"?"RESOLVE_RANGED":"RESOLVE_MELEE",attackerId:p,targetId:D}),b(`${X.nameCn} → ${Q.nameCn}：造成 ${G.damage} 伤害`),x(ee=>new Set([...ee,p])),_(null),w(!1),J(!1),z([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function le(){if(!p)return;const re=Ln(t.players[p],e,E,n);a({type:"ADD_LOG",message:`  ${Te(p)} 放弃发动${re?`【${re.nameCn}】`:K}`}),b(null),x(ee=>new Set([...ee,p])),_(null),w(!1),J(!1),z([]),s&&(v.current=!0,a({type:"ADVANCE_TIMING"}))}function de(){if(!p||C)return;const re=Km(d,$.position,[R.position]);z(re),J(!0)}function vn(re){!p||!M||(a({type:"MELEE_SENSOR_MOVE",playerId:p,to:re}),w(!0),J(!1),z([]))}function zn(){J(!1),z([])}const $a=Te(p),Jt=G.card?B?`【${G.card.nameCn}】突击值 ${X.assault} vs 防御${Q.assaultDef}`:`【${G.card.nameCn}】射程 ${G.card.rangeMin??"—"}–${G.card.rangeMax??"—"}`:null,Zn=E==="melee"&&P.moveSensor&&!C;return V?o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[Te(p)," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):o.jsxs(o.Fragment,{children:[M&&o.jsx(Wm,{reachable:N,onCellClick:vn}),!M&&o.jsx(pv,{validTargets:F.map(re=>({playerId:re,pos:t.players[re].position})),selectedTargetId:D,onSelectTarget:S}),o.jsxs("div",{className:"action-hud__panel action-hud__panel--combat",children:[o.jsx("span",{className:"action-hud__mover",children:$a}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__timing-label",children:K}),P.moveSensor&&o.jsxs("span",{className:`action-hud__aux-badge ${C?"action-hud__aux-badge--used":""}`,title:"近战前可移动1格",children:["⚙ 移动传感器",C?"（已使用）":""]}),P.vernier&&o.jsx("span",{className:"action-hud__aux-badge",title:"地形消耗-1，高低差-1",children:"⚙ 喷射推进器"}),(E==="melee"||E==="ranged"&&vc(G.card))&&o.jsx(Cc,{currentFacing:$.facing,onSelectFacing:re=>a({type:"ADJUST_FACING",playerId:p,facing:re})}),G.card?o.jsxs("span",{className:"action-hud__card-info",children:[Jt,G.card.damage!==void 0&&o.jsxs("span",{className:"action-hud__dmg",children:[" 伤害 ",G.card.damage]})]}):o.jsxs("span",{className:"action-hud__hint",children:["无",E==="ranged"?"射击":"近战","牌"]}),o.jsx("span",{className:`action-hud__validity ${G.canAttack?"action-hud__validity--ok":"action-hud__validity--no"}`,children:G.canAttack?B?`距离 ${G.dist} ✓ → 造成 ${G.damage} 伤 / 自机反伤 ${G.counterDamage}`:`距离 ${G.dist} ✓ → ${G.damage} 伤`:G.card?G.reason:""}),y&&o.jsx("span",{className:"action-hud__result",children:y}),M?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"action-hud__hint",children:"点击高亮格移动（传感器），或"}),o.jsx("button",{className:"action-hud__skip-btn",onClick:zn,children:"取消移动"})]}):o.jsxs(o.Fragment,{children:[Zn&&o.jsx("button",{className:"action-hud__sensor-btn",onClick:de,title:"移动传感器：攻击前可移动1格",children:"传感器移动"}),F.length>1&&o.jsxs("span",{className:"action-hud__target-hint",children:["目标: ",Te(D)," (",Q.nameCn,") — 点击地图切换目标 (",F.length,"个可选)"]}),o.jsx("button",{className:"action-hud__attack-btn",onClick:se,disabled:!G.canAttack,title:G.canAttack?`攻击 ${Q.nameCn}`:G.reason,children:"执行攻击"}),o.jsxs("button",{className:"action-hud__skip-btn",onClick:le,children:["跳过",E==="ranged"?"射击":"近战"]})]})]})]})}function pv({validTargets:e,selectedTargetId:n,onSelectTarget:t}){return k.useEffect(()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null});for(const{playerId:a,pos:r}of e){const s=document.querySelector(`.board-cell[data-row="${r.row}"][data-col="${r.col}"]`);s&&(a===n?s.classList.add("board-cell--target"):(s.classList.add("board-cell--target-alt"),s.onclick=i=>{i.stopPropagation(),t(a)}))}return()=>{document.querySelectorAll(".board-cell--target, .board-cell--target-alt").forEach(a=>{a.classList.remove("board-cell--target","board-cell--target-alt"),a.onclick=null})}},[e,n,t]),null}function mv({seg:e,turnOrder:n,getCard:t}){const{state:a,dispatch:r,aiConfig:s,isOnline:i,localPlayerId:l,currentTurnPlayerId:d}=Ce(),{map:u,pendingDamage:f,pendingArmorChoice:m}=a,[g,h]=k.useState(new Set),[x,p]=k.useState(null),[_,y]=k.useState([]),[b,v]=k.useState("real"),[I,S]=k.useState([]),C=k.useRef(!1);if(k.useEffect(()=>{if(x===null&&!C.current&&!(f||m)){if(i&&l){if(d!==l)return;const R=a.players[l],P=e===1?R.plotSeg1:R.plotSeg2,A=P?t(P.defId):null;!A||A.actionType!=="mine"&&A.actionType!=="special"&&A.actionType!=="aim"?(C.current=!0,r({type:"ADVANCE_TIMING"})):p(l);return}for(const R of n){if(g.has(R))continue;const P=a.players[R],A=e===1?P.plotSeg1:P.plotSeg2,B=A?t(A.defId):null;if(!B||B.actionType!=="mine"&&B.actionType!=="special"&&B.actionType!=="aim"){h(V=>new Set([...V,R]));return}p(R);return}C.current=!0,r({type:"ADVANCE_TIMING"})}},[g,x,f,m,t,d]),k.useEffect(()=>{if(!x){y([]),S([]),v("real");return}const R=a.players[x],P=e===1?R.plotSeg1:R.plotSeg2,A=P?t(P.defId):null;if(A&&A.actionType==="mine"){const B=lv(a,x);y(B)}else y([]),S([]),v("real")},[x,u,e,a,t]),k.useEffect(()=>{if(!x||f||m||i&&l&&x!==l||!Ae(s,x))return;const P=Pr(s,x),A=setTimeout(()=>{const B=Px(a,x,e,t,P);B&&(Rr(r,B.reasoning),B.actionType==="mine"?r({type:"PLACE_MINE",playerId:x,placements:B.placements,damage:B.damage}):B.actionType==="aim"&&r({type:"ADJUST_FACING",playerId:x,facing:B.facing})),h(V=>new Set([...V,x])),p(null)},800);return()=>clearTimeout(A)},[x,f,m]),i&&l&&d&&d!==l&&!x)return o.jsx("div",{className:"action-hud__panel action-hud__panel--waiting",children:o.jsxs("span",{className:"action-hud__hint",children:["等待 ",Te(d)," 行动中…"]})});if(!x)return null;const w=a.players[x],N=e===1?w.plotSeg1:w.plotSeg2,z=N?t(N.defId):null,M=Te(x),J=I.filter(R=>R.kind==="real").length,E=I.filter(R=>R.kind==="dummy").length,K=Ae(s,x);function $(){S([]),v("real"),h(R=>new Set([...R,x])),p(null),i&&(C.current=!0,r({type:"ADVANCE_TIMING"}))}function L(R){!x||!z||z.actionType!=="mine"||_.some(P=>ve(P,R))&&S(P=>P.find(V=>ve(V.position,R))?P.filter(V=>!ve(V.position,R)):P.length>=4||P.filter(V=>V.kind===b).length>=2?P:[...P,{position:R,kind:b}])}function D(){!x||!z||z.actionType!=="mine"||I.length!==4||J!==2||E!==2||(r({type:"PLACE_MINE",playerId:x,placements:I,damage:z.damage||3}),S([]),v("real"),h(R=>new Set([...R,x])),p(null),i&&(C.current=!0,r({type:"ADVANCE_TIMING"})))}return K?o.jsxs("div",{className:"action-hud__panel action-hud__panel--ai-thinking",children:[o.jsxs("span",{className:"action-hud__mover",children:[M," (AI)"]}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__hint",children:"思考中…"})]}):o.jsxs(o.Fragment,{children:[_.length>0&&o.jsx(Wm,{reachable:_,onCellClick:L}),o.jsxs("div",{className:"action-hud__panel action-hud__panel--special",children:[o.jsx("span",{className:"action-hud__mover",children:M}),o.jsx("span",{className:"action-hud__divider",children:"│"}),o.jsx("span",{className:"action-hud__timing-label",children:"特殊时机"}),o.jsx("span",{className:"action-hud__card-info",children:z?`【${z.nameCn}】效果`:"（无）"}),(z==null?void 0:z.actionType)==="mine"?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"action-hud__facing-row",children:[o.jsxs("button",{className:`action-hud__facing-btn${b==="real"?" is-selected":""}`,onClick:()=>v("real"),disabled:J>=2,children:["机雷 ",J,"/2"]}),o.jsxs("button",{className:`action-hud__facing-btn${b==="dummy"?" is-selected":""}`,onClick:()=>v("dummy"),disabled:E>=2,children:["替身雷 ",E,"/2"]})]}),o.jsxs("span",{className:"action-hud__hint",children:["点击高亮格放置 ",b==="real"?"机雷":"替身雷","，再次点击已选格可取消。"]}),o.jsxs("span",{className:"action-hud__hint",children:["当前已选 ",I.length,"/4 个指示物，需放满真雷2个与替身雷2个。"]}),o.jsx("button",{className:"action-hud__attack-btn",onClick:D,disabled:I.length!==4||J!==2||E!==2,children:"确认布雷"})]}):(z==null?void 0:z.actionType)==="aim"?o.jsxs(o.Fragment,{children:[o.jsx(Cc,{currentFacing:w.facing,onSelectFacing:R=>r({type:"ADJUST_FACING",playerId:x,facing:R})}),o.jsx("span",{className:"action-hud__hint",children:"可先调整朝向，然后"})]}):o.jsx("span",{className:"action-hud__hint",children:"暂无此牌效果支持，请"}),o.jsx("button",{className:"action-hud__skip-btn",onClick:$,children:(z==null?void 0:z.actionType)==="aim"?"确认":"跳过"})]})]})}function fv({pendingArmorChoice:e,getCard:n}){const{dispatch:t,aiConfig:a,isOnline:r,localPlayerId:s}=Ce(),{zoom:i,getZoomHandlers:l}=Ot(),{targetId:d,damage:u,source:f,handCards:m,plotCards:g}=e,[h,x]=k.useState(null),[p,_]=k.useState(new Set),y=r&&s&&d!==s,b=!y&&Ae(a,d);k.useEffect(()=>{b?x(d):r||x(null)},[d,b,r]),k.useEffect(()=>{if(!b||y)return;const M=Vx(u,m,g),J=setTimeout(()=>{Rr(t,M.reasoning),t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:M.value})},500);return()=>clearTimeout(J)},[d,b,y,u,m,g,t]);function v(M){_(J=>{const E=new Set(J);return E.has(M)?E.delete(M):E.add(M),E})}function I(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[...p]})}function S(){t({type:"CONFIRM_ARMOR_CHOICE",playerId:d,selectedInstanceIds:[]})}const C=[...p].reduce((M,J)=>{const E=g.find($=>$.instanceId===J);if(E)return M+E.armorValue;const K=m.find($=>$.instanceId===J);return M+((K==null?void 0:K.armorValue)??0)},0),w=Math.max(0,u-C),N=f==="ranged"?"射击":f==="charge"?"突击":f==="mine"?"机雷":"近战",z=Te(d);return y?o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),o.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),o.jsx("div",{className:"damage-pass__player",children:z}),o.jsxs("p",{className:"damage-pass__context",children:[z," 正在决定是否激活装甲牌…"]}),o.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),o.jsx("style",{children:ds})]}):!r&&!b&&d!==h?o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 装甲选择 —"}),o.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),o.jsx("div",{className:"damage-pass__player",children:z}),o.jsxs("p",{className:"damage-pass__context",children:["受到 ",u," 点",N,"伤害，可激活装甲牌减伤"]}),o.jsxs("button",{className:"damage-pass__btn",onClick:()=>x(d),children:[z," 已准备"]})]})}),o.jsx("style",{children:ds})]}):o.jsxs("div",{className:"action-hud",children:[o.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[o.jsxs("div",{className:"damage-panel__header",children:[o.jsx("span",{className:"damage-panel__title",children:"🛡 装甲激活"}),o.jsx("span",{className:"damage-panel__player",children:z}),o.jsxs("span",{className:"damage-panel__remaining",children:["受到 ",o.jsx("strong",{children:u})," 点",N,"伤害",C>0&&o.jsxs(o.Fragment,{children:[" → 减免后 ",o.jsx("strong",{className:"armor-reduced",children:w})," 点"]})]})]}),o.jsx("div",{className:"damage-panel__hint",children:f==="ranged"?"手牌中的装甲牌可防御射击伤害；准备区中的装甲牌可防御任意伤害。选择要激活的装甲牌，或跳过。":"准备区中的装甲牌可防御任意伤害（含突击/近战）。选择要激活的装甲牌，或跳过。"}),o.jsxs("div",{className:"damage-panel__zones",children:[m.length>0&&o.jsxs("div",{className:"damage-zone",children:[o.jsx("span",{className:"damage-zone__label",children:"手牌装甲"}),o.jsx("div",{className:"damage-zone__cards",children:m.map(M=>{const J=n(M.defId),E=p.has(M.instanceId),K=l((J==null?void 0:J.frontImageId)??"");return o.jsxs("button",{className:`damage-card-btn ${E?"damage-card-btn--selected":""}`,onClick:()=>v(M.instanceId),...K,children:[o.jsx("span",{className:"damage-card-btn__name",children:(J==null?void 0:J.nameCn)??M.defId}),o.jsxs("span",{className:"armor-value-badge",children:["-",M.armorValue]})]},M.instanceId)})})]}),g.length>0&&o.jsxs("div",{className:"damage-zone",children:[o.jsx("span",{className:"damage-zone__label",children:"准备区装甲"}),o.jsx("div",{className:"damage-zone__cards",children:g.map(M=>{const J=n(M.defId),E=p.has(M.instanceId),K=l((J==null?void 0:J.frontImageId)??"");return o.jsxs("button",{className:`damage-card-btn ${E?"damage-card-btn--selected":""}`,onClick:()=>v(M.instanceId),...K,children:[o.jsx("span",{className:"damage-card-btn__name",children:(J==null?void 0:J.nameCn)??M.defId}),o.jsxs("span",{className:"damage-zone__sub",children:["主要阶段",M.seg]}),o.jsxs("span",{className:"armor-value-badge",children:["-",M.armorValue]})]},M.instanceId)})})]})]}),o.jsxs("div",{className:"damage-panel__actions",children:[o.jsxs("button",{className:"action-hud__attack-btn",onClick:I,disabled:p.size===0,children:["激活选中装甲 (-",C," 点)"]}),o.jsx("button",{className:"action-hud__skip-btn",onClick:S,children:"不使用装甲"})]})]}),o.jsx(Kt,{zoom:i})]})}function gv({pendingDamage:e,getCard:n}){const{state:t,dispatch:a,aiConfig:r,isOnline:s,localPlayerId:i}=Ce(),{targetId:l,remaining:d,selectedInstanceIds:u}=e,{zoom:f,getZoomHandlers:m}=Ot(),[g,h]=k.useState(null),[x,p]=k.useState(!1),_=t.players[l];$n(_);const y=u.length===0,b=!!e.attackerId&&y&&!e.attackerDesignatedCardId,v=b?e.attackerId:l,I=Te(v),S=s&&i&&v!==i,C=!S&&Ae(r,v),w=Pr(r,v),N=!s&&!C&&v!==g;k.useEffect(()=>{C?h(v):s||h(null)},[v,C,s]),k.useEffect(()=>{if(!C||S||d<=0)return;const P=t.players[l],A=Sa(P),B=t.playerIds.filter(G=>G!==l&&t.teams[G]!==t.teams[l]&&!t.players[G].isDefeated),V=B.length>0?t.players[B[0]]:P,F=setTimeout(()=>{if(A.length>0){const G=Hd(e,P,n,w,b,V);Rr(a,G.reasoning),G.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:G.value}):a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v})},600);return()=>clearTimeout(F)},[d,v,C,S,t.players]),k.useEffect(()=>{if(!x)return;if(d<=0){p(!1);return}const P=t.players[l],A=Sa(P),B=setTimeout(()=>{if(A.length>0){const V=t.playerIds.filter(X=>X!==l&&t.teams[X]!==t.teams[l]&&!t.players[X].isDefeated),F=V.length>0?t.players[V[0]]:P,G=Hd(e,P,n,"hard",b,F);G.value?a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:G.value}):(a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1))}else a({type:"CONFIRM_DAMAGE_SELECTION",playerId:v}),p(!1)},150);return()=>clearTimeout(B)},[x,d,t.players]);function z(P){a({type:"SELECT_DAMAGE_CARD",playerId:v,instanceId:P})}function M(){p(!0)}if(S)return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),o.jsx("h2",{className:"damage-pass__title",children:"等待对手选择"}),o.jsx("div",{className:"damage-pass__player",children:I}),o.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方正在指定要摧毁的卡牌…":`${I} 正在选择要摧毁的 ${d} 张卡牌…`}),o.jsx("div",{className:"damage-pass__spinner",children:"⏳"})]})}),o.jsx("style",{children:ds})]});if(N)return o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"damage-pass-overlay",children:o.jsxs("div",{className:"damage-pass-card",children:[o.jsx("p",{className:"damage-pass__eyebrow",children:"— 伤害分配 —"}),o.jsx("h2",{className:"damage-pass__title",children:"请将设备交给"}),o.jsx("div",{className:"damage-pass__player",children:I}),o.jsx("p",{className:"damage-pass__context",children:b?"【瞄准加成】攻方有权指定第一张要摧毁的卡牌":`防方选择要摧毁的 ${d} 张卡牌（可自动分配）`}),o.jsxs("button",{className:"damage-pass__btn",onClick:()=>h(v),children:[I," 已准备"]})]})}),o.jsx("style",{children:ds})]});const J=_.hand.filter(P=>!P.destroyed),E=_.plotSeg1&&!_.plotSeg1.destroyed?[_.plotSeg1]:[],K=_.plotSeg2&&!_.plotSeg2.destroyed?[_.plotSeg2]:[],$=_.auxiliary.filter(P=>!P.destroyed),L=_.deck.filter(P=>!P.destroyed),D=[];J.length>0&&D.push({label:"手牌",cards:J}),E.length>0&&D.push({label:"布局格",sublabel:"主要阶段1",cards:E}),K.length>0&&D.push({label:"布局格",sublabel:"主要阶段2",cards:K}),$.length>0&&D.push({label:"辅助区",cards:$});const R=L[0]??null;return o.jsxs("div",{className:"action-hud",children:[o.jsxs("div",{className:"action-hud__panel action-hud__panel--damage",children:[o.jsxs("div",{className:"damage-panel__header",children:[o.jsx("span",{className:"damage-panel__title",children:"⚔️ 伤害分配"}),o.jsx("span",{className:"damage-panel__player",children:b?`${I} (瞄准指定)`:I}),o.jsxs("span",{className:"damage-panel__remaining",children:["还需摧毁 ",o.jsx("strong",{children:d})," 张卡牌"]})]}),(e.destroyedBombCount??0)>0&&o.jsxs("div",{className:"damage-panel__bomb-alert",children:["💣 已选中 ",e.destroyedBombCount," 张炸弹卡，选完后将进行誘爆检查"]}),o.jsx("div",{className:"damage-panel__hint",children:b?`【瞄准加成】攻方有权指定第一张要摧毁的卡牌！可从手牌、辅助区、卡组、布局格中选择。请 ${I} 选择：`:e.source==="ranged"?"射击伤害：须先从手牌 / 布局格 / 辅助区选择卡牌破坏，不足部分自动从牌组顶破坏。":"牌组与弃牌区已耗尽，近战伤害切换为自选模式。请从手牌 / 布局格 / 辅助区选择。"}),o.jsxs("div",{className:"damage-panel__zones",children:[D.map((P,A)=>o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:[P.label,P.sublabel&&o.jsxs("span",{className:"damage-zone__sub",children:["（",P.sublabel,"）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:P.cards.map(B=>{const V=n(B.defId),F=(V==null?void 0:V.nameCn)??B.defId,G=u.includes(B.instanceId),X=V!=null&&V.frontImageId?`/assets/${V.frontImageId}`:null;return o.jsxs("button",{className:`damage-card-btn ${G?"damage-card-btn--selected":""} ${V!=null&&V.hasBombIcon?"damage-card-btn--bomb":""}`,onClick:()=>z(B.instanceId),disabled:G,title:`${F} (${(V==null?void 0:V.actionType)??"?"})${V!=null&&V.hasBombIcon?" ⚠️ 含诱爆":""}`,...X?m(X):{},children:[o.jsx("span",{className:"damage-card-btn__name",children:F}),(V==null?void 0:V.isKaiVariant)&&o.jsx("span",{className:"damage-card-btn__det",title:"改型",children:"◆"}),(V==null?void 0:V.hasBombIcon)&&o.jsx("span",{className:"damage-card-btn__det damage-card-btn__bomb-icon",title:"诱爆卡",children:"💣"})]},B.instanceId)})})]},A)),R&&(e.source!=="ranged"||b)&&o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:["卡组",o.jsxs("span",{className:"damage-zone__sub",children:["（共 ",L.length," 张，正面朝下）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:o.jsxs("button",{className:"damage-card-btn damage-card-btn--deck",onClick:()=>z(R.instanceId),title:"从卡组顶部翻开并摧毁 1 张（诱爆正常触发）",children:[o.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),o.jsx("span",{className:"damage-card-btn__name",children:"顶部 × 1"})]})})]}),R&&e.source==="ranged"&&!b&&o.jsxs("div",{className:"damage-zone",children:[o.jsxs("span",{className:"damage-zone__label",children:["卡组",o.jsxs("span",{className:"damage-zone__sub",children:["（共 ",L.length," 张）"]})]}),o.jsx("div",{className:"damage-zone__cards",children:o.jsxs("div",{className:"damage-card-btn damage-card-btn--deck",style:{opacity:.5,cursor:"default"},title:"射击伤害的牌组部分将在选完表牌后自动从顶部破坏",children:[o.jsx("span",{className:"damage-card-btn__deck-back",children:"🂠"}),o.jsx("span",{className:"damage-card-btn__name",children:"自动破坏"})]})})]})]}),o.jsx("div",{className:"damage-panel__actions",children:o.jsx("button",{className:"action-hud__skip-btn",onClick:M,disabled:x,title:"智能选择价值最低的卡牌优先破坏，剩余部分从牌组顶部自动摧毁",children:x?"自动分配中…":"智能分配剩余伤害"})})]}),o.jsx(Kt,{zoom:f})]})}const vi=`
.action-hud {
...
`;function bv({onBack:e}){const[n,t]=k.useState("maps");return o.jsxs("div",{className:"data-page",children:[o.jsxs("div",{className:"data-page__header",children:[o.jsx("button",{className:"data-page__back",onClick:e,children:"← 返回"}),o.jsx("h1",{className:"data-page__title",children:"游戏资料"})]}),o.jsxs("div",{className:"data-page__tabs",children:[o.jsx("button",{className:`data-tab ${n==="maps"?"data-tab--active":""}`,onClick:()=>t("maps"),children:"地图"}),o.jsx("button",{className:`data-tab ${n==="units"?"data-tab--active":""}`,onClick:()=>t("units"),children:"机体"}),o.jsx("button",{className:`data-tab ${n==="cards"?"data-tab--active":""}`,onClick:()=>t("cards"),children:"卡牌"})]}),o.jsxs("div",{className:"data-page__content",children:[n==="maps"&&o.jsx(vv,{}),n==="units"&&o.jsx(Iv,{}),n==="cards"&&o.jsx(kv,{})]}),o.jsx("style",{children:Sv})]})}const Zm={plain:"#8fbc5a",sand:"#d4b483",rubble:"#9e8f7a",forest:"#2d7a2d",water:"#4477cc",highland:"#c4955a"},Ym={plain:"平地",sand:"沙地",rubble:"瓦砾",forest:"森林",water:"水域",highland:"高地"};function vv(){const[e,n]=k.useState(Ye[0].id),t=Ye.find(a=>a.id===e);return o.jsxs("div",{className:"maps-panel",children:[o.jsx("div",{className:"maps-panel__selector",children:Ye.map(a=>o.jsx("button",{className:`map-sel-btn ${a.id===e?"map-sel-btn--active":""}`,onClick:()=>n(a.id),children:a.nameCn},a.id))}),o.jsxs("div",{className:"maps-panel__body",children:[o.jsx(yv,{map:t}),o.jsx(_v,{})]})]})}function yv({map:e}){const n=new Set(e.startZones[0].map(a=>`${a.row},${a.col}`)),t=new Set(e.startZones[1].map(a=>`${a.row},${a.col}`));return o.jsxs("div",{className:"mini-map-wrapper",children:[o.jsxs("div",{className:"mini-map__title",children:[e.nameCn,"（",e.width,"×",e.height,"）"]}),o.jsx("div",{className:"mini-map__grid",style:{gridTemplateColumns:`repeat(${e.width}, 28px)`,gridTemplateRows:`repeat(${e.height}, 28px)`},children:e.cells.flatMap((a,r)=>a.map((s,i)=>{const l=`${r},${i}`,d=n.has(l),u=t.has(l),f=Zm[s.terrain]??"#888";return o.jsxs("div",{className:"mini-map__cell",style:{background:f},title:`(${i},${r}) ${Ym[s.terrain]??s.terrain}${s.terrain==="highland"?" Lv"+s.elevation:""}`,children:[d&&o.jsx("span",{className:"mini-map__marker mini-map__marker--p1",children:"①"}),u&&o.jsx("span",{className:"mini-map__marker mini-map__marker--p2",children:"②"}),s.terrain==="highland"&&o.jsx("span",{className:"mini-map__elev",children:s.elevation})]},l)}))})]})}function _v(){return o.jsxs("div",{className:"map-legend",children:[o.jsx("div",{className:"map-legend__title",children:"地形图例"}),Object.entries(Ym).map(([e,n])=>o.jsxs("div",{className:"map-legend__item",children:[o.jsx("span",{className:"map-legend__swatch",style:{background:Zm[e]}}),o.jsx("span",{children:n})]},e)),o.jsxs("div",{className:"map-legend__item",children:[o.jsx("span",{className:"map-legend__marker-demo mini-map__marker--p1",children:"①"}),o.jsx("span",{children:"玩家1出发区"})]}),o.jsxs("div",{className:"map-legend__item",children:[o.jsx("span",{className:"map-legend__marker-demo mini-map__marker--p2",children:"②"}),o.jsx("span",{children:"玩家2出发区"})]}),o.jsx("div",{className:"map-legend__note",children:"高地格显示海拔等级（1–3），移动力消耗与平地相同，提供射程视野优势。"})]})}function Iv(){return o.jsxs("div",{className:"units-panel",children:[o.jsxs("table",{className:"units-table",children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{children:"机体"}),o.jsx("th",{children:"日文名"}),o.jsx("th",{children:"型号"}),o.jsx("th",{children:"先制"}),o.jsx("th",{children:"移动"}),o.jsx("th",{children:"回避"}),o.jsx("th",{children:"突击"}),o.jsx("th",{children:"防突击"})]})}),o.jsx("tbody",{children:[...q].sort((e,n)=>e.initiative-n.initiative).map(e=>o.jsxs("tr",{children:[o.jsxs("td",{className:"units-table__name",children:[o.jsx("img",{src:`/assets/tokens/${e.tokenId}`,alt:e.nameCn,className:"units-table__token",onError:n=>{n.target.style.display="none"}}),e.nameCn]}),o.jsx("td",{className:"units-table__ja",children:e.nameJa}),o.jsx("td",{children:e.type}),o.jsx("td",{className:"units-table__num",children:e.initiative}),o.jsx("td",{className:"units-table__num",children:e.movement}),o.jsx("td",{className:"units-table__num",children:e.evasion}),o.jsx("td",{className:"units-table__num",children:e.assault}),o.jsx("td",{className:"units-table__num",children:e.assaultDef})]},e.id))})]}),o.jsxs("div",{className:"units-note",children:[o.jsx("strong",{children:"型号说明："}),"SS/S/M/L/LL = 体型；軽/中/重 = 重量等级；単座 = 单人驾驶。 先制值越小先手越快，移动值为每回合最大移动格数，回避值为被击中时消耗的伤害数量。"]})]})}const Xm={movement:"移动",ranged:"射击",melee:"近战",special:"特殊",mine:"机雷",aim:"瞄准",armor:"装甲",charge:"突击",auxiliary:"辅助"},Qm={movement:"#66ccaa",ranged:"#4499ee",melee:"#ff9944",special:"#cc88ff",mine:"#ff6688",aim:"#ffdd44",armor:"#88aacc",charge:"#ff6644",auxiliary:"#aaaacc"};function kv(){const e=Object.keys(Vt),[n,t]=k.useState(e[0]),a=Vt[n]??[];let r=n;const s=q.find(i=>n.startsWith(i.deckCode));return s&&(n.endsWith("+")?r=`${s.nameCn} (Plus)`:r=s.nameCn),o.jsxs("div",{className:"cards-panel",children:[o.jsx("div",{className:"cards-panel__unit-tabs",children:e.map(i=>{const l=q.find(f=>i.startsWith(f.deckCode));let d=i,u=null;return l&&(u=`/assets/tokens/${l.tokenId}`,d=i.endsWith("+")?`${l.nameCn}+`:l.nameCn),o.jsxs("button",{className:`unit-tab ${i===n?"unit-tab--active":""}`,onClick:()=>t(i),children:[u&&o.jsx("img",{src:u,alt:d,className:"unit-tab__token",onError:f=>{f.target.style.display="none"}}),o.jsx("span",{children:d})]},i)})}),o.jsxs("div",{className:"cards-panel__header",children:[o.jsx("span",{className:"cards-panel__unit-name",children:r}),o.jsxs("span",{className:"cards-panel__count",children:["共 ",a.length," 张卡牌"]})]}),o.jsx("div",{className:"cards-panel__summary",children:o.jsx(jv,{deck:a})}),o.jsx("div",{className:"cards-panel__list",children:a.map(i=>o.jsx(wv,{card:i},i.id))})]})}function jv({deck:e}){const n={};for(const t of e)n[t.actionType]=(n[t.actionType]??0)+1;return o.jsx("div",{className:"card-type-summary",children:Object.entries(n).sort(([t],[a])=>t.localeCompare(a)).map(([t,a])=>o.jsxs("span",{className:"card-type-badge",style:{background:Qm[t]??"#888"},children:[Xm[t]??t," ×",a]},t))})}function wv({card:e}){const n=Xm[e.actionType]??e.actionType,t=Qm[e.actionType]??"#888",{zoom:a,getZoomHandlers:r}=Ot(),s=`/assets/${e.frontImageId}`;let i="";return e.actionType==="movement"&&e.movementValue!==void 0?i=`移动 ${e.movementValue}`:(e.actionType==="ranged"||e.actionType==="melee")&&e.damage!==void 0?e.rangeMin!==void 0&&e.rangeMax!==void 0?i=`射程 ${e.rangeMin}–${e.rangeMax}  伤害 ${e.damage}`:i=`伤害 ${e.damage}`:e.actionType==="charge"&&e.damage!==void 0&&(i=`伤害 ${e.damage}`),o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"card-row",...r(s),children:[o.jsx("div",{className:"card-row__image-wrap",children:o.jsx("img",{src:s,alt:e.nameCn,className:"card-row__image",onError:l=>{l.target.style.display="none"}})}),o.jsx("span",{className:"card-row__type",style:{background:t},children:n}),o.jsx("span",{className:"card-row__name",children:e.nameCn}),e.effectText?o.jsx("span",{className:"card-row__effect",children:e.effectText}):i&&o.jsx("span",{className:"card-row__detail",children:i}),e.isKaiVariant&&o.jsx("span",{className:"card-row__kai",title:"改型标记",children:"◆"}),e.hasBombIcon&&o.jsx("span",{className:"card-row__bomb",title:"诱爆",children:"💥"})]}),o.jsx(Kt,{zoom:a})]})}const Sv=`
.data-page {
  display: flex;
  flex-direction: column;
  min-height: 100%;
...
`,Tv={slot_1:"存档位 1",slot_2:"存档位 2",slot_3:"存档位 3",slot_4:"存档位 4",slot_5:"存档位 5",auto:"自动存档"},Mv=[...Rx,"auto"];function Ev(e){const n=new Date(e),t=a=>String(a).padStart(2,"0");return`${n.getFullYear()}-${t(n.getMonth()+1)}-${t(n.getDate())} ${t(n.getHours())}:${t(n.getMinutes())}`}function pu({mode:e,onBack:n,onLoad:t,currentState:a,aiConfig:r}){const[s,i]=k.useState([]),[l,d]=k.useState(null),[u,f]=k.useState(null),[m,g]=k.useState(null),[h,x]=k.useState(null);k.useEffect(()=>{i(Ud())},[]);function p(){i(Ud())}function _(w){g(w),setTimeout(()=>g(null),2e3)}function y(w){return s.find(N=>N.slotId===w)}function b(w){if(!a||!r)return;if(y(w)){f(w);return}v(w)}function v(w){if(!(!a||!r))try{Sc(w,a,r,!1),p(),f(null),_("存档已保存")}catch(N){x(N instanceof Error?N.message:"保存失败")}}function I(w){const N=Ox(w);if(!N){x("存档数据已损坏，无法加载");return}t==null||t(N)}function S(w){Kx(w),p(),d(null),_("存档已删除")}const C=e==="save"?"保存游戏":"加载存档";return o.jsxs("div",{className:"sl-screen",children:[o.jsxs("div",{className:"sl-panel",children:[o.jsx("h2",{className:"sl-title",children:C}),o.jsx("div",{className:"sl-slots",children:Mv.map(w=>{const N=y(w),M=e==="save"&&!(w==="auto")&&a!=null;return o.jsxs("div",{className:`sl-slot ${N?"sl-slot--occupied":"sl-slot--empty"}`,children:[o.jsxs("div",{className:"sl-slot__label",children:[Tv[w],(N==null?void 0:N.isAutoSave)&&o.jsx("span",{className:"sl-badge",children:"自动"})]}),N?o.jsxs("div",{className:"sl-slot__info",children:[o.jsxs("span",{className:"sl-slot__units",children:[N.player1Unit," vs ",N.player2Unit]}),o.jsx("span",{className:"sl-slot__map",children:N.mapName}),o.jsxs("span",{className:"sl-slot__round",children:["第 ",N.roundNumber," 回合"]}),o.jsx("span",{className:"sl-slot__time",children:Ev(N.timestamp)})]}):o.jsx("div",{className:"sl-slot__info sl-slot__empty-label",children:"空存档位"}),o.jsxs("div",{className:"sl-slot__actions",children:[e==="load"&&N&&o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>I(w),children:"加载"}),M&&o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>b(w),children:N?"覆盖":"保存"}),N&&(l===w?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"sl-confirm-text",children:"确认删除？"}),o.jsx("button",{className:"sl-btn sl-btn--danger",onClick:()=>S(w),children:"确认"}),o.jsx("button",{className:"sl-btn",onClick:()=>d(null),children:"取消"})]}):o.jsx("button",{className:"sl-btn sl-btn--ghost",onClick:()=>d(w),children:"删除"}))]}),u===w&&o.jsxs("div",{className:"sl-overwrite",children:[o.jsx("span",{children:"覆盖此存档？"}),o.jsx("button",{className:"sl-btn sl-btn--primary",onClick:()=>v(w),children:"确认"}),o.jsx("button",{className:"sl-btn",onClick:()=>f(null),children:"取消"})]})]},w)})}),h&&o.jsxs("div",{className:"sl-error",onClick:()=>x(null),children:["⚠ ",h]}),o.jsx("button",{className:"sl-back-btn",onClick:n,children:"← 返回"})]}),m&&o.jsx("div",{className:"sl-toast",children:m}),o.jsx("style",{children:Dv})]})}const Dv=`
.sl-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`;function $v({currentState:e}){const{rawDispatch:n}=Ce();return k.useEffect(()=>{n({type:"LOAD_GAME",state:e})},[e,n]),o.jsx("div",{style:{height:"100%",width:"100%"},children:o.jsx(Ca,{})})}function Av({currentState:e}){return o.jsx(As,{children:o.jsx(Hm,{children:o.jsx($v,{currentState:e})})})}function zv({onBack:e}){const[n,t]=k.useState("list"),[a,r]=k.useState(null);function s(l){r(l),t("playback")}function i(){r(null),t("list")}return n==="playback"&&a?o.jsx(Lv,{replayData:a,onExit:i}):o.jsx(Pv,{onBack:e,onPlay:s})}function qm(e){const n=Yx(e.initialState,e.actions),t=new Blob([n],{type:"text/plain;charset=utf-8"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a;const s=new Date(e.metadata.timestamp),i=d=>String(d).padStart(2,"0"),l=`replay_${e.metadata.player1Unit}_vs_${e.metadata.player2Unit}_${s.getFullYear()}${i(s.getMonth()+1)}${i(s.getDate())}_${i(s.getHours())}${i(s.getMinutes())}.txt`;r.download=l,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(a)}function Pv({onBack:e,onPlay:n}){const[t,a]=k.useState([]),[r,s]=k.useState(null),[i,l]=k.useState(null);k.useEffect(()=>{a(Wd())},[]);function d(m){const g=Zd(m);if(!g){l("录像数据已损坏，无法播放");return}n(g)}function u(m){const g=Zd(m);if(!g){l("录像数据已损坏，无法导出");return}qm(g)}function f(m){Fx(m),a(Wd()),s(null)}return o.jsxs("div",{className:"rp-screen",children:[o.jsxs("div",{className:"rp-panel",children:[o.jsx("h2",{className:"rp-title",children:"回放录像"}),t.length===0?o.jsx("div",{className:"rp-empty",children:"暂无保存的录像"}):o.jsx("div",{className:"rp-list",children:t.map(m=>o.jsxs("div",{className:"rp-item",children:[o.jsxs("div",{className:"rp-item__info",children:[o.jsxs("span",{className:"rp-item__units",children:[m.player1Unit," vs ",m.player2Unit]}),o.jsx("span",{className:"rp-item__map",children:m.mapName}),o.jsxs("span",{className:"rp-item__rounds",children:[m.totalRounds," 回合"]}),m.winner&&o.jsx("span",{className:"rp-item__winner",children:m.winner==="draw"?"平局":`${m.winner==="player1"?"P1":"P2"} 获胜`}),o.jsx("span",{className:"rp-item__time",children:Ov(m.timestamp)})]}),o.jsxs("div",{className:"rp-item__actions",children:[o.jsx("button",{className:"rp-btn rp-btn--primary",onClick:()=>d(m.replayId),children:"▶ 播放"}),o.jsx("button",{className:"rp-btn",onClick:()=>u(m.replayId),children:"导出日志"}),r===m.replayId?o.jsxs(o.Fragment,{children:[o.jsx("span",{className:"rp-confirm",children:"确认删除？"}),o.jsx("button",{className:"rp-btn rp-btn--danger",onClick:()=>f(m.replayId),children:"确认"}),o.jsx("button",{className:"rp-btn",onClick:()=>s(null),children:"取消"})]}):o.jsx("button",{className:"rp-btn rp-btn--ghost",onClick:()=>s(m.replayId),children:"删除"})]})]},m.replayId))}),i&&o.jsxs("div",{className:"rp-error",onClick:()=>l(null),children:["⚠ ",i]}),o.jsx("button",{className:"rp-back-btn",onClick:e,children:"← 返回"})]}),o.jsx("style",{children:ef})]})}function Vv(e){const n=[0];let t=e.initialState;for(let a=0;a<e.actions.length;a++){const r=t.phase,s=t.roundNumber,i=t.plottingStep,l=t.currentTiming;t=gn(t,e.actions[a]),(t.phase!==r||t.roundNumber!==s||t.plottingStep!==i||t.currentTiming!==l)&&n.push(a+1)}return n[n.length-1]!==e.actions.length&&n.push(e.actions.length),n}function mu(e,n){let t=e.initialState;for(let a=0;a<n&&a<e.actions.length;a++)t=gn(t,e.actions[a]);return t}function Rv(e,n){const t=s=>{const i=n.players[s],l=q.find(d=>d.id===i.unitId);return(l==null?void 0:l.nameCn)??s},a=s=>{const i=te(s);return(i==null?void 0:i.nameCn)??s},r=(s,i)=>{const l=n.players[i],u=[...l.deck,...l.hand,...l.auxiliary,...l.discard,...l.destroyedCards,...l.plotSeg1?[l.plotSeg1]:[],...l.plotSeg2?[l.plotSeg2]:[]].find(f=>f.instanceId===s);return u?a(u.defId):s};switch(e.type){case"DRAW_CARDS":return`${t(e.playerId)} 抽取 ${e.count} 张牌`;case"PLOT_CARD":{const s=r(e.instanceId,e.playerId);return`${t(e.playerId)} 布局段落${e.seg}：${s}`}case"CONFIRM_PLOT":return`${t(e.playerId)} 确认布局`;case"ADVANCE_PLOT_STEP":return"布局阶段推进";case"MOVE_UNIT":return`${t(e.playerId)} 移动至 (${e.to.row},${e.to.col})${e.finalFacing?`，面向 ${e.finalFacing}`:""}`;case"ADJUST_FACING":return`${t(e.playerId)} 调整朝向 → ${e.facing}`;case"RESOLVE_RANGED":return`${t(e.attackerId)} 对 ${t(e.targetId)} 发动射击`;case"RESOLVE_MELEE":return`${t(e.attackerId)} 对 ${t(e.targetId)} 发动近战`;case"RESOLVE_CHARGE":return`${t(e.attackerId)} 对 ${t(e.targetId)} 发动突击`;case"PLACE_MINE":{const s=e.placements??(e.to?[{position:e.to,kind:"real"}]:[]);return`${t(e.playerId)} 布置隐藏指示物：${s.map(i=>`(${i.position.row},${i.position.col})`).join("、")}`}case"SELECT_DAMAGE_CARD":{const s=r(e.instanceId,e.playerId);return`${t(e.playerId)} 选择摧毁：${s}`}case"CONFIRM_DAMAGE_SELECTION":return`${t(e.playerId)} 确认伤害结算`;case"SKIP_ACTION":return"跳过行动";case"ADVANCE_TIMING":return"推进时序";case"ADVANCE_PHASE":return"推进阶段";case"MELEE_SENSOR_MOVE":return`${t(e.playerId)} 近战传感器移动至 (${e.to.row},${e.to.col})`;case"START_PLOTTING":return"进入布局阶段";default:return e.type}}function fu({player:e,label:n}){const t=q.find(l=>l.id===e.unitId),{zoom:a,getZoomHandlers:r}=Ot(),s=l=>l.filter(d=>!d.destroyed),i={N:"↑北",S:"↓南",E:"→东",W:"←西"}[e.facing]??e.facing;return o.jsxs("div",{className:"rpp",children:[o.jsxs("div",{className:"rpp__header",children:[t&&o.jsx("img",{src:`/assets/tokens/${t.tokenId}`,alt:t.nameCn,className:"rpp__token",onError:l=>{l.target.style.opacity="0.3"}}),o.jsxs("div",{children:[o.jsxs("div",{className:"rpp__name",children:[n,": ",(t==null?void 0:t.nameCn)??e.unitId]}),o.jsxs("div",{className:"rpp__pos",children:["(",e.position.row,",",e.position.col,") ",i]})]})]}),o.jsxs("div",{className:"rpp__counts",children:[o.jsxs("span",{className:"rpp__count",title:"牌库",children:["📚",s(e.deck).length]}),o.jsxs("span",{className:"rpp__count",title:"手牌",children:["🃏",e.hand.length]}),o.jsxs("span",{className:"rpp__count",title:"弃牌",children:["♻️",e.discard.length]}),o.jsxs("span",{className:"rpp__count",title:"破坏",children:["💀",e.destroyedCards.length]})]}),o.jsx("div",{className:"rpp__section-label",children:"布局"}),o.jsxs("div",{className:"rpp__plot-row",children:[o.jsx(gu,{label:"阶段1",card:e.plotSeg1,getZoomHandlers:r}),o.jsx(gu,{label:"阶段2",card:e.plotSeg2,getZoomHandlers:r})]}),o.jsxs("div",{className:"rpp__section-label",children:["手牌 (",e.hand.length,")"]}),o.jsx("div",{className:"rpp__card-list",children:e.hand.length===0?o.jsx("span",{className:"rpp__empty",children:"—"}):e.hand.map(l=>o.jsx(hu,{card:l,getZoomHandlers:r},l.instanceId))}),e.auxiliary.length>0&&o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"rpp__section-label",children:["辅助 (",s(e.auxiliary).length,"/",e.auxiliary.length,")"]}),o.jsx("div",{className:"rpp__card-list",children:e.auxiliary.map(l=>o.jsx(hu,{card:l,getZoomHandlers:r},l.instanceId))})]}),o.jsx(Kt,{zoom:a})]})}function gu({label:e,card:n,getZoomHandlers:t}){const a=n?te(n.defId):null,r=a!=null&&a.frontImageId?`/assets/${a.frontImageId}`:null,i=a?{movement:"#66ccaa",ranged:"#ff9944",melee:"#ff6060",charge:"#ff4444",aim:"#f0c040",armor:"#88aaff",mine:"#cc88ff",special:"#aaa",auxiliary:"#77ddaa"}[a.actionType]??"#888":"#555";return o.jsxs("div",{className:"rpp__plot-slot",children:[o.jsx("div",{className:"rpp__plot-label",children:e}),n&&a?o.jsxs("div",{className:"rpp__plot-card",style:{borderColor:i},...r?t(r):{},children:[o.jsx("span",{className:"rpp__plot-type",style:{color:i},children:a.actionType}),o.jsx("span",{className:"rpp__plot-name",children:a.nameCn})]}):o.jsx("div",{className:"rpp__plot-empty",children:"—"})]})}function hu({card:e,getZoomHandlers:n}){const t=te(e.defId),a=t!=null&&t.frontImageId?`/assets/${t.frontImageId}`:null,s=t?{movement:"#66ccaa",ranged:"#ff9944",melee:"#ff6060",charge:"#ff4444",aim:"#f0c040",armor:"#88aaff",mine:"#cc88ff",special:"#aaa",auxiliary:"#77ddaa"}[t.actionType]??"#888":"#555";return o.jsxs("span",{className:`rpp__chip${e.destroyed?" rpp__chip--dead":""}`,style:{borderColor:s},...a?n(a):{},children:[(t==null?void 0:t.nameCn)??e.defId,e.destroyed&&o.jsx("span",{className:"rpp__chip-x",children:"✕"})]})}function Lv({replayData:e,onExit:n}){const t=k.useMemo(()=>Vv(e),[e]),a=e.actions.length,[r,s]=k.useState(0),[i,l]=k.useState(e.initialState),[d,u]=k.useState(!1),[f,m]=k.useState(1),[g,h]=k.useState(""),[x,p]=k.useState(e.initialState.log.length),_=k.useRef(null),y=k.useRef(i),b=k.useRef(r);y.current=i,b.current=r;const v=k.useRef(null);k.useEffect(()=>{var R;(R=v.current)==null||R.scrollIntoView({behavior:"smooth"})},[i.log.length]);const I=k.useCallback(()=>{_.current!=null&&(clearInterval(_.current),_.current=null)},[]),S=k.useCallback(()=>{const R=b.current;if(R>=a)return I(),u(!1),!1;const P=e.actions[R],A=gn(y.current,P);return p(y.current.log.length),l(A),s(R+1),!0},[e,a,I]),C=k.useCallback(()=>{const R=b.current;if(R>=a)return;const A=t.find(F=>F>R)??a;let B=y.current;const V=B.log.length;for(let F=R;F<A;F++)B=gn(B,e.actions[F]);p(V),l(B),s(A),A>=a&&(I(),u(!1))},[e,a,t,I]),w=k.useCallback(()=>{const R=b.current,P=t.filter(V=>V<R),A=P.length>=2?P[P.length-2]:0,B=mu(e,A);p(0),l(B),s(A)},[e,t]);k.useEffect(()=>(I(),d&&(_.current=setInterval(()=>{if(b.current>=a){I(),u(!1);return}C()},Math.round(1500/f))),I),[d,f,C,a,I]);function N(){u(R=>!R)}function z(){u(!1),p(0),l(e.initialState),s(0)}function M(){const R=parseInt(g,10);if(isNaN(R)||R<1)return;u(!1);const{state:P,actionIndex:A}=Hx(e,R);p(0),l(P),s(A)}const J=r>0?e.actions[r-1]:null,E=J?Rv(J,r>=2?mu(e,r-1):e.initialState):null,K=r>=a,$=r===0,L={pregame:"战前准备",draw:"抽牌阶段",plotting:"布局阶段",action_seg1:"行动阶段1",action_seg2:"行动阶段2",cleanup:"清理阶段",game_over:"游戏结束"},D={movement:"移动",ranged:"射击",melee:"近战",special:"特殊"};return o.jsxs("div",{className:"rpv-screen",children:[o.jsxs("div",{className:"rpv-topbar",children:[o.jsxs("span",{className:"rpv-topbar__round",children:["第 ",i.roundNumber," 回合"]}),o.jsx("span",{className:"rpv-topbar__phase",children:L[i.phase]??i.phase}),i.currentTiming&&o.jsxs("span",{className:"rpv-topbar__timing",children:["▶ ",D[i.currentTiming]]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:"rpv-btn",onClick:z,disabled:$,title:"回到开始",children:"⏮"}),o.jsx("button",{className:"rpv-btn",onClick:w,disabled:$,title:"上一阶段",children:"◀◀"}),o.jsx("button",{className:"rpv-btn",onClick:()=>{u(!1),S()},disabled:K,title:"单步前进（单个操作）",children:"▶|"}),o.jsx("button",{className:"rpv-btn",onClick:()=>{u(!1),C()},disabled:K,title:"下一阶段",children:"▶▶"}),o.jsx("button",{className:"rpv-btn rpv-btn--primary",onClick:N,children:d?"⏸ 暂停":"▶ 自动"}),o.jsx("span",{className:"rpv-sep"}),o.jsx("span",{className:"rpv-label",children:"速度"}),[1,2,4].map(R=>o.jsxs("button",{className:`rpv-btn rpv-btn--speed ${f===R?"rpv-btn--active":""}`,onClick:()=>m(R),children:[R,"x"]},R)),o.jsx("span",{className:"rpv-sep"}),o.jsx("span",{className:"rpv-label",children:"跳至"}),o.jsx("input",{className:"rpv-input",type:"number",min:1,value:g,onChange:R=>h(R.target.value),onKeyDown:R=>R.key==="Enter"&&M(),placeholder:"回合"}),o.jsx("button",{className:"rpv-btn",onClick:M,children:"跳转"}),o.jsx("span",{className:"rpv-sep"}),o.jsxs("span",{className:"rpv-progress",children:[r,"/",a]}),o.jsx("button",{className:"rpv-btn",onClick:()=>qm(e),title:"导出完整分析日志",children:"导出日志"}),o.jsx("button",{className:"rpv-btn rpv-btn--exit",onClick:n,children:"✕ 退出"})]}),o.jsxs("div",{className:"rpv-main",children:[o.jsxs("div",{className:"rpv-map-col",children:[o.jsx("div",{className:"rpv-map-area",children:o.jsx(Av,{currentState:i})}),E&&o.jsxs("div",{className:"rpv-action-desc",children:["▶ ",E]}),o.jsxs("div",{className:"rpv-log",children:[o.jsx("div",{className:"rpv-log__header",children:"行动日志"}),o.jsxs("div",{className:"rpv-log__entries",children:[i.log.filter(R=>!R.startsWith("[DBG]")).map((R,P)=>{const A=P>=x;return o.jsx("div",{className:`rpv-log__entry ${Kv(R)}${A?" rpv-log__entry--new":""}`,children:R},P)}),o.jsx("div",{ref:v})]})]})]}),o.jsxs("div",{className:"rpv-info-col",children:[o.jsx(fu,{player:i.players.player1,label:"P1"}),o.jsx("div",{className:"rpv-info-divider"}),o.jsx(fu,{player:i.players.player2,label:"P2"})]})]}),o.jsx("style",{children:ef}),o.jsx("style",{children:Jv})]})}function Ov(e){const n=new Date(e),t=a=>String(a).padStart(2,"0");return`${n.getFullYear()}-${t(n.getMonth()+1)}-${t(n.getDate())} ${t(n.getHours())}:${t(n.getMinutes())}`}function Kv(e){return e.startsWith("===")?"rpv-log__entry--round":e.startsWith("---")?"rpv-log__entry--sep":e.includes("发动")||e.includes("攻击")?"rpv-log__entry--attack":e.includes("摧毁")||e.includes("连锁")||e.includes("诱爆")?"rpv-log__entry--damage":e.includes("移动到")?"rpv-log__entry--move":e.includes("获胜")||e.includes("击破")||e.includes("平局")?"rpv-log__entry--victory":""}const ef=`
.rp-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Bv=50;function nf(){return{terrain:"plain",elevation:0,variant:0}}function tf(e,n){const t=Array.from({length:n},()=>Array.from({length:e},()=>nf()));return{id:`custom_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,nameJa:"新しいマップ",nameCn:"新地图",width:e,height:n,cells:t,startZones:{0:[{row:0,col:Math.floor(e/2)}],1:[{row:n-1,col:Math.floor(e/2)}]},maxPlayers:2,maxTeams:2}}function Il(e){return{map:e??tf(7,11),activeTool:"terrain",selectedTerrain:"plain",selectedElevation:1,selectedVariant:0,selectedZoneTeam:0,brushSize:1,isDirty:!1,undoStack:[],redoStack:[],showCoords:!1}}function So(e){return{...e,cells:e.cells.map(n=>n.map(t=>({...t}))),startZones:Object.fromEntries(Object.entries(e.startZones).map(([n,t])=>[n,t.map(a=>({...a}))]))}}function yt(e){const n=[...e.undoStack,So(e.map)];return n.length>Bv&&n.shift(),{...e,undoStack:n,redoStack:[],isDirty:!0}}function xu(e,n,t,a,r,s){if(n<0||n>=e.height||t<0||t>=e.width)return e;const i=e.cells.map((l,d)=>d===n?l.map((u,f)=>f===t?{terrain:a,elevation:a==="highland"?r:0,variant:a==="highland"?r:s}:u):l);return{...e,cells:i}}function Fv(e,n){switch(n.type){case"SET_TOOL":return{...e,activeTool:n.tool};case"SET_TERRAIN":return{...e,selectedTerrain:n.terrain,activeTool:"terrain"};case"SET_ELEVATION":return{...e,selectedElevation:n.elevation};case"SET_VARIANT":return{...e,selectedVariant:n.variant};case"SET_BRUSH_SIZE":return{...e,brushSize:n.size};case"SET_ZONE_TEAM":return{...e,selectedZoneTeam:n.team};case"TOGGLE_COORDS":return{...e,showCoords:!e.showCoords};case"PAINT_CELL":{const t=yt(e),a=xu(t.map,n.row,n.col,t.selectedTerrain,t.selectedElevation,t.selectedVariant);return{...t,map:a}}case"PAINT_AREA":{const t=yt(e);let a=t.map;for(const{row:r,col:s}of n.cells)a=xu(a,r,s,t.selectedTerrain,t.selectedElevation,t.selectedVariant);return{...t,map:a}}case"ADD_ZONE_CELL":{const t=yt(e),{team:a,position:r}=n,s=t.map.startZones[a]??[];if(s.some(l=>l.row===r.row&&l.col===r.col))return e;const i={...t.map.startZones,[a]:[...s,r]};return{...t,map:{...t.map,startZones:i}}}case"REMOVE_ZONE_CELL":{const t=yt(e),{team:a,position:r}=n,i=(t.map.startZones[a]??[]).filter(d=>d.row!==r.row||d.col!==r.col),l={...t.map.startZones,[a]:i};return{...t,map:{...t.map,startZones:l}}}case"CLEAR_ZONE":{const t=yt(e),a={...t.map.startZones,[n.team]:[]};return{...t,map:{...t.map,startZones:a}}}case"SET_MAP_META":{const t=yt(e),a={...t.map};return n.nameJa!==void 0&&(a.nameJa=n.nameJa),n.nameCn!==void 0&&(a.nameCn=n.nameCn),n.maxPlayers!==void 0&&(a.maxPlayers=n.maxPlayers),n.maxTeams!==void 0&&(a.maxTeams=n.maxTeams),{...t,map:a}}case"RESIZE_MAP":{const t=yt(e),{newWidth:a,newHeight:r}=n,s=Array.from({length:r},(l,d)=>Array.from({length:a},(u,f)=>d<t.map.height&&f<t.map.width?{...t.map.cells[d][f]}:nf())),i={};for(const[l,d]of Object.entries(t.map.startZones))i[Number(l)]=d.filter(u=>u.row<r&&u.col<a);return{...t,map:{...t.map,width:a,height:r,cells:s,startZones:i}}}case"UNDO":{if(e.undoStack.length===0)return e;const t=e.undoStack[e.undoStack.length-1];return{...e,map:t,undoStack:e.undoStack.slice(0,-1),redoStack:[...e.redoStack,So(e.map)],isDirty:!0}}case"REDO":{if(e.redoStack.length===0)return e;const t=e.redoStack[e.redoStack.length-1];return{...e,map:t,redoStack:e.redoStack.slice(0,-1),undoStack:[...e.undoStack,So(e.map)],isDirty:!0}}case"LOAD_MAP":return{...Il(So(n.map)),isDirty:!1};case"NEW_MAP":return Il(tf(n.width,n.height));case"MARK_SAVED":return{...e,isDirty:!1};default:return e}}const Nc="em_custom_maps_index",Tc="em_custom_map_",Gv=["plain","sand","rubble","forest","water","highland"];function Mc(){try{const e=localStorage.getItem(Nc);return e?JSON.parse(e):[]}catch{return[]}}function Hv(e){const n={id:e.id,nameCn:e.nameCn,nameJa:e.nameJa,width:e.width,height:e.height,maxPlayers:e.maxPlayers,maxTeams:e.maxTeams,savedAt:Date.now()},t=Mc().filter(a=>a.id!==e.id);t.push(n),localStorage.setItem(Nc,JSON.stringify(t)),localStorage.setItem(Tc+e.id,JSON.stringify(e))}function Uv(e){try{const n=localStorage.getItem(Tc+e);if(!n)return null;const t=JSON.parse(n);return af(t)?t:null}catch{return null}}function Wv(e){const n=Mc().filter(t=>t.id!==e);localStorage.setItem(Nc,JSON.stringify(n)),localStorage.removeItem(Tc+e)}function Zv(e){return JSON.stringify(e,null,2)}function Yv(e){try{const n=JSON.parse(e);return af(n)?(n.id=`custom_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,n):null}catch{return null}}function Xv(e){const n=Zv(e),t=new Blob([n],{type:"application/json"}),a=URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=`${e.nameCn||e.id}.json`,r.click(),URL.revokeObjectURL(a)}function af(e){if(!e||typeof e!="object")return!1;const n=e;if(typeof n.id!="string"||(typeof n.nameCn!="string"&&(n.nameCn="未命名"),typeof n.nameJa!="string"&&(n.nameJa=""),typeof n.width!="number"||n.width<3||n.width>25)||typeof n.height!="number"||n.height<3||n.height>25||(typeof n.maxPlayers!="number"&&(n.maxPlayers=2),typeof n.maxTeams!="number"&&(n.maxTeams=2),!Array.isArray(n.cells))||n.cells.length!==n.height)return!1;for(const t of n.cells){if(!Array.isArray(t)||t.length!==n.width)return!1;for(const a of t)if(!a||typeof a!="object"||!Gv.includes(a.terrain))return!1}return(!n.startZones||typeof n.startZones!="object")&&(n.startZones={}),!0}const rf=k.createContext(null);function Da(){const e=k.useContext(rf);if(!e)throw new Error("useEditor must be inside EditorCtx.Provider");return e}const lo=48,bu=.2,Qv=3,vu=.1,kl=[{terrain:"plain",label:"平原",icon:"🟩"},{terrain:"sand",label:"砂地",icon:"🟨"},{terrain:"rubble",label:"瓦砾",icon:"🟫"},{terrain:"forest",label:"森林",icon:"🌲"},{terrain:"water",label:"水域",icon:"🟦"},{terrain:"highland",label:"高地",icon:"⛰️"}],ps=["#00f0ff","#ff00c8","#00cc88","#ff8800","#6688ff","#cc44ff","#44dddd","#ff4466"];function qv({onBack:e}){const[n,t]=k.useReducer(Fv,void 0,()=>Il()),a=k.useMemo(()=>({state:n,dispatch:t}),[n]);k.useEffect(()=>{function i(l){if((l.ctrlKey||l.metaKey)&&(l.key==="z"&&!l.shiftKey&&(l.preventDefault(),t({type:"UNDO"})),l.key==="z"&&l.shiftKey&&(l.preventDefault(),t({type:"REDO"})),l.key==="y"&&(l.preventDefault(),t({type:"REDO"})),l.key==="s"&&(l.preventDefault(),r())),!l.ctrlKey&&!l.metaKey&&!l.altKey){const d=parseInt(l.key)-1;d>=0&&d<kl.length&&t({type:"SET_TERRAIN",terrain:kl[d].terrain})}}return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[]);function r(){Hv(n.map),t({type:"MARK_SAVED"})}function s(){n.isDirty&&!window.confirm("有未保存的更改，确定要退出吗？")||e()}return o.jsx(rf.Provider,{value:a,children:o.jsxs("div",{className:"me__screen",children:[o.jsx(e1,{onBack:s,onSave:r}),o.jsx(t1,{}),o.jsx(we,{id:"me-terrain",title:"地形画笔",initialPos:{x:8,y:56},width:200,minHeight:60,zIndex:20,children:o.jsx(a1,{})}),o.jsx(we,{id:"me-props",title:"地图属性",initialPos:{x:8,y:380},width:200,minHeight:60,zIndex:19,children:o.jsx(r1,{})}),o.jsx(we,{id:"me-zones",title:"出击区域",initialPos:{x:8,y:600},width:200,minHeight:60,zIndex:18,children:o.jsx(o1,{})}),o.jsx("style",{children:s1})]})})}function e1({onBack:e,onSave:n}){const{state:t,dispatch:a}=Da(),[r,s]=k.useState(!1),i=k.useRef(null);function l(){t.isDirty&&!window.confirm("有未保存的更改，确定要新建吗？")||a({type:"NEW_MAP",width:7,height:11})}function d(){Xv(t.map)}function u(){var m;(m=i.current)==null||m.click()}function f(m){var x;const g=(x=m.target.files)==null?void 0:x[0];if(!g)return;const h=new FileReader;h.onload=()=>{const p=Yv(h.result);p?a({type:"LOAD_MAP",map:p}):alert("无效的地图文件")},h.readAsText(g),m.target.value=""}return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"me__topbar",children:[o.jsx("button",{className:"me__btn",onClick:e,children:"← 返回"}),o.jsx("span",{className:"me__title",children:"地图编辑器"}),o.jsxs("span",{className:"me__map-name",children:[t.map.nameCn," (",t.map.height,"×",t.map.width,")",t.isDirty&&" *"]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:"me__btn",onClick:l,children:"新建"}),o.jsx("button",{className:"me__btn",onClick:()=>s(!0),children:"打开"}),o.jsx("button",{className:"me__btn me__btn--accent",onClick:n,children:"保存"}),o.jsx("button",{className:"me__btn",onClick:d,children:"导出"}),o.jsx("button",{className:"me__btn",onClick:u,children:"导入"}),o.jsx("input",{ref:i,type:"file",accept:".json",style:{display:"none"},onChange:f}),o.jsx("span",{className:"me__sep"}),o.jsx("button",{className:"me__btn",onClick:()=>a({type:"UNDO"}),disabled:t.undoStack.length===0,children:"撤销"}),o.jsx("button",{className:"me__btn",onClick:()=>a({type:"REDO"}),disabled:t.redoStack.length===0,children:"重做"}),o.jsx("button",{className:`me__btn${t.showCoords?" me__btn--active":""}`,onClick:()=>a({type:"TOGGLE_COORDS"}),children:"坐标"})]}),r&&o.jsx(n1,{onClose:()=>s(!1)})]})}function n1({onClose:e}){const{dispatch:n,state:t}=Da(),[a]=k.useState(()=>Mc());function r(l){if(t.isDirty&&!window.confirm("有未保存的更改，确定要打开吗？"))return;const d=Uv(l);d&&(n({type:"LOAD_MAP",map:d}),e())}function s(l){if(t.isDirty&&!window.confirm("有未保存的更改，确定要打开吗？"))return;const d={...l,id:`custom_${Date.now()}_${Math.random().toString(36).slice(2,6)}`,cells:l.cells.map(u=>u.map(f=>({...f}))),startZones:Object.fromEntries(Object.entries(l.startZones).map(([u,f])=>[u,f.map(m=>({...m}))]))};n({type:"LOAD_MAP",map:d}),e()}function i(l){window.confirm("确定删除此地图？")&&(Wv(l),e())}return o.jsx("div",{className:"me__overlay",onClick:e,children:o.jsxs("div",{className:"me__dialog",onClick:l=>l.stopPropagation(),children:[o.jsx("h3",{children:"打开地图"}),a.length>0&&o.jsxs(o.Fragment,{children:[o.jsx("h4",{children:"自定义地图"}),o.jsx("div",{className:"me__dialog-list",children:a.map(l=>o.jsxs("div",{className:"me__dialog-item",children:[o.jsxs("span",{children:[l.nameCn," (",l.height,"×",l.width,")"]}),o.jsx("span",{className:"me__dialog-date",children:new Date(l.savedAt).toLocaleDateString()}),o.jsx("button",{className:"me__btn me__btn--sm",onClick:()=>r(l.id),children:"打开"}),o.jsx("button",{className:"me__btn me__btn--sm me__btn--danger",onClick:()=>i(l.id),children:"删除"})]},l.id))})]}),o.jsx("h4",{children:"内置地图 (作为模板)"}),o.jsx("div",{className:"me__dialog-list",children:Ye.map(l=>o.jsxs("div",{className:"me__dialog-item",children:[o.jsxs("span",{children:[l.nameCn," (",l.height,"×",l.width,")"]}),o.jsx("button",{className:"me__btn me__btn--sm",onClick:()=>s(l),children:"复制"})]},l.id))}),o.jsx("div",{className:"me__dialog-actions",children:o.jsx("button",{className:"me__btn",onClick:e,children:"取消"})})]})})}function t1(){const{state:e,dispatch:n}=Da(),t=k.useRef(null),[a,r]=k.useState({x:0,y:0,scale:1}),s=k.useRef(null),i=k.useRef(!1),l=k.useRef(!1),d=k.useRef(new Set),{map:u,activeTool:f,showCoords:m,selectedZoneTeam:g,brushSize:h}=e,{width:x,height:p}=u;k.useEffect(()=>{const N=t.current;if(!N)return;const z=N.clientWidth,M=N.clientHeight,J=x*lo,E=p*lo;if(!z||!M)return;const K=Math.max(bu,Math.min(1.5,Math.min(z/J,M/E)));r({x:(z-J*K)/2,y:(M-E*K)/2,scale:K})},[x,p]),k.useEffect(()=>{const N=t.current;if(!N)return;const z=M=>{M.preventDefault();const J=M.deltaY<0?vu:-vu;r(E=>({...E,scale:Math.min(Qv,Math.max(bu,E.scale+J))}))};return N.addEventListener("wheel",z,{passive:!1}),()=>N.removeEventListener("wheel",z)},[]);const _=k.useCallback(N=>{N.button!==2&&(s.current={startX:N.clientX,startY:N.clientY,origX:a.x,origY:a.y},i.current=!1,l.current=!1,d.current.clear())},[a.x,a.y]),y=k.useCallback(N=>{if(!s.current)return;const z=N.clientX-s.current.startX,M=N.clientY-s.current.startY;!i.current&&Math.sqrt(z*z+M*M)>5&&(N.buttons===4||N.buttons===2?i.current=!0:f==="terrain"||f==="startZone"||f==="eraseZone"?l.current=!0:i.current=!0),i.current&&r(J=>({...J,x:s.current.origX+z,y:s.current.origY+M}))},[f]),b=k.useCallback(()=>{s.current=null,i.current=!1,l.current=!1,d.current.clear()},[]),v=k.useMemo(()=>{const N=new Map;for(const[z,M]of Object.entries(u.startZones)){const J=Number(z);for(const E of M)N.set(`${E.row},${E.col}`,J)}return N},[u.startZones]);function I(N,z){const M=`${N},${z}`;if(f==="terrain")if(h===1)d.current.has(M)||(d.current.add(M),n({type:"PAINT_CELL",row:N,col:z}));else{const J=[],E=Math.floor(h/2);for(let K=-E;K<=E;K++)for(let $=-E;$<=E;$++){const L=N+K,D=z+$;if(L>=0&&L<p&&D>=0&&D<x){const R=`${L},${D}`;d.current.has(R)||(d.current.add(R),J.push({row:L,col:D}))}}J.length&&n({type:"PAINT_AREA",cells:J})}else if(f==="startZone")n({type:"ADD_ZONE_CELL",team:g,position:{row:N,col:z}});else if(f==="eraseZone"){const J=v.get(M);J!==void 0&&n({type:"REMOVE_ZONE_CELL",team:J,position:{row:N,col:z}})}}const{x:S,y:C,scale:w}=a;return o.jsx("div",{className:"me__viewport",ref:t,onMouseDown:_,onMouseMove:y,onMouseUp:b,onMouseLeave:b,onContextMenu:N=>N.preventDefault(),children:o.jsx("div",{className:"me__grid",style:{transform:`translate(${S}px, ${C}px) scale(${w})`,transformOrigin:"top left",display:"grid",gridTemplateColumns:`repeat(${x}, ${lo}px)`,gridTemplateRows:`repeat(${p}, ${lo}px)`},children:u.cells.flatMap((N,z)=>N.map((M,J)=>{const E=bc(M),K=`${z},${J}`,$=v.get(K),L=$!==void 0?ps[$%ps.length]:"";return o.jsxs("div",{className:`me__cell${$!==void 0?" me__cell--zone":""}`,style:{backgroundImage:`url("${E}")`,backgroundSize:"cover",...$!==void 0?{borderColor:L,boxShadow:`inset 0 0 8px ${L}66`}:{}},onMouseDown:D=>{D.button===0&&!i.current&&I(z,J)},onMouseEnter:()=>{l.current&&I(z,J)},children:[M.terrain==="highland"&&o.jsxs("span",{className:"me__cell-elev",children:["+",M.elevation]}),m&&o.jsxs("span",{className:"me__cell-coord",children:[z,",",J]}),$!==void 0&&o.jsxs("span",{className:"me__cell-zone",style:{color:L},children:["Z",$]})]},K)}))})})}function a1(){const{state:e,dispatch:n}=Da();return o.jsxs("div",{className:"me__palette",children:[o.jsx("div",{className:"me__palette-grid",children:kl.map(({terrain:t,label:a,icon:r},s)=>o.jsxs("button",{className:`me__palette-btn${e.selectedTerrain===t&&e.activeTool==="terrain"?" me__palette-btn--active":""}`,onClick:()=>n({type:"SET_TERRAIN",terrain:t}),title:`${a} (${s+1})`,children:[r," ",a]},t))}),e.selectedTerrain==="highland"&&o.jsxs("div",{className:"me__sub-option",children:[o.jsx("label",{children:"高度:"}),[1,2,3].map(t=>o.jsxs("button",{className:`me__mini-btn${e.selectedElevation===t?" me__mini-btn--active":""}`,onClick:()=>n({type:"SET_ELEVATION",elevation:t}),children:["+",t]},t))]}),e.selectedTerrain!=="highland"&&e.selectedTerrain!=="plain"&&o.jsxs("div",{className:"me__sub-option",children:[o.jsx("label",{children:"变体:"}),[0,1,2,3].map(t=>o.jsx("button",{className:`me__mini-btn${e.selectedVariant===t?" me__mini-btn--active":""}`,onClick:()=>n({type:"SET_VARIANT",variant:t}),children:t},t))]}),o.jsxs("div",{className:"me__sub-option",children:[o.jsx("label",{children:"笔刷:"}),[1,2,3].map(t=>o.jsxs("button",{className:`me__mini-btn${e.brushSize===t?" me__mini-btn--active":""}`,onClick:()=>n({type:"SET_BRUSH_SIZE",size:t}),children:[t,"×",t]},t))]})]})}function r1(){const{state:e,dispatch:n}=Da(),{map:t}=e;return o.jsxs("div",{className:"me__props",children:[o.jsxs("label",{className:"me__prop-row",children:[o.jsx("span",{children:"名称(中)"}),o.jsx("input",{type:"text",value:t.nameCn,onChange:a=>n({type:"SET_MAP_META",nameCn:a.target.value})})]}),o.jsxs("label",{className:"me__prop-row",children:[o.jsx("span",{children:"名称(日)"}),o.jsx("input",{type:"text",value:t.nameJa,onChange:a=>n({type:"SET_MAP_META",nameJa:a.target.value})})]}),o.jsxs("div",{className:"me__prop-row",children:[o.jsx("span",{children:"尺寸"}),o.jsx("input",{type:"number",min:3,max:25,value:t.width,onChange:a=>n({type:"RESIZE_MAP",newWidth:Number(a.target.value),newHeight:t.height}),style:{width:50}}),"×",o.jsx("input",{type:"number",min:3,max:25,value:t.height,onChange:a=>n({type:"RESIZE_MAP",newWidth:t.width,newHeight:Number(a.target.value)}),style:{width:50}})]}),o.jsxs("label",{className:"me__prop-row",children:[o.jsx("span",{children:"最大玩家"}),o.jsx("select",{value:t.maxPlayers,onChange:a=>n({type:"SET_MAP_META",maxPlayers:Number(a.target.value)}),children:[2,3,4,6,8].map(a=>o.jsx("option",{value:a,children:a},a))})]}),o.jsxs("label",{className:"me__prop-row",children:[o.jsx("span",{children:"最大队伍"}),o.jsx("select",{value:t.maxTeams,onChange:a=>n({type:"SET_MAP_META",maxTeams:Number(a.target.value)}),children:Array.from({length:t.maxPlayers},(a,r)=>r+1).filter(a=>a>=2).map(a=>o.jsx("option",{value:a,children:a},a))})]})]})}function o1(){const{state:e,dispatch:n}=Da(),{map:t,activeTool:a,selectedZoneTeam:r}=e;return o.jsxs("div",{className:"me__zones",children:[o.jsxs("div",{className:"me__zones-tools",children:[o.jsx("button",{className:`me__btn me__btn--sm${a==="startZone"?" me__btn--active":""}`,onClick:()=>n({type:"SET_TOOL",tool:"startZone"}),children:"添加点"}),o.jsx("button",{className:`me__btn me__btn--sm${a==="eraseZone"?" me__btn--active":""}`,onClick:()=>n({type:"SET_TOOL",tool:"eraseZone"}),children:"删除点"})]}),Array.from({length:t.maxTeams},(s,i)=>i).map(s=>{const i=t.startZones[s]??[],l=ps[s%ps.length],d=r===s;return o.jsxs("div",{className:`me__zone-row${d?" me__zone-row--active":""}`,style:{borderLeftColor:l},onClick:()=>n({type:"SET_ZONE_TEAM",team:s}),children:[o.jsxs("span",{style:{color:l},children:["区域 ",s+1]}),o.jsxs("span",{className:"me__zone-count",children:[i.length," 点"]}),o.jsx("button",{className:"me__btn me__btn--sm me__btn--danger",onClick:u=>{u.stopPropagation(),n({type:"CLEAR_ZONE",team:s})},children:"清空"})]},s)})]})}const s1=`
.me__screen {
  position: relative;
  height: 100vh;
  overflow: hidden;
...
`;function i1(e){return e?`(${e.row},${e.col})`:"(无)"}function Ht(e){if(!e)return"(空)";const n=te(e.defId),t=(n==null?void 0:n.nameCn)??e.defId,a=e.destroyed?" [已摧毁]":"";return`${t}(${e.defId})${a}`}function l1(e,n){const t=e.players[n];if(!t)return`  ${n}: (不存在)`;const a=q.find(s=>s.id===t.unitId),r=[];return r.push(`  ── ${n} ──`),r.push(`    机体: ${(a==null?void 0:a.nameCn)??t.unitId} (${t.unitId})`),r.push(`    位置: ${i1(t.position)}  朝向: ${t.facing}`),r.push(`    状态: ${t.isDefeated?"已击破":"存活"}`),r.push(`    手牌(${t.hand.length}): ${t.hand.map(s=>Ht(s)).join(", ")||"(无)"}`),r.push(`    阶段1配置: ${Ht(t.plotSeg1)}`),r.push(`    阶段2配置: ${Ht(t.plotSeg2)}`),r.push(`    辅助区(${t.auxiliary.length}): ${t.auxiliary.map(s=>Ht(s)).join(", ")||"(无)"}`),r.push(`    弃牌堆(${t.discard.length}): ${t.discard.map(s=>Ht(s)).join(", ")||"(无)"}`),r.push(`    摧毁区(${t.destroyedCards.length}): ${t.destroyedCards.map(s=>Ht(s)).join(", ")||"(无)"}`),r.push(`    卡组剩余: ${t.deck.filter(s=>!s.destroyed).length} 张`),r.join(`
`)}function c1(e){var t,a,r;const n=[];if(n.push("══════════════════════════════════════════"),n.push("  当前状态快照"),n.push("══════════════════════════════════════════"),n.push(`回合: ${e.roundNumber}`),n.push(`阶段: ${e.phase}`),n.push(`当前时机: ${e.currentTiming??"(无)"}`),n.push(`行动顺序: ${e.turnOrder.length>0?e.turnOrder.join(" → "):"(无)"}`),n.push(`布局步骤: ${e.plottingStep??"(无)"}`),n.push(`活跃玩家: ${e.activePlayer}`),n.push(`地图: ${((t=e.map)==null?void 0:t.id)??"(无)"}`),n.push(`地雷数: ${((a=e.mines)==null?void 0:a.length)??0}`),(r=e.mines)!=null&&r.length&&n.push(`隐藏指示物: ${e.mines.map(s=>`(${s.position.row},${s.position.col}) owner=${s.ownerId}`).join("；")}`),e.pendingDamage){const s=e.pendingDamage;n.push(`待处理伤害: 目标=${s.targetId}, 剩余=${s.remaining}, 来源=${s.source}, 攻击者=${s.attackerId??"(无)"}, 已选=${s.selectedInstanceIds.length}`)}n.push(""),n.push("── 玩家状态 ──");for(const s of e.playerIds)n.push(l1(e,s));return n.push(""),n.join(`
`)}function of(e,n){const t=new Date,a=t.toISOString().replace(/[:.]/g,"-").slice(0,19),r=[];r.push("╔══════════════════════════════════════════╗"),r.push("║   Embryo Machine — 全量游戏日志导出      ║"),r.push("╚══════════════════════════════════════════╝"),r.push(`导出时间: ${t.toLocaleString("zh-CN")}`),n!=null&&n.localPlayerId&&r.push(`本地玩家: ${n.localPlayerId}`),n!=null&&n.connectionStatus&&r.push(`连接状态: ${n.connectionStatus}`),r.push(""),r.push(c1(e)),r.push("══════════════════════════════════════════"),r.push("  完整游戏日志 (按时间顺序)"),r.push("══════════════════════════════════════════");const s=e.log.filter(f=>!f.startsWith("[DBG]"));for(let f=0;f<s.length;f++)r.push(`[${String(f+1).padStart(4," ")}] ${s[f]}`);r.push(""),r.push(`── 共 ${s.length} 条日志 ──`);const i=r.join(`
`),l=new Blob([i],{type:"text/plain;charset=utf-8"}),d=URL.createObjectURL(l),u=document.createElement("a");u.href=d,u.download=`embryo-log-${a}.txt`,u.click(),URL.revokeObjectURL(d)}const yu=[1e3,2e3,4e3,8e3,15e3];class d1{constructor(n,t,a){en(this,"ws",null);en(this,"url");en(this,"sessionId");en(this,"onMessage");en(this,"onStatus");en(this,"reconnectAttempt",0);en(this,"reconnectTimer",null);en(this,"intentionallyClosed",!1);en(this,"hasEverConnected",!1);this.url=n,this.sessionId=localStorage.getItem("embryo-session-id"),this.onMessage=t,this.onStatus=a}connect(){this.intentionallyClosed=!1,this.onStatus("connecting");const n=this.sessionId?`?sessionId=${this.sessionId}`:"";this.ws=new WebSocket(`${this.url}${n}`),this.ws.onopen=()=>{var t;if(this.intentionallyClosed){(t=this.ws)==null||t.close(),this.ws=null,this.onStatus("disconnected");return}this.hasEverConnected=!0,this.reconnectAttempt=0,this.onStatus("connected")},this.ws.onmessage=t=>{try{const a=JSON.parse(t.data);a.type==="SESSION_ID"&&(this.sessionId=a.sessionId,localStorage.setItem("embryo-session-id",a.sessionId)),this.onMessage(a)}catch{console.warn("[GameSocket] Failed to parse message:",t.data)}},this.ws.onclose=()=>{if(this.intentionallyClosed){this.onStatus("disconnected");return}this.hasEverConnected||(this.sessionId=null,localStorage.removeItem("embryo-session-id")),this.onStatus("reconnecting"),this.scheduleReconnect()},this.ws.onerror=()=>{}}send(n){var t;((t=this.ws)==null?void 0:t.readyState)===WebSocket.OPEN?this.ws.send(JSON.stringify(n)):console.warn("[GameSocket] Cannot send — not connected")}disconnect(){if(this.intentionallyClosed=!0,this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws){const n=this.ws.readyState;n===WebSocket.OPEN||n===WebSocket.CLOSING?(this.ws.close(),this.ws=null):n===WebSocket.CONNECTING&&(this.ws.onmessage=null,this.ws.onerror=null)}this.onStatus("disconnected")}clearSession(){this.sessionId=null,localStorage.removeItem("embryo-session-id")}get isConnected(){var n;return((n=this.ws)==null?void 0:n.readyState)===WebSocket.OPEN}scheduleReconnect(){const n=yu[Math.min(this.reconnectAttempt,yu.length-1)];this.reconnectAttempt++,this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.connect()},n)}}const sf=k.createContext(null);function u1({serverUrl:e,children:n}){const[t,a]=k.useState(null),[r,s]=k.useState(null),[i,l]=k.useState(null),[d,u]=k.useState("disconnected"),[f,m]=k.useState(null),[g,h]=k.useState(null),[x,p]=k.useState([]),[_,y]=k.useState(null),[b,v]=k.useState(null),[I,S]=k.useState(null),C=k.useRef(null),w=k.useRef(null),N=k.useRef(-1),z=k.useRef([]),M=k.useCallback(D=>{switch(D.type){case"SESSION_ID":break;case"ROOM_STATE":s(D.room),l(D.yourPlayerId);break;case"ROOM_LIST":p(D.rooms);break;case"GAME_STATE":{D.state.phase==="plotting"&&(w.current!=="plotting"||N.current!==D.state.roundNumber)&&m(null),w.current=D.state.phase,N.current=D.state.roundNumber,a(D.state),l(D.yourPlayerId),y(D.currentTurnPlayerId??null),v(D.turnDeadline??null),D.replayActions&&D.replayActions.length>0&&(z.current=[...z.current,...D.replayActions]);break}case"PLOTTING_STATUS":m({confirmed:D.confirmed,total:D.total});break;case"GAME_STARTED":D.initialState&&(S(D.initialState),z.current=[]);break;case"RECONNECTED":s(D.room),a(D.state),l(D.yourPlayerId),y(D.currentTurnPlayerId??null),v(D.turnDeadline??null),w.current=D.state.phase,N.current=D.state.roundNumber,D.initialState&&S(D.initialState),D.replayActions&&(z.current=D.replayActions);break;case"SPECTATE_STATE":a(D.state),s(D.room),l(null);break;case"ACTION_REJECTED":h(D.reason),setTimeout(()=>h(null),5e3);break;case"PLAYER_JOINED":case"PLAYER_LEFT":case"PLAYER_RECONNECTED":case"PLAYER_DISCONNECTED":break;case"ERROR":h(D.message),setTimeout(()=>h(null),5e3);break}},[]);k.useEffect(()=>{const D=new d1(e,M,u);return C.current=D,D.connect(),()=>{D.clearSession(),D.disconnect(),C.current=null}},[e,M]);const J=k.useCallback(D=>{var R;(R=C.current)==null||R.send({type:"GAME_ACTION",action:D})},[]),E=k.useCallback(D=>{var R;(R=C.current)==null||R.send({type:"LOBBY_ACTION",action:D})},[]),K=k.useCallback(D=>{var R;(R=C.current)==null||R.send(D)},[]),$=k.useCallback(D=>te(D),[]),L={state:t,room:r,localPlayerId:i,dispatch:J,sendLobbyAction:E,send:K,getCard:$,connectionStatus:d,plottingStatus:f,isOnline:!0,lastError:g,roomList:x,currentTurnPlayerId:_,turnDeadline:b,replayInitialState:I,replayActions:z.current};return o.jsx(sf.Provider,{value:L,children:n})}function Ec(){const e=k.useContext(sf);if(!e)throw new Error("useOnlineGame must be used within OnlineGameProvider");return e}function p1({children:e}){const{state:n,localPlayerId:t,dispatch:a,getCard:r,plottingStatus:s,send:i,currentTurnPlayerId:l,replayInitialState:d,replayActions:u}=Ec(),[f,m]=k.useState(!0),g=k.useRef(-1),h=k.useRef(null),x={player1:!1,player2:!1,player1Difficulty:"hard",player2Difficulty:"hard"},p=k.useCallback(I=>{if(I.type==="ADVANCE_TIMING"||I.type==="ADVANCE_PHASE"){i({type:"TIMING_DONE"});return}I.type==="START_PLOTTING"||I.type==="DRAW_CARDS"||a(I)},[a,i]),_=k.useCallback(()=>d?{initialState:d,actions:[...u]}:null,[d,u]);if(k.useEffect(()=>{if(!(!f||!n)){if(n.phase==="plotting"&&h.current!=="plotting"&&n.roundNumber!==g.current){g.current=n.roundNumber;try{Sc("auto",n,x,!0)}catch{}}h.current=n.phase}},[f,n]),!n||!t)return null;let y=n;if(n.phase==="plotting"){const I=(s==null?void 0:s.confirmed.includes(t))??!1;y={...n,plottingStep:I?"waiting_online":t}}const b={player1:t!=="player1",player2:t!=="player2",player1Difficulty:"easy",player2Difficulty:"easy",playerAI:Object.fromEntries(n.playerIds.map(I=>[I,I!==t])),playerDifficulty:Object.fromEntries(n.playerIds.map(I=>[I,"easy"]))},v={state:y,dispatch:p,rawDispatch:p,getCard:r,aiConfig:b,setAIConfig:()=>{},getReplayData:_,autoSaveEnabled:f,setAutoSaveEnabled:m,exposureMode:!1,setExposureMode:()=>{},isOnline:!0,localPlayerId:t,currentTurnPlayerId:l,plottingStatus:s};return o.jsx(Os.Provider,{value:v,children:e})}const m1={lobby:"等待中",playing:"游戏中",finished:"已结束"};function lf({onBack:e,onCreateRoom:n,onJoinRoom:t,roomList:a,onRefreshRooms:r,onSpectate:s}){const[i,l]=k.useState("create"),[d,u]=k.useState(()=>localStorage.getItem("embryo-player-name")??""),[f,m]=k.useState(""),[g,h]=k.useState(""),[x,p]=k.useState(2),[_,y]=k.useState(2),[b,v]=k.useState(Ye[0].id);function I(D){const R=[];for(let P=2;P<=D;P++)D%P===0&&R.push(P);return R}function S(D){p(D);const R=I(D);R.includes(_)||y(R[0]);const P=Ye.find(A=>A.id===b);if(!P||P.maxPlayers<D){const A=Ye.find(B=>B.maxPlayers>=D);A&&v(A.id)}}const[C,w]=k.useState(""),[N,z]=k.useState(!1),[M,J]=k.useState(0);function E(){const D=d.trim()||`Player_${Math.random().toString(36).slice(2,6)}`;return localStorage.setItem("embryo-player-name",D),D}function K(){n(E(),{maxPlayers:x,teamCount:_,mapId:b,turnTimeoutSeconds:M,password:N?C:void 0})}function $(){const D=f.trim().toUpperCase();D&&t(D,E(),g||void 0)}function L(D,R){m(D),R?(l("join"),h("")):t(D,E())}return o.jsxs("div",{className:"ol-screen",children:[o.jsxs("div",{className:"ol-center",children:[o.jsx("h1",{className:"ol-title",children:"联机对战"}),o.jsx("p",{className:"ol-subtitle",children:"创建、加入或浏览房间"}),o.jsx("div",{className:"ol-divider"}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"昵称"}),o.jsx("input",{className:"ol-input",value:d,onChange:D=>u(D.target.value),placeholder:"输入昵称…",maxLength:16})]}),o.jsxs("div",{className:"ol-tabs",children:[o.jsx("button",{className:`ol-tab${i==="create"?" ol-tab--active":""}`,onClick:()=>l("create"),children:"创建房间"}),o.jsx("button",{className:`ol-tab${i==="join"?" ol-tab--active":""}`,onClick:()=>l("join"),children:"加入房间"}),o.jsx("button",{className:`ol-tab${i==="browse"?" ol-tab--active":""}`,onClick:()=>{l("browse"),r==null||r()},children:"浏览房间"})]}),i==="create"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"最大玩家数"}),o.jsx("select",{className:"ol-select",value:x,onChange:D=>S(+D.target.value),children:[2,3,4,5,6,7,8].map(D=>o.jsxs("option",{value:D,children:[D," 人"]},D))})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"队伍数量"}),o.jsx("select",{className:"ol-select",value:_,onChange:D=>y(+D.target.value),children:I(x).map(D=>o.jsxs("option",{value:D,children:[D," 队 (",x/D,"人/队)"]},D))})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"地图"}),o.jsx("select",{className:"ol-select",value:b,onChange:D=>v(D.target.value),children:Ye.filter(D=>D.maxPlayers>=x).map(D=>o.jsxs("option",{value:D.id,children:[D.nameCn," (",D.maxPlayers,"人)"]},D.id))})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"回合限时"}),o.jsxs("select",{className:"ol-select",value:M,onChange:D=>J(+D.target.value),children:[o.jsx("option",{value:0,children:"无限制"}),o.jsx("option",{value:30,children:"30 秒"}),o.jsx("option",{value:60,children:"60 秒"}),o.jsx("option",{value:90,children:"90 秒"}),o.jsx("option",{value:120,children:"120 秒"})]})]}),o.jsxs("label",{className:"ol-check",onClick:()=>z(!N),children:[o.jsx("span",{className:`ol-check__box${N?" ol-check__box--on":""}`,children:N?"✓":""}),o.jsx("span",{children:"设置房间密码"})]}),N&&o.jsx("div",{className:"ol-field",children:o.jsx("input",{className:"ol-input",value:C,onChange:D=>w(D.target.value),placeholder:"输入密码…",maxLength:20,type:"password"})}),o.jsx("button",{className:"ol-btn ol-btn--primary",onClick:K,children:"创建房间"})]}),i==="join"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"房间号"}),o.jsx("input",{className:"ol-input ol-input--code",value:f,onChange:D=>m(D.target.value.toUpperCase()),placeholder:"输入6位房间号",maxLength:6})]}),o.jsxs("div",{className:"ol-field",children:[o.jsx("label",{className:"ol-label",children:"密码（若有）"}),o.jsx("input",{className:"ol-input",value:g,onChange:D=>h(D.target.value),placeholder:"无密码可留空",maxLength:20,type:"password"})]}),o.jsx("button",{className:"ol-btn ol-btn--primary",onClick:$,disabled:f.trim().length<1,children:"加入房间"})]}),i==="browse"&&o.jsxs("div",{className:"ol-panel",children:[o.jsxs("div",{className:"ol-browse-header",children:[o.jsx("span",{className:"ol-label",children:"在线房间"}),o.jsx("button",{className:"ol-refresh-btn",onClick:r,children:"刷新"})]}),!a||a.length===0?o.jsx("div",{className:"ol-empty",children:"暂无房间，创建一个吧"}):o.jsx("div",{className:"ol-room-list",children:a.map(D=>o.jsxs("div",{className:"ol-room-row",children:[o.jsx("span",{className:"ol-room-row__code",children:D.roomCode}),o.jsx("span",{className:"ol-room-row__host",children:D.hostName}),o.jsx("span",{className:`ol-room-row__status ol-room-row__status--${D.status}`,children:m1[D.status]??D.status}),o.jsxs("span",{className:"ol-room-row__count",children:[D.playerCount,"/",D.maxPlayers]}),D.hasPassword&&o.jsx("span",{className:"ol-room-row__lock",title:"需要密码",children:"🔒"}),D.status==="lobby"?o.jsx("button",{className:"ol-room-row__join",onClick:()=>L(D.roomCode,D.hasPassword),children:"加入"}):o.jsx("button",{className:"ol-room-row__join",onClick:()=>s==null?void 0:s(D.roomCode),disabled:!s,children:"观战"})]},D.roomCode))})]}),o.jsx("button",{className:"ol-btn ol-btn--back",onClick:e,children:"返回主菜单"})]}),o.jsx("style",{children:f1})]})}const f1=`
.ol-screen {
  display: flex;
  align-items: center;
  justify-content: center;
...
`,b1=[{key:"alive",label:"存活",icon:"💚"},{key:"kills",label:"击杀",icon:"💀"},{key:"assists",label:"助攻",icon:"🤝"},{key:"damageDealt",label:"造成伤害",icon:"⚔️"},{key:"damageTaken",label:"承受伤害",icon:"🛡️"},{key:"cardsRemaining",label:"剩余卡牌",icon:"📋"}];function cf({state:e,onHome:n,onSaveReplay:t,isOnline:a}){const[r,s]=k.useState("kills"),[i,l]=k.useState(!0),[d,u]=k.useState("table"),[f,m]=k.useState("damageDealt"),[g,h]=k.useState(!0);k.useEffect(()=>{const v=setTimeout(()=>h(!1),800);return()=>clearTimeout(v)},[]);const x=k.useMemo(()=>Jh(e),[e]),p=k.useMemo(()=>Bh(x,r,i),[x,r,i]),_=k.useMemo(()=>{const v=new Set;for(const I of e.playerIds)e.players[I].isDefeated||v.add(e.teams[I]);if(v.size===0)return"平局 — 双方同时全灭";if(v.size===1){const I=[...v][0],S=e.playerIds.filter(C=>e.teams[C]===I).map(C=>{const w=q.find(N=>N.id===e.players[C].unitId);return(w==null?void 0:w.nameCn)??C});return`队伍 ${I+1} 获胜 — ${S.join("、")}`}return"游戏结束"},[e]);function y(v){r===v?l(!i):(s(v),l(!0))}const b=k.useMemo(()=>Math.max(1,...x.map(v=>{switch(f){case"kills":return v.kills;case"assists":return v.assists;case"damageDealt":return v.damageDealt;case"damageTaken":return v.damageTaken;case"cardsRemaining":return v.cardsRemaining;default:return 0}})),[x,f]);return o.jsxs("div",{className:`bs-screen ${g?"bs-screen--entering":""}`,children:[o.jsxs("div",{className:"bs-header",children:[o.jsx("div",{className:"bs-header__icon",children:"📊"}),o.jsx("h1",{className:"bs-header__title",children:"战斗结算"}),o.jsx("p",{className:"bs-header__subtitle",children:_}),o.jsxs("p",{className:"bs-header__round",children:["共 ",e.roundNumber," 回合"]})]}),o.jsxs("div",{className:"bs-toggle-bar",children:[o.jsx("button",{className:`bs-toggle-btn ${d==="table"?"bs-toggle-btn--active":""}`,onClick:()=>u("table"),children:"📋 数据表"}),o.jsx("button",{className:`bs-toggle-btn ${d==="chart"?"bs-toggle-btn--active":""}`,onClick:()=>u("chart"),children:"📊 图表"})]}),o.jsx("div",{className:"bs-content",children:d==="table"?o.jsx(v1,{stats:p,state:e,sortKey:r,sortDesc:i,onSort:y}):o.jsx(y1,{stats:x,state:e,metric:f,chartMax:b,onMetricChange:m})}),o.jsxs("div",{className:"bs-actions",children:[o.jsx("button",{className:"bs-btn bs-btn--primary",onClick:n,children:"🏠 返回主菜单"}),!a&&o.jsx("button",{className:"bs-btn bs-btn--secondary",onClick:t,children:"🎬 保存录像"})]}),o.jsx("style",{children:_1})]})}function v1({stats:e,state:n,sortKey:t,sortDesc:a,onSort:r}){return o.jsx("div",{className:"bs-table-wrap",children:o.jsxs("table",{className:"bs-table",children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{className:"bs-table__th bs-table__th--player",children:"机体"}),b1.map(s=>o.jsxs("th",{className:`bs-table__th bs-table__th--sortable ${t===s.key?"bs-table__th--sorted":""}`,onClick:()=>r(s.key),title:`按${s.label}排序`,children:[o.jsx("span",{className:"bs-table__th-icon",children:s.icon}),o.jsx("span",{className:"bs-table__th-label",children:s.label}),t===s.key&&o.jsx("span",{className:"bs-table__th-arrow",children:a?"▼":"▲"})]},s.key))]})}),o.jsx("tbody",{children:e.map((s,i)=>{const l=ht(n,s.playerId);return o.jsxs("tr",{className:`bs-table__row ${s.alive?"":"bs-table__row--defeated"}`,style:{"--delay":`${i*.08}s`,"--player-color":l},children:[o.jsxs("td",{className:"bs-table__td bs-table__td--player",children:[o.jsx("span",{className:"bs-player-badge",style:{borderColor:l,color:l},children:s.label}),o.jsx("span",{className:"bs-player-name",children:s.unitName}),s.alive&&o.jsx("span",{className:"bs-alive-dot",title:"存活"})]}),o.jsx("td",{className:"bs-table__td bs-table__td--status",children:s.alive?o.jsx("span",{className:"bs-status bs-status--alive",children:"存活"}):o.jsx("span",{className:"bs-status bs-status--dead",children:"击毁"})}),o.jsx("td",{className:"bs-table__td bs-table__td--num",children:o.jsx("span",{className:"bs-num bs-num--kills",children:s.kills})}),o.jsx("td",{className:"bs-table__td bs-table__td--num",children:o.jsx("span",{className:"bs-num",children:s.assists})}),o.jsx("td",{className:"bs-table__td bs-table__td--num",children:o.jsx("span",{className:"bs-num bs-num--damage",children:s.damageDealt})}),o.jsx("td",{className:"bs-table__td bs-table__td--num",children:o.jsx("span",{className:"bs-num bs-num--taken",children:s.damageTaken})}),o.jsx("td",{className:"bs-table__td bs-table__td--num",children:o.jsxs("div",{className:"bs-hp-cell",children:[o.jsx("span",{className:"bs-num",children:s.cardsRemaining}),o.jsx("div",{className:"bs-hp-bar",children:o.jsx("div",{className:"bs-hp-bar__fill",style:{width:`${s.hpPercent}%`,background:s.hpPercent>50?"linear-gradient(90deg, #00c864, #44ee88)":s.hpPercent>20?"linear-gradient(90deg, #ffa000, #ffcc44)":"linear-gradient(90deg, #ff3333, #ff6666)"}})})]})})]},s.playerId)})})]})})}function y1({stats:e,state:n,metric:t,chartMax:a,onMetricChange:r}){const s=[{key:"damageDealt",label:"造成伤害",icon:"⚔️",barColor:"#ff6644"},{key:"damageTaken",label:"承受伤害",icon:"🛡️",barColor:"#4488ff"},{key:"kills",label:"击杀数",icon:"💀",barColor:"#ff3366"},{key:"assists",label:"助攻数",icon:"🤝",barColor:"#44ddaa"},{key:"cardsRemaining",label:"剩余卡牌",icon:"📋",barColor:"#ffcc00"}],i=s.find(u=>u.key===t)??s[0];function l(u){switch(t){case"kills":return u.kills;case"assists":return u.assists;case"damageDealt":return u.damageDealt;case"damageTaken":return u.damageTaken;case"cardsRemaining":return u.cardsRemaining;default:return 0}}const d=[...e].sort((u,f)=>l(f)-l(u));return o.jsxs("div",{className:"bs-chart",children:[o.jsx("div",{className:"bs-chart__selector",children:s.map(u=>o.jsxs("button",{className:`bs-chart__metric-btn ${t===u.key?"bs-chart__metric-btn--active":""}`,onClick:()=>r(u.key),children:[u.icon," ",u.label]},u.key))}),o.jsx("div",{className:"bs-chart__bars",children:d.map((u,f)=>{const m=l(u),g=a>0?m/a*100:0,h=ht(n,u.playerId);return o.jsxs("div",{className:"bs-chart__bar-row",style:{"--delay":`${f*.1}s`},children:[o.jsxs("div",{className:"bs-chart__bar-label",children:[o.jsx("span",{className:"bs-chart__bar-badge",style:{borderColor:h,color:h},children:u.label}),o.jsx("span",{className:"bs-chart__bar-name",children:u.unitName})]}),o.jsxs("div",{className:"bs-chart__bar-track",children:[o.jsx("div",{className:"bs-chart__bar-fill",style:{width:`${g}%`,background:`linear-gradient(90deg, ${i.barColor}dd, ${i.barColor}88)`,boxShadow:`0 0 12px ${i.barColor}44`}}),o.jsx("span",{className:"bs-chart__bar-value",children:m})]})]},u.playerId)})}),o.jsxs("div",{className:"bs-chart__summary",children:[o.jsx("h3",{className:"bs-chart__summary-title",children:"综合对比"}),o.jsx("div",{className:"bs-chart__summary-grid",children:d.map(u=>{const f=ht(n,u.playerId);return o.jsxs("div",{className:"bs-chart__summary-card",style:{borderColor:`${f}44`},children:[o.jsxs("div",{className:"bs-chart__summary-header",style:{color:f},children:[u.label," ",u.unitName,!u.alive&&o.jsx("span",{className:"bs-chart__summary-dead",children:"✕"})]}),o.jsxs("div",{className:"bs-chart__summary-stats",children:[o.jsxs("div",{className:"bs-chart__summary-stat",children:[o.jsx("span",{className:"bs-chart__summary-stat-icon",children:"💀"}),o.jsx("span",{children:u.kills})]}),o.jsxs("div",{className:"bs-chart__summary-stat",children:[o.jsx("span",{className:"bs-chart__summary-stat-icon",children:"🤝"}),o.jsx("span",{children:u.assists})]}),o.jsxs("div",{className:"bs-chart__summary-stat",children:[o.jsx("span",{className:"bs-chart__summary-stat-icon",children:"⚔️"}),o.jsx("span",{children:u.damageDealt})]}),o.jsxs("div",{className:"bs-chart__summary-stat",children:[o.jsx("span",{className:"bs-chart__summary-stat-icon",children:"🛡️"}),o.jsx("span",{children:u.damageTaken})]})]}),o.jsxs("div",{className:"bs-chart__summary-hp",children:[o.jsx("div",{className:"bs-hp-bar",style:{height:6,borderRadius:3},children:o.jsx("div",{className:"bs-hp-bar__fill",style:{width:`${u.hpPercent}%`,background:u.hpPercent>50?"#00c864":u.hpPercent>20?"#ffa000":"#ff3333"}})}),o.jsxs("span",{className:"bs-chart__summary-hp-text",children:[u.cardsRemaining,"/",u.totalCards]})]})]},u.playerId)})})]})]})}const _1=`
/* ═══════════════════════════════════════════════════════
   Battle Stats Screen
   ═══════════════════════════════════════════════════════ */
...
`;function N1(){const e=Vr(),{rawDispatch:n,aiConfig:t,setAIConfig:a,getReplayData:r,autoSaveEnabled:s,setAutoSaveEnabled:i,exposureMode:l,setExposureMode:d}=Ce(),[u,f]=k.useState("home"),[m,g]=k.useState("map"),[h,x]=k.useState(!0),[p,_]=k.useState(2),[y,b]=k.useState(2),[v,I]=k.useState(null),[S,C]=k.useState({loaded:0,total:0}),w=k.useRef(null),N=k.useCallback(()=>{fe.init(),g("map"),f("game")},[]),z=k.useCallback(()=>{const K=Um().length;C({loaded:0,total:K}),I("asking")},[]),M=k.useCallback(()=>{I("loading");const K=new AbortController;w.current=K,kb(($,L)=>{C({loaded:$,total:L}),$>=L&&setTimeout(()=>I(null),600)},K.signal)},[]),J=k.useCallback(()=>{var K;(K=w.current)==null||K.abort(),I(null)},[]);function E(K){n({type:"LOAD_GAME",state:K.gameState}),a(K.aiConfig),f("game")}return u==="rules"?o.jsx(hv,{onBack:()=>f((e.phase==="setup","game"))}):u==="data"?o.jsx(bv,{onBack:()=>f("game")}):u==="load"?o.jsx(pu,{mode:"load",onBack:()=>f("home"),onLoad:E}):u==="replay"?o.jsx(zv,{onBack:()=>f("home")}):u==="save"?o.jsx(pu,{mode:"save",onBack:()=>f("game"),currentState:e,aiConfig:t}):u==="mapEditor"?o.jsx(qv,{onBack:()=>f("home")}):u==="online"?o.jsx(j1,{onBack:()=>f("home")}):u==="settings"?o.jsxs(o.Fragment,{children:[v!==null&&o.jsx(hb,{phase:v,loaded:S.loaded,total:S.total,onConfirm:M,onSkip:J}),o.jsx(fb,{onBack:()=>f("home"),soundEnabled:fe.enabled,onToggleSound:()=>{fe.enabled=!fe.enabled,C(K=>({...K}))},soundVolume:fe.volume,onVolumeChange:K=>{fe.volume=K,fe.init(),fe.uiBlip(),C($=>({...$}))},exposureMode:l,onToggleExposure:()=>d(!l),autoFill:h,onToggleAutoFill:()=>x(!h),onCacheAssets:z})]}):u==="home"?o.jsx(pb,{onStart:N,onOnlinePlay:()=>{fe.init(),f("online")},onViewRules:()=>f("rules"),onViewData:()=>f("data"),onLoadGame:()=>f("load"),onReplay:()=>f("replay"),onMapEditor:()=>f("mapEditor"),onSettings:()=>f("settings")}):e.phase==="setup"?m==="map"?o.jsx(eb,{onNext:()=>g("units"),onBack:()=>f("home"),playerCount:p,setPlayerCount:_,teamCount:y,setTeamCount:b}):m==="units"?o.jsx(ab,{onNext:()=>g("spawn"),onBack:()=>g("map"),autoFill:h}):o.jsx(db,{onBack:()=>g("units")}):e.phase==="game_over"?o.jsx(cf,{state:e,onHome:()=>{n({type:"RESET_GAME"}),f("home"),g("map")},onSaveReplay:()=>{const K=r();if(!K)return;const $=e.players.player1.isDefeated,L=e.players.player2.isDefeated,D=$&&L?"draw":$?"player2":L?"player1":null;try{Bx(K.initialState,K.actions,D),alert("录像已保存！")}catch{alert("保存失败，存储空间可能不足。")}}}):o.jsx(T1,{onSave:()=>f("save"),autoSaveEnabled:s,onToggleAutoSave:()=>i(!s)})}function T1({onSave:e,autoSaveEnabled:n,onToggleAutoSave:t}){const a=Vr(),{dispatch:r,exposureMode:s,getCard:i,aiConfig:l}=Ce();k.useEffect(()=>{a.phase==="pregame"&&r({type:"START_PLOTTING"})},[a.phase,r]);const d=k.useRef(a.phase);k.useEffect(()=>{const C=d.current;if(d.current=a.phase,!!s&&C==="plotting"&&a.phase==="action_seg1"){const w=N=>{if(!N)return"无";const z=i(N.defId);return z?z.nameCn:N.defId};for(const N of a.playerIds){const z=a.players[N];if(z.isDefeated)continue;const M=`P${N.replace("player","")}`;r({type:"ADD_LOG",message:`[暴露] ${M} 布局: 段1=${w(z.plotSeg1)} / 段2=${w(z.plotSeg2)}`})}}},[a.phase]);const[u,f]=k.useState([{id:"map",zIndex:10},{id:"log",zIndex:11},{id:"mecha",zIndex:12},{id:"plot",zIndex:100}]),m=k.useRef(new Map),g=k.useCallback(C=>{f(w=>{const N=Math.max(...w.map($=>$.zIndex)),z=w.find($=>$.id===C);if(z&&z.zIndex===N)return w;const M=[...w].sort(($,L)=>$.zIndex-L.zIndex),J=10,E=new Map;let K=0;for(const $ of M)$.id!==C&&E.set($.id,J+K++);return E.set(C,J+M.length-1),w.map($=>({...$,zIndex:E.get($.id)??$.zIndex}))})},[]),h=C=>{var w;return((w=u.find(N=>N.id===C))==null?void 0:w.zIndex)??10},x=k.useCallback(C=>{const w=[];return m.current.forEach((N,z)=>{z!==C&&N&&w.push(N.getBoundingClientRect())}),w},[]),p=Ks(),_=p?window.innerWidth:Math.max(400,Math.min(window.innerWidth*.6,620)),y=300,b=window.innerWidth-y-16,v=36,I=p?window.innerWidth:380,S=window.innerWidth-I-16;if(p){const C=a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&!Ae(l,a.plottingStep),w=a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&Ae(l,a.plottingStep);return o.jsxs("div",{className:"game-screen game-screen--mobile",children:[o.jsx("div",{className:"game-screen__header",style:{flexShrink:0},children:o.jsx(_u,{onSave:e,autoSaveEnabled:n,onToggleAutoSave:t})}),o.jsxs("div",{className:"game-screen__board-mobile",children:[o.jsx(Ca,{}),o.jsx(Iu,{})]}),o.jsxs("div",{className:"game-screen__panels-mobile",children:[C&&o.jsx(we,{id:"plot",title:"布局阶段",initialPos:{x:0,y:0},width:I,children:o.jsx(ca,{})}),w&&o.jsx("div",{style:{width:0,height:0,overflow:"hidden",opacity:0,pointerEvents:"none"},children:o.jsx(ca,{})}),o.jsx(we,{id:"mecha",title:"机体信息",initialPos:{x:0,y:0},defaultMinimized:!0,children:o.jsx(us,{})}),o.jsx(we,{id:"log",title:"行动日志",initialPos:{x:0,y:0},defaultMinimized:!0,children:o.jsx(Nr,{})})]}),o.jsx(ls,{}),o.jsx(cs,{}),o.jsx("style",{children:ku})]})}return o.jsxs("div",{className:"game-screen",style:{position:"relative",height:"100vh",overflow:"hidden",display:"flex",flexDirection:"column"},children:[o.jsx("div",{className:"game-screen__header",style:{flexShrink:0},children:o.jsx(_u,{onSave:e,autoSaveEnabled:n,onToggleAutoSave:t})}),o.jsxs("div",{style:{position:"relative",flex:1},children:[o.jsx(we,{id:"map",title:"地图",initialPos:{x:16,y:8},width:_,minHeight:300,zIndex:h("map"),onFocus:g,siblingRects:x("map"),children:o.jsx("div",{style:{height:`calc(100vh - ${v+60}px)`,minHeight:300},children:o.jsx(Ca,{})})}),o.jsx(we,{id:"log",title:"行动日志",initialPos:{x:b,y:8},width:y,height:260,minHeight:120,zIndex:h("log"),onFocus:g,siblingRects:x("log"),children:o.jsx(Nr,{})}),o.jsx(we,{id:"mecha",title:"机体信息",initialPos:{x:b,y:280},width:y,minHeight:160,zIndex:h("mecha"),onFocus:g,siblingRects:x("mecha"),children:o.jsx(us,{})}),a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&!Ae(l,a.plottingStep)&&o.jsx(we,{id:"plot",title:"布局阶段",initialPos:{x:S,y:8},width:I,height:620,minHeight:80,zIndex:h("plot"),onFocus:g,siblingRects:x("plot"),children:o.jsx(ca,{})}),a.phase==="plotting"&&a.plottingStep!=="complete"&&a.plottingStep!==null&&!a.plottingStep.startsWith("transition_to_")&&Ae(l,a.plottingStep)&&o.jsx("div",{style:{position:"absolute",width:0,height:0,overflow:"hidden",opacity:0,pointerEvents:"none"},children:o.jsx(ca,{})})]}),o.jsx(ls,{}),o.jsx(cs,{}),o.jsx(Iu,{}),o.jsx("style",{children:ku})]})}function _u({onSave:e,autoSaveEnabled:n,onToggleAutoSave:t}){const a=Vr(),r={pregame:"战前准备",draw:"抽牌阶段",plotting:"布局阶段",action_seg1:"行动阶段 [主要阶段 1]",action_seg2:"行动阶段 [主要阶段 2]",cleanup:"清理阶段",game_over:"游戏结束"},s={movement:"移动",ranged:"射击",melee:"近战",special:"特殊"};return o.jsxs("div",{className:"phase-bar",children:[o.jsxs("span",{className:"phase-bar__round",children:["第 ",a.roundNumber," 回合"]}),o.jsx("span",{className:"phase-bar__phase",children:r[a.phase]??a.phase}),a.currentTiming&&o.jsxs("span",{className:"phase-bar__timing",children:["▶ ",s[a.currentTiming]??a.currentTiming]}),o.jsx("span",{style:{flex:1}}),o.jsx("button",{className:"phase-bar__autosave-btn",onClick:t,title:n?"自动存档已开启（点击关闭）":"自动存档已关闭（点击开启）",children:n?"💾 自动":"💾 关"}),o.jsx("button",{className:"phase-bar__save-btn",onClick:e,title:"保存游戏",children:"💾 保存"}),o.jsx("button",{className:"phase-bar__save-btn",onClick:()=>of(a),title:"导出全量日志（含调试状态快照）",children:"📋 日志"})]})}function M1(e){return e.startsWith("[DBG]")?"log-panel__entry log-panel__entry--debug":e.startsWith("===")?"log-panel__entry log-panel__entry--round-start":e.startsWith("---")?"log-panel__entry log-panel__entry--round-end":e.includes("发动")||e.includes("攻击")?"log-panel__entry log-panel__entry--attack":e.includes("摧毁")||e.includes("连锁")||e.includes("诱爆")?"log-panel__entry log-panel__entry--damage":e.includes("移动到")?"log-panel__entry log-panel__entry--move":e.includes("获胜")||e.includes("击破")||e.includes("平局")?"log-panel__entry log-panel__entry--victory":"log-panel__entry"}function Nr(){const e=Vr();return o.jsx("div",{className:"log-panel",children:o.jsx("div",{className:"log-panel__entries",children:[...e.log].filter(n=>!n.startsWith("[DBG]")).reverse().map((n,t)=>o.jsx("div",{className:M1(n),children:n},t))})})}function Iu(){const{isAnimating:e,skipAnimation:n}=zr();return e?o.jsx("button",{className:"skip-anim-btn",onClick:n,children:"⏩ 跳过"}):null}function E1(){return o.jsx(As,{children:o.jsx(Hm,{children:o.jsx(N1,{})})})}const ku=`
.game-screen__header {
  background: var(--color-bg-panel);
  border-bottom: 1px solid var(--color-border);
}
...
`;yi.createRoot(document.getElementById("root")).render(o.jsx(Ef.StrictMode,{children:o.jsx(E1,{})}));
